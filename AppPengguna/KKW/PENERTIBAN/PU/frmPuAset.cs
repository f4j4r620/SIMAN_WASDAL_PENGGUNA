    ...
    public partial class frmPuAset : Form
    {
        ...
        public void getInitialData()
        {
            try
            {
                ...
                {
                    case "Y":
                        whereTb = " (KD_JNS_BMN = 1 OR KD_JNS_BMN = 2) AND ";
                        break;
                    case "N":
                        whereTb = " (KD_JNS_BMN != 1 AND KD_JNS_BMN != 2) AND ";
                        break;
                }
                //parInp.STR_WHERE = String.Format(" {0} ID_SATKER = {1} {2} ", whereTb, idSatker, strCari);
                parInp.STR_WHERE = String.Format(" {0} ID_SATKER = {1} AND IN_KD_PELAYANAN =  {2} {3}",whereTb, konfigApp.idSatker, konfigApp.kdPelayanan,strCari);
