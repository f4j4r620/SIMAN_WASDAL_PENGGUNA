...
namespace AppPengguna.KKW.TL.PU
{
    public partial class frmPuAset : Form
    {
        ...
        SvcWasdalAsetSelect.sbsnAsetSelect_pttClient ambilDaftarAset;
        SvcWasdalAsetSelect.SBSNSROW_SBSN_M_ASET dataTerpilih;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                ambilDaftarAset = new SvcWasdalAsetSelect.sbsnAsetSelect_pttClient();
        ...
        {
            int jmlData = dataOut.SF_ROW_SBSN_M_ASET.Count();
            ...
            {
                dataOut.SF_ROW_SBSN_M_ASET[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_ROW_SBSN_M_ASET[i]);
            }
        ...
        public SvcWasdalAsetSelect.SBSNSROW_SBSN_M_ASET daftarAsetTerpilih;
        ...
        private void bbiSimpan_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (rowTerpilih != null)
            {
                ...
                else
                {
                    ...
                    {
                        daftarAsetTerpilih = (SvcWasdalAsetSelect.SBSNSROW_SBSN_M_ASET)daftarTerpilih[i];
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalAsetSelect.SBSNSROW_SBSN_M_ASET)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
