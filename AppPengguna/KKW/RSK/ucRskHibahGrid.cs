...
{
    public partial class ucRskHibahGrid : UserControl
    {
        ...
        private void gvGridSk_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (viewTerpilih.SelectedRowsCount > 0)
                dataTerpilih = (SvcWasdalHibahSkSelect.WASDALSROW_READ_WASDAL_PT_HIBAH)viewTerpilih.GetRow(e.FocusedRowHandle);
        }
