...
{
    public partial class frmPuAsetNonPsp : Form
    {
        ...
        public void getInitialData()
        {
            try
            {
                ...
                string tambahan = (konfigApp.kodeSatker.Contains("DK") || konfigApp.kodeSatker.Contains("TP"))?"AND IN_KD_PELAYANAN IS NOT NULL ":" ";
        ...
        private void dsSimpanData(SvcWasdalAsetSelect.OutputParameters dataOut)
        {
            ...
            string totalData = (jmlData == 0) ? jmlData.ToString() : dataOut.SF_ROW_WASDAL_M_ASET[jmlData - 1].TOTAL_DATA.ToString();
