...
namespace AppPengguna.KKW.RSK
{
    public partial class ucRskHibahForm : UserControl
    {
        ...
        private delegate void DsDaftarAset(SvcWasdalHibahDetailCrud.OutputParameters dataOut);

        private void dsDaftarAset(SvcWasdalHibahDetailCrud.OutputParameters dataOut)
        {
