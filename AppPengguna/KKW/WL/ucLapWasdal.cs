...
using AppPengguna.KKW.WL.PENGGUNAAN;
using AppPengguna.KKW.WL.PEMINDAHTANGANAN;
using AppPengguna.KKW.WL.PENGHAPUSAN;
using AppPengguna.KKW.WL.PEMANFAATAN;
using AppPengguna.KKW.WL.PEMINDAHTANGAN;
...
//    public delegate void CariDataOnline(string strCariData);
    ...
    public partial class ucLapWasdal : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public FrmKoorKorwil FrmKoorKorwil;
        ...
        public ucLapWasdal(FrmKoorKorwil _frmKpknl)
        {
            InitializeComponent();
            this.FrmKoorKorwil = _frmKpknl;
            this.initSearch();
        ...
        public void tabSelect()
        {
            ...
            if (xtbDetail1.SelectedTabPageIndex == 0)
            {
                ...
                if (!tabPenggunaan1Open)
                {
                    ...
                    {
                        penggunaan1 = new ucPenggunaan(FrmKoorKorwil, this);
                    ...
                    {
                        pemanfaatan1 = new ucPemanfaatan(FrmKoorKorwil, this);
                    ...
                    {
                        pemindahtanganan1 = new ucPemindahtangan(FrmKoorKorwil, this);
                    ...
                    {
                        penghapusan1 = new ucPenghapusan(FrmKoorKorwil, this);
                    ...
                    {
                        penggunaan2 = new ucPenggunaanNew(FrmKoorKorwil, this);
                    ...
                    {
                        pemanfaatan2 = new ucPemanfaatanNew(FrmKoorKorwil, this);
                    ...
                    {
                        pemindahtanganan2 = new ucPemindahtanganNew(FrmKoorKorwil, this);
                    ...
                    else if (namaModul.Equals("Penertiban BMN Monitoring")) {
                        pemindahtanganan2 = new ucPemindahtanganNew(FrmKoorKorwil, this);
                        pemindahtanganan2.cariDataOnline = new CariDataOnline(this.pencarianData);
                        pemindahtanganan2.Dock = DockStyle.Fill;
                        panelPenggunaan.Controls.Clear();
                ...
                if (xtbDetail1.SelectedTabPageIndex == 0)
                {
                    ...
                    if (xtpPenggunaan.Text.Equals("Pemanfaatan BMN Monitoring"))
                    {
                        if ((pemanfaatan2.modeLoadData != "cari") || (cariSebelumnya != teCari1.Text.Trim()))
                        {
                            ...
                            cariSebelumnya = teCari1.Text.Trim();
                            pemanfaatan2.initModeLoad = true;
                        }
                        else
                        {
                    ...
                    if (xtpPenggunaan.Text.Equals("Pemindahtanganan BMN Monitoring"))
                    {
                        if ((pemindahtanganan2.modeLoadData != "cari") || (cariSebelumnya != teCari1.Text.Trim()))
                        {
                            pemindahtanganan2.dataInisial = true;
                            pemindahtanganan2.modeLoadData = "cari";
                            cariSebelumnya = teCari1.Text.Trim();
                            pemindahtanganan2.initModeLoad = true;
                        }
                        else
                        {
                            pemindahtanganan2.dataInisial = false;
                            pemindahtanganan2.initModeLoad = false;
                        }
                        this.setStrCari();
                        pemindahtanganan2.cariDataOnline(this.strCari, true);
                    }
                }
        ...
        private void pencarianData(string kataCari, bool initcari)
        {
            if (xtbDetail1.SelectedTabPageIndex == 0)
            {
                ...
                {
                    penggunaan2.strCari = kataCari;
                    penggunaan2.getTindakLanjut();
                }
                else if (xtpPenggunaan.Text.Equals("Pemanfaatan BMN Monitoring"))
                {
                    pemanfaatan2.strCari = kataCari;
                    pemanfaatan2.getTindakLanjut();
                }
                else if (xtpPenggunaan.Text.Equals("Pemindahtanganan BMN Monitoring"))
                {
                    pemindahtanganan2.strCari = kataCari;
                    pemindahtanganan2.getTindakLanjut();
                }
            }
