...
namespace AppPengguna.KKW.MWD.HapusBmnLain.DETAIL1
{
    ...
    public partial class ucTindakLanjut : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucTindakLanjut(FrmKoorKorwil _frmSatker, ucHapusBmnLain _ucHapusBmnLain)
        {
            InitializeComponent();
        ...
        public void getTindakLanjut()
        {
            ...
            try
            {
                ...
                parInp.STR_WHERE = " ID_KORWIL = "+ konfigApp.idKorwil + " " + HapusBmnLain.strKdPelayanan + this.strCari;
                parInp.P_COL = "KD_BRG";
                parInp.P_SORT = "ASC";
                parInp.P_COUNT = "y";
