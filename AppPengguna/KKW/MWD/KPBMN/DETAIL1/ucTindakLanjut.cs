...
namespace AppPengguna.KKW.MWD.KPBMN.DETAIL1
{
    ...
    public partial class ucTindakLanjut : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucTindakLanjut(FrmKoorKorwil _frmSatker, ucKPBMN _ucASPBMN)
        {
            InitializeComponent();
        ...
        public void getTindakLanjut()
        {
            ...
            try
            {
                ...
                parInp.STR_WHERE = " ID_KORWIL = " + konfigApp.idKorwil + " AND (NO_SURAT <> '-')" + KPBMN.strKdPelayanan + this.strCari;
