...
namespace AppPengguna.KKW.MWD.HapusBmnPengadilan
{
    ...
    public partial class ucHapusBmnPengadilan : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucHapusBmnPengadilan(FrmKoorKorwil _frmSatker)
        {
            InitializeComponent();
        ...
        public void initSearch()
        {
            ...
            this.dtParams1.Add("{1}%");
            this.addColumn("ALASAN", "ALASAN");
            this.dtParams1.Add("{1}%");
            this.addColumn("NAMA_PENGADILAN", "NAMA PENGADILAN");
            this.dtParams1.Add("{1}%");
