...
using AppPengguna.KKW.MWD.PMBMN;
...
namespace AppPengguna.KKW.MWD.HapusBmnPengadilan
{
...

    {
        ...
        ucHapusBmnPengadilan uchapusBmnPengadilan;
        ...
        public frmTL(ucHapusBmnPengadilan _uchapusBmnPengadilan)
        {
            InitializeComponent(); Icon = Properties.Resources.logo_2016;
            this.uchapusBmnPengadilan = _uchapusBmnPengadilan;
        }
        ...
        private void responWlPSPBMNLAINDetailCrud(SvcWasdalHapusDetilCud.OutputParameters dataoutWlPSPBMNLAINDetailCrud)
        {
            ...
            {
                uchapusBmnPengadilan.tabSelect();
                this.Close();
            }
            else
            {
