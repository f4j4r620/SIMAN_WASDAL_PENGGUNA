...
namespace AppPengguna.KKW.MWD.TUKAR
{
    ...
    public partial class ucTukar : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucTukar(FrmKoorKorwil _frmKpknl)
        {
            InitializeComponent();
        ...
        public void tabSelect()
        {
            ...
            if (xtbDetail1.SelectedTabPageIndex == 0)
            {
                if (!tabTindakLanjut1Open)
                {
                    ...
                    {
                        tindakLanjut1 = new DETAIL1.ucTindakLanjut(FrmKoorKorwil, this);
            ...
            //    if (!tabTanah1Open)
            //    {
            //        tanah1 = new DETAIL1.ucTanah(FrmKoorKorwil, this);
            ...
            //    if (!tabBangunan1Open)
            //    {
            //        bangunan1 = new DETAIL1.ucBangunan(FrmKoorKorwil, this);
            ...
            //    if (!tabRmhNgr1Open)
            //    {
            //        rmhNgr1 = new DETAIL1.ucRmhNgr(FrmKoorKorwil, this);
            ...
            //    if (!tabAngkutan1Open)
            //    {
            //        angkutan1 = new DETAIL1.ucAngkutan(FrmKoorKorwil, this);
            ...
            //    if (!tabBgnAir1Open)
            //    {
            //        bangunanAir1 = new DETAIL1.ucBangunanAir(FrmKoorKorwil, this);
            ...
            //    if (!tabSenjata1Open)
            //    {
            //        senjata1 = new DETAIL1.ucSenjata(FrmKoorKorwil, this);
            ...
            //    if (!tabMsnNTik1Open)
            //    {
            //        mesinNonTik1 = new DETAIL1.ucMesinNonTik(FrmKoorKorwil, this);
            ...
            //    if (!tabJlnJmbtn1Open)
            //    {
            //        jlnJmbtn1 = new DETAIL1.ucJlnJmbtn(FrmKoorKorwil, this);
            ...
            //    if (!tabPropSus1Open)
            //    {
            //        propSus1 = new DETAIL1.ucPropSus(FrmKoorKorwil, this);
            ...
            //    if (!tabAtl1Open)
            //    {
            //        ATL1 = new DETAIL1.ucATL(FrmKoorKorwil, this);
            ...
            //    if (!tabMsnTik1Open)
            //    {
            //        mesinTik1 = new DETAIL1.ucMesinTik(FrmKoorKorwil, this);
            ...
            //    if (!tabAtb1Open)
            //    {
            //        ATB1 = new DETAIL1.ucATB(FrmKoorKorwil, this);
            ...
            //    if (!tabKdp1Open)
            //    {
            //        KDP1 = new DETAIL1.ucKDP(FrmKoorKorwil, this);
            ...
            //    if (!tabRenov1Open)
            //    {
            //        renovasi1 = new DETAIL1.ucRenovasi(FrmKoorKorwil, this);
        ...
        public void initSearch()
        {
            ...
            this.dtParams1.Add("{1}%");
            this.addColumn("Aset_Pengganti_jenis", "Aset Pengganti jenis");
            this.dtParams1.Add("%{1}%");
            this.addColumn("Aset_Pengganti_kuantitas", "Aset Pengganti kuantitas");
            this.dtParams1.Add("{1}%");
            this.addColumn("Aset_Pengganti_Luas", "Aset Pengganti Luas");
            this.dtParams1.Add("{1}%");
            this.addColumn("Aset_Pengganti_Alamat", "Aset Pengganti Alamat");
            this.dtParams1.Add("{1}%");
