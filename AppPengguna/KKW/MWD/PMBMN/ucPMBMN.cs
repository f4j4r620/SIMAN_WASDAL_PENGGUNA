...
namespace AppPengguna.KKW.MWD.PMBMN
{
    ...
    public partial class ucPMBMN : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucPMBMN(FrmKoorKorwil _frmSatker)
        {
            InitializeComponent();
            this.FrmKoorKorwil = _frmSatker; 
            this.initSearch();
        ...
        public void initSearch()
        {
            ...
            this.dtParams1.Add("%{1}%");
            this.addColumn("NILAI_PEROLEHAN", "NILAI PEROLEHAN");
            this.dtParams1.Add("%{1}%");
            this.addColumn("PERUNTUKAN", "PERUNTUKAN");
            this.dtParams1.Add("{1}%");
            this.addColumn("NOMOR_PP", "NOMOR PP");
            this.dtParams1.Add("{1}%");
            this.addColumn("TGL_PP", "TANGGAL PP");
            this.dtParams1.Add("{1}%");
            this.addColumn("KODE_PELAYANAN", "KODE PELAYANAN");
            this.dtParams1.Add("{1}%");
            this.addColumn("NAMA_PELAYANAN", "NAMA PELAYANAN");
            this.dtParams1.Add("{1}%");
