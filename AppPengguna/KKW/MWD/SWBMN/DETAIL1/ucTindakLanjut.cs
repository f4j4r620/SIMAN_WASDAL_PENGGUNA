...
namespace AppPengguna.KKW.MWD.SWBMN.DETAIL1
{
    ...
    public partial class ucTindakLanjut : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucTindakLanjut(FrmKoorKorwil _frmSatker, ucSWBMN _ucSWBMN)
        {
            InitializeComponent();
        ...
        public void getTindakLanjut()
        {
            ...
            try
            {
                ...
                parInp.STR_WHERE = " ID_KORWIL = " + konfigApp.idKorwil + " AND (NO_SURAT <> '-')" + SWBMN.strKdPelayanan + this.strCari;
