...
namespace AppPengguna.KKW.MWD.PSPBMN.DETAIL1
{
    ...
    public partial class ucTindakLanjut : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucTindakLanjut(FrmKoorKorwil _frmKorwil, ucPSPBMN _ucPSPBMN)
        {
            InitializeComponent();
        ...
        public void getTindakLanjut()
        {
            ...
            try
            {
                ...
                parInp.STR_WHERE = " ID_KORWIL=" + konfigApp.idKorwil + " " + PSPBMN.strKdPelayanan + " AND NO_SURAT <> '-' " + this.strCari;
