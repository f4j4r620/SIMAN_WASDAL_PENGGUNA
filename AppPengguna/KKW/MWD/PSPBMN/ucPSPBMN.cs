...
namespace AppPengguna.KKW.MWD.PSPBMN
{
    ...
    public partial class ucPSPBMN : DevExpress.XtraEditors.XtraUserControl
    {
       ...
       // public DETAIL2.ucPersediaan persediaan2 = null;
        ...
        public ucPSPBMN(FrmKoorKorwil _frmKpknl)
        {
            InitializeComponent();
        ...
        public void tabSelect()
        {
            ...
            else 
            {
                ...
                if (xtbDetail2.SelectedTabPageIndex == 0)
                {
                    if (!tabTanah2Open)
                    {
                        tanah2 = new DETAIL2.ucTanah(frmKoorKorwil, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 1)
                {
                    if (!tabBangunan2Open)
                    {
                        bangunan2 = new DETAIL2.ucBangunan(frmKoorKorwil, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 2)
                {
                    if (!tabRmhNgr2Open)
                    {
                        rmhNgr2 = new DETAIL2.ucRmhNgr(frmKoorKorwil, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 3)
                {
                    if (!tabAngkutan2Open)
                    {
                        angkutan2 = new DETAIL2.ucAngkutan(frmKoorKorwil, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 4)
                {
                    if (!tabBgnAir2Open)
                    {
                        bangunanAir2 = new DETAIL2.ucBangunanAir(frmKoorKorwil, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 5)
                {
                    if (!tabSenjata2Open)
                    {
                        senjata2 = new DETAIL2.ucSenjata(frmKoorKorwil, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 6)
                {
                    if (!tabMsnNTik2Open)
                    {
                        mesinNonTik2 = new DETAIL2.ucMesinNonTik(frmKoorKorwil, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 7)
                {
                    if (!tabJlnJmbtn2Open)
                    {
                        jlnJmbtn2 = new DETAIL2.ucJlnJmbtn(frmKoorKorwil, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 8)
                {
                    if (!tabPropSus2Open)
                    {
                        propSus2 = new DETAIL2.ucPropSus(frmKoorKorwil, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 9)
                {
                    if (!tabAtl2Open)
                    {
                        ATL2 = new DETAIL2.ucATL(frmKoorKorwil, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 10)
                {
                    if (!tabMsnTik2Open)
                    {
                        mesinTik2 = new DETAIL2.ucMesinTik(frmKoorKorwil, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 11)
                {
                    if (!tabAtb2Open)
                    {
                        ATB2 = new DETAIL2.ucATB(frmKoorKorwil, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 12)
                {
                    if (!tabKdp2Open)
                    {
                        KDP2 = new DETAIL2.ucKDP(frmKoorKorwil, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 13)
                {
                    if (!tabRenov2Open)
                    {
                        renovasi2 = new DETAIL2.ucRenovasi(frmKoorKorwil, this);
