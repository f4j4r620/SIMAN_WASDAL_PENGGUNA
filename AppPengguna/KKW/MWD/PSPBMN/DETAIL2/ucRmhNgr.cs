...
namespace AppPengguna.KKW.MWD.PSPBMN.DETAIL2
{
    ...
    public partial class ucRmhNgr : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucRmhNgr(FrmKoorKorwil _frmKpknl, ucPSPBMN _ucPspBmn)
        {
            InitializeComponent();
        ...
        public void getRmhNgr()
        {
            ...
            try
            {
                ...
                parInp.STR_WHERE = String.Format("ID_KORWIL={0}", konfigApp.idSatker) + " AND (NO_SURAT is null) " + this.strCari;
