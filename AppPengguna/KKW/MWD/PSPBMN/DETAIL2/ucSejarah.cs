...
namespace AppPengguna.KKW.MWD.PSPBMN.DETAIL2
{
    ...
    public partial class ucSejarah : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucSejarah(FrmKoorKorwil _frmKpknl, ucPSPBMN _ucPspBmn)
        {
            InitializeComponent();
        ...
        public void getSejarah()
        {
            ...
            try
            {
                ...
                parInp.STR_WHERE = String.Format("(UPPER({0}) = '{1}') ", "ID_KORWIL", konfigApp.idKorwil) + "AND (NO_SURAT is null)" + this.strCari;
