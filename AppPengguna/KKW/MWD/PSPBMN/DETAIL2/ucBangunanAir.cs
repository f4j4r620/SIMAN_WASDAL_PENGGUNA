...
namespace AppPengguna.KKW.MWD.PSPBMN.DETAIL2
{
    ...
    public partial class ucBangunanAir : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucBangunanAir(FrmKoorKorwil _frmKpknl, ucPSPBMN _ucPspBmn)
        {
            InitializeComponent();
        ...
        private void loadDataBangunanAir(SvcMonBgnAirSelect.OutputParameters dataOut)
        {
            ...
            {
                //dataOut.SF_MON_KBAIR_PSP2[i].TGL_SK = konfigApp.setDefaultDate(dataOut.SF_MON_KBAIR_PSP2[i].TGL_SK);S
