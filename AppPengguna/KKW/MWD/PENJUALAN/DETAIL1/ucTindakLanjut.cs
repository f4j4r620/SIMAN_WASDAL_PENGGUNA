...
namespace AppPengguna.KKW.MWD.PENJUALAN.DETAIL1
{
    ...
    public partial class ucTindakLanjut : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucTindakLanjut(FrmKoorKorwil _frmSatker, ucPENJUALAN _ucPENJUALAN)
        {
            InitializeComponent();
        ...
        public void getTindakLanjut()
        {
            ...
            try
            {
                ...
                parInp.STR_WHERE = " ID_KORWIL = " + konfigApp.idKorwil+ " " + PENJUALAN.strKdPelayanan + this.strCari;
