...
{
    class ucPersediaanRwytPengguna : UserControlDetail
    {


        private frmPengelola puPengelola;
        private String Status;
        public decimal? ID_SEDIA_RWYT_PENGGUNA;
        private decimal? ID_SEDIA;
        private string search;
        public frmProgres progresBar = null;

        private SvcPersediaanRwytPengguna.call_pttClient fetchData;
        private SvcPersediaanRwytPengguna.InputParameters parInp;
        private SvcPersediaanRwytPengguna.OutputParameters outData;
        public SvcPersediaanRwytPengguna.BPSIMANSROW_SEDIA_RWYT_PENGGUNA selectedData;



        public ucPersediaanRwytPengguna(decimal? _ID_SEDIA, String Status)
            : base()
        {
        ...
        private void initTnhRPengguna()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcPersediaanRwytPengguna.BPSIMANSROW_SEDIA_RWYT_PENGGUNA);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_SEDIA_RWYT_PENGGUNA;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_SEDIA_RWYT_PENGGUNA";
                parInp.P_TABLE = "M_SEDIA_RWYT_PENGGUNA";
        ...
        public void getInitTnhRPgn(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcPersediaanRwytPengguna.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcPersediaanRwytPengguna.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcPersediaanRwytPengguna.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcPersediaanRwytPengguna.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_SEDIA_RWYT_PENGGUNA.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_SEDIA_RWYT_PENGGUNA[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_SEDIA_RWYT_PENGGUNA[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_SEDIA_RWYT_PENGGUNA[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
                binder.Add(serviceOutPut.SF_ROW_SEDIA_RWYT_PENGGUNA[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcPersediaanRwytPengguna.BPSIMANSROW_SEDIA_RWYT_PENGGUNA)selectedView.GetRow(e.FocusedRowHandle);
        ...
        SvcPersediaanRpengelolaCrud.call_pttClient svcRiwayatPengelolaCrud;
        SvcPersediaanRpengelolaCrud.OutputParameters outRiwayatPengelolaCrud;
        ...
        private void saveForm(string text)
        {
            ...
            try
            {
                ...
                SvcPersediaanRpengelolaCrud.InputParameters parInp = new SvcPersediaanRpengelolaCrud.InputParameters();
                parInp.P_ID_SEDIA = this.ID_SEDIA;
                parInp.P_ID_SEDIA_RWYT_PENGGUNA = (this.puPengelola.Status == "input") ? 0 : this.selectedData.ID_SEDIA_RWYT_PENGGUNA;
                parInp.P_ID_SEDIA_RWYT_PENGGUNASpecified = true;
                parInp.P_ID_SEDIASpecified = true;
                ...
                this.svcRiwayatPengelolaCrud = new SvcPersediaanRpengelolaCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcPersediaanRpengelolaCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcPersediaanRpengelolaCrud.OutputParameters outCrud)
        {
            SvcPersediaanRwytPengguna.BPSIMANSROW_SEDIA_RWYT_PENGGUNA dataPenyama = new SvcPersediaanRwytPengguna.BPSIMANSROW_SEDIA_RWYT_PENGGUNA();

            dataPenyama.NUM = 999;
            dataPenyama.NUMSpecified = true;
            dataPenyama.ID_ASET = (this.modeCrud == 'U') ? selectedData.ID_ASET : 0;
            dataPenyama.ID_ASETSpecified = true;
            dataPenyama.ID_SEDIA = (this.modeCrud == 'U') ? selectedData.ID_SEDIA : 0;
            dataPenyama.ID_SEDIA_RWYT_PENGGUNA = (this.modeCrud == 'U') ? selectedData.ID_SEDIA_RWYT_PENGGUNA : outCrud.PO_ID_SEDIA_RWYT_PENGGUNA;
            dataPenyama.ID_SEDIA_RWYT_PENGGUNASpecified = true;
            dataPenyama.ID_SEDIASpecified = true;
            ...
            this.ID_SEDIA_RWYT_PENGGUNA = (this.StatusCrud == "input") ? outCrud.PO_ID_SEDIA_RWYT_PENGGUNA : selectedData.ID_SEDIA_RWYT_PENGGUNA;
            ...
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puPengelola.FilePath != null)
                    {
                        ...
                        simpanFile("ID_SEDIA_RWYT_PENGGUNA", dataPenyama.ID_SEDIA_RWYT_PENGGUNA, "M_SEDIA_RWYT_PENGGUNA", filePath, "C");
                    }
                    else
                    {
                        ...
                        this.getById = true;
                        this.getInitTnhRPgn(" ID_SEDIA_RWYT_PENGGUNA = " + this.ID_SEDIA_RWYT_PENGGUNA.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puPengelola.FilePath != null)
                    {
                        ...
                        simpanFile("ID_SEDIA_RWYT_PENGGUNA", dataPenyama.ID_SEDIA_RWYT_PENGGUNA, "M_SEDIA_RWYT_PENGGUNA", filePath, SELECT);
                    }
                    else
                    {
                        this.puPengelola.Close();
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
             ...
             MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    myThread.Start();
                    SvcPersediaanRpengelolaCrud.InputParameters parInp = new SvcPersediaanRpengelolaCrud.InputParameters();
                    parInp.P_ID_SEDIA = selectedData.ID_SEDIA;
                    parInp.P_ID_SEDIASpecified = true;
                    parInp.P_ID_SEDIA_RWYT_PENGGUNA = selectedData.ID_SEDIA_RWYT_PENGGUNA;
                    parInp.P_ID_SEDIA_RWYT_PENGGUNASpecified = true;


                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatPengelolaCrud = new SvcPersediaanRpengelolaCrud.call_pttClient();
                    svcRiwayatPengelolaCrud.Open();
