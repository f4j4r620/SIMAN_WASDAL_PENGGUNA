...
{
    class ucPersediaanRwytMutasi : UserControlDetail
    {
        ...
        public decimal? ID_SEDIA;



        private SvcPersediaanRwytMutasi.call_pttClient fetchData;
        private SvcPersediaanRwytMutasi.InputParameters parInp;
        private SvcPersediaanRwytMutasi.OutputParameters outData;
        public SvcPersediaanRwytMutasi.BPSIMANSROW_SEDIA_RWYT_MUTASI selectedData;



        public ucPersediaanRwytMutasi(decimal? _ID_SEDIA, String Status)
            : base()
        {
            this.initTnhRMutasi();
            this.Status = Status;
        ...
        private void initTnhRMutasi()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcPersediaanRwytMutasi.BPSIMANSROW_SEDIA_RWYT_MUTASI);
        ...
        public void getInitMutasi(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcPersediaanRwytMutasi.InputParameters();
            parInp.P_COL = "";
            ...
            parInp.P_SORT = "DESC";
            parInp.STR_WHERE = String.Format(" ID_SEDIA = {0} {1}", this.ID_SEDIA, this.search);
            fetchData = new SvcPersediaanRwytMutasi.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcPersediaanRwytMutasi.OutputParameters dataOut);

        public void showData(SvcPersediaanRwytMutasi.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_SEDIA_RWYT_MUTASI.Count();
            ...
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_SEDIA_RWYT_MUTASI[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
                binder.Add(serviceOutPut.SF_ROW_SEDIA_RWYT_MUTASI[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcPersediaanRwytMutasi.BPSIMANSROW_SEDIA_RWYT_MUTASI)selectedView.GetRow(e.FocusedRowHandle);
