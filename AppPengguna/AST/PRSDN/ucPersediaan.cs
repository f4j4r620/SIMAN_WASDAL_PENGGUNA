...
{
    class ucPersediaan : UserControlDetail
    {
        ...
        private SvcPersediaanCrud.call_pttClient SvcPersediaanCrud;
        ...
        public ucPersediaan(bool tracking = false)
        {
        ...
        public void hapusData(SvcPersediaanSelect.BPSIMANSROW_SEDIA selectedData)
        {
            ...
            //    SvcPersediaanCrud = new SvcPersediaanCrud.call_pttClient(konfigApp.SvcPersediaanCrud_name, konfigApp.SvcPersediaanCrud_address);
            //    SvcPersediaanCrud.Beginexecute(parInp, new AsyncCallback(getResultCrud), "");
            //}
            //catch
            //{
            //    this.modeCrud = 'A';
        ...
        private void getResultCrud(IAsyncResult result)
        {
            try
            {
                outDataCrud = SvcPersediaanCrud.Endexecute(result);
                this.Invoke(new closeProgresBar(this.CloseProgresBar),DevExpress.XtraBars.BarItemVisibility.Never);
                this.Invoke(new AktifkanForm(this.aktifkanForm), "");
        ...
        private delegate void UbahBangunan(SvcPersediaanCrud.OutputParameters dataOutCrud);

        private void ubahBangunan(SvcPersediaanCrud.OutputParameters dataOutCrud)
        {
        ...
        protected override void bbSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                this.dataInisial = true;
                this.getinitPersediaan(get_where_clause(nama_kolom, opr, parameter, parameter_2));
        ...
        public void getinitPersediaan(string strwhere = null)
        {
        ...
        ucPersediaanForm PersediaanForm;
        ...
        public void showData(SvcPersediaanSelect.OutputParameters serviceOutPut)
        {
            if (!FROM_TRACKING)
            {
                ...
                if (jmlData > 0)
                {
                    ////this.SUM_RPH_ASET = serviceOutPut.SF_ROW_MSEDIA[0].SUM_RPH_ASET;
                    ////this.SUM_RPH_MUTASI = serviceOutPut.SF_ROW_MSEDIA[0].SUM_RPH_MUTASI;
                    ////this.SUM_RPH_SUSUT = serviceOutPut.SF_ROW_MSEDIA[0].SUM_RPH_SUSUT;
                }
            ...
            else
            {
                ...
                if (jmlData > 0)
                {
                    PersediaanForm = new ucPersediaanForm("detail");
                    PersediaanForm.nonAktifForm = new NonAktifkanFormSatker(this.nonAktifForm);
                    PersediaanForm.aktifkanForm = new AktifkanFormSatker(this.aktifkanForm);

                    PersediaanForm.ShowProgresBar = new showProgresBar(this.ShowProgresBar);
                    PersediaanForm.CloseProgresBar = new closeProgresBar(this.CloseProgresBar);
                    PersediaanForm.Dock = System.Windows.Forms.DockStyle.Fill;
                    PersediaanForm.IsiForm(serviceOutPut.SF_ROW_MSEDIA[0]);
                }
                 else
                 {
                     MessageBox.Show("Data aset tidak ditemukan", "Perhatian");
                 }
                setPanel(PersediaanForm);
               
                //this.frmKoorSatker.panelKoorSatker.Controls.Clear();
                //this.frmKoorSatker.panelKoorSatker.Controls.Add(PersediaanForm);
            }
