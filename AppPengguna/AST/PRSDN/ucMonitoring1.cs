...
{
  class ucMonitoring1 : UserControlDetail
  {
    ...
    public ucMonitoring1(bool tracking = false)
    {
    ...
    public void getinitMonitoring(string strwhere = null)
    {
      ...
      if (this.dataInisial == true)
      {
        this.search = " ID_SATKER = " + Convert.ToString(konfigApp.idSatker);
      }
    ...
    //ucMonitoring1Form JalanJembatanForm;
    ...
    public void showData(SvcPersediaanSelect.OutputParameters serviceOutPut)
    {
      ...
      else
      {
        ...
        if (jmlData > 0)
        {
          //JalanJembatanForm = new ucMonitoring1Form("detail");
