...
{
    public delegate void SimpanDokRumahNegara(SvcDokRmhNgrCrud.InputParameters parIn);
    public partial class PuDokRumahNegara : Form
    {

        public NonAktifkanFormSatker nonAktifForm;
        public AktifkanFormSatker aktifkanForm;
        public SimpanDokRumahNegara simpanDokRumahNegara;
        ...
        public string FilePath;
          ...
          public PuDokRumahNegara( string status, decimal? id_krmh_neg, decimal? id_kbdg_dok)
        {
            InitializeComponent();
            this.ID_KRMH_NEG = id_krmh_neg;
            this.teIdKbdg.Text = id_krmh_neg.ToString();
            this.ID_KRMH_DOK = id_kbdg_dok;
            this.STATUS = status;
          ...
          public PuDokRumahNegara(string status, SvcDokRmhNgrSelect.BPSIMANSROW_M_KRMH_NEG_DOK selectedData)
          {
              InitializeComponent();
              this.STATUS = status;
        ...
        public void init()
        {
            ...
            else if (this.STATUS == "edit")
            {
                try
                {
                    ...
                    this.ID_KRMH_DOK = selectedData.ID_KRMH_DOK;
                    ...
                    this.ID_KRMH_DOK = selectedData.ID_KRMH_DOK;
                    this.teNamaDok.Text = selectedData.NM_JNS_SERTI;
                    ...
                    //this.textEdit5.Text = selectedData.KET_DOK;
        ...
        private void barSimpan_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
                if(this.cek_input())
                {
	                ...
	                {	        
                        ...
                        parInp.P_ID_KRMH_DOK = this.ID_KRMH_DOK;
                        ...
                        parInp.P_KET_DOK = this.meKet.Text;
                        if (teFilePath.Text != null)
                        {
                            //parInp.P_ISI_FILE = konfigApp.FileToByteArray(teFilePath.Text);
        ...
        private void teUrDok_EditValueChanged(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                this.teTglBerlaku.Text = "01/01/0001";
                this.teTglDok.Text = "01/01/0001";
