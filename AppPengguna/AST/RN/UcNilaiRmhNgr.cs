...
{
    class UcNilaiRmhNgr : UserControlDetail
    {


        private frmNilai puNilai;
        private decimal? ID_KRMH_RWYT_NILAI;
        ...
        private SvcRwyNilRmhNgrSelect.call_pttClient fetchData;
        private SvcRwyNilRmhNgrSelect.InputParameters parInp;
        private SvcRwyNilRmhNgrSelect.OutputParameters outData;
        private SvcRwyNilRmhNgrSelect.BPSIMANSROW_KRMH_NEG_RWYT_NILAI selectedData;


        public UcNilaiRmhNgr(decimal? _ID_KRMH_NEG, String _Status)
            : base()
        {
        ...
        private void initTnhRPenilaian()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcRwyNilRmhNgrSelect.BPSIMANSROW_KRMH_NEG_RWYT_NILAI);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KRMH_RWYT_NILAI;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_KRMH_RWYT_NILAI";
                parInp.P_TABLE = "M_KRMH_NEG_RWYT_NILAI";
        ...
        public void getInitTnhRPnl(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcRwyNilRmhNgrSelect.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcRwyNilRmhNgrSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcRwyNilRmhNgrSelect.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcRwyNilRmhNgrSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_KRMH_NEG_RWYT_NILAI.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_KRMH_NEG_RWYT_NILAI[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_KRMH_NEG_RWYT_NILAI[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_KRMH_NEG_RWYT_NILAI[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
              string date = Convert.ToString(serviceOutPut.SF_ROW_KRMH_NEG_RWYT_NILAI[i].TGL_BUKU).Substring(0, 10);
              string date_ = Convert.ToString(serviceOutPut.SF_ROW_KRMH_NEG_RWYT_NILAI[i].TGL_BUKU).Substring(0, 8);
              string date2 = Convert.ToString(serviceOutPut.SF_ROW_KRMH_NEG_RWYT_NILAI[i].TGL_NILAI).Substring(0, 10);
              string date2_ = Convert.ToString(serviceOutPut.SF_ROW_KRMH_NEG_RWYT_NILAI[i].TGL_NILAI).Substring(0, 8);

              if (date == "11/11/1000" || date_ == "1/1/0001")
              {
                serviceOutPut.SF_ROW_KRMH_NEG_RWYT_NILAI[i].TGL_BUKU = null;
              }
              if (date2 == "11/11/1000" || date2_ == "1/1/0001")
              {
                serviceOutPut.SF_ROW_KRMH_NEG_RWYT_NILAI[i].TGL_NILAI = null;
              }
                binder.Add(serviceOutPut.SF_ROW_KRMH_NEG_RWYT_NILAI[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcRwyNilRmhNgrSelect.BPSIMANSROW_KRMH_NEG_RWYT_NILAI)selectedView.GetRow(e.FocusedRowHandle);
        ...
        SvcRumahRnilaiCrud.call_pttClient svcRiwayatNilaiCrud;
        SvcRumahRnilaiCrud.OutputParameters outRiwayatNilaiCrud;
        ...
        private void saveFrmNilai(string text)
        {
            ...
            try
            {
                ...
                SvcRumahRnilaiCrud.InputParameters parInp = new SvcRumahRnilaiCrud.InputParameters();
                parInp.P_ID_KRMH_NEG = this.ID_KRMH_NEG;
                parInp.P_ID_KRMH_RWYT_NILAI = (this.puNilai.Status == "input") ? 0 : this.selectedData.ID_KRMH_RWYT_NILAI;
                parInp.P_ID_KRMH_RWYT_NILAISpecified = true;
                ...
                this.svcRiwayatNilaiCrud = new SvcRumahRnilaiCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcRumahRnilaiCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcRumahRnilaiCrud.OutputParameters outCrud)
        {
            SvcRwyNilRmhNgrSelect.BPSIMANSROW_KRMH_NEG_RWYT_NILAI dataPenyama = new SvcRwyNilRmhNgrSelect.BPSIMANSROW_KRMH_NEG_RWYT_NILAI();
            ...
            dataPenyama.ID_KRMH_RWYT_NILAI = (this.modeCrud == 'U') ? selectedData.ID_KRMH_RWYT_NILAI : outCrud.PO_ID_KRMH_RWYT_NILAI;
            dataPenyama.ID_KRMH_RWYT_NILAISpecified = true;
            ...
            this.ID_KRMH_RWYT_NILAI = (this.StatusCrud == "edit")? selectedData.ID_KRMH_RWYT_NILAI : outCrud.PO_ID_KRMH_RWYT_NILAI;
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puNilai.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KRMH_RWYT_NILAI", dataPenyama.ID_KRMH_RWYT_NILAI, "M_KRMH_NEG_RWYT_NILAI", filePath, "C", puNilai.ID_JNSDOK);
                    }
                    else
                    {
                        this.puNilai.Close();
                        ...
                        this.getById = true;
                        this.getInitTnhRPnl(" ID_KRMH_RWYT_NILAI = " + outCrud.PO_ID_KRMH_RWYT_NILAI.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puNilai.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KRMH_RWYT_NILAI", dataPenyama.ID_KRMH_RWYT_NILAI, "M_KRMH_NEG_RWYT_NILAI", filePath, SELECT, puNilai.ID_JNSDOK);
                    }
                    else
                    {
                        this.puNilai.Close();
        ...
        private void crudDokAset(SvcAsetDokCrud.OutputParameters dataoutDokAsetCrud)
        {
            if (dataoutDokAsetCrud.PO_RESULT == "Y")
            {
                ...
                if (this.modeCrud != 'D')
                {
                    ...
                    this.dataInisial = false;
                    this.getById = true;
                    this.getInitTnhRPnl(" ID_KRMH_RWYT_NILAI = " + ID_KRMH_RWYT_NILAI.ToString());
                }
            }
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
               ...
               MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    parInp.P_ID_KRMH_RWYT_NILAI = selectedData.ID_KRMH_RWYT_NILAI;
                    parInp.P_ID_KRMH_RWYT_NILAISpecified = true;
                    parInp.P_ID_KRMH_NEGSpecified = true;
                    ...
                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatNilaiCrud = new SvcRumahRnilaiCrud.call_pttClient();
                    svcRiwayatNilaiCrud.Open();
