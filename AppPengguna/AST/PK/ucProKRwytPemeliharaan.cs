...
{
    class ucProKRwytPemeliharaan : UserControlDetail
    {
        ...
        private decimal? ID_KPROK_RWYT_PELIHARA;



        private SvcProkRwytPemeliharaanSelect.call_pttClient fetchData;
        private SvcProkRwytPemeliharaanSelect.InputParameters parInp;
        private SvcProkRwytPemeliharaanSelect.OutputParameters outData;
        private SvcProkRwytPemeliharaanSelect.BPSIMANSROW_M_KPROK_RWYT_PELIHARA selectedData;




        public ucProKRwytPemeliharaan(decimal? _ID_KPROK, String Status)
            : base()
        {
        ...
        private void initTnhRPemeliharaan()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcProkRwytPemeliharaanSelect.BPSIMANSROW_M_KPROK_RWYT_PELIHARA);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KPROK_RWYT_PELIHARA;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_KPROK_RWYT_PELIHARA";
                parInp.P_TABLE = "M_KPROK_RWYT_PELIHARA";
        ...
        public void getInitTnhRPml(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcProkRwytPemeliharaanSelect.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcProkRwytPemeliharaanSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcProkRwytPemeliharaanSelect.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcProkRwytPemeliharaanSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[0].NUM = this.NUM;
                    
                }
                else
                {
                    serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
                string date = Convert.ToString(serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].TGL_BUKU).Substring(0, 10);
                string date_ = Convert.ToString(serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].TGL_BUKU).Substring(0, 8);
                string date2 = Convert.ToString(serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].TGL_SP2D).Substring(0, 10);
                string date2_ = Convert.ToString(serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].TGL_SP2D).Substring(0, 8);
                if (date == "11/11/1000" || date_ == "1/1/0001")
                {
                    serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].TGL_BUKU = null;
                    
                }
                if (date2 == "11/11/1000" || date2_ == "1/1/0001")
                {
                    
                    serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].TGL_SP2D = null;
                }
                if (serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].NO_DIPA == "-")
                {
                    serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].NO_DIPA = null;
                }
                if (serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].NO_SP2D == "-")
                {
                    serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].NO_SP2D = null;
                }
                if (serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].KD_AKUN == "-")
                {
                    serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].KD_AKUN = null;
                }
                if (serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].UR_AKUN == "-")
                {
                    serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].UR_AKUN = null;
                }
                if (serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].JNS_PELIHARA == "-")
                {
                    serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].JNS_PELIHARA = null;
                }
                if (serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].UR_SATKER == "-")
                {
                    serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].UR_SATKER = null;
                }
                if (serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].KET == "-")
                {
                    serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].KET = null;
                }
                if (serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].NMFILE == "-")
                {
                    serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].NMFILE = null;
                }
                if (serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].KD_SATKER == "-")
                {
                    serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i].KD_SATKER = null;
                }
                binder.Add(serviceOutPut.SF_ROW_M_KPROK_RWYT_PELIHARA[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcProkRwytPemeliharaanSelect.BPSIMANSROW_M_KPROK_RWYT_PELIHARA)selectedView.GetRow(e.FocusedRowHandle);
        ...
        SvcProkKhususRpemeliharaanCrud.call_pttClient svcRiwayatPemeliharaanCrud;
        SvcProkKhususRpemeliharaanCrud.OutputParameters outRiwayatPemeliharaanCrud;
        ...
        private void saveForm(string text)
        {
            ...
            try
            {
                ...
                SvcProkKhususRpemeliharaanCrud.InputParameters parInp = new SvcProkKhususRpemeliharaanCrud.InputParameters();
                parInp.P_ID_KPROK = this.ID_KPROK;
                parInp.P_ID_KPROK_RWYT_PELIHARA = (this.puPemeliharaan.Status == "input") ? 0 : this.selectedData.ID_KPROK_RWYT_PELIHARA;
                parInp.P_ID_KPROK_RWYT_PELIHARASpecified = true;
                ...
                this.svcRiwayatPemeliharaanCrud = new SvcProkKhususRpemeliharaanCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcProkKhususRpemeliharaanCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcProkKhususRpemeliharaanCrud.OutputParameters outCrud)
        {
            SvcProkRwytPemeliharaanSelect.BPSIMANSROW_M_KPROK_RWYT_PELIHARA dataPenyama = new SvcProkRwytPemeliharaanSelect.BPSIMANSROW_M_KPROK_RWYT_PELIHARA();
            ...
            dataPenyama.ID_KPROK_RWYT_PELIHARA = (this.modeCrud == 'U') ? selectedData.ID_KPROK_RWYT_PELIHARA : outCrud.PO_ID_KPROK_RWYT_PELIHARA;
            dataPenyama.ID_KPROK_RWYT_PELIHARASpecified = true;
            ...
            this.ID_KPROK_RWYT_PELIHARA = outCrud.PO_ID_KPROK_RWYT_PELIHARA;
            ...
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puPemeliharaan.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KPROK_RWYT_PELIHARA", dataPenyama.ID_KPROK_RWYT_PELIHARA, "M_KPROK_RWYT_PELIHARA", filePath, "C");
                    }
                    else
                    {
                        ...
                        this.getById = true;
                        this.getInitTnhRPml(" ID_KPROK_RWYT_PELIHARA = " + outCrud.PO_ID_KPROK_RWYT_PELIHARA.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puPemeliharaan.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KPROK_RWYT_PELIHARA", dataPenyama.ID_KPROK_RWYT_PELIHARA, "M_KPROK_RWYT_PELIHARA", filePath, SELECT);
                    }
                    else
                    {
        ...
        private void crudDokAset(SvcAsetDokCrud.OutputParameters dataoutDokAsetCrud)
        {
            if (dataoutDokAsetCrud.PO_RESULT == "Y")
            {
                ...
                if (this.modeCrud != 'D')
                {
                    ...
                    this.dataInisial = false;
                    this.getById = true;
                    this.getInitTnhRPml(" ID_KPROK_RWYT_PELIHARA = " + this.ID_KPROK_RWYT_PELIHARA.ToString());
                }
            }
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
              ...
              MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    parInp.P_ID_KPROKSpecified = true;
                    parInp.P_ID_KPROK_RWYT_PELIHARA = selectedData.ID_KPROK_RWYT_PELIHARA;
                    parInp.P_ID_KPROK_RWYT_PELIHARASpecified = true;


                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatPemeliharaanCrud = new SvcProkKhususRpemeliharaanCrud.call_pttClient();
                    svcRiwayatPemeliharaanCrud.Open();
