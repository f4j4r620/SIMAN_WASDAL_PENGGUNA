...
{
    class ucPropKRwytNilai : UserControlDetail
    {


        private frmNilai puNilai;
        private decimal? ID_KPROK_RWYT_NILAI;
        ...
        private SvcProkRwytNilaiSelect.call_pttClient fetchData;
        private SvcProkRwytNilaiSelect.InputParameters parInp;
        private SvcProkRwytNilaiSelect.OutputParameters outData;
        private SvcProkRwytNilaiSelect.BPSIMANSROW_M_KPROK_RWYT_NILAI selectedData;


        public ucPropKRwytNilai(decimal? _ID_KPROK, String _Status)
            : base()
        {
        ...
        private void initTnhRPenilaian()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcProkRwytNilaiSelect.BPSIMANSROW_M_KPROK_RWYT_NILAI);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KPROK_RWYT_NILAI;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_KPROK_RWYT_NILAI";
                parInp.P_TABLE = "M_KPROK_RWYT_NILAI";
        ...
        public void getInitTnhRPnl(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcProkRwytNilaiSelect.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcProkRwytNilaiSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcProkRwytNilaiSelect.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcProkRwytNilaiSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_M_KPROK_RWYT_NILAI.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_M_KPROK_RWYT_NILAI[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_M_KPROK_RWYT_NILAI[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KPROK_RWYT_NILAI[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
                string date = Convert.ToString(serviceOutPut.SF_ROW_M_KPROK_RWYT_NILAI[i].TGL_BUKU).Substring(0, 10);
                string date_ = Convert.ToString(serviceOutPut.SF_ROW_M_KPROK_RWYT_NILAI[i].TGL_BUKU).Substring(0, 8);
                string date2 = Convert.ToString(serviceOutPut.SF_ROW_M_KPROK_RWYT_NILAI[i].TGL_NILAI).Substring(0, 10);
                string date2_ = Convert.ToString(serviceOutPut.SF_ROW_M_KPROK_RWYT_NILAI[i].TGL_NILAI).Substring(0, 8);
                if (date == "11/11/1000" || date_ == "1/1/0001")
                {
                    serviceOutPut.SF_ROW_M_KPROK_RWYT_NILAI[i].TGL_BUKU = null;
                    
                }
                if (date2 == "11/11/1000" || date2_ == "1/1/0001")
                {
                    
                    serviceOutPut.SF_ROW_M_KPROK_RWYT_NILAI[i].TGL_NILAI = null;
                }
                if (serviceOutPut.SF_ROW_M_KPROK_RWYT_NILAI[i].NO_NILAI == "-")
                {
                    serviceOutPut.SF_ROW_M_KPROK_RWYT_NILAI[i].NO_NILAI = null;
                }
                if (serviceOutPut.SF_ROW_M_KPROK_RWYT_NILAI[i].PENILAI == "-")
                {
                    serviceOutPut.SF_ROW_M_KPROK_RWYT_NILAI[i].PENILAI = null;
                }
                if (serviceOutPut.SF_ROW_M_KPROK_RWYT_NILAI[i].NMFILE == "-")
                {
                    serviceOutPut.SF_ROW_M_KPROK_RWYT_NILAI[i].NMFILE = null;
                }
                binder.Add(serviceOutPut.SF_ROW_M_KPROK_RWYT_NILAI[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcProkRwytNilaiSelect.BPSIMANSROW_M_KPROK_RWYT_NILAI)selectedView.GetRow(e.FocusedRowHandle);
        ...
        SvcPropKhususRnilaiCrud.call_pttClient svcRiwayatNilaiCrud;
        SvcPropKhususRnilaiCrud.OutputParameters outRiwayatNilaiCrud;
        ...
        private void saveFrmNilai(string text)
        {
            ...
            try
            {
                ...
                SvcPropKhususRnilaiCrud.InputParameters parInp = new SvcPropKhususRnilaiCrud.InputParameters();
                parInp.P_ID_KPROK = this.ID_KPROK;
                parInp.P_ID_KPROK_RWYT_NILAI = (this.puNilai.Status == "input") ? 0 : this.selectedData.ID_KPROK_RWYT_NILAI;
                parInp.P_ID_KPROK_RWYT_NILAISpecified = true;
                ...
                this.svcRiwayatNilaiCrud = new SvcPropKhususRnilaiCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcPropKhususRnilaiCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcPropKhususRnilaiCrud.OutputParameters outCrud)
        {
            SvcProkRwytNilaiSelect.BPSIMANSROW_M_KPROK_RWYT_NILAI dataPenyama = new SvcProkRwytNilaiSelect.BPSIMANSROW_M_KPROK_RWYT_NILAI();
            ...
            dataPenyama.ID_KPROK_RWYT_NILAI = (this.modeCrud == 'U') ? selectedData.ID_KPROK_RWYT_NILAI : outCrud.PO_ID_KPROK_RWYT_NILAI;
            dataPenyama.ID_KPROK_RWYT_NILAISpecified = true;
            ...
            dataPenyama.NO_ASET = (this.modeCrud == 'U') ? this.selectedData.NO_ASET : 0;
            ...
            this.ID_KPROK_RWYT_NILAI = outCrud.PO_ID_KPROK_RWYT_NILAI;
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puNilai.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KPROK_RWYT_NILAI", dataPenyama.ID_KPROK_RWYT_NILAI, "M_KPROK_RWYT_NILAI", filePath, "C");
                    }
                    else
                    {
                        this.puNilai.Close();
                        ...
                        this.getById = true;
                        this.getInitTnhRPnl(" ID_KPROK_RWYT_NILAI = " + outCrud.PO_ID_KPROK_RWYT_NILAI.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puNilai.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KPROK_RWYT_NILAI", dataPenyama.ID_KPROK_RWYT_NILAI, "M_KPROK_RWYT_NILAI", filePath, SELECT);
                    }
                    else
                    {
                        this.puNilai.Close();
        ...
        private void crudDokAset(SvcAsetDokCrud.OutputParameters dataoutDokAsetCrud)
        {
            if (dataoutDokAsetCrud.PO_RESULT == "Y")
            {
                ...
                if (this.modeCrud != 'D')
                {
                    ...
                    this.dataInisial = false;
                    this.getById = true;
                    this.getInitTnhRPnl(" ID_KPROK_RWYT_NILAI = " + ID_KPROK_RWYT_NILAI.ToString());
                }
            }
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
               ...
               MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    parInp.P_ID_KPROK_RWYT_NILAI = selectedData.ID_KPROK_RWYT_NILAI;
                    parInp.P_ID_KPROK_RWYT_NILAISpecified = true;
                    parInp.P_ID_KPROKSpecified = true;
                    ...
                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatNilaiCrud = new SvcPropKhususRnilaiCrud.call_pttClient();
                    svcRiwayatNilaiCrud.Open();
