...
{
    class ucPKRwytPengguna : UserControlDetail
    {


        private frmPengelola puPengelola;
        private String Status;
        public decimal? ID_KPROK_RWYT_PENGGUNA;
        private decimal? ID_KPROK;
        private string search;
        public frmProgres progresBar = null;

        private SvcPropKhususRwytPenggunaSelect.call_pttClient fetchData;
        private SvcPropKhususRwytPenggunaSelect.InputParameters parInp;
        private SvcPropKhususRwytPenggunaSelect.OutputParameters outData;
        public SvcPropKhususRwytPenggunaSelect.BPSIMANSROW_KPROK_RWYT_PENGGUNA selectedData;



        public ucPKRwytPengguna(decimal? _ID_KPROK, String Status)
            : base()
        {
            this.initTnhRPengguna();
            this.Status = Status;
            this.ID_KPROK = _ID_KPROK;
            if (Status == "detail")
            {
        ...
        private void initTnhRPengguna()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcPropKhususRwytPenggunaSelect.BPSIMANSROW_KPROK_RWYT_PENGGUNA);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KPROK_RWYT_PENGGUNA;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_KPROK_RWYT_PENGGUNA";
                parInp.P_TABLE = "M_KPROK_RWYT_PENGGUNA";
        ...
        public void getInitTnhRPgn(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcPropKhususRwytPenggunaSelect.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcPropKhususRwytPenggunaSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcPropKhususRwytPenggunaSelect.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcPropKhususRwytPenggunaSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[0].TOTAL_DATA.ToString();
                }
            }
            else
            {
            ...
            {
                string date = Convert.ToString(serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].TGL_KONTRAK).Substring(0, 10);
                string date_ = Convert.ToString(serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].TGL_KONTRAK).Substring(0, 8);
                string date2 = Convert.ToString(serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].TGL_MULAI).Substring(0, 10);
                string date2_ = Convert.ToString(serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].TGL_MULAI).Substring(0, 8);
                string date3 = Convert.ToString(serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].TGL_SELESAI).Substring(0, 10);
                string date3_ = Convert.ToString(serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].TGL_SELESAI).Substring(0, 8);
                string date4 = Convert.ToString(serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].TGL_SK).Substring(0, 10);
                string date4_ = Convert.ToString(serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].TGL_SK).Substring(0, 8);
                
                if (date == "11/11/1000" || date_ == "1/1/0001")
                {
                    serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].TGL_KONTRAK = null;
                    
                }
                if (date2 == "11/11/1000" || date2_ == "1/1/0001")
                {
                    
                    serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].TGL_MULAI = null;
                    
                }
                if (date3 == "11/11/1000" || date3_ == "1/1/0001")
                {
                    
                    serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].TGL_SELESAI = null;
                    
                }
                if (date4 == "11/11/1000" || date4_ == "1/1/0001")
                {

                    serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].TGL_SK = null;
                }
                if (serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].PHK_PENGGUNA == "-")
                {
                    serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].PHK_PENGGUNA = null;
                }
                if (serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].NMFILE == "-")
                {
                    serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].NMFILE = null;
                }
                if (serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].UR_SATKER == "-")
                {
                    serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].UR_SATKER = null;
                }
                if (serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].KD_SATKER == "-")
                {
                    serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].KD_SATKER = null;
                }
                if (serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].STATUS_KELOLA == "-")
                {
                    serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].STATUS_KELOLA = null;
                }
                if (serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].NO_SK_PENETAPAN == "-")
                {
                    serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].NO_SK_PENETAPAN = null;
                }
                if (serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].NO_KONTRAK == "-")
                {
                    serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].NO_KONTRAK = null;
                }
                if (serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].KET == "-")
                {
                    serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i].KET = null;
                }
                binder.Add(serviceOutPut.SF_ROW_KPROK_RWYT_PENGGUNA[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcPropKhususRwytPenggunaSelect.BPSIMANSROW_KPROK_RWYT_PENGGUNA)selectedView.GetRow(e.FocusedRowHandle);
        ...
        private void resetForm(string text)
        {
            ...
            this.puPengelola.tePihakPengelola.Text = (selectedData.PHK_PENGGUNA == "-") ? null : selectedData.PHK_PENGGUNA;
        ...
        SvcPropKhususRpengelolaCrud.call_pttClient svcRiwayatPengelolaCrud;
        SvcPropKhususRpengelolaCrud.OutputParameters outRiwayatPengelolaCrud;
        ...
        private void saveForm(string text)
        {
            ...
            try
            {
                ...
                SvcPropKhususRpengelolaCrud.InputParameters parInp = new SvcPropKhususRpengelolaCrud.InputParameters();
                parInp.P_ID_KPROK = this.ID_KPROK;
                parInp.P_ID_KPROK_RWYT_PENGGUNA = (this.puPengelola.Status == "input") ? 0 : this.selectedData.ID_KPROK_RWYT_PENGGUNA;
                parInp.P_ID_KPROK_RWYT_PENGGUNASpecified = true;
                ...
                //parInp.P_KD_STATUS = this.puPengelola
                ...
                this.svcRiwayatPengelolaCrud = new SvcPropKhususRpengelolaCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcPropKhususRpengelolaCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcPropKhususRpengelolaCrud.OutputParameters outCrud)
        {
            SvcPropKhususRwytPenggunaSelect.BPSIMANSROW_KPROK_RWYT_PENGGUNA dataPenyama = new SvcPropKhususRwytPenggunaSelect.BPSIMANSROW_KPROK_RWYT_PENGGUNA();

            dataPenyama.NUM = 999;
            dataPenyama.NUMSpecified = true;
            dataPenyama.ID_ASET = (this.modeCrud == 'U') ? selectedData.ID_ASET : 0;
            dataPenyama.ID_ASETSpecified = true;
            dataPenyama.ID_KPROK = (this.modeCrud == 'U') ? selectedData.ID_KPROK : 0;
            dataPenyama.ID_KPROK_RWYT_PENGGUNA = (this.modeCrud == 'U') ? selectedData.ID_KPROK_RWYT_PENGGUNA : outCrud.PO_ID_KPROK_RWYT_PENGGUNA;
            dataPenyama.ID_KPROK_RWYT_PENGGUNASpecified = true;
            dataPenyama.ID_KPROKSpecified = true;
            ...
            this.ID_KPROK_RWYT_PENGGUNA = (this.StatusCrud == "input") ? outCrud.PO_ID_KPROK_RWYT_PENGGUNA : selectedData.ID_KPROK_RWYT_PENGGUNA;
            ...
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puPengelola.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KPROK_RWYT_PENGGUNA", dataPenyama.ID_KPROK_RWYT_PENGGUNA, "M_KPROK_RWYT_PENGGUNA", filePath, "C");
                    }
                    else
                    {
                        ...
                        this.getById = true;
                        this.getInitTnhRPgn(" ID_KPROK_RWYT_PENGGUNA = " + this.ID_KPROK_RWYT_PENGGUNA.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puPengelola.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KPROK_RWYT_PENGGUNA", dataPenyama.ID_KPROK_RWYT_PENGGUNA, "M_KPROK_RWYT_PENGGUNA", filePath, SELECT);
                    }
                    else
                    {
                        this.puPengelola.Close();
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
             ...
             MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    myThread.Start();
                    SvcPropKhususRpengelolaCrud.InputParameters parInp = new SvcPropKhususRpengelolaCrud.InputParameters();
                    parInp.P_ID_KPROK = selectedData.ID_KPROK;
                    parInp.P_ID_KPROKSpecified = true;
                    parInp.P_ID_KPROK_RWYT_PENGGUNA = selectedData.ID_KPROK_RWYT_PENGGUNA;
                    parInp.P_ID_KPROK_RWYT_PENGGUNASpecified = true;


                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatPengelolaCrud = new SvcPropKhususRpengelolaCrud.call_pttClient();
                    svcRiwayatPengelolaCrud.Open();
        ...
        protected override void bbTambah_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            this.puPengelola.saveForm = new SaveFrmPengelola(this.saveForm);
            puPengelola.Enabled = true;
            puPengelola.teJenisPemakai.Text = "K/L";
            puPengelola.teKDPengelola.Text = konfigApp.kodeSatker;
            puPengelola.teUr_Pengelola.Text = konfigApp.namaSatker;
            puPengelola.ID_SATKER = konfigApp.idSatker;
            puPengelola.tePihakPengelola.Text = "";
            puPengelola.tePihakPengelola.Properties.ReadOnly = true;
            this.puPengelola.LayoutLuasPenetapan.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never;
            puPengelola.ShowDialog();
        }
        #endregion
