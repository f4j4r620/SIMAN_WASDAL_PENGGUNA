...
{
    class UcRwyPenggunaRenov : UserControlDetail
    {


        private frmPengelola puPengelola;
        private String Status;
        public decimal? ID_KRNV_RWYT_PENGGUNA;
        private decimal? ID_KRNV;
        private string search;
        public frmProgres progresBar = null;

        private SvcRwyPenggunaRenovSelect.call_pttClient fetchData;
        private SvcRwyPenggunaRenovSelect.InputParameters parInp;
        private SvcRwyPenggunaRenovSelect.OutputParameters outData;
        public SvcRwyPenggunaRenovSelect.BPSIMANSROW_KRNV_RWYT_PENGGUNA selectedData;



        public UcRwyPenggunaRenov(decimal? _ID_KRNV, String Status)
            : base()
        {
            this.initRiwayatPengguna();
            this.Status = Status;
            this.ID_KRNV = _ID_KRNV;
            if (Status == "detail")
            {
        ...
        private void initRiwayatPengguna()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcRwyPenggunaRenovSelect.BPSIMANSROW_KRNV_RWYT_PENGGUNA);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KRNV_RWYT_PENGGUNA;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_KRNV_RWYT_PENGGUNA";
                parInp.P_TABLE = "M_KRNV_RWYT_PENGGUNA";
        ...
        public void getInitTnhRPgn(string _where = null)
        {
            ...
            parInp = new SvcRwyPenggunaRenovSelect.InputParameters();
            parInp.P_COL = "";
            ...
            parInp.P_SORT = "DESC";
            parInp.STR_WHERE = String.Format(" ID_KRNV = {0} {1}", this.ID_KRNV, _where);
            fetchData = new SvcRwyPenggunaRenovSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcRwyPenggunaRenovSelect.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcRwyPenggunaRenovSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_KRNV_RWYT_PENGGUNA.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_KRNV_RWYT_PENGGUNA[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_KRNV_RWYT_PENGGUNA[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_KRNV_RWYT_PENGGUNA[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
                string date1 = Convert.ToString(serviceOutPut.SF_ROW_KRNV_RWYT_PENGGUNA[i].TGL_SK).Substring(0, 10);
                if (date1 == "11/11/1000") { serviceOutPut.SF_ROW_KRNV_RWYT_PENGGUNA[i].TGL_SK = null; }
                string date2 = Convert.ToString(serviceOutPut.SF_ROW_KRNV_RWYT_PENGGUNA[i].TGL_KONTRAK).Substring(0, 10);
                if (date1 == "11/11/1000") { serviceOutPut.SF_ROW_KRNV_RWYT_PENGGUNA[i].TGL_KONTRAK = null; }
                string date3 = Convert.ToString(serviceOutPut.SF_ROW_KRNV_RWYT_PENGGUNA[i].TGL_MULAI).Substring(0, 10);
                if (date1 == "11/11/1000") { serviceOutPut.SF_ROW_KRNV_RWYT_PENGGUNA[i].TGL_MULAI = null; }
                string date4 = Convert.ToString(serviceOutPut.SF_ROW_KRNV_RWYT_PENGGUNA[i].TGL_SELESAI).Substring(0, 10);
                if (date1 == "11/11/1000") { serviceOutPut.SF_ROW_KRNV_RWYT_PENGGUNA[i].TGL_SELESAI = null; }
                binder.Add(serviceOutPut.SF_ROW_KRNV_RWYT_PENGGUNA[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcRwyPenggunaRenovSelect.BPSIMANSROW_KRNV_RWYT_PENGGUNA)selectedView.GetRow(e.FocusedRowHandle);
        ...
        SvcRenovasiRpengelolaCrud.call_pttClient svcRiwayatPengelolaCrud;
        SvcRenovasiRpengelolaCrud.OutputParameters outRiwayatPengelolaCrud;
        ...
        private void saveForm(string text)
        {
            ...
            try
            {
                ...
                SvcRenovasiRpengelolaCrud.InputParameters parInp = new SvcRenovasiRpengelolaCrud.InputParameters();
                parInp.P_ID_KRNV = this.ID_KRNV;
                parInp.P_ID_KRNV_RWYT_PENGGUNA = (this.puPengelola.Status == "input") ? 0 : this.selectedData.ID_KRNV_RWYT_PENGGUNA;
                parInp.P_ID_KRNV_RWYT_PENGGUNASpecified = true;
                ...
                this.svcRiwayatPengelolaCrud = new SvcRenovasiRpengelolaCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcRenovasiRpengelolaCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcRenovasiRpengelolaCrud.OutputParameters outCrud)
        {
            SvcRwyPenggunaRenovSelect.BPSIMANSROW_KRNV_RWYT_PENGGUNA dataPenyama = new SvcRwyPenggunaRenovSelect.BPSIMANSROW_KRNV_RWYT_PENGGUNA();
            ...
            dataPenyama.ID_KRNV_RWYT_PENGGUNA = (this.modeCrud == 'U') ? selectedData.ID_KRNV_RWYT_PENGGUNA : outCrud.PO_ID_KRNV_RWYT_PENGGUNA;
            dataPenyama.ID_KRNV_RWYT_PENGGUNASpecified = true;
            ...
            this.ID_KRNV_RWYT_PENGGUNA = (this.StatusCrud == "input") ? outCrud.PO_ID_KRNV_RWYT_PENGGUNA : selectedData.ID_KRNV_RWYT_PENGGUNA;
            ...
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puPengelola.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KRNV_RWYT_PENGGUNA", dataPenyama.ID_KRNV_RWYT_PENGGUNA, "M_KRNV_RWYT_PENGGUNA", filePath, "C");
                    }
                    else
                    {
                        ...
                        this.getById = true;
                        this.getInitTnhRPgn(" ID_KRNV_RWYT_PENGGUNA = " + this.ID_KRNV_RWYT_PENGGUNA.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puPengelola.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KRNV_RWYT_PENGGUNA", dataPenyama.ID_KRNV_RWYT_PENGGUNA, "M_KRNV_RWYT_PENGGUNA", filePath, SELECT);
                    }
                    else
                    {
                        this.puPengelola.Close();
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
             ...
             MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    parInp.P_ID_KRNVSpecified = true;
                    parInp.P_ID_KRNV_RWYT_PENGGUNA = selectedData.ID_KRNV_RWYT_PENGGUNA;
                    parInp.P_ID_KRNV_RWYT_PENGGUNASpecified = true;


                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatPengelolaCrud = new SvcRenovasiRpengelolaCrud.call_pttClient();
                    svcRiwayatPengelolaCrud.Open();
