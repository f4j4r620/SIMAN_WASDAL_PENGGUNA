...
{
    class UcRwyMutRenov : UserControlDetail
    {
        ...
        public decimal? ID_KRNV;



        private SvcRwyMutRenovSelect.call_pttClient fetchData;
        private SvcRwyMutRenovSelect.InputParameters parInp;
        private SvcRwyMutRenovSelect.OutputParameters outData;
        public SvcRwyMutRenovSelect.BPSIMANSROW_KRNV_RWYT_MUTASI selectedData;



        public UcRwyMutRenov(decimal? _ID_KRNV, String Status)
            : base()
        {
            this.initTnhRMutasi();
            this.Status = Status;
        ...
        private void initTnhRMutasi()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcRwyMutRenovSelect.BPSIMANSROW_KRNV_RWYT_MUTASI);
        ...
        public void getInitMutasi(string _where = null)
        {
            ...
            this.nonAktifForm("");
            parInp = new SvcRwyMutRenovSelect.InputParameters();
            parInp.P_COL = "";
            ...
            parInp.P_SORT = "DESC";
            parInp.STR_WHERE = String.Format(" ID_KRNV = {0} {1}", this.ID_KRNV, this.search);
            fetchData = new SvcRwyMutRenovSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcRwyMutRenovSelect.OutputParameters dataOut);

        public void showData(SvcRwyMutRenovSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_KRNV_RWYT_MUTASI.Count();
            ...
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_KRNV_RWYT_MUTASI[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
                string date1 = Convert.ToString(serviceOutPut.SF_ROW_KRNV_RWYT_MUTASI[i].TGL_DSR_MUTASI).Substring(0, 10);
                if (date1 == "11/11/1000") { serviceOutPut.SF_ROW_KRNV_RWYT_MUTASI[i].TGL_DSR_MUTASI = null; }
                binder.Add(serviceOutPut.SF_ROW_KRNV_RWYT_MUTASI[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcRwyMutRenovSelect.BPSIMANSROW_KRNV_RWYT_MUTASI)selectedView.GetRow(e.FocusedRowHandle);
