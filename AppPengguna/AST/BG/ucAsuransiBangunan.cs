...
{
  class ucAsuransiBangunan : UserControlDetail
  {

    private SvcAsuransiBangunanSelect.rwytAsuransiSelect_pttClient fetchData;
    private SvcAsuransiBangunanSelect.InputParameters parInp;
    private SvcAsuransiBangunanSelect.OutputParameters outData;
    public SvcAsuransiBangunanSelect.BPSIMANSROW_KBDG_RWYT_ASURANSI selectedData;

    private String Status;
    public decimal? IdKbg;
    private decimal? jmlData = 0;
    GridView viewTerpilih = null;
    public bool rowTerakhir = false;

    private PuAsuransiBangunan PuAsuransiBangunan;
    ...
    public ucAsuransiBangunan(decimal? _ID_KBDG, String status)
      : base()
    {
      this.InitAsuransi();
      this.Status = Status;
    ...
    public void InitAsuransi()
    {
      ...
      this.binder.DataSource = typeof(AppPengguna.SvcAsuransiBangunanSelect.BPSIMANSROW_KBDG_RWYT_ASURANSI);
    ...
    protected void view_dokumen(object sender, ItemClickEventArgs e)
    {
      try
      {
        ...
        parInp.P_ID = selectedData.ID_KBDG_RWYT_ASURANSI;
        parInp.P_ID_TABLE = "ID_KBDG_RWYT_ASURANSI";
        parInp.P_IDSpecified = true;
        parInp.P_TABLE = "M_KBDG_RWYT_ASURANSI";
    ...
    public void getInitAsuransi(string _where = null)
    {
      ...
      myThread.Start();
      this.nonAktifForm("");
      parInp = new SvcAsuransiBangunanSelect.InputParameters();
      parInp.P_COL = "";
      decimal Max, Min;
      ...
      parInp.P_SORT = "DESC";
      parInp.STR_WHERE = String.Format(" ID_KBDG = {0} {1}", this.IdKbg, _where);
      parInp.P_COUNT = "Y";
      Console.WriteLine(parInp.STR_WHERE);
      fetchData = new SvcAsuransiBangunanSelect.rwytAsuransiSelect_pttClient();
      fetchData.Open();
    ...
    private delegate void ShowData(SvcAsuransiBangunanSelect.OutputParameters dataOut);
    public decimal? NUM;
    private string StatusCrud = "";
    public void showData(SvcAsuransiBangunanSelect.OutputParameters serviceOutPut)
    {
      ...
      if (this.getById == true && jmlDataGroup > 0)
      {
        ...
        {
          serviceOutPut.SF_ROW_KBDG_RWYT_ASURANSI[0].NUM = this.NUM;
        }
        else
        {
          serviceOutPut.SF_ROW_KBDG_RWYT_ASURANSI[0].NUM = binder.Count + 1;
        }
      }
      if (this.dataInisial == true)
      {
        ...
        if (jmlDataGroup > 0)
        {
          ...
          //serviceOutPut.SF_ROW_KBDG_RWYT_ASURANSI[0].TOTAL_DATASpecified = true;
          StrTotalDb.Caption = serviceOutPut.SF_ROW_KBDG_RWYT_ASURANSI[0].TOTAL_DATA.ToString();
        }
        else
        {
      ...
      {
        string date1 = Convert.ToString(serviceOutPut.SF_ROW_KBDG_RWYT_ASURANSI[i].TGL_JATUH_TEMPO).Substring(0, 10);
        string date2 = Convert.ToString(serviceOutPut.SF_ROW_KBDG_RWYT_ASURANSI[i].TGL_POLIS).Substring(0, 10);
        string date1_ = Convert.ToString(serviceOutPut.SF_ROW_KBDG_RWYT_ASURANSI[i].TGL_JATUH_TEMPO).Substring(0, 8);
        string date2_ = Convert.ToString(serviceOutPut.SF_ROW_KBDG_RWYT_ASURANSI[i].TGL_POLIS).Substring(0, 8);

        if (date1 == "11/11/1000" || date1_ == "1/1/1000")
        {
          serviceOutPut.SF_ROW_KBDG_RWYT_ASURANSI[i].TGL_JATUH_TEMPO = null;
        }
        if (date2 == "11/11/1000" || date2_ == "1/1/1000")
        {
          serviceOutPut.SF_ROW_KBDG_RWYT_ASURANSI[i].TGL_POLIS = null;
        }

        binder.Add(serviceOutPut.SF_ROW_KBDG_RWYT_ASURANSI[i]);
      }
    ...
    {
      this.PuAsuransiBangunan = new PuAsuransiBangunan(this, "input");
      StatusCrud = "input";
      this.PuAsuransiBangunan.ShowDialog();
    }
    protected override void bbEdit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
    {
      ...
      {
        this.PuAsuransiBangunan = new PuAsuransiBangunan(this, "detail");
        StatusCrud = "detail";
      }
      else
      {
        this.PuAsuransiBangunan = new PuAsuransiBangunan(this, "edit");
        StatusCrud = "edit";
      }
      this.PuAsuransiBangunan.ShowDialog();
    }
    protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
    {
      ...
      StatusCrud = "hapus";
      this.PuAsuransiBangunan = new PuAsuransiBangunan(this, "hapus");
      this.PuAsuransiBangunan.Size = new System.Drawing.Size(0, 0);
      this.PuAsuransiBangunan.Opacity = 0;
      this.PuAsuransiBangunan.Show();
      this.PuAsuransiBangunan.Hide();
      this.PuAsuransiBangunan.hapusData();
    ...
    protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
    {
      ...
      {
        selectedData = (SvcAsuransiBangunanSelect.BPSIMANSROW_KBDG_RWYT_ASURANSI)viewTerpilih.GetRow(e.FocusedRowHandle);
