...
{
    class ucBGFoto : UserControlDetail
    {
        ...
        public ucBGFoto(decimal? _ID_ASET, String status)
            : base()
        {
            this.InitFoto();
            this.Status = Status;
        ...
        {
            this.PuBGFoto = new PuBGFoto(this, "input");
            StatusCrud = "input";
            this.PuBGFoto.ShowDialog();
        }
        protected override void bbEdit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                this.PuBGFoto = new PuBGFoto(this, "detail");
                StatusCrud = "detail";
            }
            else
            {
                this.PuBGFoto = new PuBGFoto(this, "edit");
                StatusCrud = "edit";
            }
            this.PuBGFoto.ShowDialog();
        }
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            StatusCrud = "hapus";
            this.PuBGFoto = new PuBGFoto(this, "hapus");
            this.PuBGFoto.Size = new System.Drawing.Size(0, 0);
            this.PuBGFoto.Opacity = 0;
            this.PuBGFoto.Show();
            this.PuBGFoto.Hide();
            this.PuBGFoto.hapusData();
