...
{
    class ucKibBangunan : UserControlDetail
    {

        private SvcKibBangunanSelect.call_pttClient fetchData;
        private SvcKibBangunanSelect.InputParameters parInp;
        private SvcKibBangunanSelect.OutputParameters outData;
        public SvcKibBangunanSelect.BPSIMANSROW_M_KBDG_DOK_KIB selectedData;
        ...
        private PuKibBangunan PuKibBangunan;
        ...
        public ucKibBangunan(decimal? _ID_KBDG, String status)
            : base()
        {
            this.InitDokKib();
            this.Status = Status;
        ...
        public void InitDokKib()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcKibBangunanSelect.BPSIMANSROW_M_KBDG_DOK_KIB);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KBDG_DOK_KIB;
        ...
        public void getInitDokKib(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcKibBangunanSelect.InputParameters();
            parInp.P_COL = "";
            decimal Max, Min;
            ...
            fetchData = new SvcKibBangunanSelect.call_pttClient();
            fetchData.Open();
        ...
        public void showData(SvcKibBangunanSelect.OutputParameters serviceOutPut)
        {
            ...
            if (this.getById == true && jmlDataGroup > 0)
            {
                ...
                {
                    serviceOutPut.SF_ROW_M_KBDG_DOK_KIB[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_M_KBDG_DOK_KIB[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KBDG_DOK_KIB[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
              string date = Convert.ToString(serviceOutPut.SF_ROW_M_KBDG_DOK_KIB[i].TGL_DOK_KIB).Substring(0, 10);
              string date_ = Convert.ToString(serviceOutPut.SF_ROW_M_KBDG_DOK_KIB[i].TGL_DOK_KIB).Substring(0, 8);

              if (date == "11/11/1000" || date_ == "1/1/0001")
              {
                serviceOutPut.SF_ROW_M_KBDG_DOK_KIB[i].TGL_DOK_KIB = null;
              }

                binder.Add(serviceOutPut.SF_ROW_M_KBDG_DOK_KIB[i]);
            }
        ...
        {
            this.PuKibBangunan = new PuKibBangunan(this, "input");
            StatusCrud = "input";
            this.PuKibBangunan.ShowDialog();
        }
        protected override void bbEdit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                this.PuKibBangunan = new PuKibBangunan(this, "detail");
                StatusCrud = "detail";
            }
            else
            {
                this.PuKibBangunan = new PuKibBangunan(this, "edit");
                StatusCrud = "edit";
            }
            this.PuKibBangunan.ShowDialog();
        }
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            StatusCrud = "hapus";
            this.PuKibBangunan = new PuKibBangunan(this, "hapus");
            this.PuKibBangunan.Size = new System.Drawing.Size(0, 0);
            this.PuKibBangunan.Opacity = 0;
            this.PuKibBangunan.Show();
            this.PuKibBangunan.Hide();
            this.PuKibBangunan.hapusData();
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcKibBangunanSelect.BPSIMANSROW_M_KBDG_DOK_KIB)viewTerpilih.GetRow(e.FocusedRowHandle);
