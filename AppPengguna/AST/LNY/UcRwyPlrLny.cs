...
{
    class UcRwyPlrLny : UserControlDetail
    {
        ...
        private decimal? ID_KLAIN_RWYT_PELIHARA;



        private SvcLnyPlrSelect.call_pttClient fetchData;
        private SvcLnyPlrSelect.InputParameters parInp;
        private SvcLnyPlrSelect.OutputParameters outData;
        private SvcLnyPlrSelect.BPSIMANSROW_M_KLAIN_RWYT_PELIHARA selectedData;




        public UcRwyPlrLny(decimal? _ID_KLAIN, String Status)
            : base()
        {
        ...
        private void initTnhRPemeliharaan()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcLnyPlrSelect.BPSIMANSROW_M_KLAIN_RWYT_PELIHARA);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KLAIN_RWYT_PELIHARA;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_KLAIN_RWYT_PELIHARA";
                parInp.P_TABLE = "M_KLAIN_RWYT_PELIHARA";
        ...
        public void getInitTnhRPml(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcLnyPlrSelect.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcLnyPlrSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcLnyPlrSelect.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcLnyPlrSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_M_KLAIN_RWYT_PELIHARA.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_M_KLAIN_RWYT_PELIHARA[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_M_KLAIN_RWYT_PELIHARA[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KLAIN_RWYT_PELIHARA[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
                string date1 = Convert.ToString(serviceOutPut.SF_ROW_M_KLAIN_RWYT_PELIHARA[i].TGL_BUKU).Substring(0, 10);
                string date2 = Convert.ToString(serviceOutPut.SF_ROW_M_KLAIN_RWYT_PELIHARA[i].TGL_SP2D).Substring(0, 10);
                if (date1 == "11/11/1000")
                {
                    serviceOutPut.SF_ROW_M_KLAIN_RWYT_PELIHARA[i].TGL_BUKU = null;
                }
                if (date2 == "11/11/1000")
                {
                    serviceOutPut.SF_ROW_M_KLAIN_RWYT_PELIHARA[i].TGL_SP2D = null;
                }

                this.binder.Add(serviceOutPut.SF_ROW_M_KLAIN_RWYT_PELIHARA[i]);
            }

            for (int i = 0; i < jmlDataGroup; i++)
            {
                binder.Add(serviceOutPut.SF_ROW_M_KLAIN_RWYT_PELIHARA[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcLnyPlrSelect.BPSIMANSROW_M_KLAIN_RWYT_PELIHARA)selectedView.GetRow(e.FocusedRowHandle);
        ...
        SvcLnyRpemeliharaanCrud.call_pttClient svcRiwayatPemeliharaanCrud;
        SvcLnyRpemeliharaanCrud.OutputParameters outRiwayatPemeliharaanCrud;
        ...
        private void saveForm(string text)
        {
            ...
            try
            {
                ...
                SvcLnyRpemeliharaanCrud.InputParameters parInp = new SvcLnyRpemeliharaanCrud.InputParameters();
                parInp.P_ID_KLAIN = this.ID_KLAIN;
                parInp.P_ID_KLAIN_RWYT_PELIHARA = (this.puPemeliharaan.Status == "input") ? 0 : this.selectedData.ID_KLAIN_RWYT_PELIHARA;
                parInp.P_ID_KLAIN_RWYT_PELIHARASpecified = true;
                ...
                this.svcRiwayatPemeliharaanCrud = new SvcLnyRpemeliharaanCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcLnyRpemeliharaanCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcLnyRpemeliharaanCrud.OutputParameters outCrud)
        {
            SvcLnyPlrSelect.BPSIMANSROW_M_KLAIN_RWYT_PELIHARA dataPenyama = new SvcLnyPlrSelect.BPSIMANSROW_M_KLAIN_RWYT_PELIHARA();
            ...
            dataPenyama.ID_KLAIN_RWYT_PELIHARA = (this.modeCrud == 'U') ? outCrud.PO_ID_KLAIN_RWYT_PELIHARA : selectedData.ID_KLAIN_RWYT_PELIHARA;
            dataPenyama.ID_KLAIN_RWYT_PELIHARASpecified = true;
            ...
            this.ID_KLAIN_RWYT_PELIHARA = outCrud.PO_ID_KLAIN_RWYT_PELIHARA;
            ...
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puPemeliharaan.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KLAIN_RWYT_PELIHARA", dataPenyama.ID_KLAIN_RWYT_PELIHARA, "M_KLAIN_RWYT_PELIHARA", filePath, "C");
                    }
                    else
                    {
                        ...
                        this.getById = true;
                        this.getInitTnhRPml(" ID_KLAIN_RWYT_PELIHARA = " + outCrud.PO_ID_KLAIN_RWYT_PELIHARA.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puPemeliharaan.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KLAIN_RWYT_PELIHARA", dataPenyama.ID_KLAIN_RWYT_PELIHARA, "M_KLAIN_RWYT_PELIHARA", filePath, SELECT);
                    }
                    else
                    {
        ...
        public void simpanFile(string ID_TYPE, decimal? ID_VALUE, string TABLE_TYPE, string filePath, string SELECT)
        {
            ...
            try
            {
                ...
                inputData.P_KD_DOK = puPemeliharaan.ID_JNSDOK;
        ...
        private void crudDokAset(SvcAsetDokCrud.OutputParameters dataoutDokAsetCrud)
        {
            if (dataoutDokAsetCrud.PO_RESULT == "Y")
            {
                ...
                if (this.modeCrud != 'D')
                {
                    ...
                    this.dataInisial = false;
                    this.getById = true;
                    this.getInitTnhRPml(" ID_KLAIN_RWYT_PELIHARA = " + this.ID_KLAIN_RWYT_PELIHARA.ToString());
                }
            }
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
              ...
              MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    parInp.P_ID_KLAINSpecified = true;
                    parInp.P_ID_KLAIN_RWYT_PELIHARA = selectedData.ID_KLAIN_RWYT_PELIHARA;
                    parInp.P_ID_KLAIN_RWYT_PELIHARASpecified = true;


                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatPemeliharaanCrud = new SvcLnyRpemeliharaanCrud.call_pttClient();
                    svcRiwayatPemeliharaanCrud.Open();
