...
{
    class UcRwyNilLny : UserControlDetail
    {


        private frmNilai puNilai;
        private decimal? ID_KLAIN_RWYT_NILAI;
        ...
        private SvcLnyNilSelect.call_pttClient fetchData;
        private SvcLnyNilSelect.InputParameters parInp;
        private SvcLnyNilSelect.OutputParameters outData;
        private SvcLnyNilSelect.BPSIMANSROW_M_KLAIN_RWYT_NILAI selectedData;


        public UcRwyNilLny(decimal? _ID_KLAIN, String _Status)
            : base()
        {
        ...
        private void initTnhRPenilaian()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcLnyNilSelect.BPSIMANSROW_M_KLAIN_RWYT_NILAI);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KLAIN_RWYT_NILAI;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_KLAIN_RWYT_NILAI";
                parInp.P_TABLE = "M_KLAIN_RWYT_NILAI";
        ...
        public void getInitTnhRPnl(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcLnyNilSelect.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcLnyNilSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcLnyNilSelect.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcLnyNilSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_M_KLAIN_RWYT_NILAI.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_M_KLAIN_RWYT_NILAI[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_M_KLAIN_RWYT_NILAI[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KLAIN_RWYT_NILAI[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
                binder.Add(serviceOutPut.SF_ROW_M_KLAIN_RWYT_NILAI[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcLnyNilSelect.BPSIMANSROW_M_KLAIN_RWYT_NILAI)selectedView.GetRow(e.FocusedRowHandle);
        ...
        SvcLnyRnilaiCrud.call_pttClient svcRiwayatNilaiCrud;
        SvcLnyRnilaiCrud.OutputParameters outRiwayatNilaiCrud;
        ...
        private void saveFrmNilai(string text)
        {
            ...
            try
            {
                ...
                SvcLnyRnilaiCrud.InputParameters parInp = new SvcLnyRnilaiCrud.InputParameters();
                parInp.P_ID_KLAIN = this.ID_KLAIN;
                parInp.P_ID_KLAIN_RWYT_NILAI = (this.puNilai.Status == "input") ? 0 : this.selectedData.ID_KLAIN_RWYT_NILAI;
                parInp.P_ID_KLAIN_RWYT_NILAISpecified = true;
                ...
                this.svcRiwayatNilaiCrud = new SvcLnyRnilaiCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcLnyRnilaiCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcLnyRnilaiCrud.OutputParameters outCrud)
        {
            SvcLnyNilSelect.BPSIMANSROW_M_KLAIN_RWYT_NILAI dataPenyama = new SvcLnyNilSelect.BPSIMANSROW_M_KLAIN_RWYT_NILAI();
            ...
            dataPenyama.ID_KLAIN_RWYT_NILAI = (this.modeCrud == 'U') ? selectedData.ID_KLAIN_RWYT_NILAI : outCrud.PO_ID_KLAIN_RWYT_NILAI;
            dataPenyama.ID_KLAIN_RWYT_NILAISpecified = true;
            ...
            this.ID_KLAIN_RWYT_NILAI = outCrud.PO_ID_KLAIN_RWYT_NILAI;
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puNilai.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KLAIN_RWYT_NILAI", dataPenyama.ID_KLAIN_RWYT_NILAI, "M_KLAIN_RWYT_NILAI", filePath, "C", puNilai.ID_JNSDOK);
                    }
                    else
                    {
                        this.puNilai.Close();
                        ...
                        this.getById = true;
                        this.getInitTnhRPnl(" ID_KLAIN_RWYT_NILAI = " + outCrud.PO_ID_KLAIN_RWYT_NILAI.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puNilai.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KLAIN_RWYT_NILAI", dataPenyama.ID_KLAIN_RWYT_NILAI, "M_KLAIN_RWYT_NILAI", filePath, SELECT, puNilai.ID_JNSDOK);
                    }
                    else
                    {
                        this.puNilai.Close();
        ...
        public void simpanFile(string ID_TYPE, decimal? ID_VALUE, string TABLE_TYPE, string filePath, string SELECT, string jnsDok)
        {
            myThread = new Thread(new ThreadStart(this.puNilai.ShowProgresBar));
            myThread.Start();
            try
            {
                ...
                inputData.P_KD_DOK = puNilai.ID_JNSDOK;
                inputData.P_TABLE_TYPE = TABLE_TYPE;
                inputData.P_SELECT = SELECT;
                if (jnsDok != "" || jnsDok != null)
                { inputData.P_KD_DOK = jnsDok; }
        ...
        private void crudDokAset(SvcAsetDokCrud.OutputParameters dataoutDokAsetCrud)
        {
            if (dataoutDokAsetCrud.PO_RESULT == "Y")
            {
                ...
                if (this.modeCrud != 'D')
                {
                    ...
                    this.dataInisial = false;
                    this.getById = true;
                    this.getInitTnhRPnl(" ID_KLAIN_RWYT_NILAI = " + ID_KLAIN_RWYT_NILAI.ToString());
                }
            }
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
               ...
               MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    parInp.P_ID_KLAIN_RWYT_NILAI = selectedData.ID_KLAIN_RWYT_NILAI;
                    parInp.P_ID_KLAIN_RWYT_NILAISpecified = true;
                    parInp.P_ID_KLAINSpecified = true;
                    ...
                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatNilaiCrud = new SvcLnyRnilaiCrud.call_pttClient();
                    svcRiwayatNilaiCrud.Open();
