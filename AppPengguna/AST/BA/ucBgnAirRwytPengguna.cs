...
{
  class ucBgnAirRwytPengguna : UserControlDetail
  {
    private SvcBgnAirRwytPengguna.call_pttClient fetchData;
    private SvcBgnAirRwytPengguna.InputParameters parInp;
    private SvcBgnAirRwytPengguna.OutputParameters outDat;
    private SvcBgnAirRwytPengguna.BPSIMANSROW_KBAIR_RWYT_PENGGUNA selectedData;

    SvcBgnAirRwytPengguna.BPSIMANSROW_KBAIR_RWYT_PENGGUNA newRow;
    private ColumnView View;

    private Thread myThread_ = null;
    private decimal? ID_KBAIR;
    public decimal? NUM;
    private string StatusCrud = "";
    private decimal? ID_KBAIR_RWYT_PENGGUNA;
    private frmPengelola puPengelola;
    private string Status;
    private string coba;
    //child form customization 
    private void initRpenggunaBair()
    {
      int _width;
      this.binder = new BindingSource();
      this.binder.DataSource = typeof(SvcBgnAirRwytPengguna.BPSIMANSROW_KBAIR_RWYT_PENGGUNA);
      ...
      this.setKolom("Status Pengelolaan BMN", "STATUS_KELOLA", "STATUS_KELOLA", 3, true, 100);
    ...
    protected void view_dokumen(object sender, ItemClickEventArgs e)
    {
      try
      {
        ...
        parInp.P_ID = selectedData.ID_KBAIR_RWYT_PENGGUNA;
        parInp.P_IDSpecified = true;
        parInp.P_ID_TABLE = "ID_KBAIR_RWYT_PENGGUNA";
        parInp.P_TABLE = "M_KBAIR_RWYT_PENGGUNA";
    ...
    public ucBgnAirRwytPengguna(decimal? ID_KBAIR = null, string _status = "edit")
      : base()
    {

      //this.targetPanel = _targetPanel;
      this.Status = _status;
      this.ID_KBAIR = ID_KBAIR;
      this.initRpenggunaBair();
    ...
    protected override void gvUcDtl_InitNewRow(object sender, InitNewRowEventArgs e)
    {
      ...
      newRow = (SvcBgnAirRwytPengguna.BPSIMANSROW_KBAIR_RWYT_PENGGUNA)selectedView.GetRow(e.RowHandle);
    }
    ...
    private void resetForm(string text)
    {
      ...
      {
        this.puPengelola.teFileName.Text = null;
      }
      else
      {
    ...
    SvcBangunanAirPengelolaCrud.call_pttClient svcRiwayatPengelolaCrud;
    SvcBangunanAirPengelolaCrud.OutputParameters outRiwayatPengelolaCrud;
    ...
    private void saveForm(string text)
    {
      if (this.puPengelola.teSKPenetapan.Text != "" || this.puPengelola.teTglSKPenetapan.Text != "" || this.puPengelola.teTglSKPenetapan.Text != null)
      {
        ...
        try
        {
          ...
          SvcBangunanAirPengelolaCrud.InputParameters parInp = new SvcBangunanAirPengelolaCrud.InputParameters();
          parInp.P_ID_KBAIR = this.ID_KBAIR;
          parInp.P_ID_KBAIR_RWYT_PENGGUNA = (this.puPengelola.Status == "input") ? 0 : this.selectedData.ID_KBAIR_RWYT_PENGGUNA;
          parInp.P_ID_KBAIR_RWYT_PENGGUNASpecified = true;
          ...
          this.svcRiwayatPengelolaCrud = new SvcBangunanAirPengelolaCrud.call_pttClient();
    ...
    public delegate void UbahDsDetail(SvcBangunanAirPengelolaCrud.OutputParameters outCrud);

    public void ubahDsDetail(SvcBangunanAirPengelolaCrud.OutputParameters outCrud)
    {
      SvcBgnAirRwytPengguna.BPSIMANSROW_KBAIR_RWYT_PENGGUNA dataPenyama = new SvcBgnAirRwytPengguna.BPSIMANSROW_KBAIR_RWYT_PENGGUNA();

      dataPenyama.NUM = 999;
      dataPenyama.NUMSpecified = true;
      dataPenyama.ID_ASET = (this.modeCrud == 'U') ? selectedData.ID_ASET : 0;
      dataPenyama.ID_ASETSpecified = true;
      dataPenyama.ID_KBAIR = (this.modeCrud == 'U') ? selectedData.ID_KBAIR : 0;
      dataPenyama.ID_KBAIR_RWYT_PENGGUNA = (this.modeCrud == 'U') ? selectedData.ID_KBAIR_RWYT_PENGGUNA : outCrud.PO_ID_KBAIR_RWYT_PENGGUNA;
      dataPenyama.ID_KBAIR_RWYT_PENGGUNASpecified = true;
      dataPenyama.ID_KBAIRSpecified = true;
      ...
      this.ID_KBAIR_RWYT_PENGGUNA = (this.StatusCrud == "edit") ? selectedData.ID_KBAIR_RWYT_PENGGUNA : outCrud.PO_ID_KBAIR_RWYT_PENGGUNA;
      ...
      switch (this.modeCrud)
      {
        case 'C':
          ...
          if (this.puPengelola.FilePath != null)
          {
            ...
            simpanFile("ID_KBAIR_RWYT_PENGGUNA", dataPenyama.ID_KBAIR_RWYT_PENGGUNA, "M_KBAIR_RWYT_PENGGUNA", filePath, "C", this.puPengelola.ID_JNSDOK);
          ...
          else
          {
            ...
            this.getById = true;
            this.getInitBgnAirPengelola(" ID_KBAIR_RWYT_PENGGUNA = " + outCrud.PO_ID_KBAIR_RWYT_PENGGUNA.ToString());
          }
        ...
        case 'U':
          ...
          if (this.puPengelola.FilePath != null)
          {
            ...
            simpanFile("ID_KBAIR_RWYT_PENGGUNA", dataPenyama.ID_KBAIR_RWYT_PENGGUNA, "M_KBAIR_RWYT_PENGGUNA", filePath, SELECT, this.puPengelola.ID_JNSDOK);
        ...
        case 'D':
          ...
          this.StrTotalDb.Caption = (StrTotalDb.Caption == "") ? "0" : (Convert.ToInt64(this.StrTotalDb.Caption) - 1).ToString();
          this.search = "";
          this.initGrid();
          this.getInitBgnAirPengelola();
          break;
    ...
    private void crudDokAset(SvcAsetDokCrud.OutputParameters dataoutDokAsetCrud)
    {
      if (dataoutDokAsetCrud.PO_RESULT == "Y")
      {
        ...
        if (this.modeCrud != 'D')
        {
          ...
          this.dataInisial = false;
          this.getById = true;
          //this.getInitBgnAirPengelola(" ID_KBAIR_RWYT_PENGGUNA = " + this.ID_KBAIR_RWYT_PENGGUNA.ToString());
        }
        this.search = "";
        this.initGrid();
        this.getInitBgnAirPengelola();
    ...
    protected override void bbSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
    {
      try
      {
        ...
        this.dataInisial = false;
        this.getInitBgnAirPengelola(get_where_clause(nama_kolom, opr, parameter, parameter_2));
    ...
    protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
    {
       ...
       MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
      {
        try
        {
          ...
          myThread.Start();
          SvcBangunanAirPengelolaCrud.InputParameters parInp = new SvcBangunanAirPengelolaCrud.InputParameters();
          parInp.P_ID_KBAIR = selectedData.ID_KBAIR;
          parInp.P_ID_KBAIRSpecified = true;
          parInp.P_ID_KBAIR_RWYT_PENGGUNA = selectedData.ID_KBAIR_RWYT_PENGGUNA;
          parInp.P_ID_KBAIR_RWYT_PENGGUNASpecified = true;


          parInp.P_SELECT = "D";
          this.modeCrud = Convert.ToChar(parInp.P_SELECT);
          svcRiwayatPengelolaCrud = new SvcBangunanAirPengelolaCrud.call_pttClient();
          svcRiwayatPengelolaCrud.Open();
    ...
    protected override void gvUcDtl_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
    {
      ...
      {
        selectedData = (SvcBgnAirRwytPengguna.BPSIMANSROW_KBAIR_RWYT_PENGGUNA)selectedView.GetRow(e.FocusedRowHandle);
    ...
    protected void getInitBgnAirPengelola(string _where = null)
    {
      decimal Max, Min;
      this.nonAktifForm("");
      myThread = new Thread(new ThreadStart(this.ShowProgresBar));
      myThread.Start();
      SvcBgnAirRwytPengguna.InputParameters parInp = new SvcBgnAirRwytPengguna.InputParameters();
      parInp.P_COL = "";
      ...
      parInp.P_SORT = "DESC";
      fetchData = new SvcBgnAirRwytPengguna.call_pttClient();
      fetchData.Open();
    ...
    private delegate void ShowData(SvcBgnAirRwytPengguna.OutputParameters dataOut);

    public void showData(SvcBgnAirRwytPengguna.OutputParameters serviceOutPut)
    {
      int jmlDataGroup = serviceOutPut.SF_ROW_KBAIR_RWYT_PENGGUNA.Count();

      if (this.getById == true && jmlDataGroup > 0)
      {
        if (this.StatusCrud == "edit")
        {
          serviceOutPut.SF_ROW_KBAIR_RWYT_PENGGUNA[0].NUM = this.NUM;
        }
        else
        {
          serviceOutPut.SF_ROW_KBAIR_RWYT_PENGGUNA[0].NUM = binder.Count + 1;
        }
      }
      if (this.dataInisial == true)
      {
        ...
        if (jmlDataGroup > 0)
        {
          ...
          StrTotalDb.Caption = serviceOutPut.SF_ROW_KBAIR_RWYT_PENGGUNA[0].TOTAL_DATA.ToString();
        }
        else
        {
      ...
      else
      {
        if (jmlDataGroup > 0 && this.StatusCrud != "edit")
        {
          ...
          {
            StrTotalDb.Caption = (StrTotalDb.Caption == "") ? "0" : (Convert.ToInt64(StrTotalDb.Caption) + 1).ToString();
          }
        }
      }
      ...
      {
        string date = Convert.ToString(serviceOutPut.SF_ROW_KBAIR_RWYT_PENGGUNA[i].TGL_KONTRAK).Substring(0, 10);
        string date2 = Convert.ToString(serviceOutPut.SF_ROW_KBAIR_RWYT_PENGGUNA[i].TGL_MULAI).Substring(0, 10);
        string date3 = Convert.ToString(serviceOutPut.SF_ROW_KBAIR_RWYT_PENGGUNA[i].TGL_SELESAI).Substring(0, 10);
        string date4 = Convert.ToString(serviceOutPut.SF_ROW_KBAIR_RWYT_PENGGUNA[i].TGL_SK).Substring(0, 10);

        if (date == "11/11/1000")
        {
          serviceOutPut.SF_ROW_KBAIR_RWYT_PENGGUNA[i].TGL_KONTRAK = null;
        }
        if (date2 == "11/11/1000")
        {
          serviceOutPut.SF_ROW_KBAIR_RWYT_PENGGUNA[i].TGL_MULAI = null;
        }
        if (date3 == "11/11/1000")
        {
          serviceOutPut.SF_ROW_KBAIR_RWYT_PENGGUNA[i].TGL_SELESAI = null;
        }
        if (date4 == "11/11/1000")
        {
          serviceOutPut.SF_ROW_KBAIR_RWYT_PENGGUNA[i].TGL_SK = null;
        }
        binder.Add(serviceOutPut.SF_ROW_KBAIR_RWYT_PENGGUNA[i]);
      }
