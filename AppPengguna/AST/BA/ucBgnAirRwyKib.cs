...
{
    class ucBgnAirRwyKib : UserControlDetail
    {

        private SvcBgnAirRwyKibSelect.call_pttClient fetchData;
        private SvcBgnAirRwyKibSelect.InputParameters parInp;
        private SvcBgnAirRwyKibSelect.OutputParameters outData;
        public SvcBgnAirRwyKibSelect.BPSIMANSROW_M_KBAIR_DOK_KIB selectedData;

        private String Status;
        public decimal? IdKBgnAir;

        GridView viewTerpilih = null;
        public bool rowTerakhir = false;

        private FrmBgnAirKib FrmBgnAirKib;
        ...
        public ucBgnAirRwyKib(decimal? _ID_KBAIR, String status)
            : base()
        {
            this.InitDokKib();
            this.Status = Status;
            this.IdKBgnAir = _ID_KBAIR;
        ...
        public void InitDokKib()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcBgnAirRwyKibSelect.BPSIMANSROW_M_KBAIR_DOK_KIB);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KBAIR_DOK_KIB;
        ...
        public void getInitDokKib(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcBgnAirRwyKibSelect.InputParameters();
            parInp.P_COL = "";
            decimal Max, Min;
            ...
            parInp.P_SORT = "DESC";
            parInp.STR_WHERE = String.Format(" ID_KBAIR = {0} {1}", this.IdKBgnAir, _where);
            parInp.P_COUNT = "Y";
            Console.WriteLine(parInp.STR_WHERE);
            fetchData = new SvcBgnAirRwyKibSelect.call_pttClient();
            fetchData.Open();
        ...
        public void showData(SvcBgnAirRwyKibSelect.OutputParameters serviceOutPut)
        {
            ...
            if (this.getById == true && jmlDataGroup > 0)
            {
                ...
                {
                    serviceOutPut.SF_ROW_M_KBAIR_DOK_KIB[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_M_KBAIR_DOK_KIB[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    //serviceOutPut.SF_ROW_M_KBAIR_DOK_KIB[0].TOTAL_DATASpecified = true;
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KBAIR_DOK_KIB[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
              string date = Convert.ToString(serviceOutPut.SF_ROW_M_KBAIR_DOK_KIB[i].TGL_DOK_KIB).Substring(0, 10);
              string date_ = Convert.ToString(serviceOutPut.SF_ROW_M_KBAIR_DOK_KIB[i].TGL_DOK_KIB).Substring(0, 8);

              if (date == "11/11/1000" || date_ == "1/1/0001")
              {
                serviceOutPut.SF_ROW_M_KBAIR_DOK_KIB[i].TGL_DOK_KIB = null;
              }
                binder.Add(serviceOutPut.SF_ROW_M_KBAIR_DOK_KIB[i]);
            }
        ...
        {
            this.FrmBgnAirKib = new FrmBgnAirKib(this, "input");
            StatusCrud = "input";
            this.FrmBgnAirKib.ShowDialog();
        }
        protected override void bbEdit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                this.FrmBgnAirKib = new FrmBgnAirKib(this, "detail");
                StatusCrud = "detail";
            }
            else
            {
                this.FrmBgnAirKib = new FrmBgnAirKib(this, "edit");
                StatusCrud = "edit";
            }
            this.FrmBgnAirKib.ShowDialog();
        }
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            StatusCrud = "hapus";
            this.FrmBgnAirKib = new FrmBgnAirKib(this, "hapus");
            this.FrmBgnAirKib.Size = new System.Drawing.Size(0, 0);
            this.FrmBgnAirKib.Opacity = 0;
            this.FrmBgnAirKib.Show();
            this.FrmBgnAirKib.Hide();
            this.FrmBgnAirKib.hapusData();
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcBgnAirRwyKibSelect.BPSIMANSROW_M_KBAIR_DOK_KIB)viewTerpilih.GetRow(e.FocusedRowHandle);
