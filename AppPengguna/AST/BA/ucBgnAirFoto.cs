...
{
    class ucTnhFoto : UserControlDetail
    {

        private SvcTanahRiwayatFotoSelect.photoSelectGrid_pttClient fetchData;
        private SvcTanahRiwayatFotoSelect.InputParameters parInp;
        private SvcTanahRiwayatFotoSelect.OutputParameters outData;
        public SvcTanahRiwayatFotoSelect.BPSIMANSROW_M_ASET_PHOTO_GRID selectedData;
        ...
        public ucTnhFoto(decimal? _ID_ASET, String status)
            : base()
        {
            this.InitFoto();
            this.Status = Status;
        ...
        public void InitFoto()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcTanahRiwayatFotoSelect.BPSIMANSROW_M_ASET_PHOTO_GRID);
        ...
        public void getInitFoto(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcTanahRiwayatFotoSelect.InputParameters();
            parInp.P_COL = "";
            decimal Max, Min;
            ...
            fetchData = new SvcTanahRiwayatFotoSelect.photoSelectGrid_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcTanahRiwayatFotoSelect.OutputParameters dataOut);
        public decimal? NUM;
        private string StatusCrud = "";
        public void showData(SvcTanahRiwayatFotoSelect.OutputParameters serviceOutPut)
        {
        ...
        {
            this.frmTnhFoto = new frmTnhFoto(this, "input");
            StatusCrud = "input";
            this.frmTnhFoto.ShowDialog();
        }
        protected override void bbEdit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                this.frmTnhFoto = new frmTnhFoto(this, "detail");
                StatusCrud = "detail";
            }
            else
            {
                this.frmTnhFoto = new frmTnhFoto(this, "edit");
                StatusCrud = "edit";
            }
            this.frmTnhFoto.ShowDialog();
        }
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            StatusCrud = "hapus";
            this.frmTnhFoto = new frmTnhFoto(this, "hapus");
            this.frmTnhFoto.Size = new System.Drawing.Size(0, 0);
            this.frmTnhFoto.Opacity = 0;
            this.frmTnhFoto.Show();
            this.frmTnhFoto.Hide();
            this.frmTnhFoto.hapusData();
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcTanahRiwayatFotoSelect.BPSIMANSROW_M_ASET_PHOTO_GRID)viewTerpilih.GetRow(e.FocusedRowHandle);
