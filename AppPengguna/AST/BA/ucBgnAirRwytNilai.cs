...
{
    class ucBgnAirRwytNilai : UserControlDetail
    {

   
        private frmNilai puNilai;
        private decimal? ID_KBAIR_RWYT_NILAI;
        ...
        private SvcBgnAirRwytNilaiSelect.call_pttClient fetchData;
        private SvcBgnAirRwytNilaiSelect.InputParameters parInp;
        private SvcBgnAirRwytNilaiSelect.OutputParameters outData;
        private SvcBgnAirRwytNilaiSelect.BPSIMANSROW_KBAIR_RWYT_NILAI selectedData;


        public ucBgnAirRwytNilai(decimal? _ID_KBAIR, String _Status)
            : base()
        {
            this.initBgnAir();
        ...
        private void initBgnAir()
        {
            this.binder = new BindingSource();
            this.binder.DataSource = typeof(AppPengguna.SvcBgnAirRwytNilaiSelect.BPSIMANSROW_KBAIR_RWYT_NILAI);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KBAIR_RWYT_NILAI;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_KBAIR_RWYT_NILAI";
                parInp.P_TABLE = "M_KBAIR_RWYT_NILAI";
        ...
        public void getInitTnhRPnl(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcBgnAirRwytNilaiSelect.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcBgnAirRwytNilaiSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcBgnAirRwytNilaiSelect.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcBgnAirRwytNilaiSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_KBAIR_RWYT_NILAI.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_KBAIR_RWYT_NILAI[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_KBAIR_RWYT_NILAI[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_KBAIR_RWYT_NILAI[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
              string date = Convert.ToString(serviceOutPut.SF_ROW_KBAIR_RWYT_NILAI[i].TGL_BUKU).Substring(0, 10);
              string date_ = Convert.ToString(serviceOutPut.SF_ROW_KBAIR_RWYT_NILAI[i].TGL_BUKU).Substring(0, 8);
              string date2 = Convert.ToString(serviceOutPut.SF_ROW_KBAIR_RWYT_NILAI[i].TGL_NILAI).Substring(0, 10);
              string date2_ = Convert.ToString(serviceOutPut.SF_ROW_KBAIR_RWYT_NILAI[i].TGL_NILAI).Substring(0, 8);

              if (date == "11/11/1000" || date_ == "1/1/0001")
              {
                serviceOutPut.SF_ROW_KBAIR_RWYT_NILAI[i].TGL_BUKU = null;
              }
              if (date2 == "11/11/1000" || date2_ == "1/1/0001")
              {
                serviceOutPut.SF_ROW_KBAIR_RWYT_NILAI[i].TGL_NILAI = null;
              }

                binder.Add(serviceOutPut.SF_ROW_KBAIR_RWYT_NILAI[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcBgnAirRwytNilaiSelect.BPSIMANSROW_KBAIR_RWYT_NILAI)selectedView.GetRow(e.FocusedRowHandle);
        ...
        SvcBangunanAirRnilaiCrud.call_pttClient svcRiwayatNilaiCrud;
        SvcBangunanAirRnilaiCrud.OutputParameters outRiwayatNilaiCrud;
        ...
        private void saveFrmNilai(string text)
        {
            ...
            try
            {
                ...
                SvcBangunanAirRnilaiCrud.InputParameters parInp = new SvcBangunanAirRnilaiCrud.InputParameters();
                parInp.P_ID_KBAIR = this.ID_KBAIR;
                parInp.P_ID_KBAIR_RWYT_NILAI = (this.puNilai.Status == "input") ? 0 : this.selectedData.ID_KBAIR_RWYT_NILAI;
                parInp.P_ID_KBAIR_RWYT_NILAISpecified = true;
                ...
                this.svcRiwayatNilaiCrud = new SvcBangunanAirRnilaiCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcBangunanAirRnilaiCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcBangunanAirRnilaiCrud.OutputParameters outCrud)
        {
            SvcBgnAirRwytNilaiSelect.BPSIMANSROW_KBAIR_RWYT_NILAI dataPenyama = new SvcBgnAirRwytNilaiSelect.BPSIMANSROW_KBAIR_RWYT_NILAI();
            ...
            dataPenyama.ID_KBAIR_RWYT_NILAI = (this.modeCrud == 'U') ? selectedData.ID_KBAIR_RWYT_NILAI : outCrud.PO_ID_KBAIR_RWYT_NILAI;
            dataPenyama.ID_KBAIR_RWYT_NILAISpecified = true;
            ...
            this.ID_KBAIR_RWYT_NILAI = outCrud.PO_ID_KBAIR_RWYT_NILAI;
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puNilai.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KBAIR_RWYT_NILAI", dataPenyama.ID_KBAIR_RWYT_NILAI, "M_KBAIR_RWYT_NILAI", filePath, "C", this.puNilai.ID_JNSDOK);
                    }
                    else
                    {
                        this.puNilai.Close();
                        ...
                        this.getById = true;
                        this.getInitTnhRPnl(" ID_KBAIR_RWYT_NILAI = " + outCrud.PO_ID_KBAIR_RWYT_NILAI.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puNilai.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KBAIR_RWYT_NILAI", dataPenyama.ID_KBAIR_RWYT_NILAI, "M_KBAIR_RWYT_NILAI", filePath, SELECT, this.puNilai.ID_JNSDOK);
                    }
                    else
                    {
                        this.puNilai.Close();
        ...
        private void crudDokAset(SvcAsetDokCrud.OutputParameters dataoutDokAsetCrud)
        {
            if (dataoutDokAsetCrud.PO_RESULT == "Y")
            {
                ...
                if (this.modeCrud != 'D')
                {
                    ...
                    this.dataInisial = false;
                    this.getById = true;
                    this.getInitTnhRPnl(" ID_KBAIR_RWYT_NILAI = " + ID_KBAIR_RWYT_NILAI.ToString());
                }
            }
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
               ...
               MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    parInp.P_ID_KBAIR_RWYT_NILAI = selectedData.ID_KBAIR_RWYT_NILAI;
                    parInp.P_ID_KBAIR_RWYT_NILAISpecified = true;
                    parInp.P_ID_KBAIRSpecified = true;
                    ...
                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatNilaiCrud = new SvcBangunanAirRnilaiCrud.call_pttClient();
                    svcRiwayatNilaiCrud.Open();
