...
{
    class ucBgnAirRwytPemeliharaan : UserControlDetail
    {
        ...
        private decimal? ID_KBAIR_RWYT_PELIHARA;



        private SvcBgnAirRwytPemeliharaSelect.call_pttClient fetchData;
        private SvcBgnAirRwytPemeliharaSelect.InputParameters parInp;
        private SvcBgnAirRwytPemeliharaSelect.OutputParameters outData;
        private SvcBgnAirRwytPemeliharaSelect.BPSIMANSROW_M_KBAIR_RWYT_PELIHARA selectedData;




        public ucBgnAirRwytPemeliharaan(decimal? _ID_KBAIR, String Status)
            : base()
        {
            this.initTnhRPemeliharaan();
            this.Status = Status;
            this.IdKtnh = _ID_KBAIR;
        ...
        private void initTnhRPemeliharaan()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcBgnAirRwytPemeliharaSelect.BPSIMANSROW_M_KBAIR_RWYT_PELIHARA);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KBAIR_RWYT_PELIHARA;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_KBAIR_RWYT_PELIHARA";
                parInp.P_TABLE = "M_KBAIR_RWYT_PELIHARA";
        ...
        {
            this.initGrid();
            this.getInitBgnAirPelihara();
        }



        #region load data
        public void getInitBgnAirPelihara(string _where = null)
        {
            decimal Max, Min;
            myThread = new Thread(new ThreadStart(this.ShowProgresBar));
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcBgnAirRwytPemeliharaSelect.InputParameters();
            parInp.P_COL = "";
            ...
            parInp.P_SORT = "DESC";
            parInp.STR_WHERE = String.Format(" ID_KBAIR = {0} {1}", this.IdKtnh, _where);
            fetchData = new SvcBgnAirRwytPemeliharaSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcBgnAirRwytPemeliharaSelect.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcBgnAirRwytPemeliharaSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_KBAIR_RWYT_PELIHARA.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_KBAIR_RWYT_PELIHARA[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_KBAIR_RWYT_PELIHARA[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_KBAIR_RWYT_PELIHARA[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
              string date = Convert.ToString(serviceOutPut.SF_ROW_KBAIR_RWYT_PELIHARA[i].TGL_BUKU).Substring(0, 10);
              string date_ = Convert.ToString(serviceOutPut.SF_ROW_KBAIR_RWYT_PELIHARA[i].TGL_BUKU).Substring(0, 8);
              string date2 = Convert.ToString(serviceOutPut.SF_ROW_KBAIR_RWYT_PELIHARA[i].TGL_SP2D).Substring(0, 10);
              string date2_ = Convert.ToString(serviceOutPut.SF_ROW_KBAIR_RWYT_PELIHARA[i].TGL_SP2D).Substring(0, 8);

              if (date == "11/11/1000" || date_ == "1/1/0001")
              {
                serviceOutPut.SF_ROW_KBAIR_RWYT_PELIHARA[i].TGL_BUKU = null;
              }
              if (date2 == "11/11/1000" || date2_ == "1/1/0001")
              {
                serviceOutPut.SF_ROW_KBAIR_RWYT_PELIHARA[i].TGL_SP2D = null;
              }
                binder.Add(serviceOutPut.SF_ROW_KBAIR_RWYT_PELIHARA[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcBgnAirRwytPemeliharaSelect.BPSIMANSROW_M_KBAIR_RWYT_PELIHARA)selectedView.GetRow(e.FocusedRowHandle);
        ...
        SvcBangunanAirRpemeliharaanCrud.call_pttClient svcRiwayatPemeliharaanCrud;
        SvcBangunanAirRpemeliharaanCrud.OutputParameters outRiwayatPemeliharaanCrud;
        ...
        private void saveForm(string text)
        {
            ...
            try
            {
                ...
                SvcBangunanAirRpemeliharaanCrud.InputParameters parInp = new SvcBangunanAirRpemeliharaanCrud.InputParameters();
                parInp.P_ID_KBAIR = this.IdKtnh;
                parInp.P_ID_KBAIR_RWYT_PELIHARA = (this.puPemeliharaan.Status == "input") ? 0 : this.selectedData.ID_KBAIR_RWYT_PELIHARA;
                parInp.P_ID_KBAIR_RWYT_PELIHARASpecified = true;
                ...
                parInp.P_JNS_PELIHARA =konfigApp.StringtoNull( this.puPemeliharaan.teJenisPemeliharaan.Text);
                ...
                this.svcRiwayatPemeliharaanCrud = new SvcBangunanAirRpemeliharaanCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcBangunanAirRpemeliharaanCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcBangunanAirRpemeliharaanCrud.OutputParameters outCrud)
        {
            SvcBgnAirRwytPemeliharaSelect.BPSIMANSROW_M_KBAIR_RWYT_PELIHARA dataPenyama = new SvcBgnAirRwytPemeliharaSelect.BPSIMANSROW_M_KBAIR_RWYT_PELIHARA();
            ...
            dataPenyama.ID_KBAIR_RWYT_PELIHARA = (this.modeCrud == 'U') ? selectedData.ID_KBAIR_RWYT_PELIHARA : outCrud.PO_ID_KBAIR_RWYT_PELIHARA;
            dataPenyama.ID_KBAIR_RWYT_PELIHARASpecified = true;
            ...
            this.ID_KBAIR_RWYT_PELIHARA = outCrud.PO_ID_KBAIR_RWYT_PELIHARA;
            ...
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puPemeliharaan.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KBAIR_RWYT_PELIHARA", dataPenyama.ID_KBAIR_RWYT_PELIHARA, "M_KBAIR_RWYT_PELIHARA", filePath, "C", this.puPemeliharaan.ID_JNSDOK);
                    }
                    else
                    {
                        ...
                        this.getById = true;
                        this.getInitBgnAirPelihara(" ID_KBAIR_RWYT_PELIHARA = " + outCrud.PO_ID_KBAIR_RWYT_PELIHARA.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puPemeliharaan.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KBAIR_RWYT_PELIHARA", dataPenyama.ID_KBAIR_RWYT_PELIHARA, "M_KBAIR_RWYT_PELIHARA", filePath, SELECT, this.puPemeliharaan.ID_JNSDOK);
                    }
                    else
                    {
        ...
        private void crudDokAset(SvcAsetDokCrud.OutputParameters dataoutDokAsetCrud)
        {
            if (dataoutDokAsetCrud.PO_RESULT == "Y")
            {
                ...
                if (this.modeCrud != 'D')
                {
                    ...
                    this.dataInisial = false;
                    this.getById = true;
                    this.getInitBgnAirPelihara(" ID_KBAIR_RWYT_PELIHARA = " + this.ID_KBAIR_RWYT_PELIHARA.ToString());
                }
            }
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
              ...
              MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    parInp.P_ID_KBAIRSpecified = true;
                    parInp.P_ID_KBAIR_RWYT_PELIHARA = selectedData.ID_KBAIR_RWYT_PELIHARA;
                    parInp.P_ID_KBAIR_RWYT_PELIHARASpecified = true;


                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatPemeliharaanCrud = new SvcBangunanAirRpemeliharaanCrud.call_pttClient();
                    svcRiwayatPemeliharaanCrud.Open();
        ...
        protected override void bbSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                this.getInitBgnAirPelihara(get_where_clause(nama_kolom, opr, parameter, parameter_2));
        ...
        protected override void bbTambah_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            this.puPemeliharaan.saveForm = new SaveFrmPemeliharaan(this.saveForm);
            StatusCrud = "input";
            //this.puPemeliharaan.teUrSatker.Text = konfigApp.namaSatker;
            //this.puPemeliharaan.teKdSatker.Text = konfigApp.kodeSatker;
            this.puPemeliharaan.ID_SATKER = konfigApp.idSatker;
