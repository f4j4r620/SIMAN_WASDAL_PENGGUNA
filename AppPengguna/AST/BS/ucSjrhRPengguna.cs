...
{
    class ucSjrhRPengguna : UserControlDetail
    {


        private frmPengelola puPengelola;
        private String Status;
        public decimal? ID_SEJARAH_RWYT_PENGGUNA;
        private decimal? ID_SEJARAH;
        private string search;
        public frmProgres progresBar = null;

        private SvcSjrhRwyPenggunaSelect.call_pttClient fetchData;
        private SvcSjrhRwyPenggunaSelect.InputParameters parInp;
        private SvcSjrhRwyPenggunaSelect.OutputParameters outData;
        public SvcSjrhRwyPenggunaSelect.BPSIMANSROW_SEJARAH_RWYT_PENGGUNA selectedData;



        public ucSjrhRPengguna(decimal? _ID_SEJARAH, String Status)
            : base()
        {
        ...
        private void initRiwayatPengguna()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcSjrhRwyPenggunaSelect.BPSIMANSROW_SEJARAH_RWYT_PENGGUNA);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_SEJARAH_RWYT_PENGGUNA;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_SEJARAH_RWYT_PENGGUNA";
                parInp.P_TABLE = "M_SEJARAH_RWYT_PENGGUNA";
        ...
        public void getInitTnhRPgn(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcSjrhRwyPenggunaSelect.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcSjrhRwyPenggunaSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcSjrhRwyPenggunaSelect.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcSjrhRwyPenggunaSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_SEJARAH_RWYT_PENGGUNA.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_SEJARAH_RWYT_PENGGUNA[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_SEJARAH_RWYT_PENGGUNA[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_SEJARAH_RWYT_PENGGUNA[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
                binder.Add(serviceOutPut.SF_ROW_SEJARAH_RWYT_PENGGUNA[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcSjrhRwyPenggunaSelect.BPSIMANSROW_SEJARAH_RWYT_PENGGUNA)selectedView.GetRow(e.FocusedRowHandle);
        ...
        SvcSjrhRpengelolaCrud.call_pttClient svcRiwayatPengelolaCrud;
        SvcSjrhRpengelolaCrud.OutputParameters outRiwayatPengelolaCrud;
        ...
        private void saveForm(string text)
        {
            ...
            try
            {
                ...
                SvcSjrhRpengelolaCrud.InputParameters parInp = new SvcSjrhRpengelolaCrud.InputParameters();
                parInp.P_ID_SEJARAH = this.ID_SEJARAH;
                parInp.P_ID_SEJARAH_RWYT_PENGGUNA = (this.puPengelola.Status == "input") ? 0 : this.selectedData.ID_SEJARAH_RWYT_PENGGUNA;
                parInp.P_ID_SEJARAH_RWYT_PENGGUNASpecified = true;
                ...
                this.svcRiwayatPengelolaCrud = new SvcSjrhRpengelolaCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcSjrhRpengelolaCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcSjrhRpengelolaCrud.OutputParameters outCrud)
        {
            SvcSjrhRwyPenggunaSelect.BPSIMANSROW_SEJARAH_RWYT_PENGGUNA dataPenyama = new SvcSjrhRwyPenggunaSelect.BPSIMANSROW_SEJARAH_RWYT_PENGGUNA();
            ...
            dataPenyama.ID_SEJARAH_RWYT_PENGGUNA = (this.modeCrud == 'U') ? selectedData.ID_SEJARAH_RWYT_PENGGUNA : outCrud.PO_ID_SEJARAH_RWYT_PENGGUNA;
            dataPenyama.ID_SEJARAH_RWYT_PENGGUNASpecified = true;
            ...
            this.ID_SEJARAH_RWYT_PENGGUNA = (this.StatusCrud == "input") ? outCrud.PO_ID_SEJARAH_RWYT_PENGGUNA : selectedData.ID_SEJARAH_RWYT_PENGGUNA;
            ...
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puPengelola.FilePath != null)
                    {
                        ...
                        simpanFile("ID_SEJARAH_RWYT_PENGGUNA", dataPenyama.ID_SEJARAH_RWYT_PENGGUNA, "M_SEJARAH_RWYT_PENGGUNA", filePath, "C");
                    }
                    else
                    {
                        ...
                        this.getById = true;
                        this.getInitTnhRPgn(" ID_SEJARAH_RWYT_PENGGUNA = " + this.ID_SEJARAH_RWYT_PENGGUNA.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puPengelola.FilePath != null)
                    {
                        ...
                        simpanFile("ID_SEJARAH_RWYT_PENGGUNA", dataPenyama.ID_SEJARAH_RWYT_PENGGUNA, "M_SEJARAH_RWYT_PENGGUNA", filePath, SELECT);
                    }
                    else
                    {
                        this.puPengelola.Close();
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
             ...
             MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    parInp.P_ID_SEJARAHSpecified = true;
                    parInp.P_ID_SEJARAH_RWYT_PENGGUNA = selectedData.ID_SEJARAH_RWYT_PENGGUNA;
                    parInp.P_ID_SEJARAH_RWYT_PENGGUNASpecified = true;


                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatPengelolaCrud = new SvcSjrhRpengelolaCrud.call_pttClient();
                    svcRiwayatPengelolaCrud.Open();
