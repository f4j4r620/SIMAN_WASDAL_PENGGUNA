...
{
    class ucSjrhRMutasi : UserControlDetail
    {
        ...
        private SvcSjrhRwyMutasiSelect.call_pttClient fetchData;
        private SvcSjrhRwyMutasiSelect.InputParameters parInp;
        private SvcSjrhRwyMutasiSelect.OutputParameters outData;
        public SvcSjrhRwyMutasiSelect.BPSIMANSROW_SEJARAH_RWYT_MUTASI selectedData;



        public ucSjrhRMutasi(decimal? _ID_SEJARAH, String Status)
            : base()
        {
            this.initTnhRMutasi();
            this.Status = Status;
        ...
        private void initTnhRMutasi()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcSjrhRwyMutasiSelect.BPSIMANSROW_SEJARAH_RWYT_MUTASI);
        ...
        public void getInitMutasi(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcSjrhRwyMutasiSelect.InputParameters();
            parInp.P_COL = "";
            ...
            parInp.P_SORT = "DESC";
            parInp.STR_WHERE = String.Format(" ID_SEJARAH = {0} {1}", this.ID_SEJARAH, this.search);
            fetchData = new SvcSjrhRwyMutasiSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcSjrhRwyMutasiSelect.OutputParameters dataOut);

        public void showData(SvcSjrhRwyMutasiSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_SEJARAH_RWYT_MUTASI.Count();
            ...
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_SEJARAH_RWYT_MUTASI[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
                binder.Add(serviceOutPut.SF_ROW_SEJARAH_RWYT_MUTASI[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcSjrhRwyMutasiSelect.BPSIMANSROW_SEJARAH_RWYT_MUTASI)selectedView.GetRow(e.FocusedRowHandle);
