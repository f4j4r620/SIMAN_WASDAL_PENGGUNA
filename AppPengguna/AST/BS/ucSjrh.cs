...
{
    class ucSjrh : UserControlDetail
    {
        private SvcSjrhSelect.call_pttClient fetchData;
        public SvcSjrhSelect.OutputParameters outDat;
        public SvcSjrhSelect.BPSIMANSROW_M_SEJARAH selectedData;
        ...
        SvcSjrhSelect.BPSIMANSROW_M_SEJARAH newRow;
        ...
        public ucSjrh(bool tracking = false)
        {
            FROM_TRACKING = tracking;
            this.binder = new BindingSource();
            this.binder.DataSource = typeof(SvcSjrhSelect.BPSIMANSROW_M_SEJARAH);
        ...
        public void hapusData(SvcSjrhSelect.BPSIMANSROW_M_SEJARAH selectedData)
        {
            
            try
            {
                this.nonAktifForm("");
                //MessageBox.Show(selectedData.ID_ASET.ToString(),selectedData.ID_SEJARAH.ToString());
              //  myThread = new Thread(new ThreadStart(ShowProgresBar),"");
               // myThread.Start();
                ...
                svcbangunanCrud = new SvcSjrhCrud.call_pttClient();
        ...
        private void getResultCrud(IAsyncResult result)
        {
            try
            {
                ...
                {
                    this.Invoke(new UbahSejarah(this.ubahSejarah), outDataCrud);
                }
            }
            catch
            {
        ...
        private delegate void UbahSejarah(SvcSjrhCrud.OutputParameters dataOutCrud);

        private void ubahSejarah(SvcSjrhCrud.OutputParameters dataOutCrud)
        {
            SvcSjrhSelect.BPSIMANSROW_M_SEJARAH dataPenyama = new SvcSjrhSelect.BPSIMANSROW_M_SEJARAH();
            dataPenyama.ID_SEJARAH = dataOutCrud.PO_ID_SEJARAH;
        ...
        protected override void gvUcDtl_InitNewRow(object sender, InitNewRowEventArgs e)
        {
            ...
            newRow = (SvcSjrhSelect.BPSIMANSROW_M_SEJARAH)selectedView.GetRow(e.RowHandle);
        ...
        protected override void bbSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                this.dataInisial = true;
                this.getinitSejarah(get_where_clause(nama_kolom, opr, parameter, parameter_2));
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcSjrhSelect.BPSIMANSROW_M_SEJARAH)selectedView.GetRow(e.FocusedRowHandle);
        ...
        public void getinitSejarah(string strwhere = null)
        {
            this.nonAktifForm("");
            ...
            fetchData = new SvcSjrhSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcSjrhSelect.OutputParameters dataOut);

        ucSjrhForm SejarahForm;


        public void showData(SvcSjrhSelect.OutputParameters serviceOutPut)
        {
            if (!FROM_TRACKING)
            {
                ...
                if (this.dataInisial == true)
                {
                    ...
                    if (jmlData > 0)
                    {
                        ...
                        StrTotalDb.Caption = serviceOutPut.SF_ROW_M_SEJARAH[0].TOTAL_DATA.ToString();
                    }
                    else
                    {
                ...
                if (jmlData > 0)
                {
                    this.SUM_RPH_ASET = serviceOutPut.SF_ROW_M_SEJARAH[0].SUM_RPH_ASET;
                    this.SUM_RPH_MUTASI = serviceOutPut.SF_ROW_M_SEJARAH[0].SUM_RPH_MUTASI;
                    this.SUM_RPH_SUSUT = serviceOutPut.SF_ROW_M_SEJARAH[0].SUM_RPH_SUSUT;
                }

                for (int i = 0; i < jmlData; i++)
                {
                    this.binder.Add(serviceOutPut.SF_ROW_M_SEJARAH[i]);
                }
            ...
            else
            {
                ...
                if (jmlData > 0)
                {
                    SejarahForm = new ucSjrhForm("detail");
                    SejarahForm.nonAktifForm = new NonAktifkanFormSatker(this.nonAktifForm);
                    SejarahForm.aktifkanForm = new AktifkanFormSatker(this.aktifkanForm);

                    SejarahForm.ShowProgresBar = new showProgresBar(this.ShowProgresBar);
                    SejarahForm.CloseProgresBar = new closeProgresBar(this.CloseProgresBar);
                    SejarahForm.Dock = System.Windows.Forms.DockStyle.Fill;
                    SejarahForm.IsiForm(serviceOutPut.SF_ROW_M_SEJARAH[0]);
                }
                else
                {
                    MessageBox.Show("Data aset tidak ditemukan", "Perhatian");
                }
                setPanel(SejarahForm);
               
                //this.frmKoorSatker.panelKoorSatker.Controls.Clear();
                //this.frmKoorSatker.panelKoorSatker.Controls.Add(SejarahForm);
            }
