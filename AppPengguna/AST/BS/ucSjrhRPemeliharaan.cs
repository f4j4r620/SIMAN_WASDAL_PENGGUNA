...
{
    class ucSjrhRPemeliharaan : UserControlDetail
    {
        ...
        public decimal? ID_SEJARAH;
        private decimal? ID_SEJARAH_RWYT_PELIHARA;



        private SvcSjrhRwyPeliharaSelect.call_pttClient fetchData;
        private SvcSjrhRwyPeliharaSelect.InputParameters parInp;
        private SvcSjrhRwyPeliharaSelect.OutputParameters outData;
        private SvcSjrhRwyPeliharaSelect.BPSIMANSROW_M_SEJARAH_RWYT_PELIHARA selectedData;




        public ucSjrhRPemeliharaan(decimal? _ID_SEJARAH, String Status)
            : base()
        {
            this.initTnhRPemeliharaan();
            this.Status = Status;
            this.ID_SEJARAH = _ID_SEJARAH;
        ...
        private void initTnhRPemeliharaan()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcSjrhRwyPeliharaSelect.BPSIMANSROW_M_SEJARAH_RWYT_PELIHARA);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_SEJARAH_RWYT_PELIHARA;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_SEJARAH_RWYT_PELIHARA";
                parInp.P_TABLE = "M_SEJARAH_RWYT_PELIHARA";
        ...
        public void getInitTnhRPml(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcSjrhRwyPeliharaSelect.InputParameters();
            parInp.P_COL = "";
            ...
            parInp.P_SORT = "DESC";
            parInp.STR_WHERE = String.Format(" ID_SEJARAH = {0} {1}", this.ID_SEJARAH, _where);
            fetchData = new SvcSjrhRwyPeliharaSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcSjrhRwyPeliharaSelect.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcSjrhRwyPeliharaSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_M_SEJARAH_RWYT_PELIHARA.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_M_SEJARAH_RWYT_PELIHARA[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_M_SEJARAH_RWYT_PELIHARA[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_SEJARAH_RWYT_PELIHARA[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
                binder.Add(serviceOutPut.SF_ROW_M_SEJARAH_RWYT_PELIHARA[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcSjrhRwyPeliharaSelect.BPSIMANSROW_M_SEJARAH_RWYT_PELIHARA)selectedView.GetRow(e.FocusedRowHandle);
        ...
        SvcSjrhRpemeliharaanCrud.call_pttClient svcRiwayatPemeliharaanCrud;
        SvcSjrhRpemeliharaanCrud.OutputParameters outRiwayatPemeliharaanCrud;
        ...
        private void saveForm(string text)
        {
            ...
            try
            {
                ...
                SvcSjrhRpemeliharaanCrud.InputParameters parInp = new SvcSjrhRpemeliharaanCrud.InputParameters();
                parInp.P_ID_SEJARAH = this.ID_SEJARAH;
                parInp.P_ID_SEJARAH_RWYT_PELIHARA = (this.puPemeliharaan.Status == "input") ? 0 : this.selectedData.ID_SEJARAH_RWYT_PELIHARA;
                parInp.P_ID_SEJARAH_RWYT_PELIHARASpecified = true;
                parInp.P_ID_SEJARAHSpecified = true;
                ...
                this.svcRiwayatPemeliharaanCrud = new SvcSjrhRpemeliharaanCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcSjrhRpemeliharaanCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcSjrhRpemeliharaanCrud.OutputParameters outCrud)
        {
            SvcSjrhRwyPeliharaSelect.BPSIMANSROW_M_SEJARAH_RWYT_PELIHARA dataPenyama = new SvcSjrhRwyPeliharaSelect.BPSIMANSROW_M_SEJARAH_RWYT_PELIHARA();

            dataPenyama.NUM = 999;
            dataPenyama.NUMSpecified = true;
            dataPenyama.ID_ASET = (this.modeCrud == 'U') ? selectedData.ID_ASET : 0;
            dataPenyama.ID_ASETSpecified = true;
            dataPenyama.ID_SEJARAH = (this.modeCrud == 'U') ? selectedData.ID_SEJARAH : 0;
            dataPenyama.ID_SEJARAH_RWYT_PELIHARA = (this.modeCrud == 'U') ? outCrud.PO_ID_SEJARAH_RWYT_PELIHARA : selectedData.ID_SEJARAH_RWYT_PELIHARA;
            dataPenyama.ID_SEJARAH_RWYT_PELIHARASpecified = true;
            dataPenyama.ID_SEJARAHSpecified = true;
            ...
            this.ID_SEJARAH_RWYT_PELIHARA = outCrud.PO_ID_SEJARAH_RWYT_PELIHARA;
            ...
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puPemeliharaan.FilePath != null)
                    {
                        ...
                        simpanFile("ID_SEJARAH_RWYT_PELIHARA", dataPenyama.ID_SEJARAH_RWYT_PELIHARA, "M_SEJARAH_RWYT_PELIHARA", filePath, "C");
                    }
                    else
                    {
                        ...
                        this.getById = true;
                        this.getInitTnhRPml(" ID_SEJARAH_RWYT_PELIHARA = " + outCrud.PO_ID_SEJARAH_RWYT_PELIHARA.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puPemeliharaan.FilePath != null)
                    {
                        ...
                        simpanFile("ID_SEJARAH_RWYT_PELIHARA", dataPenyama.ID_SEJARAH_RWYT_PELIHARA, "M_SEJARAH_RWYT_PELIHARA", filePath, SELECT);
                    }
                    else
                    {
        ...
        private void crudDokAset(SvcAsetDokCrud.OutputParameters dataoutDokAsetCrud)
        {
            if (dataoutDokAsetCrud.PO_RESULT == "Y")
            {
                ...
                if (this.modeCrud != 'D')
                {
                    ...
                    this.dataInisial = false;
                    this.getById = true;
                    this.getInitTnhRPml(" ID_SEJARAH_RWYT_PELIHARA = " + this.ID_SEJARAH_RWYT_PELIHARA.ToString());
                }
            }
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
              ...
              MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    myThread.Start();
                    SvcSjrhRpemeliharaanCrud.InputParameters parInp = new SvcSjrhRpemeliharaanCrud.InputParameters();
                    parInp.P_ID_SEJARAH = selectedData.ID_SEJARAH;
                    parInp.P_ID_SEJARAHSpecified = true;
                    parInp.P_ID_SEJARAH_RWYT_PELIHARA = selectedData.ID_SEJARAH_RWYT_PELIHARA;
                    parInp.P_ID_SEJARAH_RWYT_PELIHARASpecified = true;


                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatPemeliharaanCrud = new SvcSjrhRpemeliharaanCrud.call_pttClient();
                    svcRiwayatPemeliharaanCrud.Open();
