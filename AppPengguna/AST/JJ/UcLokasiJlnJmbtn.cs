...
{
    class UcLokasiJlnJmbtn : UserControlDetail
    {

  
        private FormLokTnhBngn FormLokTnhBngn;
        ...
        private SvcLokasiJlnJmbtnSelect.call_pttClient fetchData;
        private SvcLokasiJlnJmbtnSelect.InputParameters parInp;
        private SvcLokasiJlnJmbtnSelect.OutputParameters outData;
        public SvcLokasiJlnJmbtnSelect.BPSIMANSROW_M_KJALJ_LOKASI selectedData;


        public UcLokasiJlnJmbtn(decimal? ID_KJALJ, string status)
            : base()
        {
            this.initTnhLok();

            this.Status = Status;
            this.ID_KJALJ = ID_KJALJ;
            if (Status == "detail")
            {
        ...
        private void initTnhLok()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcLokasiJlnJmbtnSelect.BPSIMANSROW_M_KJALJ_LOKASI);
        ...
        public void getInitTnhLok(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcLokasiJlnJmbtnSelect.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcLokasiJlnJmbtnSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcLokasiJlnJmbtnSelect.OutputParameters dataOut);
        public decimal? NUM;
        private string StatusCrud = "";
        public void showData(SvcLokasiJlnJmbtnSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_M_KJALJ_LOKASI.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_M_KJALJ_LOKASI[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_M_KJALJ_LOKASI[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KJALJ_LOKASI[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
                binder.Add(serviceOutPut.SF_ROW_M_KJALJ_LOKASI[i]);
            }
        ...
        {
            this.FormLokTnhBngn = new FormLokTnhBngn(this, "input");
            StatusCrud = "input";
            this.FormLokTnhBngn.ShowDialog();
        }
        ...
        protected override void bbEdit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                this.FormLokTnhBngn = new FormLokTnhBngn(this, "detail");
                this.StatusCrud = "detail";
            }
            else
            {
                this.FormLokTnhBngn = new FormLokTnhBngn(this, "edit");
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (this.selectedData != null)
            {
                ...
                this.FormLokTnhBngn = new FormLokTnhBngn(this, "hapus");
                this.FormLokTnhBngn.Size = new System.Drawing.Size(0, 0);
                this.FormLokTnhBngn.Opacity = 0;
                this.FormLokTnhBngn.Show();
                this.FormLokTnhBngn.Hide();
                this.FormLokTnhBngn.hapusData();
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcLokasiJlnJmbtnSelect.BPSIMANSROW_M_KJALJ_LOKASI)viewTerpilih.GetRow(e.FocusedRowHandle);
                ...
                if (selectedData.GPS != null || selectedData.GPS != "-")
                {
