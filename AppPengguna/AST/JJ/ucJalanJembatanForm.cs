...
{
    public delegate void UpdateJalanJembatan(SvcJlnJmbtnCrud.OutputParameters dataOutJalanJembatanCrud);
    public  class ucJalanJembatanForm : ucDetailAsetForm
    {
      
        public ucIdentitasJalanJembatan identitas = new ucIdentitasJalanJembatan();
        private SvcJlnJmbtnSelect.BPSIMANSROW_KJALJ selectedData;
   
        public NonAktifkanFormSatker nonAktifForm;
        public AktifkanFormSatker aktifkanForm;
        public UpdateJalanJembatan updateJalanJembatan;
        ...
        private bool status_DokJalanJembatan;
        private bool status_LokJalanJembatan;
        private bool status_GPS;
        private bool status_DetailRuangan;
        private bool status_KonstruksiJalanJembatan;
        private bool status_RiwayatPenilaian;
        private bool status_NJOP;
        private bool status_RiwayatJalanJembatan;
        ...
        public ucJalanJembatanForm(string status)
        {
        ...
        public bool IsiForm(SvcJlnJmbtnSelect.BPSIMANSROW_KJALJ Data)
        {
            this.selectedData = Data;
            try
            {
                this.ID_SATKER = selectedData.ID_SATKER;
                this.ID_KJALJ = selectedData.ID_KJALJ;
        ...
        public void simpanUpdate()
        {
            if (this.cek_input())
            {
                    ...
                    try
                    {
                        ...
                        parInp.P_LEBAR = (decimal?) selectedData.LEBAR;
                        ...
                        parInp.P_TGL_RENOV = konfigApp.DateToDb(this.identitas.teTanggalRenovasi.Text);
                        ...
                        svcJlnJmbtnCrud = new SvcJlnJmbtnCrud.call_pttClient(konfigApp.SvcJlnJmbtnCrud_name,konfigApp.SvcJlnJmbtnCrud_address);
                        svcJlnJmbtnCrud.Open();
                        svcJlnJmbtnCrud.Beginexecute(parInp, new AsyncCallback(crudJalanJembatan), "");
        ...
        private void crudJalanJembatan(IAsyncResult result)
        {
            try
            {
        ...
        private delegate void SimpanData(SvcJlnJmbtnCrud.OutputParameters dataOutJalanJembatanCrud);

        private void simpanData(SvcJlnJmbtnCrud.OutputParameters dataOutJalanJembatanCrud)
        {
            this.updateJalanJembatan(dataOutJalanJembatanCrud);
        }
        ...
        protected override void TabDetail_SelectedPageChanged(object sender, DevExpress.XtraTab.TabPageChangedEventArgs e)
        {
            ...
            if (TabDetail.SelectedTabPage == this.TabLokasi && status_LokJalanJembatan == false)
            {
                status_LokJalanJembatan = true;
                UcLokasiJlnJmbtn ucLokasiJlnJmbtn = new UcLokasiJlnJmbtn(this.ID_KJALJ, this.status);
                ucLokasiJlnJmbtn.nonAktifForm = new NonAktifkanFormSatker(this.nonAktifForm);
                ucLokasiJlnJmbtn.aktifkanForm = new AktifkanFormSatker(this.aktifkanForm);
                ucLokasiJlnJmbtn.ShowProgresBar = new showProgresBar(this.ShowProgresBar);
                ucLokasiJlnJmbtn.CloseProgresBar = new closeProgresBar(this.CloseProgresBar);
                ucLokasiJlnJmbtn.nama_aset = this.teNamaBarang.Text;
                ucLokasiJlnJmbtn.Dock = DockStyle.Fill;
                TabLokasi.Controls.Clear();
                TabLokasi.Controls.Add(ucLokasiJlnJmbtn);
            }
            ...
            else if (TabDetail.SelectedTabPage == this.TabRiwayatPemeliharaan && status_RiwayatPemeliharaan == false)
            {
                ...
                UcRwyPemeliharaanJlnJmbtn ucRwyPemeliharaanJlnJmbtn = new UcRwyPemeliharaanJlnJmbtn(this.ID_KJALJ, this.status);
                ucRwyPemeliharaanJlnJmbtn.nonAktifForm = new NonAktifkanFormSatker(this.nonAktifForm);
                ucRwyPemeliharaanJlnJmbtn.aktifkanForm = new AktifkanFormSatker(this.aktifkanForm);
                ucRwyPemeliharaanJlnJmbtn.ShowProgresBar = new showProgresBar(this.ShowProgresBar);
                ucRwyPemeliharaanJlnJmbtn.CloseProgresBar = new closeProgresBar(this.CloseProgresBar);

                ucRwyPemeliharaanJlnJmbtn.Dock = DockStyle.Fill;
                TabRiwayatPemeliharaan.Controls.Clear();
                TabRiwayatPemeliharaan.Controls.Add(ucRwyPemeliharaanJlnJmbtn);
            }
            else if (TabDetail.SelectedTabPage == this.TabRiwayatPenilaian && status_RiwayatPenilaian == false)
            {
                status_RiwayatPenilaian = true;
                UcRwyPenilaianJlnJmbtn ucRwyPenilaianJlnJmbtn = new UcRwyPenilaianJlnJmbtn(this.ID_KJALJ, this.status);
                ucRwyPenilaianJlnJmbtn.nonAktifForm = new NonAktifkanFormSatker(this.nonAktifForm);
                ucRwyPenilaianJlnJmbtn.aktifkanForm = new AktifkanFormSatker(this.aktifkanForm);
                ucRwyPenilaianJlnJmbtn.ShowProgresBar = new showProgresBar(this.ShowProgresBar);
                ucRwyPenilaianJlnJmbtn.CloseProgresBar = new closeProgresBar(this.CloseProgresBar);
                ucRwyPenilaianJlnJmbtn.Dock = DockStyle.Fill;
                TabRiwayatPenilaian.Controls.Clear();
                TabRiwayatPenilaian.Controls.Add(ucRwyPenilaianJlnJmbtn);
            }
            
            else if (TabDetail.SelectedTabPage == this.TabRiwayatMutasi && status_RiwayatMutasi == false)
            {
                status_RiwayatMutasi = true;
                UcRwyMutJlnJmbtn ucRwyMutJlnJmbtn = new UcRwyMutJlnJmbtn(this.ID_KJALJ, this.status);
                ucRwyMutJlnJmbtn.nonAktifForm = new NonAktifkanFormSatker(this.nonAktifForm);
                ucRwyMutJlnJmbtn.aktifkanForm = new AktifkanFormSatker(this.aktifkanForm);
                ucRwyMutJlnJmbtn.ShowProgresBar = new showProgresBar(this.ShowProgresBar);
                ucRwyMutJlnJmbtn.CloseProgresBar = new closeProgresBar(this.CloseProgresBar);
                ucRwyMutJlnJmbtn.Dock = DockStyle.Fill;
                TabRiwayatMutasi.Controls.Clear();
                TabRiwayatMutasi.Controls.Add(ucRwyMutJlnJmbtn);
            }
           
            else if (TabDetail.SelectedTabPage == this.TabRiwayatPengelolaan && status_RiwayatPengguna == false)
            {
                status_RiwayatPengguna = true;
                UcRwyPenggunaJlnJmbtn ucRwyPenggunaJlnJmbtn = new UcRwyPenggunaJlnJmbtn(this.ID_KJALJ, this.status);
                ucRwyPenggunaJlnJmbtn.nonAktifForm = new NonAktifkanFormSatker(this.nonAktifForm);
                ucRwyPenggunaJlnJmbtn.aktifkanForm = new AktifkanFormSatker(this.aktifkanForm);
                ucRwyPenggunaJlnJmbtn.ShowProgresBar = new showProgresBar(this.ShowProgresBar);
                ucRwyPenggunaJlnJmbtn.CloseProgresBar = new closeProgresBar(this.CloseProgresBar);
                ucRwyPenggunaJlnJmbtn.Dock = DockStyle.Fill;
                TabRiwayatPengelolaan.Controls.Clear();
                TabRiwayatPengelolaan.Controls.Add(ucRwyPenggunaJlnJmbtn);
            }
            else if (TabDetail.SelectedTabPage == this.TabSusut && status_Susut == false)
            {
                status_Susut = true;
                UcRwytSusutJlnJmbtn UcrwytSusutJlnJmbtn = new UcRwytSusutJlnJmbtn(this.ID_KJALJ, this.status);
                UcrwytSusutJlnJmbtn.nonAktifForm = new NonAktifkanFormSatker(this.nonAktifForm);
                UcrwytSusutJlnJmbtn.aktifkanForm = new AktifkanFormSatker(this.aktifkanForm);
                UcrwytSusutJlnJmbtn.ShowProgresBar = new showProgresBar(this.ShowProgresBar);
                UcrwytSusutJlnJmbtn.CloseProgresBar = new closeProgresBar(this.CloseProgresBar);
                UcrwytSusutJlnJmbtn.Dock = DockStyle.Fill;
                TabSusut.Controls.Clear();
                TabSusut.Controls.Add(UcrwytSusutJlnJmbtn);
            }
            else if (TabDetail.SelectedTabPage == this.TabSpm && status_Spm == false)
            {
                status_Spm = true;
                UcRwytSpmJlnJmbtn UcrwytSpmJlnJmbtn = new UcRwytSpmJlnJmbtn(this.ID_KJALJ, this.status);
                UcrwytSpmJlnJmbtn.nonAktifForm = new NonAktifkanFormSatker(this.nonAktifForm);
                UcrwytSpmJlnJmbtn.aktifkanForm = new AktifkanFormSatker(this.aktifkanForm);
                UcrwytSpmJlnJmbtn.ShowProgresBar = new showProgresBar(this.ShowProgresBar);
                UcrwytSpmJlnJmbtn.CloseProgresBar = new closeProgresBar(this.CloseProgresBar);
                UcrwytSpmJlnJmbtn.Dock = DockStyle.Fill;
                TabSpm.Controls.Clear();
                TabSpm.Controls.Add(UcrwytSpmJlnJmbtn);
            }
        ...
        private void ambilSatkerPMK(decimal? id, string kode, string nama)
        {
            ...
            //this.teKdPenggunaJalanJembatan.Text = kode;
            //this.teNamaPenggunaJalanJembatan.Text = nama;
        }
