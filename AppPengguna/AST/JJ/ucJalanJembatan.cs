...
{
    class ucJalanJembatan : UserControlDetail
    {
        private SvcJlnJmbtnSelect.call_pttClient fetchData;
        public SvcJlnJmbtnSelect.OutputParameters outDat;
        public SvcJlnJmbtnSelect.BPSIMANSROW_KJALJ selectedData;
        ...
        SvcJlnJmbtnSelect.BPSIMANSROW_KJALJ newRow;
        ...
        public ucJalanJembatan(bool tracking = false)
        {
            FROM_TRACKING = tracking;
            this.binder = new BindingSource();
            this.binder.DataSource = typeof(SvcJlnJmbtnSelect.BPSIMANSROW_KJALJ);
        ...
        protected override void ucDetail_Load(object sender, EventArgs e)
        {
            ...
            //this.initGrid();
            //this.getinitJalanJembatan();

            
        }
        

        public void hapusData(SvcJlnJmbtnSelect.BPSIMANSROW_KJALJ selectedData)
        {
        ...
        private delegate void UbahJalanJembatan(SvcJlnJmbtnCrud.OutputParameters dataOutCrud);

        private void ubahJalanJembatan(SvcJlnJmbtnCrud.OutputParameters dataOutCrud)
        {
            SvcJlnJmbtnSelect.BPSIMANSROW_KJALJ dataPenyama = new SvcJlnJmbtnSelect.BPSIMANSROW_KJALJ();
            dataPenyama.ID_KJALJ = dataOutCrud.PO_ID_KJALJ;
        ...
        protected override void gvUcDtl_InitNewRow(object sender, InitNewRowEventArgs e)
        {
            ...
            newRow = (SvcJlnJmbtnSelect.BPSIMANSROW_KJALJ)selectedView.GetRow(e.RowHandle);
        ...
        protected override void bbSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                this.dataInisial = true;
                this.getinitJalanJembatan(get_where_clause(nama_kolom, opr, parameter, parameter_2));
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcJlnJmbtnSelect.BPSIMANSROW_KJALJ)selectedView.GetRow(e.FocusedRowHandle);
        ...
        public void getinitJalanJembatan(string strwhere = null)
        {
            this.nonAktifForm("");
            ...
            fetchData = new SvcJlnJmbtnSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcJlnJmbtnSelect.OutputParameters dataOut);

        ucJalanJembatanForm JalanJembatanForm;


        public void showData(SvcJlnJmbtnSelect.OutputParameters serviceOutPut)
        {
            if (!FROM_TRACKING)
            {
                ...
                if (this.dataInisial == true)
                {
                    ...
                    if (jmlData > 0)
                    {
                        ...
                        StrTotalDb.Caption = serviceOutPut.SF_ROW_MKJALJ[0].TOTAL_DATA.ToString();
                    }
                    else
                    {
                ...
                if (jmlData > 0)
                {
                    this.SUM_RPH_ASET = serviceOutPut.SF_ROW_MKJALJ[0].SUM_RPH_ASET;
                    this.SUM_RPH_MUTASI = serviceOutPut.SF_ROW_MKJALJ[0].SUM_RPH_MUTASI;
                    this.SUM_RPH_SUSUT = serviceOutPut.SF_ROW_MKJALJ[0].SUM_RPH_SUSUT;
                }

                for (int i = 0; i < jmlData; i++)
                {
                  string date = Convert.ToString(serviceOutPut.SF_ROW_MKJALJ[i].TGL_BUKU).Substring(0, 10);
                  string date_ = Convert.ToString(serviceOutPut.SF_ROW_MKJALJ[i].TGL_BUKU).Substring(0, 8);
                  string date2 = Convert.ToString(serviceOutPut.SF_ROW_MKJALJ[i].TGL_DANA).Substring(0, 10);
                  string date2_ = Convert.ToString(serviceOutPut.SF_ROW_MKJALJ[i].TGL_DANA).Substring(0, 8);
                  string date3 = Convert.ToString(serviceOutPut.SF_ROW_MKJALJ[i].TGL_PERLH).Substring(0, 10);
                  string date3_ = Convert.ToString(serviceOutPut.SF_ROW_MKJALJ[i].TGL_PERLH).Substring(0, 8);
                  string date4 = Convert.ToString(serviceOutPut.SF_ROW_MKJALJ[i].TGL_REKAM).Substring(0, 10);
                  string date4_ = Convert.ToString(serviceOutPut.SF_ROW_MKJALJ[i].TGL_REKAM).Substring(0, 8);
                  string date5 = Convert.ToString(serviceOutPut.SF_ROW_MKJALJ[i].TGL_RENOV).Substring(0, 10);
                  string date5_ = Convert.ToString(serviceOutPut.SF_ROW_MKJALJ[i].TGL_RENOV).Substring(0, 8);
                 
                  if (date == "11/11/1000" || date_ == "1/1/0001")
                  {
                    serviceOutPut.SF_ROW_MKJALJ[i].TGL_BUKU = null;
                  }
                  if (date2 == "11/11/1000" || date2_ == "1/1/0001")
                  {
                    serviceOutPut.SF_ROW_MKJALJ[i].TGL_DANA = null;
                  }
                  if (date3 == "11/11/1000" || date3_ == "1/1/0001")
                  {
                    serviceOutPut.SF_ROW_MKJALJ[i].TGL_PERLH = null;
                  }
                  if (date4 == "11/11/1000" || date4_ == "1/1/0001")
                  {
                    serviceOutPut.SF_ROW_MKJALJ[i].TGL_REKAM = null;
                  }
                  if (date5 == "11/11/1000" || date5_ == "1/1/0001")
                  {
                    serviceOutPut.SF_ROW_MKJALJ[i].TGL_RENOV = null;
                  }
                  
                    this.binder.Add(serviceOutPut.SF_ROW_MKJALJ[i]);
                }
            ...
            else
            {
                int jmlData = serviceOutPut.SF_ROW_MKJALJ.Count();
                 ...
                 if (jmlData > 0)
                 {
                    JalanJembatanForm = new ucJalanJembatanForm("detail");
                    ...
                    JalanJembatanForm.IsiForm(serviceOutPut.SF_ROW_MKJALJ[0]);
                 }
                 else
                 {
