...
{
    class UcRwyPenilaianJlnJmbtn : UserControlDetail
    {


        private frmNilai puNilai;
        private decimal? ID_KJALJ_RWYT_NILAI;
        ...
        private SvcRwyNilaiJlnJmbtnSelect.call_pttClient fetchData;
        private SvcRwyNilaiJlnJmbtnSelect.InputParameters parInp;
        private SvcRwyNilaiJlnJmbtnSelect.OutputParameters outData;
        private SvcRwyNilaiJlnJmbtnSelect.BPSIMANSROW_M_KJALJ_RWYT_NILAI selectedData;


        public UcRwyPenilaianJlnJmbtn(decimal? _ID_KJALJ, String _Status)
            : base()
        {
        ...
        private void initTnhRPenilaian()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcRwyNilaiJlnJmbtnSelect.BPSIMANSROW_M_KJALJ_RWYT_NILAI);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KJALJ_RWYT_NILAI;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_KJALJ_RWYT_NILAI";
                parInp.P_TABLE = "M_KJALJ_RWYT_NILAI";
        ...
        public void getInitTnhRPnl(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcRwyNilaiJlnJmbtnSelect.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcRwyNilaiJlnJmbtnSelect.call_pttClient(konfigApp.SvcRwyNilaiJlnJmbtnSelect_name, konfigApp.SvcRwyNilaiJlnJmbtnSelect_address);
            fetchData.Open();
        ...
        private delegate void ShowData(SvcRwyNilaiJlnJmbtnSelect.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcRwyNilaiJlnJmbtnSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_M_KJALJ_RWYT_NILAI.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_M_KJALJ_RWYT_NILAI[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_M_KJALJ_RWYT_NILAI[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KJALJ_RWYT_NILAI[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
              string date = Convert.ToString(serviceOutPut.SF_ROW_M_KJALJ_RWYT_NILAI[i].TGL_BUKU).Substring(0, 10);
              string date_ = Convert.ToString(serviceOutPut.SF_ROW_M_KJALJ_RWYT_NILAI[i].TGL_BUKU).Substring(0, 8);
              string date2 = Convert.ToString(serviceOutPut.SF_ROW_M_KJALJ_RWYT_NILAI[i].TGL_NILAI).Substring(0, 10);
              string date2_ = Convert.ToString(serviceOutPut.SF_ROW_M_KJALJ_RWYT_NILAI[i].TGL_NILAI).Substring(0, 8);
              if (date == "11/11/1000" || date_ == "1/1/0001")
              {
                serviceOutPut.SF_ROW_M_KJALJ_RWYT_NILAI[i].TGL_BUKU = null;
              }
              if (date2 == "11/11/1000" || date2_ == "1/1/0001")
              {
                serviceOutPut.SF_ROW_M_KJALJ_RWYT_NILAI[i].TGL_NILAI = null;
              }
                binder.Add(serviceOutPut.SF_ROW_M_KJALJ_RWYT_NILAI[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcRwyNilaiJlnJmbtnSelect.BPSIMANSROW_M_KJALJ_RWYT_NILAI)selectedView.GetRow(e.FocusedRowHandle);
        ...
        SvcJalanJembatanRpenilaianCrud.call_pttClient svcRiwayatNilaiCrud;
        SvcJalanJembatanRpenilaianCrud.OutputParameters outRiwayatNilaiCrud;
        ...
        private void saveFrmNilai(string text)
        {
            ...
            try
            {
                ...
                SvcJalanJembatanRpenilaianCrud.InputParameters parInp = new SvcJalanJembatanRpenilaianCrud.InputParameters();
                parInp.P_ID_KJALJ = this.ID_KJALJ;
                parInp.P_ID_KJALJ_RWYT_NILAI = (this.puNilai.Status == "input") ? 0 : this.selectedData.ID_KJALJ_RWYT_NILAI;
                parInp.P_ID_KJALJ_RWYT_NILAISpecified = true;
                ...
                this.svcRiwayatNilaiCrud = new SvcJalanJembatanRpenilaianCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcJalanJembatanRpenilaianCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcJalanJembatanRpenilaianCrud.OutputParameters outCrud)
        {
            SvcRwyNilaiJlnJmbtnSelect.BPSIMANSROW_M_KJALJ_RWYT_NILAI dataPenyama = new SvcRwyNilaiJlnJmbtnSelect.BPSIMANSROW_M_KJALJ_RWYT_NILAI();
            ...
            dataPenyama.ID_KJALJ_RWYT_NILAI = (this.modeCrud == 'U') ? selectedData.ID_KJALJ_RWYT_NILAI : outCrud.PO_ID_KJALJ_RWYT_NILAI;
            dataPenyama.ID_KJALJ_RWYT_NILAISpecified = true;
            ...
            this.ID_KJALJ_RWYT_NILAI = outCrud.PO_ID_KJALJ_RWYT_NILAI;
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puNilai.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KJALJ_RWYT_NILAI", dataPenyama.ID_KJALJ_RWYT_NILAI, "M_KJALJ_RWYT_NILAI", filePath, "C", puNilai.ID_JNSDOK);
                    }
                    else
                    {
                        this.puNilai.Close();
                        ...
                        this.getById = true;
                        this.getInitTnhRPnl(" ID_KJALJ_RWYT_NILAI = " + outCrud.PO_ID_KJALJ_RWYT_NILAI.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puNilai.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KJALJ_RWYT_NILAI", dataPenyama.ID_KJALJ_RWYT_NILAI, "M_KJALJ_RWYT_NILAI", filePath, SELECT, puNilai.ID_JNSDOK);
                    }
                    else
                    {
                        this.puNilai.Close();
        ...
        private void crudDokAset(SvcAsetDokCrud.OutputParameters dataoutDokAsetCrud)
        {
            if (dataoutDokAsetCrud.PO_RESULT == "Y")
            {
                ...
                if (this.modeCrud != 'D')
                {
                    ...
                    this.dataInisial = false;
                    this.getById = true;
                    //this.getInitTnhRPnl(" ID_KJALJ_RWYT_NILAI = " + ID_KJALJ_RWYT_NILAI.ToString());
                }
                this.search = "";
                this.initGrid();
                this.getInitTnhRPnl();
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
               ...
               MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    parInp.P_ID_KJALJ_RWYT_NILAI = selectedData.ID_KJALJ_RWYT_NILAI;
                    parInp.P_ID_KJALJ_RWYT_NILAISpecified = true;
                    parInp.P_ID_KJALJSpecified = true;
                    ...
                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatNilaiCrud = new SvcJalanJembatanRpenilaianCrud.call_pttClient();
                    svcRiwayatNilaiCrud.Open();
