...
{
    class ucTnhRPemeliharaan : UserControlDetail
    {
        ...
        private decimal? ID_M_KTNH_RWYT_PELIHARA;
        

        private SvcTnhRwyPeliharaSelect.call_pttClient fetchData;
        private SvcTnhRwyPeliharaSelect.InputParameters parInp;
        private SvcTnhRwyPeliharaSelect.OutputParameters outData;
        private SvcTnhRwyPeliharaSelect.BPSIMANSROW_M_KTNH_RWYT_PELIHARA selectedData;

 


        public ucTnhRPemeliharaan(decimal? _ID_KTNH, String Status)
            : base()
        {
        ...
        private void initTnhRPemeliharaan()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcTnhRwyPeliharaSelect.BPSIMANSROW_M_KTNH_RWYT_PELIHARA);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_M_KTNH_RWYT_PELIHARA;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_M_KTNH_RWYT_PELIHARA";
                parInp.P_TABLE = "M_KTNH_RWYT_PELIHARA";
        ...
        public void getInitTnhRPml(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcTnhRwyPeliharaSelect.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcTnhRwyPeliharaSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcTnhRwyPeliharaSelect.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcTnhRwyPeliharaSelect.OutputParameters serviceOutPut)
        {
            ...
            if (this.getById == true && jmlDataGroup > 0)
            {
                ...
                {
                    serviceOutPut.SF_ROW_M_KTNH_RWYT_PELIHARA[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_M_KTNH_RWYT_PELIHARA[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KTNH_RWYT_PELIHARA[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
              string date1 = Convert.ToString(serviceOutPut.SF_ROW_M_KTNH_RWYT_PELIHARA[i].TGL_SP2D).Substring(0, 10);
              if (date1 == "11/11/1000")
                {
                    serviceOutPut.SF_ROW_M_KTNH_RWYT_PELIHARA[i].TGL_SP2D = null;
                }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcTnhRwyPeliharaSelect.BPSIMANSROW_M_KTNH_RWYT_PELIHARA)selectedView.GetRow(e.FocusedRowHandle);
        ...
        SvcTanahRiwayatPemeliharaanCrud.call_pttClient svcRiwayatPemeliharaanCrud;
        SvcTanahRiwayatPemeliharaanCrud.OutputParameters outRiwayatPemeliharaanCrud;
        ...
        private void saveForm(string text)
        {
            ...
            try
            {
                ...
                SvcTanahRiwayatPemeliharaanCrud.InputParameters parInp = new SvcTanahRiwayatPemeliharaanCrud.InputParameters();
                parInp.P_ID_KTNH = this.ID_KTNH;
                parInp.P_ID_M_KTNH_RWYT_PELIHARA = (this.puPemeliharaan.Status == "input") ? 0 : this.selectedData.ID_M_KTNH_RWYT_PELIHARA;
                parInp.P_ID_M_KTNH_RWYT_PELIHARASpecified = true;
                ...
                this.svcRiwayatPemeliharaanCrud = new SvcTanahRiwayatPemeliharaanCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcTanahRiwayatPemeliharaanCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcTanahRiwayatPemeliharaanCrud.OutputParameters outCrud)
        {
            SvcTnhRwyPeliharaSelect.BPSIMANSROW_M_KTNH_RWYT_PELIHARA dataPenyama = new SvcTnhRwyPeliharaSelect.BPSIMANSROW_M_KTNH_RWYT_PELIHARA();
            ...
            dataPenyama.ID_M_KTNH_RWYT_PELIHARA = (this.modeCrud == 'U') ? outCrud.PO_ID_M_KTNH_RWYT_PELIHARA : selectedData.ID_M_KTNH_RWYT_PELIHARA;
            dataPenyama.ID_M_KTNH_RWYT_PELIHARASpecified = true;
            ...
            this.ID_M_KTNH_RWYT_PELIHARA = outCrud.PO_ID_M_KTNH_RWYT_PELIHARA;
            ...
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puPemeliharaan.FilePath != null)
                    {
                        ...
                        simpanFile("ID_M_KTNH_RWYT_PELIHARA", dataPenyama.ID_M_KTNH_RWYT_PELIHARA, "M_KTNH_RWYT_PELIHARA", filePath, "C", puPemeliharaan.ID_JNSDOK);
                    }
                    else
                    {
                        ...
                        this.getById = true;
                        this.getInitTnhRPml(" ID_M_KTNH_RWYT_PELIHARA = " + outCrud.PO_ID_M_KTNH_RWYT_PELIHARA.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puPemeliharaan.FilePath != null)
                    {
                        ...
                        simpanFile("ID_M_KTNH_RWYT_PELIHARA", dataPenyama.ID_M_KTNH_RWYT_PELIHARA, "M_KTNH_RWYT_PELIHARA", filePath, SELECT, puPemeliharaan.ID_JNSDOK);
                    }
                    else
                    {
        ...
        private void crudDokAset(SvcAsetDokCrud.OutputParameters dataoutDokAsetCrud)
        {
            if (dataoutDokAsetCrud.PO_RESULT == "Y")
            {
                ...
                if (this.modeCrud != 'D')
                {
                    ...
                    this.dataInisial = false;
                    this.getById = true;
                    this.getInitTnhRPml(" ID_M_KTNH_RWYT_PELIHARA = " + this.ID_M_KTNH_RWYT_PELIHARA.ToString());
                }
            }
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
              ...
              MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    parInp.P_ID_KTNHSpecified = true;
                    parInp.P_ID_M_KTNH_RWYT_PELIHARA = selectedData.ID_M_KTNH_RWYT_PELIHARA;
                    parInp.P_ID_M_KTNH_RWYT_PELIHARASpecified = true;
                    

                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatPemeliharaanCrud = new SvcTanahRiwayatPemeliharaanCrud.call_pttClient();
                    svcRiwayatPemeliharaanCrud.Open();
