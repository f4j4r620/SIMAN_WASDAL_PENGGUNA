...
{
    class ucTnhRPengguna : UserControlDetail
    {

  
        private frmPengelola puPengelola;
        private String Status;
        public decimal? ID_M_KTNH_RWYT_PENGGUNA;
        private decimal? ID_KTNH;
        public string ID_JNSDOK;
        private string search;
        private decimal? jmlData = 0;
        public frmProgres progresBar = null;

        private SvcTnhRwyPenggunaSelect.call_pttClient fetchData;
        private SvcTnhRwyPenggunaSelect.InputParameters parInp;
        private SvcTnhRwyPenggunaSelect.OutputParameters outData;
        public SvcTnhRwyPenggunaSelect.BPSIMANSROW_M_KTNH_RWYT_PENGGUNA selectedData;


  
        public ucTnhRPengguna(decimal? _ID_KTNH, String Status)
            : base()
        {
        ...
        private void initRiwayatPengguna()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcTnhRwyPenggunaSelect.BPSIMANSROW_M_KTNH_RWYT_PENGGUNA);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_M_KTNH_RWYT_PENGGUNA;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_M_KTNH_RWYT_PENGGUNA";
                parInp.P_TABLE = "M_KTNH_RWYT_PENGGUNA";
        ...
        public void getInitTnhRPgn(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcTnhRwyPenggunaSelect.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcTnhRwyPenggunaSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcTnhRwyPenggunaSelect.OutputParameters dataOut);
        private string StatusCrud="";
        private decimal? NUM;
        public void showData(SvcTnhRwyPenggunaSelect.OutputParameters serviceOutPut)
        {
            ...
            if (this.getById == true && jmlDataGroup > 0)
            {
                ...
                {
                    serviceOutPut.SF_ROW_M_KTNH_RWYT_PENGGUNA[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_M_KTNH_RWYT_PENGGUNA[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KTNH_RWYT_PENGGUNA[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
              string date1 = Convert.ToString(serviceOutPut.SF_ROW_M_KTNH_RWYT_PENGGUNA[i].TGL_KONTRAK).Substring(0, 10);
              string date2 = Convert.ToString(serviceOutPut.SF_ROW_M_KTNH_RWYT_PENGGUNA[i].TGL_MULAI).Substring(0, 10);
              string date3 = Convert.ToString(serviceOutPut.SF_ROW_M_KTNH_RWYT_PENGGUNA[i].TGL_SELESAI).Substring(0, 10);
              string date4 = Convert.ToString(serviceOutPut.SF_ROW_M_KTNH_RWYT_PENGGUNA[i].TGL_SK).Substring(0, 10);
              if (date1 == "11/11/1000")
                {
                    serviceOutPut.SF_ROW_M_KTNH_RWYT_PENGGUNA[i].TGL_KONTRAK = null;
                }
                if (date2 == "11/11/1000")
                {
                    serviceOutPut.SF_ROW_M_KTNH_RWYT_PENGGUNA[i].TGL_MULAI = null;
                }
                if (date3 == "11/11/1000")
                {
                    serviceOutPut.SF_ROW_M_KTNH_RWYT_PENGGUNA[i].TGL_SELESAI = null;
                }
                if (date4 == "11/11/1000")
                {
                    serviceOutPut.SF_ROW_M_KTNH_RWYT_PENGGUNA[i].TGL_SK = null;
                }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcTnhRwyPenggunaSelect.BPSIMANSROW_M_KTNH_RWYT_PENGGUNA)selectedView.GetRow(e.FocusedRowHandle);
        ...
        private void resetForm(string text)
        {
            ...
            this.puPengelola.teJenisPemakai.Text = konfigApp.StringtoNull(selectedData.JNS_PMK);
            this.puPengelola.teStatusPegelolaan.Text = konfigApp.StringtoNull(selectedData.STATUS_KELOLA);
        ...
        SvcTanahRiwayatPengelolaCrud.call_pttClient svcRiwayatPengelolaCrud;
        SvcTanahRiwayatPengelolaCrud.OutputParameters outRiwayatPengelolaCrud;
        ...
        private void saveForm(string text)
        {
            ...
            try
            {
                ...
                SvcTanahRiwayatPengelolaCrud.InputParameters parInp = new SvcTanahRiwayatPengelolaCrud.InputParameters();
                parInp.P_ID_KTNH = this.ID_KTNH;
                parInp.P_ID_M_KTNH_RWYT_PENGGUNA = (this.puPengelola.Status == "input") ? 0 : this.selectedData.ID_M_KTNH_RWYT_PENGGUNA;
                parInp.P_ID_M_KTNH_RWYT_PENGGUNASpecified = true;
                ...
                this.svcRiwayatPengelolaCrud = new SvcTanahRiwayatPengelolaCrud.call_pttClient();
            ...
            catch (Exception e)
            {
                ...
                MessageBox.Show("No Sk & Tgl. Sk harus terisi!", "Peringatan!!!");
            }
        }
        #region crud
        ...
        public delegate void UbahDsDetail(SvcTanahRiwayatPengelolaCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcTanahRiwayatPengelolaCrud.OutputParameters outCrud)
        {
            SvcTnhRwyPenggunaSelect.BPSIMANSROW_M_KTNH_RWYT_PENGGUNA dataPenyama = new SvcTnhRwyPenggunaSelect.BPSIMANSROW_M_KTNH_RWYT_PENGGUNA();
            ...
            dataPenyama.ID_M_KTNH_RWYT_PENGGUNA = (this.modeCrud == 'U') ? selectedData.ID_M_KTNH_RWYT_PENGGUNA :outCrud.PO_ID_M_KTNH_RWYT_PENGGUNA ;
            dataPenyama.ID_M_KTNH_RWYT_PENGGUNASpecified = true;
            ...
            this.ID_M_KTNH_RWYT_PENGGUNA = (this.StatusCrud== "input")? outCrud.PO_ID_M_KTNH_RWYT_PENGGUNA : selectedData.ID_M_KTNH_RWYT_PENGGUNA ;
            ...
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puPengelola.FilePath != null)
                    {
                        ...
                        simpanFile("ID_M_KTNH_RWYT_PENGGUNA", dataPenyama.ID_M_KTNH_RWYT_PENGGUNA, "M_KTNH_RWYT_PENGGUNA", filePath, "C", puPengelola.ID_JNSDOK);
                    }
                    else
                    {
                        ...
                        this.getById = true;
                        this.getInitTnhRPgn(" ID_M_KTNH_RWYT_PENGGUNA = " + this.ID_M_KTNH_RWYT_PENGGUNA.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puPengelola.FilePath != null)
                    {
                        ...
                        simpanFile("ID_M_KTNH_RWYT_PENGGUNA", dataPenyama.ID_M_KTNH_RWYT_PENGGUNA, "M_KTNH_RWYT_PENGGUNA", filePath, SELECT, puPengelola.ID_JNSDOK);
                    }
                    else
                    {
                        this.puPengelola.Close();
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
             ...
             MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    parInp.P_ID_KTNHSpecified = true;
                    parInp.P_ID_M_KTNH_RWYT_PENGGUNA = selectedData.ID_M_KTNH_RWYT_PENGGUNA;
                    parInp.P_ID_M_KTNH_RWYT_PENGGUNASpecified = true;


                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatPengelolaCrud = new SvcTanahRiwayatPengelolaCrud.call_pttClient();
                    svcRiwayatPengelolaCrud.Open();
