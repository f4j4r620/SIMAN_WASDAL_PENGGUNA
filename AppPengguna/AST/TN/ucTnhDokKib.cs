...
{
    class ucTnhDokKib : UserControlDetail
    {
        ...
        private frmTnhDokKib frmTnhDokKib;
        ...
        public ucTnhDokKib(decimal? _ID_KTNH, String status)
            : base()
        {
            this.InitDokKib();
            this.Status = Status;
        ...
        public void showData(SvcTnhDokKibSelect.OutputParameters serviceOutPut)
        {
            ...
            {
              string date = Convert.ToString(serviceOutPut.SF_ROW_M_KTNH_DOK_KIB[i].TGL_DOK_KIB).Substring(0, 10);
              if (date == "11/11/1000")
                {
        ...
        {
            this.frmTnhDokKib = new frmTnhDokKib(this, "input");
            StatusCrud = "input";
            this.frmTnhDokKib.ShowDialog();
        }
        protected override void bbEdit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                this.frmTnhDokKib = new frmTnhDokKib(this, "detail");
                StatusCrud = "detail";
            }
            else
            {
                this.frmTnhDokKib = new frmTnhDokKib(this, "edit");
                StatusCrud = "edit";
            }
            this.frmTnhDokKib.ShowDialog();
        }
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            StatusCrud = "hapus";
            this.frmTnhDokKib = new frmTnhDokKib(this, "hapus");
            this.frmTnhDokKib.Size = new System.Drawing.Size(0, 0);
            this.frmTnhDokKib.Opacity = 0;
            this.frmTnhDokKib.Show();
            this.frmTnhDokKib.Hide();
            this.frmTnhDokKib.hapusData();
