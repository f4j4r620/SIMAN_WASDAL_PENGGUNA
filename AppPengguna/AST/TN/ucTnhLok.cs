...
{
    class ucTnhLok : UserControlDetail
    {

        private ucTanahForm frmTanah;
        private frmTnhLok frmTnhLok;
        ...
        private SvcTnhLokSelect.call_pttClient fetchData;
        private SvcTnhLokSelect.InputParameters parInp;
        private SvcTnhLokSelect.OutputParameters outData;
        public SvcTnhLokSelect.BPSIMANSROW_M_KTNH_LOKASI selectedData;
        ...
        public ucTnhLok(decimal? ID_KTNH, string status)
            : base()
        {
            this.initTnhLok();
        ...
        private void initTnhLok()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcTnhLokSelect.BPSIMANSROW_M_KTNH_LOKASI);
        ...
        public void getInitTnhLok(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcTnhLokSelect.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcTnhLokSelect.call_pttClient(konfigApp.SvcTnhLokasiSelect_name, konfigApp.SvcTnhLokasiSelect_address);
            fetchData.Open();
        ...
        private delegate void ShowData(SvcTnhLokSelect.OutputParameters dataOut);
        public decimal? NUM;
        private string StatusCrud = "";
        public void showData(SvcTnhLokSelect.OutputParameters serviceOutPut)
        {
            ...
            if (this.getById == true && jmlDataGroup > 0)
            {
                ...
                {
                    serviceOutPut.SF_ROW_M_KTNH_LOKASI[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_M_KTNH_LOKASI[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KTNH_LOKASI[0].TOTAL_DATA.ToString();
                }
                else
                {
        ...
        {
            this.frmTnhLok = new frmTnhLok(this, "input");
            StatusCrud = "input";
            this.frmTnhLok.ShowDialog();
        }
        ...
        protected override void bbEdit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                this.frmTnhLok = new frmTnhLok(this, "detail");
                this.StatusCrud = "detail";
            }
            else
            {
                this.frmTnhLok = new frmTnhLok(this, "edit");
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (this.selectedData != null)
            {
                ...
                this.frmTnhLok = new frmTnhLok(this, "hapus");
                this.frmTnhLok.Size = new System.Drawing.Size(0, 0);
                this.frmTnhLok.Opacity = 0;
                this.frmTnhLok.Show();
                this.frmTnhLok.Hide();
                this.frmTnhLok.hapusData();
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcTnhLokSelect.BPSIMANSROW_M_KTNH_LOKASI)viewTerpilih.GetRow(e.FocusedRowHandle);
