...
{
    class ucTnhRMutasi : UserControlDetail
    {
        ...
        private SvcTnhRwyMutasiSelect.call_pttClient fetchData;
        private SvcTnhRwyMutasiSelect.InputParameters parInp;
        private SvcTnhRwyMutasiSelect.OutputParameters outData;
        public SvcTnhRwyMutasiSelect.BPSIMANSROW_M_KTNH_RWYT_MUTASI selectedData;



        public ucTnhRMutasi(decimal? _ID_KTNH, String Status)
            : base()
        {
            this.initTnhRMutasi();
            this.Status = Status;
        ...
        private void initTnhRMutasi()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcTnhRwyMutasiSelect.BPSIMANSROW_M_KTNH_RWYT_MUTASI);
        ...
        public void getInitMutasi(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcTnhRwyMutasiSelect.InputParameters();
            ...
            parInp.P_SORT = "ASC";
            parInp.STR_WHERE = String.Format(" ID_KTNH = {0} {1}", this.ID_KTNH, this.search);
            fetchData = new SvcTnhRwyMutasiSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcTnhRwyMutasiSelect.OutputParameters dataOut);

        public void showData(SvcTnhRwyMutasiSelect.OutputParameters serviceOutPut)
        {
            ...
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KTNH_RWYT_MUTASI[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
              string date1 = Convert.ToString(serviceOutPut.SF_ROW_M_KTNH_RWYT_MUTASI[i].TGL_BUKU).Substring(0, 10);
              string date2 = Convert.ToString(serviceOutPut.SF_ROW_M_KTNH_RWYT_MUTASI[i].TGL_DSR_MUTASI).Substring(0, 10); 
              if (date1 == "11/11/1000")
                {
                    serviceOutPut.SF_ROW_M_KTNH_RWYT_MUTASI[i].TGL_BUKU = null;
                }
              if (date2 == "11/11/1000")
                {
                    serviceOutPut.SF_ROW_M_KTNH_RWYT_MUTASI[i].TGL_DSR_MUTASI = null;
                }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcTnhRwyMutasiSelect.BPSIMANSROW_M_KTNH_RWYT_MUTASI)selectedView.GetRow(e.FocusedRowHandle);
