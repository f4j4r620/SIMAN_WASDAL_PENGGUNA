...
{
    internal partial class frmTnhLok : Form
    {

        private ucTnhLok uctnhlok = null;
        public string status;
        public decimal? NUM;
        public string FilePath;
        private decimal? idKtnh;
        private decimal? idKtnhLok;
        ...
        private SvcTnhLokSelect.BPSIMANSROW_M_KTNH_LOKASI selecetdData;
        private SvcTnhLokCrud.call_pttClient crudData;
        private SvcTnhLokCrud.InputParameters inputCrud;
        private SvcTnhLokCrud.OutputParameters outCrud;

        public frmTnhLok(ucTnhLok uctnhlok, string status)
        {
            InitializeComponent();
            this.uctnhlok = uctnhlok;
            this.status = status;
            this.idKtnh = uctnhlok.IdKtnh;
        ...
        private void init()
        {
            ...
            else if (this.status == "edit")
            {
                ...
                this.idKtnhLok = this.selecetdData.ID_M_KTNH_LOKASI;
        ...
        private void bbSave_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                SvcTnhLokCrud.InputParameters parInp = new SvcTnhLokCrud.InputParameters();
                parInp.P_ID_KTNHSpecified = true;
                parInp.P_ID_M_KTNH_LOKASISpecified = true;

                parInp.P_ID_M_KTNH_LOKASI = idKtnhLok;
                ...
                this.crudData = new SvcTnhLokCrud.call_pttClient(konfigApp.SvcTnhLokasiCrud_name, konfigApp.SvcTnhLokasiCrud_address);
                crudData.Open();
        ...
        public void hapusData()
        {
                ...
                MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    SvcTnhLokCrud.InputParameters parInp = new SvcTnhLokCrud.InputParameters();
                    parInp.P_ID_M_KTNH_LOKASISpecified = true;
                    parInp.P_ID_M_KTNH_LOKASI = this.idKtnhLok;
                    parInp.P_SELECT = "D";
        ...
        public delegate void UbahDsDetail(SvcTnhLokCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcTnhLokCrud.OutputParameters outCrud)
        {
            SvcTnhLokSelect.BPSIMANSROW_M_KTNH_LOKASI dataPenyama = new SvcTnhLokSelect.BPSIMANSROW_M_KTNH_LOKASI();
          ...
          dataPenyama.NUM = -999;
            ...
            dataPenyama.ID_M_KTNH_LOKASI = outCrud.PO_ID_M_KTNH_LOKASI;
