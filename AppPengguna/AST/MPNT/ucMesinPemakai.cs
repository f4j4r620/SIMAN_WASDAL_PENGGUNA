...
namespace AppPengguna.AST.MPNT
{
    class ucMesinPemakai : UserControlDetail
    {
        ...
        private SvcMesinPntPemakaiSelect.call_pttClient fetchData;
        private SvcMesinPntPemakaiSelect.InputParameters parInp;
        private SvcMesinPntPemakaiSelect.OutputParameters outData;
        public SvcMesinPntPemakaiSelect.BPSIMANSROW_KALB_RWYT_PEMAKAI selectedData;
        ...
        private PuMesinPntPemakai PuMesinPntPemakai;
        ...
        public ucMesinPemakai(decimal? _ID_KALB, String status)
            : base()
        {
            this.InitPemakai();
            this.Status = Status;
        ...
        public void InitPemakai()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcMesinPntPemakaiSelect.BPSIMANSROW_KALB_RWYT_PEMAKAI);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KALB_RWYT_PEMAKAI;
                parInp.P_ID_TABLE = "ID_KALB_RWYT_PEMAKAI";
                parInp.P_IDSpecified = true;
                parInp.P_TABLE = "M_KALB_RWYT_PEMAKAI";
        ...
        public void getInitPemakai(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcMesinPntPemakaiSelect.InputParameters();
            parInp.P_COL = "";
            decimal Max, Min;
            ...
            fetchData = new SvcMesinPntPemakaiSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcMesinPntPemakaiSelect.OutputParameters dataOut);
        public decimal? NUM;
        private string StatusCrud = "";
        public void showData(SvcMesinPntPemakaiSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_KALB_RWYT_PEMAKAI.Count();
            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_KALB_RWYT_PEMAKAI[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_KALB_RWYT_PEMAKAI[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    //serviceOutPut.SF_ROW_KALB_RWYT_PEMAKAI[0].TOTAL_DATASpecified = true;
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_KALB_RWYT_PEMAKAI[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
              string date1 = Convert.ToString(serviceOutPut.SF_ROW_KALB_RWYT_PEMAKAI[i].TGL_LAHIR).Substring(0, 10);
              string date2 = Convert.ToString(serviceOutPut.SF_ROW_KALB_RWYT_PEMAKAI[i].TGL_MULAI).Substring(0, 10);
              string date3 = Convert.ToString(serviceOutPut.SF_ROW_KALB_RWYT_PEMAKAI[i].TGL_PENSIUN).Substring(0, 10);
              string date4 = Convert.ToString(serviceOutPut.SF_ROW_KALB_RWYT_PEMAKAI[i].TGL_SELESAI).Substring(0, 10);
              string date5 = Convert.ToString(serviceOutPut.SF_ROW_KALB_RWYT_PEMAKAI[i].TGL_SIP).Substring(0, 10); 
              string date6 = Convert.ToString(serviceOutPut.SF_ROW_KALB_RWYT_PEMAKAI[i].TGL_SK).Substring(0, 10);
              string date7 = Convert.ToString(serviceOutPut.SF_ROW_KALB_RWYT_PEMAKAI[i].TMT_JAB).Substring(0, 10);

              if (date1 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_KALB_RWYT_PEMAKAI[i].TGL_LAHIR = null;
              }
              if (date2 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_KALB_RWYT_PEMAKAI[i].TGL_MULAI = null;
              }
              if (date3 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_KALB_RWYT_PEMAKAI[i].TGL_PENSIUN = null;
              }
              if (date4 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_KALB_RWYT_PEMAKAI[i].TGL_SELESAI = null;
              }
              if (date5 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_KALB_RWYT_PEMAKAI[i].TGL_SIP = null;
              }
              if (date6 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_KALB_RWYT_PEMAKAI[i].TGL_SK = null;
              }
              if (date7 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_KALB_RWYT_PEMAKAI[i].TMT_JAB = null;
              }
                binder.Add(serviceOutPut.SF_ROW_KALB_RWYT_PEMAKAI[i]);
            }
        ...
        {
            this.PuMesinPntPemakai = new PuMesinPntPemakai(this, "input");
            StatusCrud = "input";
            this.PuMesinPntPemakai.ShowDialog();
        }
        protected override void bbEdit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                this.PuMesinPntPemakai = new PuMesinPntPemakai(this, "detail");
                StatusCrud = "detail";
            }
            else
            {
                this.PuMesinPntPemakai = new PuMesinPntPemakai(this, "edit");
                StatusCrud = "edit";
            }
            this.PuMesinPntPemakai.ShowDialog();
        }
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            StatusCrud = "hapus";
            this.PuMesinPntPemakai = new PuMesinPntPemakai(this, "hapus");
            this.PuMesinPntPemakai.Size = new System.Drawing.Size(0, 0);
            this.PuMesinPntPemakai.Opacity = 0;
            this.PuMesinPntPemakai.Show();
            this.PuMesinPntPemakai.Hide();
            this.PuMesinPntPemakai.hapusData();
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcMesinPntPemakaiSelect.BPSIMANSROW_KALB_RWYT_PEMAKAI)viewTerpilih.GetRow(e.FocusedRowHandle);
