...
{
    class ucMesinPntKib : UserControlDetail
    {

        private SvcMesinPntKibSelect.call_pttClient fetchData;
        private SvcMesinPntKibSelect.InputParameters parInp;
        private SvcMesinPntKibSelect.OutputParameters outData;
        public SvcMesinPntKibSelect.BPSIMANSROW_M_KALB_DOK_KIB selectedData;
        ...
        private PuMesinPntKib PuMesinPntKib;
        ...
        public ucMesinPntKib(decimal? _ID_KALB, String status)
            : base()
        {
            this.InitDokKib();
            this.Status = Status;
        ...
        protected override void ucDetail_Load(object sender, EventArgs e)
        {
            ...
            //gvUcDtl.OptionsBehavior.Editable = false;
        ...
        public void InitDokKib()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcMesinPntKibSelect.BPSIMANSROW_M_KALB_DOK_KIB);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KALB_DOK_KIB;
        ...
        public void getInitDokKib(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcMesinPntKibSelect.InputParameters();
            parInp.P_COL = "";
            decimal Max, Min;
            ...
            fetchData = new SvcMesinPntKibSelect.call_pttClient();
            fetchData.Open();
        ...
        public void showData(SvcMesinPntKibSelect.OutputParameters serviceOutPut)
        {
            ...
            if (this.getById == true && jmlDataGroup > 0)
            {
                ...
                {
                    serviceOutPut.SF_ROW_M_KALB_DOK_KIB[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_M_KALB_DOK_KIB[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    //serviceOutPut.SF_ROW_M_KALB_DOK_KIB[0].TOTAL_DATASpecified = true;
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KALB_DOK_KIB[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
              string date = Convert.ToString(serviceOutPut.SF_ROW_M_KALB_DOK_KIB[i].TGL_DOK_KIB).Substring(0, 10);
              string date_ = Convert.ToString(serviceOutPut.SF_ROW_M_KALB_DOK_KIB[i].TGL_DOK_KIB).Substring(0, 8);
              if (date == "11/11/1000" || date_ == "1/1/0001")
              {
                serviceOutPut.SF_ROW_M_KALB_DOK_KIB[i].TGL_DOK_KIB = null;
              }
                binder.Add(serviceOutPut.SF_ROW_M_KALB_DOK_KIB[i]);
            }
        ...
        {
            this.PuMesinPntKib = new PuMesinPntKib(this, "input");
            StatusCrud = "input";
            this.PuMesinPntKib.ShowDialog();
        }
        protected override void bbEdit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                this.PuMesinPntKib = new PuMesinPntKib(this, "detail");
                StatusCrud = "detail";
            }
            else
            {
                this.PuMesinPntKib = new PuMesinPntKib(this, "edit");
                StatusCrud = "edit";
            }
            this.PuMesinPntKib.ShowDialog();
        }
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            StatusCrud = "hapus";
            this.PuMesinPntKib = new PuMesinPntKib(this, "hapus");
            this.PuMesinPntKib.Size = new System.Drawing.Size(0, 0);
            this.PuMesinPntKib.Opacity = 0;
            this.PuMesinPntKib.Show();
            this.PuMesinPntKib.Hide();
            this.PuMesinPntKib.hapusData();
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcMesinPntKibSelect.BPSIMANSROW_M_KALB_DOK_KIB)viewTerpilih.GetRow(e.FocusedRowHandle);
