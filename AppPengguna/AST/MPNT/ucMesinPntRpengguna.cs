...
{
    class ucMesinPntRpengguna : UserControlDetail
    {


        private frmPengelola puPengelola;
        private String Status;
        public decimal? ID_KALB_RWYT_PENGGUNA;
        private decimal? ID_KALB;
        private string search;
        public frmProgres progresBar = null;
        private decimal? jmlData = 0;

        private SvcMesinPntRpenggunaSelect.call_pttClient fetchData;
        private SvcMesinPntRpenggunaSelect.InputParameters parInp;
        private SvcMesinPntRpenggunaSelect.OutputParameters outData;
        public SvcMesinPntRpenggunaSelect.BPSIMANSROW_KALB_RWYT_PENGGUNA selectedData;



        public ucMesinPntRpengguna(decimal? _ID_KALB, String Status)
            : base()
        {
            this.initTnhRPengguna();
            this.Status = Status;
            this.ID_KALB = _ID_KALB;
            if (Status == "detail")
            {
        ...
        private void initTnhRPengguna()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcMesinPntRpenggunaSelect.BPSIMANSROW_KALB_RWYT_PENGGUNA);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KALB_RWYT_PENGGUNA;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_KALB_RWYT_PENGGUNA";
                parInp.P_TABLE = "M_KALB_RWYT_PENGGUNA";
        ...
        public void getInitTnhRPgn(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcMesinPntRpenggunaSelect.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcMesinPntRpenggunaSelect.call_pttClient(konfigApp.SvcMesinPntRpenggunaSelect_name, konfigApp.SvcMesinPntRpenggunaSelect_address);
            fetchData.Open();
        ...
        private delegate void ShowData(SvcMesinPntRpenggunaSelect.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcMesinPntRpenggunaSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_KALB_RWYT_PENGGUNA.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_KALB_RWYT_PENGGUNA[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_KALB_RWYT_PENGGUNA[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_KALB_RWYT_PENGGUNA[0].TOTAL_DATA.ToString();
            ...
            {
              string date1 = Convert.ToString(serviceOutPut.SF_ROW_KALB_RWYT_PENGGUNA[i].TGL_KONTRAK).Substring(0, 10);
              string date2 = Convert.ToString(serviceOutPut.SF_ROW_KALB_RWYT_PENGGUNA[i].TGL_MULAI).Substring(0, 10);
              string date3 = Convert.ToString(serviceOutPut.SF_ROW_KALB_RWYT_PENGGUNA[i].TGL_SELESAI).Substring(0, 10);
              string date4 = Convert.ToString(serviceOutPut.SF_ROW_KALB_RWYT_PENGGUNA[i].TGL_SK).Substring(0, 10);
              if (date1 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_KALB_RWYT_PENGGUNA[i].TGL_KONTRAK = null;
              }
              if (date2 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_KALB_RWYT_PENGGUNA[i].TGL_MULAI = null;
              }
              if (date3 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_KALB_RWYT_PENGGUNA[i].TGL_SELESAI = null;
              }
              if (date4 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_KALB_RWYT_PENGGUNA[i].TGL_SK = null;
              }
                binder.Add(serviceOutPut.SF_ROW_KALB_RWYT_PENGGUNA[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcMesinPntRpenggunaSelect.BPSIMANSROW_KALB_RWYT_PENGGUNA)selectedView.GetRow(e.FocusedRowHandle);
        ...
        SvcMesinPntRpengelolaCrud.call_pttClient svcRiwayatPengelolaCrud;
        SvcMesinPntRpengelolaCrud.OutputParameters outRiwayatPengelolaCrud;
        ...
        private void saveForm(string text)
        {
            ...
            try
            {
                ...
                SvcMesinPntRpengelolaCrud.InputParameters parInp = new SvcMesinPntRpengelolaCrud.InputParameters();
                parInp.P_ID_KALB = this.ID_KALB;
                parInp.P_ID_KALB_RWYT_PENGGUNA = (this.puPengelola.Status == "input") ? 0 : this.selectedData.ID_KALB_RWYT_PENGGUNA;
                parInp.P_ID_KALB_RWYT_PENGGUNASpecified = true;
                ...
                this.svcRiwayatPengelolaCrud = new SvcMesinPntRpengelolaCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcMesinPntRpengelolaCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcMesinPntRpengelolaCrud.OutputParameters outCrud)
        {
            SvcMesinPntRpenggunaSelect.BPSIMANSROW_KALB_RWYT_PENGGUNA dataPenyama = new SvcMesinPntRpenggunaSelect.BPSIMANSROW_KALB_RWYT_PENGGUNA();
            ...
            dataPenyama.ID_KALB_RWYT_PENGGUNA = (this.modeCrud == 'U') ? selectedData.ID_KALB_RWYT_PENGGUNA : outCrud.PO_ID_KALB_RWYT_PENGGUNA;
            dataPenyama.ID_KALB_RWYT_PENGGUNASpecified = true;
            ...
            this.ID_KALB_RWYT_PENGGUNA = (this.StatusCrud == "input") ? outCrud.PO_ID_KALB_RWYT_PENGGUNA : selectedData.ID_KALB_RWYT_PENGGUNA;
            ...
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puPengelola.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KALB_RWYT_PENGGUNA", dataPenyama.ID_KALB_RWYT_PENGGUNA, "M_KALB_RWYT_PENGGUNA", filePath, "C", puPengelola.ID_JNSDOK);
                        this.search = "";
                    ...
                    else
                    {
                        ...
                        this.getById = true;
                        this.getInitTnhRPgn(" ID_KALB_RWYT_PENGGUNA = " + this.ID_KALB_RWYT_PENGGUNA.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puPengelola.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KALB_RWYT_PENGGUNA", dataPenyama.ID_KALB_RWYT_PENGGUNA, "M_KALB_RWYT_PENGGUNA", filePath, SELECT, puPengelola.ID_JNSDOK);
                        this.search = "";
                        this.pencarian = false;
                        this.initGrid();
                        this.getInitTnhRPgn();
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
             ...
             MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    parInp.P_ID_KALBSpecified = true;
                    parInp.P_ID_KALB_RWYT_PENGGUNA = selectedData.ID_KALB_RWYT_PENGGUNA;
                    parInp.P_ID_KALB_RWYT_PENGGUNASpecified = true;


                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatPengelolaCrud = new SvcMesinPntRpengelolaCrud.call_pttClient();
                    svcRiwayatPengelolaCrud.Open();
