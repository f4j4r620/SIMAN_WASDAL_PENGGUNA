...
{
    class ucMesinPntRmutasi : UserControlDetail
    {
        ...
        private SvcMesinPntRmutasiSelect.call_pttClient fetchData;
        private SvcMesinPntRmutasiSelect.InputParameters parInp;
        private SvcMesinPntRmutasiSelect.OutputParameters outData;
        public SvcMesinPntRmutasiSelect.BPSIMANSROW_KALB_RWYT_MUTASI selectedData;



        public ucMesinPntRmutasi(decimal? _ID_KALB, String Status)
            : base()
        {
            this.initTnhRMutasi();
            this.Status = Status;
        ...
        private void initTnhRMutasi()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcMesinPntRmutasiSelect.BPSIMANSROW_KALB_RWYT_MUTASI);
        ...
        public void getInitTnhRMutasi(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcMesinPntRmutasiSelect.InputParameters();
            ...
            parInp.P_SORT = "ASC";
            parInp.STR_WHERE = String.Format(" ID_KALB = {0} {1}", this.ID_KALB, this.search);
            fetchData = new SvcMesinPntRmutasiSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcMesinPntRmutasiSelect.OutputParameters dataOut);

        public void showData(SvcMesinPntRmutasiSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_KALB_RWYT_MUTASI.Count();
            ...
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_KALB_RWYT_MUTASI[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
              string date1 = Convert.ToString(serviceOutPut.SF_ROW_KALB_RWYT_MUTASI[i].TGL_BUKU).Substring(0, 10);
              string date2 = Convert.ToString(serviceOutPut.SF_ROW_KALB_RWYT_MUTASI[i].TGL_DSR_MUTASI).Substring(0, 10);
              if (date1 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_KALB_RWYT_MUTASI[i].TGL_BUKU = null;
              }
              if (date2 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_KALB_RWYT_MUTASI[i].TGL_DSR_MUTASI = null;
              }
                binder.Add(serviceOutPut.SF_ROW_KALB_RWYT_MUTASI[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcMesinPntRmutasiSelect.BPSIMANSROW_KALB_RWYT_MUTASI)selectedView.GetRow(e.FocusedRowHandle);
