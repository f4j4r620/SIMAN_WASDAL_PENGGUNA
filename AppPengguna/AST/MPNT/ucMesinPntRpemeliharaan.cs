...
{
    class ucMesinPntRpemeliharaan : UserControlDetail
    {
        ...
        public decimal? ID_KALB;
        private decimal? ID_KALB_RWYT_PELIHARA;
        private decimal? jmlData = 0;


        private SvcMesinPntRpemeliharaanSelect.call_pttClient fetchData;
        private SvcMesinPntRpemeliharaanSelect.InputParameters parInp;
        private SvcMesinPntRpemeliharaanSelect.OutputParameters outData;
        private SvcMesinPntRpemeliharaanSelect.BPSIMANSROW_M_KALB_RWYT_PELIHARA selectedData;




        public ucMesinPntRpemeliharaan(decimal? _ID_KALB, String Status)
            : base()
        {
        ...
        private void initTnhRPemeliharaan()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcMesinPntRpemeliharaanSelect.BPSIMANSROW_M_KALB_RWYT_PELIHARA);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KALB_RWYT_PELIHARA;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_KALB_RWYT_PELIHARA";
                parInp.P_TABLE = "M_KALB_RWYT_PELIHARA";
        ...
        public void getInitTnhRPml(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcMesinPntRpemeliharaanSelect.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcMesinPntRpemeliharaanSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcMesinPntRpemeliharaanSelect.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcMesinPntRpemeliharaanSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_M_KALB_RWYT_PELIHARA.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_M_KALB_RWYT_PELIHARA[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_M_KALB_RWYT_PELIHARA[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KALB_RWYT_PELIHARA[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
              string date1 = Convert.ToString(serviceOutPut.SF_ROW_M_KALB_RWYT_PELIHARA[i].TGL_BUKU).Substring(0, 10);
              string date2 = Convert.ToString(serviceOutPut.SF_ROW_M_KALB_RWYT_PELIHARA[i].TGL_SP2D).Substring(0, 10);
              if (date1 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_M_KALB_RWYT_PELIHARA[i].TGL_BUKU = null;
              }
              if (date2 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_M_KALB_RWYT_PELIHARA[i].TGL_SP2D = null;
              }
                binder.Add(serviceOutPut.SF_ROW_M_KALB_RWYT_PELIHARA[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcMesinPntRpemeliharaanSelect.BPSIMANSROW_M_KALB_RWYT_PELIHARA)selectedView.GetRow(e.FocusedRowHandle);
        ...
        SvcMesinPntRpemeliharaanCrud.call_pttClient svcRiwayatPemeliharaanCrud;
        SvcMesinPntRpemeliharaanCrud.OutputParameters outRiwayatPemeliharaanCrud;
        ...
        private void saveForm(string text)
        {
            ...
            try
            {
                ...
                SvcMesinPntRpemeliharaanCrud.InputParameters parInp = new SvcMesinPntRpemeliharaanCrud.InputParameters();
                parInp.P_ID_KALB = this.ID_KALB;
                parInp.P_ID_KALB_RWYT_PELIHARA = (this.puPemeliharaan.Status == "input") ? 0 : this.selectedData.ID_KALB_RWYT_PELIHARA;
                parInp.P_ID_KALB_RWYT_PELIHARASpecified = true;
                ...
                this.svcRiwayatPemeliharaanCrud = new SvcMesinPntRpemeliharaanCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcMesinPntRpemeliharaanCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcMesinPntRpemeliharaanCrud.OutputParameters outCrud)
        {
            SvcMesinPntRpemeliharaanSelect.BPSIMANSROW_M_KALB_RWYT_PELIHARA dataPenyama = new SvcMesinPntRpemeliharaanSelect.BPSIMANSROW_M_KALB_RWYT_PELIHARA();
            ...
            dataPenyama.ID_KALB_RWYT_PELIHARA = (this.modeCrud == 'U') ? selectedData.ID_KALB_RWYT_PELIHARA : outCrud.PO_ID_KALB_RWYT_PELIHARA;
            dataPenyama.ID_KALB_RWYT_PELIHARASpecified = true;
            ...
            this.ID_KALB_RWYT_PELIHARA = outCrud.PO_ID_KALB_RWYT_PELIHARA;
            ...
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puPemeliharaan.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KALB_RWYT_PELIHARA", dataPenyama.ID_KALB_RWYT_PELIHARA, "M_KALB_RWYT_PELIHARA", filePath, "C", puPemeliharaan.ID_JNSDOK);
                        this.search = "";
                    ...
                    else
                    {
                        ...
                        this.getById = true;
                        this.getInitTnhRPml(" ID_KALB_RWYT_PELIHARA = " + outCrud.PO_ID_KALB_RWYT_PELIHARA.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puPemeliharaan.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KALB_RWYT_PELIHARA", dataPenyama.ID_KALB_RWYT_PELIHARA, "M_KALB_RWYT_PELIHARA", filePath, SELECT, puPemeliharaan.ID_JNSDOK);
                        this.search = "";
                        this.pencarian = false;
                        this.initGrid();
                        this.getInitTnhRPml();
        ...
        private void crudDokAset(SvcAsetDokCrud.OutputParameters dataoutDokAsetCrud)
        {
            if (dataoutDokAsetCrud.PO_RESULT == "Y")
            {
                ...
                if (this.modeCrud != 'D')
                {
                    ...
                    this.dataInisial = false;
                    this.getById = true;
                    this.getInitTnhRPml(" ID_KALB_RWYT_PELIHARA = " + this.ID_KALB_RWYT_PELIHARA.ToString());
                }
                this.search = "";
                this.pencarian = false;
                this.initGrid();
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
              ...
              MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    parInp.P_ID_KALBSpecified = true;
                    parInp.P_ID_KALB_RWYT_PELIHARA = selectedData.ID_KALB_RWYT_PELIHARA;
                    parInp.P_ID_KALB_RWYT_PELIHARASpecified = true;


                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatPemeliharaanCrud = new SvcMesinPntRpemeliharaanCrud.call_pttClient();
                    svcRiwayatPemeliharaanCrud.Open();
