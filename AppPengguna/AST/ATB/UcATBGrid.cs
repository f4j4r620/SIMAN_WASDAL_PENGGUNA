...
{
    class UcATBGrid : UserControlDetail
    {
        private SvcATBSelect.call_pttClient fetchData;
        public SvcATBSelect.OutputParameters outDat;
        public SvcATBSelect.BPSIMANSROW_KTWJD selectedData;

        SvcATBSelect.BPSIMANSROW_KTWJD newRow;
        ...
        public UcATBGrid(bool tracking = false)
        {
            FROM_TRACKING = tracking;
            this.binder = new BindingSource();
            this.binder.DataSource = typeof(SvcATBSelect.BPSIMANSROW_KTWJD);
        ...
        public void hapusData(SvcATBSelect.BPSIMANSROW_KTWJD selectedData)
        {
            ...
            try
            {
              ...
              //  myThread = new Thread(new ThreadStart(ShowProgresBar),"");
               // myThread.Start();
                ...
                SvcATBCrud = new SvcATBCrud.call_pttClient();
                SvcATBCrud.Open();
                SvcATBCrud.Beginexecute(parInp, new AsyncCallback(getResultCrud), "");
            }
            catch
            {
                this.modeCrud = 'A';
        ...
        private delegate void UbahBangunan(SvcATBCrud.OutputParameters dataOutCrud);

        private void ubahBangunan(SvcATBCrud.OutputParameters dataOutCrud)
        {
            SvcATBSelect.BPSIMANSROW_KTWJD dataPenyama = new SvcATBSelect.BPSIMANSROW_KTWJD();
            dataPenyama.ID_KTWJD = dataOutCrud.PO_ID_KTWJD;
        ...
        protected override void gvUcDtl_InitNewRow(object sender, InitNewRowEventArgs e)
        {
            ...
            newRow = (SvcATBSelect.BPSIMANSROW_KTWJD)selectedView.GetRow(e.RowHandle);
        ...
        protected override void bbSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            try
            {
                ...
                this.dataInisial = true;
                this.getinitATB(get_where_clause(nama_kolom, opr, parameter, parameter_2));
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcATBSelect.BPSIMANSROW_KTWJD)selectedView.GetRow(e.FocusedRowHandle);
        ...
        public void getinitATB(string strwhere = null)
        {
            this.nonAktifForm("");
            ...
            fetchData = new SvcATBSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcATBSelect.OutputParameters dataOut);

        UcATBForm ATBForm;


        public void showData(SvcATBSelect.OutputParameters serviceOutPut)
        {
            if (!FROM_TRACKING)
            {
                ...
                if (this.dataInisial == true)
                {
                    ...
                    if (jmlData > 0)
                    {
                        ...
                        StrTotalDb.Caption = serviceOutPut.SF_ROW_MKTWJD[0].TOTAL_DATA.ToString();
                    }
                }
                else
                {
                ...
                if (jmlData > 0)
                {
                    this.SUM_RPH_ASET = serviceOutPut.SF_ROW_MKTWJD[0].SUM_RPH_ASET;
                    this.SUM_RPH_MUTASI = serviceOutPut.SF_ROW_MKTWJD[0].SUM_RPH_MUTASI;
                    this.SUM_RPH_SUSUT = serviceOutPut.SF_ROW_MKTWJD[0].SUM_RPH_SUSUT;
                }
                for (int i = 0; i < jmlData; i++)
                {
                    this.binder.Add(serviceOutPut.SF_ROW_MKTWJD[i]);
                }
            ...
            else
            {
                ...
                if (jmlData > 0)
                {
                    ATBForm = new UcATBForm("detail");
                    ATBForm.nonAktifForm = new NonAktifkanFormSatker(this.nonAktifForm);
                    ATBForm.aktifkanForm = new AktifkanFormSatker(this.aktifkanForm);

                    ATBForm.ShowProgresBar = new showProgresBar(this.ShowProgresBar);
                    ATBForm.CloseProgresBar = new closeProgresBar(this.CloseProgresBar);
                    ATBForm.Dock = System.Windows.Forms.DockStyle.Fill;
                    ATBForm.IsiForm(serviceOutPut.SF_ROW_MKTWJD[0]);
                }
                else
                {
                ...
                //this.frmKoorSatker.panelKoorSatker.Controls.Add(ATBForm);
            }
