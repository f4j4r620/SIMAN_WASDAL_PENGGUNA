...
{
    class ucRpemeliharaanSenjata : UserControlDetail
    {
        ...
        private decimal? ID_KSENJ_RWYT_PELIHARA;



        private SvcSenjataRpemeliharaanSelect.call_pttClient fetchData;
        private SvcSenjataRpemeliharaanSelect.InputParameters parInp;
        private SvcSenjataRpemeliharaanSelect.OutputParameters outData;
        private SvcSenjataRpemeliharaanSelect.BPSIMANSROW_M_KSENJ_RWYT_PELIHARA selectedData;




        public ucRpemeliharaanSenjata(decimal? _ID_KSENJ, String Status)
            : base()
        {
        ...
        private void initTnhRPemeliharaan()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcSenjataRpemeliharaanSelect.BPSIMANSROW_M_KSENJ_RWYT_PELIHARA);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KSENJ_RWYT_PELIHARA;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_KSENJ_RWYT_PELIHARA";
                parInp.P_TABLE = "M_KSENJ_RWYT_PELIHARA";
        ...
        public void getInitTnhRPml(string _where = null)
        {
            ...
            parInp = new SvcSenjataRpemeliharaanSelect.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcSenjataRpemeliharaanSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcSenjataRpemeliharaanSelect.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcSenjataRpemeliharaanSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_M_KSENJ_RWYT_PELIHARA.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_M_KSENJ_RWYT_PELIHARA[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_M_KSENJ_RWYT_PELIHARA[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KSENJ_RWYT_PELIHARA[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
                binder.Add(serviceOutPut.SF_ROW_M_KSENJ_RWYT_PELIHARA[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcSenjataRpemeliharaanSelect.BPSIMANSROW_M_KSENJ_RWYT_PELIHARA)selectedView.GetRow(e.FocusedRowHandle);
        ...
        SvcSenjataRpemeliharaanCrud.call_pttClient svcRiwayatPemeliharaanCrud;
        SvcSenjataRpemeliharaanCrud.OutputParameters outRiwayatPemeliharaanCrud;
        ...
        private void saveForm(string text)
        {
            ...
            try
            {
                ...
                SvcSenjataRpemeliharaanCrud.InputParameters parInp = new SvcSenjataRpemeliharaanCrud.InputParameters();
                parInp.P_ID_KSENJ = this.ID_KSENJ;
                parInp.P_ID_KSENJ_RWYT_PELIHARA = (this.puPemeliharaan.Status == "input") ? 0 : this.selectedData.ID_KSENJ_RWYT_PELIHARA;
                parInp.P_ID_KSENJ_RWYT_PELIHARASpecified = true;
                ...
                this.svcRiwayatPemeliharaanCrud = new SvcSenjataRpemeliharaanCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcSenjataRpemeliharaanCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcSenjataRpemeliharaanCrud.OutputParameters outCrud)
        {
            SvcSenjataRpemeliharaanSelect.BPSIMANSROW_M_KSENJ_RWYT_PELIHARA dataPenyama = new SvcSenjataRpemeliharaanSelect.BPSIMANSROW_M_KSENJ_RWYT_PELIHARA();

            dataPenyama.NUM = 999;
            dataPenyama.NUMSpecified = true;
            dataPenyama.ID_ASET = (this.modeCrud == 'U') ? selectedData.ID_ASET : 0;
            dataPenyama.ID_ASETSpecified = true;
            dataPenyama.ID_KSENJ = (this.modeCrud == 'U') ? selectedData.ID_KSENJ : 0;
            dataPenyama.ID_KSENJ_RWYT_PELIHARA = (this.modeCrud == 'U') ? outCrud.PO_ID_KSENJ_RWYT_PELIHARA : selectedData.ID_KSENJ_RWYT_PELIHARA;
            dataPenyama.ID_KSENJ_RWYT_PELIHARASpecified = true;
            dataPenyama.ID_KSENJSpecified = true;
            ...
            this.ID_KSENJ_RWYT_PELIHARA = outCrud.PO_ID_KSENJ_RWYT_PELIHARA;
            ...
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puPemeliharaan.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KSENJ_RWYT_PELIHARA", dataPenyama.ID_KSENJ_RWYT_PELIHARA, "M_KSENJ_RWYT_PELIHARA", filePath, "C");
                    }
                    else
                    {
                        ...
                        this.getById = true;
                        this.getInitTnhRPml(" ID_KSENJ_RWYT_PELIHARA = " + outCrud.PO_ID_KSENJ_RWYT_PELIHARA.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puPemeliharaan.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KSENJ_RWYT_PELIHARA", dataPenyama.ID_KSENJ_RWYT_PELIHARA, "M_KSENJ_RWYT_PELIHARA", filePath, SELECT);
                    }
                    else
                    {
        ...
        private void crudDokAset(SvcAsetDokCrud.OutputParameters dataoutDokAsetCrud)
        {
            if (dataoutDokAsetCrud.PO_RESULT == "Y")
            {
                ...
                if (this.modeCrud != 'D')
                {
                    ...
                    this.dataInisial = false;
                    this.getById = true;
                    this.getInitTnhRPml(" ID_KSENJ_RWYT_PELIHARA = " + this.ID_KSENJ_RWYT_PELIHARA.ToString());
                }
            }
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
              ...
              MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    parInp.P_ID_KSENJSpecified = true;
                    parInp.P_ID_KSENJ_RWYT_PELIHARA = selectedData.ID_KSENJ_RWYT_PELIHARA;
                    parInp.P_ID_KSENJ_RWYT_PELIHARASpecified = true;


                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatPemeliharaanCrud = new SvcSenjataRpemeliharaanCrud.call_pttClient();
                    svcRiwayatPemeliharaanCrud.Open();
