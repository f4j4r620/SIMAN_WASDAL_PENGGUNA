...
{
    class ucRKibSenjata : UserControlDetail
    {

        private SvcSenjataRkibSelect.call_pttClient fetchData;
        private SvcSenjataRkibSelect.InputParameters parInp;
        private SvcSenjataRkibSelect.OutputParameters outData;
        public SvcSenjataRkibSelect.BPSIMANSROW_M_KSENJ_DOK_KIB selectedData;
        ...
        private PuSenjataKib PuSenjataKib;
        ...
        public ucRKibSenjata(decimal? _ID_KSENJ, String status)
            : base()
        {
            this.InitDokKib();
            this.Status = Status;
        ...
        public void InitDokKib()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcSenjataRkibSelect.BPSIMANSROW_M_KSENJ_DOK_KIB);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KSENJ_DOK_KIB;
        ...
        public void getInitDokKib(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcSenjataRkibSelect.InputParameters();
            parInp.P_COL = "";
            decimal Max, Min;
            ...
            fetchData = new SvcSenjataRkibSelect.call_pttClient();
            fetchData.Open();
        ...
        public void showData(SvcSenjataRkibSelect.OutputParameters serviceOutPut)
        {
            ...
            if (this.getById == true && jmlDataGroup > 0)
            {
                ...
                {
                    serviceOutPut.SF_ROW_M_KSENJ_DOK_KIB[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_M_KSENJ_DOK_KIB[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    //serviceOutPut.SF_ROW_M_KSENJ_DOK_KIB[0].TOTAL_DATASpecified = true;
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KSENJ_DOK_KIB[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
                binder.Add(serviceOutPut.SF_ROW_M_KSENJ_DOK_KIB[i]);
            }
        ...
        {
            this.PuSenjataKib = new PuSenjataKib(this, "input");
            StatusCrud = "input";
            this.PuSenjataKib.ShowDialog();
        }
        protected override void bbEdit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                this.PuSenjataKib = new PuSenjataKib(this, "detail");
                StatusCrud = "detail";
            }
            else
            {
                this.PuSenjataKib = new PuSenjataKib(this, "edit");
                StatusCrud = "edit";
            }
            this.PuSenjataKib.ShowDialog();
        }
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            StatusCrud = "hapus";
            this.PuSenjataKib = new PuSenjataKib(this, "hapus");
            this.PuSenjataKib.Size = new System.Drawing.Size(0, 0);
            this.PuSenjataKib.Opacity = 0;
            this.PuSenjataKib.Show();
            this.PuSenjataKib.Hide();
            this.PuSenjataKib.hapusData();
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcSenjataRkibSelect.BPSIMANSROW_M_KSENJ_DOK_KIB)viewTerpilih.GetRow(e.FocusedRowHandle);
