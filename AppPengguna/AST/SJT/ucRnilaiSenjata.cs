...
{
    class ucRnilaiSenjata : UserControlDetail
    {


        private frmNilai puNilai;
        private decimal? ID_KSENJ_RWYT_NILAI;
        ...
        private SvcSenjataRnilaiSelect.call_pttClient fetchData;
        private SvcSenjataRnilaiSelect.InputParameters parInp;
        private SvcSenjataRnilaiSelect.OutputParameters outData;
        private SvcSenjataRnilaiSelect.BPSIMANSROW_M_KSENJ_RWYT_NILAI selectedData;


        public ucRnilaiSenjata(decimal? _ID_KSENJ, String _Status)
            : base()
        {
        ...
        private void initTnhRPenilaian()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcSenjataRnilaiSelect.BPSIMANSROW_M_KSENJ_RWYT_NILAI);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KSENJ_RWYT_NILAI;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_KSENJ_RWYT_NILAI";
                parInp.P_TABLE = "M_KSENJ_RWYT_NILAI";
        ...
        public void getInitTnhRPnl(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcSenjataRnilaiSelect.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcSenjataRnilaiSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcSenjataRnilaiSelect.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcSenjataRnilaiSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_M_KSENJ_RWYT_NILAI.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_M_KSENJ_RWYT_NILAI[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_M_KSENJ_RWYT_NILAI[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KSENJ_RWYT_NILAI[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
                binder.Add(serviceOutPut.SF_ROW_M_KSENJ_RWYT_NILAI[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcSenjataRnilaiSelect.BPSIMANSROW_M_KSENJ_RWYT_NILAI)selectedView.GetRow(e.FocusedRowHandle);
        ...
        SvcSenjataRnilaiCrud.call_pttClient svcRiwayatNilaiCrud;
        SvcSenjataRnilaiCrud.OutputParameters outRiwayatNilaiCrud;
        ...
        private void saveFrmNilai(string text)
        {
            ...
            try
            {
                ...
                SvcSenjataRnilaiCrud.InputParameters parInp = new SvcSenjataRnilaiCrud.InputParameters();
                parInp.P_ID_KSENJ = this.ID_KSENJ;
                parInp.P_ID_KSENJ_RWYT_NILAI = (this.puNilai.Status == "input") ? 0 : this.selectedData.ID_KSENJ_RWYT_NILAI;
                parInp.P_ID_KSENJ_RWYT_NILAISpecified = true;
                ...
                this.svcRiwayatNilaiCrud = new SvcSenjataRnilaiCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcSenjataRnilaiCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcSenjataRnilaiCrud.OutputParameters outCrud)
        {
            SvcSenjataRnilaiSelect.BPSIMANSROW_M_KSENJ_RWYT_NILAI dataPenyama = new SvcSenjataRnilaiSelect.BPSIMANSROW_M_KSENJ_RWYT_NILAI();
            ...
            dataPenyama.ID_KSENJ_RWYT_NILAI = (this.modeCrud == 'U') ? selectedData.ID_KSENJ_RWYT_NILAI : outCrud.PO_ID_KSENJ_RWYT_NILAI;
            dataPenyama.ID_KSENJ_RWYT_NILAISpecified = true;
            ...
            this.ID_KSENJ_RWYT_NILAI = outCrud.PO_ID_KSENJ_RWYT_NILAI;
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puNilai.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KSENJ_RWYT_NILAI", dataPenyama.ID_KSENJ_RWYT_NILAI, "M_KSENJ_RWYT_NILAI", filePath, "C");
                    }
                    else
                    {
                        this.puNilai.Close();
                        ...
                        this.getById = true;
                        this.getInitTnhRPnl(" ID_KSENJ_RWYT_NILAI = " + outCrud.PO_ID_KSENJ_RWYT_NILAI.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puNilai.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KSENJ_RWYT_NILAI", dataPenyama.ID_KSENJ_RWYT_NILAI, "M_KSENJ_RWYT_NILAI", filePath, SELECT);
                    }
                    else
                    {
                        this.puNilai.Close();
        ...
        private void crudDokAset(SvcAsetDokCrud.OutputParameters dataoutDokAsetCrud)
        {
            if (dataoutDokAsetCrud.PO_RESULT == "Y")
            {
                ...
                if (this.modeCrud != 'D')
                {
                    ...
                    this.dataInisial = false;
                    this.getById = true;
                    this.getInitTnhRPnl(" ID_KSENJ_RWYT_NILAI = " + ID_KSENJ_RWYT_NILAI.ToString());
                }
            }
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
               ...
               MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    parInp.P_ID_KSENJ_RWYT_NILAI = selectedData.ID_KSENJ_RWYT_NILAI;
                    parInp.P_ID_KSENJ_RWYT_NILAISpecified = true;
                    parInp.P_ID_KSENJSpecified = true;
                    ...
                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatNilaiCrud = new SvcSenjataRnilaiCrud.call_pttClient();
                    svcRiwayatNilaiCrud.Open();
