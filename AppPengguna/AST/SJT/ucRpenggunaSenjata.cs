...
{
    class ucRpenggunaSenjata : UserControlDetail
    {


        private frmPengelola puPengelola;
        private String Status;
        public decimal? ID_KSENJ_RWYT_PENGGUNA;
        private decimal? ID_KSENJ;
        private string search;
        public frmProgres progresBar = null;

        private SvcSenjataRpenggunaSelect.call_pttClient fetchData;
        private SvcSenjataRpenggunaSelect.InputParameters parInp;
        private SvcSenjataRpenggunaSelect.OutputParameters outData;
        public SvcSenjataRpenggunaSelect.BPSIMANSROW_KSENJ_RWYT_PENGGUNA selectedData;



        public ucRpenggunaSenjata(decimal? _ID_KSENJ, String Status)
            : base()
        {
        ...
        private void initTnhRPengguna()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcSenjataRpenggunaSelect.BPSIMANSROW_KSENJ_RWYT_PENGGUNA);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KSENJ_RWYT_PENGGUNA;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_KSENJ_RWYT_PENGGUNA";
                parInp.P_TABLE = "M_KSENJ_RWYT_PENGGUNA";
        ...
        public void getInitTnhRPgn(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcSenjataRpenggunaSelect.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcSenjataRpenggunaSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcSenjataRpenggunaSelect.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcSenjataRpenggunaSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_KSENJ_RWYT_PENGGUNA.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_KSENJ_RWYT_PENGGUNA[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_KSENJ_RWYT_PENGGUNA[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_KSENJ_RWYT_PENGGUNA[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
                binder.Add(serviceOutPut.SF_ROW_KSENJ_RWYT_PENGGUNA[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcSenjataRpenggunaSelect.BPSIMANSROW_KSENJ_RWYT_PENGGUNA)selectedView.GetRow(e.FocusedRowHandle);
        ...
        SvcSenjataRpengelolaCrud.call_pttClient svcRiwayatPengelolaCrud;
        SvcSenjataRpengelolaCrud.OutputParameters outRiwayatPengelolaCrud;
        ...
        private void saveForm(string text)
        {
            ...
            try
            {
                ...
                SvcSenjataRpengelolaCrud.InputParameters parInp = new SvcSenjataRpengelolaCrud.InputParameters();
                parInp.P_ID_KSENJ = this.ID_KSENJ;
                parInp.P_ID_KSENJ_RWYT_PENGGUNA = (this.puPengelola.Status == "input") ? 0 : this.selectedData.ID_KSENJ_RWYT_PENGGUNA;
                parInp.P_ID_KSENJ_RWYT_PENGGUNASpecified = true;
                ...
                this.svcRiwayatPengelolaCrud = new SvcSenjataRpengelolaCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcSenjataRpengelolaCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcSenjataRpengelolaCrud.OutputParameters outCrud)
        {
            SvcSenjataRpenggunaSelect.BPSIMANSROW_KSENJ_RWYT_PENGGUNA dataPenyama = new SvcSenjataRpenggunaSelect.BPSIMANSROW_KSENJ_RWYT_PENGGUNA();
            ...
            dataPenyama.ID_KSENJ_RWYT_PENGGUNA = (this.modeCrud == 'U') ? selectedData.ID_KSENJ_RWYT_PENGGUNA : outCrud.PO_ID_KSENJ_RWYT_PENGGUNA;
            dataPenyama.ID_KSENJ_RWYT_PENGGUNASpecified = true;
            ...
            this.ID_KSENJ_RWYT_PENGGUNA = (this.StatusCrud == "input") ? outCrud.PO_ID_KSENJ_RWYT_PENGGUNA : selectedData.ID_KSENJ_RWYT_PENGGUNA;
            ...
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puPengelola.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KSENJ_RWYT_PENGGUNA", dataPenyama.ID_KSENJ_RWYT_PENGGUNA, "M_KSENJ_RWYT_PENGGUNA", filePath, "C");
                    }
                    else
                    {
                        ...
                        this.getById = true;
                        this.getInitTnhRPgn(" ID_KSENJ_RWYT_PENGGUNA = " + this.ID_KSENJ_RWYT_PENGGUNA.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puPengelola.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KSENJ_RWYT_PENGGUNA", dataPenyama.ID_KSENJ_RWYT_PENGGUNA, "M_KSENJ_RWYT_PENGGUNA", filePath, SELECT);
                    }
                    else
                    {
                        this.puPengelola.Close();
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
             ...
             MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    parInp.P_ID_KSENJSpecified = true;
                    parInp.P_ID_KSENJ_RWYT_PENGGUNA = selectedData.ID_KSENJ_RWYT_PENGGUNA;
                    parInp.P_ID_KSENJ_RWYT_PENGGUNASpecified = true;


                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatPengelolaCrud = new SvcSenjataRpengelolaCrud.call_pttClient();
                    svcRiwayatPengelolaCrud.Open();
