...
{
    class ucMPKTRwytNilai : UserControlDetail
    {

      
        private frmNilai puNilai;
        private decimal? ID_KKTIK_RWYT_NILAI;
        ...
        private SvcMPKTRwytNilai.call_pttClient fetchData;
        private SvcMPKTRwytNilai.InputParameters parInp;
        private SvcMPKTRwytNilai.OutputParameters outData;
        private SvcMPKTRwytNilai.BPSIMANSROW_M_KKTIK_RWYT_NILAI selectedData;


        public ucMPKTRwytNilai(decimal? _ID_KKTIK, String _Status)
            : base()
        {
        ...
        private void initTnhRPenilaian()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcMPKTRwytNilai.BPSIMANSROW_M_KKTIK_RWYT_NILAI);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KKTIK_RWYT_NILAI;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_KKTIK_RWYT_NILAI";
                parInp.P_TABLE = "M_KKTIK_RWYT_NILAI";
        ...
        {
            this.initGrid();
            this.getInitMpktNilai();
            gvUcDtl.OptionsBehavior.CopyToClipboardWithColumnHeaders = false;
        }


        #region load data
        public void getInitMpktNilai(string _where = null)
        {
            decimal Max, Min;
            myThread = new Thread(new ThreadStart(this.ShowProgresBar));
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcMPKTRwytNilai.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcMPKTRwytNilai.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcMPKTRwytNilai.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcMPKTRwytNilai.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_M_KKTIK_RWYT_NILAI.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_M_KKTIK_RWYT_NILAI[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_M_KKTIK_RWYT_NILAI[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KKTIK_RWYT_NILAI[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
              string date1 = Convert.ToString(serviceOutPut.SF_ROW_M_KKTIK_RWYT_NILAI[i].TGL_BUKU).Substring(0, 10);
              string date2 = Convert.ToString(serviceOutPut.SF_ROW_M_KKTIK_RWYT_NILAI[i].TGL_NILAI).Substring(0, 10);

              if (date1 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_M_KKTIK_RWYT_NILAI[i].TGL_BUKU = null;
              }
              if (date2 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_M_KKTIK_RWYT_NILAI[i].TGL_NILAI = null;
              }
                binder.Add(serviceOutPut.SF_ROW_M_KKTIK_RWYT_NILAI[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcMPKTRwytNilai.BPSIMANSROW_M_KKTIK_RWYT_NILAI)selectedView.GetRow(e.FocusedRowHandle);
        ...
        SvcMPKTRnilaiCrud.call_pttClient svcRiwayatNilaiCrud;
        SvcMPKTRnilaiCrud.OutputParameters outRiwayatNilaiCrud;
        ...
        private void saveFrmNilai(string text)
        {
            ...
            try
            {
                ...
                SvcMPKTRnilaiCrud.InputParameters parInp = new SvcMPKTRnilaiCrud.InputParameters();
                parInp.P_ID_KKTIK = this.ID_KKTIK;
                parInp.P_ID_KKTIK_RWYT_NILAI = (this.puNilai.Status == "input") ? 0 : this.selectedData.ID_KKTIK_RWYT_NILAI;
                parInp.P_ID_KKTIK_RWYT_NILAISpecified = true;
                ...
                this.svcRiwayatNilaiCrud = new SvcMPKTRnilaiCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcMPKTRnilaiCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcMPKTRnilaiCrud.OutputParameters outCrud)
        {
            SvcMPKTRwytNilai.BPSIMANSROW_M_KKTIK_RWYT_NILAI dataPenyama = new SvcMPKTRwytNilai.BPSIMANSROW_M_KKTIK_RWYT_NILAI();
            ...
            dataPenyama.ID_KKTIK_RWYT_NILAI = (this.modeCrud == 'U') ? selectedData.ID_KKTIK_RWYT_NILAI : outCrud.PO_ID_KKTIK_RWYT_NILAI;
            dataPenyama.ID_KKTIK_RWYT_NILAISpecified = true;
            ...
            this.ID_KKTIK_RWYT_NILAI = outCrud.PO_ID_KKTIK_RWYT_NILAI;
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puNilai.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KKTIK_RWYT_NILAI", dataPenyama.ID_KKTIK_RWYT_NILAI, "M_KKTIK_RWYT_NILAI", filePath, "C", puNilai.ID_JNSDOK);
                    }
                    else
                    {
                        this.puNilai.Close();
                        ...
                        this.getById = true;
                        this.getInitMpktNilai(" ID_KKTIK_RWYT_NILAI = " + outCrud.PO_ID_KKTIK_RWYT_NILAI.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puNilai.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KKTIK_RWYT_NILAI", dataPenyama.ID_KKTIK_RWYT_NILAI, "M_KKTIK_RWYT_NILAI", filePath, SELECT, puNilai.ID_JNSDOK);
                    }
                    else
                    {
                        this.puNilai.Close();
        ...
        private void crudDokAset(SvcAsetDokCrud.OutputParameters dataoutDokAsetCrud)
        {
            if (dataoutDokAsetCrud.PO_RESULT == "Y")
            {
                ...
                if (this.modeCrud != 'D')
                {
                    ...
                    this.dataInisial = false;
                    this.getById = true;
                    this.getInitMpktNilai(" ID_KKTIK_RWYT_NILAI = " + ID_KKTIK_RWYT_NILAI.ToString());
                }
            }
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
               ...
               MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    parInp.P_ID_KKTIK_RWYT_NILAI = selectedData.ID_KKTIK_RWYT_NILAI;
                    parInp.P_ID_KKTIK_RWYT_NILAISpecified = true;
                    parInp.P_ID_KKTIKSpecified = true;
                    ...
                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatNilaiCrud = new SvcMPKTRnilaiCrud.call_pttClient();
                    svcRiwayatNilaiCrud.Open();
        ...
        protected override void bbSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                this.getInitMpktNilai(get_where_clause(nama_kolom, opr, parameter, parameter_2));
