...
{
    class ucMPKTRwytPemeliharaan : UserControlDetail
    {
        ...
        private char unnormalVal;
        private decimal? jmlData = 0;
        
        private String Status;
        public decimal? ID_KKTIK;
        private decimal? ID_KKTIK_RWYT_PELIHARA;



        private SvcMPKTRwytPemeliharaan.call_pttClient fetchData;
        private SvcMPKTRwytPemeliharaan.InputParameters parInp;
        private SvcMPKTRwytPemeliharaan.OutputParameters outData;
        private SvcMPKTRwytPemeliharaan.BPSIMANSROW_M_KKTIK_RWYT_PELIHARA selectedData;




        public ucMPKTRwytPemeliharaan(decimal? _ID_KKTIK, String Status)
            : base()
        {
        ...
        private void initTnhRPemeliharaan()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcMPKTRwytPemeliharaan.BPSIMANSROW_M_KKTIK_RWYT_PELIHARA);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KKTIK_RWYT_PELIHARA;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_KKTIK_RWYT_PELIHARA";
                parInp.P_TABLE = "M_KKTIK_RWYT_PELIHARA";
        ...
        public void getInitTnhRPml(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcMPKTRwytPemeliharaan.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcMPKTRwytPemeliharaan.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcMPKTRwytPemeliharaan.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcMPKTRwytPemeliharaan.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_M_KKTIK_RWYT_PELIHARA.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_M_KKTIK_RWYT_PELIHARA[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_M_KKTIK_RWYT_PELIHARA[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KKTIK_RWYT_PELIHARA[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
              string date1 = Convert.ToString(serviceOutPut.SF_ROW_M_KKTIK_RWYT_PELIHARA[i].TGL_BUKU).Substring(0, 10);
              string date2 = Convert.ToString(serviceOutPut.SF_ROW_M_KKTIK_RWYT_PELIHARA[i].TGL_SP2D).Substring(0, 10);

              if (date1 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_M_KKTIK_RWYT_PELIHARA[i].TGL_BUKU = null;
              }
              if (date2 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_M_KKTIK_RWYT_PELIHARA[i].TGL_SP2D = null;
              }
                binder.Add(serviceOutPut.SF_ROW_M_KKTIK_RWYT_PELIHARA[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcMPKTRwytPemeliharaan.BPSIMANSROW_M_KKTIK_RWYT_PELIHARA)selectedView.GetRow(e.FocusedRowHandle);
        ...
        SvcMPKTRpemeliharaanCrud.call_pttClient svcRiwayatPemeliharaanCrud;
        SvcMPKTRpemeliharaanCrud.OutputParameters outRiwayatPemeliharaanCrud;
        ...
        private void saveForm(string text)
        {
            ...
            try
            {
                ...
                SvcMPKTRpemeliharaanCrud.InputParameters parInp = new SvcMPKTRpemeliharaanCrud.InputParameters();
                parInp.P_ID_KKTIK = this.ID_KKTIK;
                parInp.P_ID_KKTIK_RWYT_PELIHARA = (this.puPemeliharaan.Status == "input") ? 0 : this.selectedData.ID_KKTIK_RWYT_PELIHARA;
                parInp.P_ID_KKTIK_RWYT_PELIHARASpecified = true;
                ...
                this.svcRiwayatPemeliharaanCrud = new SvcMPKTRpemeliharaanCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcMPKTRpemeliharaanCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcMPKTRpemeliharaanCrud.OutputParameters outCrud)
        {
            SvcMPKTRwytPemeliharaan.BPSIMANSROW_M_KKTIK_RWYT_PELIHARA dataPenyama = new SvcMPKTRwytPemeliharaan.BPSIMANSROW_M_KKTIK_RWYT_PELIHARA();
            ...
            dataPenyama.ID_KKTIK_RWYT_PELIHARA = (this.modeCrud == 'U') ? selectedData.ID_KKTIK_RWYT_PELIHARA  : outCrud.PO_ID_KKTIK_RWYT_PELIHARA;
            dataPenyama.ID_KKTIK_RWYT_PELIHARASpecified = true;
            ...
            this.ID_KKTIK_RWYT_PELIHARA = outCrud.PO_ID_KKTIK_RWYT_PELIHARA;
            ...
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puPemeliharaan.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KKTIK_RWYT_PELIHARA", dataPenyama.ID_KKTIK_RWYT_PELIHARA, "M_KKTIK_RWYT_PELIHARA", filePath, "C", puPemeliharaan.ID_JNSDOK);
                        this.search = "";
                        this.initGrid();
                        this.getInitTnhRPml();
                        this.unnormalVal = 'R';
                    ...
                    else
                    {
                        ...
                        this.getById = true;
                        this.getInitTnhRPml(" ID_KKTIK_RWYT_PELIHARA = " + outCrud.PO_ID_KKTIK_RWYT_PELIHARA.ToString());
                ...
                case 'U':
                    ...
                    if (this.puPemeliharaan.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KKTIK_RWYT_PELIHARA", dataPenyama.ID_KKTIK_RWYT_PELIHARA, "M_KKTIK_RWYT_PELIHARA", filePath, SELECT, puPemeliharaan.ID_JNSDOK);
                        this.search = "";
        ...
        private void crudDokAset(SvcAsetDokCrud.OutputParameters dataoutDokAsetCrud)
        {
            if (dataoutDokAsetCrud.PO_RESULT == "Y")
            {
                ...
                if (this.modeCrud != 'D')
                {
                    ...
                    this.dataInisial = false;
                    this.getById = true;
                    this.getInitTnhRPml(" ID_KKTIK_RWYT_PELIHARA = " + this.ID_KKTIK_RWYT_PELIHARA.ToString());
                }
                this.search = "";
                this.initGrid();
                this.getInitTnhRPml();
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
              ...
              MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    parInp.P_ID_KKTIKSpecified = true;
                    parInp.P_ID_KKTIK_RWYT_PELIHARA = selectedData.ID_KKTIK_RWYT_PELIHARA;
                    parInp.P_ID_KKTIK_RWYT_PELIHARASpecified = true;


                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatPemeliharaanCrud = new SvcMPKTRpemeliharaanCrud.call_pttClient();
                    svcRiwayatPemeliharaanCrud.Open();
