...
{
    class UcKDPRwyPgg : UserControlDetail
    {


        private frmPengelola puPengelola;
        private String Status;
        public decimal? ID_KDP_RWYT_PENGGUNA;
        private decimal? ID_KDP;
        private string search;
        public frmProgres progresBar = null;

        private SvcKDPPggSelect.call_pttClient fetchData;
        private SvcKDPPggSelect.InputParameters parInp;
        private SvcKDPPggSelect.OutputParameters outData;
        public SvcKDPPggSelect.BPSIMANSROW_KDP_RWYT_PENGGUNA selectedData;



        public UcKDPRwyPgg(decimal? _ID_KDP, String Status)
            : base()
        {
        ...
        private void initRiwayatPengguna()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcKDPPggSelect.BPSIMANSROW_KDP_RWYT_PENGGUNA);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KDP_RWYT_PENGGUNA;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_KDP_RWYT_PENGGUNA";
                parInp.P_TABLE = "M_KDP_RWYT_PENGGUNA";
        ...
        public void getInitTnhRPgn(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcKDPPggSelect.InputParameters();
            parInp.P_COL = "";
            ...
            parInp.P_SORT = "DESC";
            parInp.STR_WHERE = String.Format(" ID_KDP = {0} {1}", this.ID_KDP, _where);
            fetchData = new SvcKDPPggSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcKDPPggSelect.OutputParameters dataOut);
        private string StatusCrud = "";
        private decimal? NUM;
        public void showData(SvcKDPPggSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_KDP_RWYT_PENGGUNA.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_KDP_RWYT_PENGGUNA[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_KDP_RWYT_PENGGUNA[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_KDP_RWYT_PENGGUNA[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
                binder.Add(serviceOutPut.SF_ROW_KDP_RWYT_PENGGUNA[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcKDPPggSelect.BPSIMANSROW_KDP_RWYT_PENGGUNA)selectedView.GetRow(e.FocusedRowHandle);
        ...
        SvcKDPRpengelolaCrud.call_pttClient svcRiwayatPengelolaCrud;
        SvcKDPRpengelolaCrud.OutputParameters outRiwayatPengelolaCrud;
        ...
        private void saveForm(string text)
        {
            ...
            try
            {
                ...
                SvcKDPRpengelolaCrud.InputParameters parInp = new SvcKDPRpengelolaCrud.InputParameters();
                parInp.P_ID_KDP = this.ID_KDP;
                parInp.P_ID_KDP_RWYT_PENGGUNA = (this.puPengelola.Status == "input") ? 0 : this.selectedData.ID_KDP_RWYT_PENGGUNA;
                parInp.P_ID_KDP_RWYT_PENGGUNASpecified = true;
                parInp.P_ID_KDPSpecified = true;
                ...
                this.svcRiwayatPengelolaCrud = new SvcKDPRpengelolaCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcKDPRpengelolaCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcKDPRpengelolaCrud.OutputParameters outCrud)
        {
            SvcKDPPggSelect.BPSIMANSROW_KDP_RWYT_PENGGUNA dataPenyama = new SvcKDPPggSelect.BPSIMANSROW_KDP_RWYT_PENGGUNA();

            dataPenyama.NUM = 999;
            dataPenyama.NUMSpecified = true;
            dataPenyama.ID_ASET = (this.modeCrud == 'U') ? selectedData.ID_ASET : 0;
            dataPenyama.ID_ASETSpecified = true;
            dataPenyama.ID_KDP = (this.modeCrud == 'U') ? selectedData.ID_KDP : 0;
            dataPenyama.ID_KDP_RWYT_PENGGUNA = (this.modeCrud == 'U') ? selectedData.ID_KDP_RWYT_PENGGUNA : outCrud.PO_ID_KDP_RWYT_PENGGUNA;
            dataPenyama.ID_KDP_RWYT_PENGGUNASpecified = true;
            dataPenyama.ID_KDPSpecified = true;
            ...
            this.ID_KDP_RWYT_PENGGUNA = (this.StatusCrud == "input") ? outCrud.PO_ID_KDP_RWYT_PENGGUNA : selectedData.ID_KDP_RWYT_PENGGUNA;
            ...
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puPengelola.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KDP_RWYT_PENGGUNA", dataPenyama.ID_KDP_RWYT_PENGGUNA, "M_KDP_RWYT_PENGGUNA", filePath, "C");
                    }
                    else
                    {
                        ...
                        this.getById = true;
                        this.getInitTnhRPgn(" ID_KDP_RWYT_PENGGUNA = " + this.ID_KDP_RWYT_PENGGUNA.ToString());
                    }
                ...
                case 'U':
                    ...
                    if (this.puPengelola.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KDP_RWYT_PENGGUNA", dataPenyama.ID_KDP_RWYT_PENGGUNA, "M_KDP_RWYT_PENGGUNA", filePath, SELECT);
                    }
                    else
                    {
                        this.puPengelola.Close();
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
             ...
             MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    myThread.Start();
                    SvcKDPRpengelolaCrud.InputParameters parInp = new SvcKDPRpengelolaCrud.InputParameters();
                    parInp.P_ID_KDP = selectedData.ID_KDP;
                    parInp.P_ID_KDPSpecified = true;
                    parInp.P_ID_KDP_RWYT_PENGGUNA = selectedData.ID_KDP_RWYT_PENGGUNA;
                    parInp.P_ID_KDP_RWYT_PENGGUNASpecified = true;


                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatPengelolaCrud = new SvcKDPRpengelolaCrud.call_pttClient();
                    svcRiwayatPengelolaCrud.Open();
