...
{
    class UcKDPRwyMut : UserControlDetail
    {
        ...
        private SvcKDPMutasiSelect.call_pttClient fetchData;
        private SvcKDPMutasiSelect.InputParameters parInp;
        private SvcKDPMutasiSelect.OutputParameters outData;
        public SvcKDPMutasiSelect.BPSIMANSROW_KDP_RWYT_MUTASI selectedData;



        public UcKDPRwyMut(decimal? _ID_KDP, String Status)
            : base()
        {
            this.initTnhRMutasi();
            this.Status = Status;
        ...
        private void initTnhRMutasi()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcKDPMutasiSelect.BPSIMANSROW_KDP_RWYT_MUTASI);
        ...
        public void getInitMutasi(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcKDPMutasiSelect.InputParameters();
            parInp.P_COL = "";
            ...
            parInp.P_SORT = "DESC";
            parInp.STR_WHERE = String.Format(" ID_KDP = {0} {1}", this.ID_KDP, this.search);
            fetchData = new SvcKDPMutasiSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcKDPMutasiSelect.OutputParameters dataOut);

        public void showData(SvcKDPMutasiSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_KDP_RWYT_MUTASI.Count();
            ...
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_KDP_RWYT_MUTASI[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
                binder.Add(serviceOutPut.SF_ROW_KDP_RWYT_MUTASI[i]);
            }
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcKDPMutasiSelect.BPSIMANSROW_KDP_RWYT_MUTASI)selectedView.GetRow(e.FocusedRowHandle);
