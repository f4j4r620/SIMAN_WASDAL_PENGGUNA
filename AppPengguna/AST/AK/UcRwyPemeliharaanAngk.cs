...
{
    class UcRwyPemeliharaanAngk:UserControlDetail
    {
        private SvcRwyPemeliharaanAngkSelect.call_pttClient fetchData;
        private SvcRwyPemeliharaanAngkSelect.InputParameters parInp;
        private SvcRwyPemeliharaanAngkSelect.OutputParameters outDat;
        private SvcRwyPemeliharaanAngkSelect.BPSIMANSROW_M_KANGK_RWYT_PELIHARA selectedData;
        GridRow grow;
        ...
        public UcRwyPemeliharaanAngk(decimal? _ID_KANGK, string _status)
            : base()
        {
        ...
        public void getInitPemeliharaanAngk(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            SvcRwyPemeliharaanAngkSelect.InputParameters parInp = new SvcRwyPemeliharaanAngkSelect.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcRwyPemeliharaanAngkSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcRwyPemeliharaanAngkSelect.OutputParameters dataOut);

        public void showData(SvcRwyPemeliharaanAngkSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_M_KANGK_RWYT_PELIHARA.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_M_KANGK_RWYT_PELIHARA[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_M_KANGK_RWYT_PELIHARA[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KANGK_RWYT_PELIHARA[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
              string date1 = Convert.ToString(serviceOutPut.SF_ROW_M_KANGK_RWYT_PELIHARA[i].TGL_BUKU).Substring(0, 10);
              string date2 = Convert.ToString(serviceOutPut.SF_ROW_M_KANGK_RWYT_PELIHARA[i].TGL_SP2D).Substring(0, 10);
              if (date1 == "11/11/1000")
                {
                    serviceOutPut.SF_ROW_M_KANGK_RWYT_PELIHARA[i].TGL_BUKU = null;
                }
                if (date2 == "11/11/1000")
                {
                    serviceOutPut.SF_ROW_M_KANGK_RWYT_PELIHARA[i].TGL_SP2D = null;
                }
                binder.Add(serviceOutPut.SF_ROW_M_KANGK_RWYT_PELIHARA[i]);
            }
        ...
        protected override void ucDetail_Load(object sender, EventArgs e)
        {
            ...
            this.binder.DataSource = typeof(SvcRwyPemeliharaanAngkSelect.BPSIMANSROW_M_KANGK_RWYT_PELIHARA);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KANGK_RWYT_PELIHARA;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_KANGK_RWYT_PELIHARA";
                parInp.P_TABLE = "M_KANGK_RWYT_PELIHARA";
        ...
        SvcAngkutanRiwayatPemeliharaanCrud.call_pttClient svcRiwayatPemeliharaanCrud;
        SvcAngkutanRiwayatPemeliharaanCrud.OutputParameters outRiwayatPemeliharaanCrud;
        ...
        private void saveForm(string text)
        {
            ...
            try
            {
                ...
                myThread.Start();
                this.nonAktifForm("");
                SvcAngkutanRiwayatPemeliharaanCrud.InputParameters parInp = new SvcAngkutanRiwayatPemeliharaanCrud.InputParameters();
                parInp.P_ID_KANGK = this.ID_KANGK;
                parInp.P_ID_KANGK_RWYT_PELIHARA = (this.puPemeliharaan.Status == "input") ? 0 : this.selectedData.ID_KANGK_RWYT_PELIHARA;
                parInp.P_ID_KANGK_RWYT_PELIHARASpecified = true;
                ...
                this.svcRiwayatPemeliharaanCrud = new SvcAngkutanRiwayatPemeliharaanCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcAngkutanRiwayatPemeliharaanCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcAngkutanRiwayatPemeliharaanCrud.OutputParameters outCrud)
        {
            SvcRwyPemeliharaanAngkSelect.BPSIMANSROW_M_KANGK_RWYT_PELIHARA dataPenyama = new SvcRwyPemeliharaanAngkSelect.BPSIMANSROW_M_KANGK_RWYT_PELIHARA();
            ...
            dataPenyama.ID_KANGK_RWYT_PELIHARA = (this.modeCrud == 'U') ? selectedData.ID_KANGK_RWYT_PELIHARA : outCrud.PO_ID_KANGK_RWYT_PELIHARA;
            dataPenyama.ID_KANGK_RWYT_PELIHARASpecified = true;
            ...
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puPemeliharaan.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KANGK_RWYT_PELIHARA", dataPenyama.ID_KANGK_RWYT_PELIHARA, "M_KANGK_RWYT_PELIHARA", filePath, "C", puPemeliharaan.ID_JNSDOK);
                    }
                    else
                    {
                ...
                case 'U':
                    ...
                    if (this.puPemeliharaan.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KANGK_RWYT_PELIHARA", dataPenyama.ID_KANGK_RWYT_PELIHARA, "M_KANGK_RWYT_PELIHARA", filePath, SELECT, puPemeliharaan.ID_JNSDOK);
                    }
                    else
                    {
                        this.puPemeliharaan.Close();
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
               ...
               MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    parInp.P_ID_KANGKSpecified = true;
                    parInp.P_ID_KANGK_RWYT_PELIHARA = selectedData.ID_KANGK_RWYT_PELIHARA;
                    parInp.P_ID_KANGK_RWYT_PELIHARASpecified = true;


                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatPemeliharaanCrud = new SvcAngkutanRiwayatPemeliharaanCrud.call_pttClient();
                    svcRiwayatPemeliharaanCrud.Open();
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcRwyPemeliharaanAngkSelect.BPSIMANSROW_M_KANGK_RWYT_PELIHARA)selectedView.GetRow(e.FocusedRowHandle);
