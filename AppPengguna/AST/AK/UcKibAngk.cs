...
{
    class UcKibAngk : UserControlDetail
    {

        private SvcKibAngkSelect.call_pttClient fetchData;
        private SvcKibAngkSelect.InputParameters parInp;
        private SvcKibAngkSelect.OutputParameters outData;
        public SvcKibAngkSelect.BPSIMANSROW_M_KANGK_DOK_KIB selectedData;
        ...
        private FormRwyDokKib FormRwyDokKib;
        ...
        public UcKibAngk(decimal? _ID_KANGK, String status)
            : base()
        {
            this.InitDokKib();
            this.Status = Status;
        ...
        public void InitDokKib()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcKibAngkSelect.BPSIMANSROW_M_KANGK_DOK_KIB);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KANGK_DOK_KIB;
        ...
        public void getInitDokKib(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcKibAngkSelect.InputParameters();
            parInp.P_COL = "";
            decimal Max, Min;
            ...
            fetchData = new SvcKibAngkSelect.call_pttClient();
            fetchData.Open();
        ...
        public void showData(SvcKibAngkSelect.OutputParameters serviceOutPut)
        {
            ...
            if (this.getById == true && jmlDataGroup > 0)
            {
                ...
                {
                    serviceOutPut.SF_ROW_M_KANGK_DOK_KIB[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_M_KANGK_DOK_KIB[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    //serviceOutPut.SF_ROW_M_KANGK_DOK_KIB[0].TOTAL_DATASpecified = true;
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KANGK_DOK_KIB[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
              string date = Convert.ToString(serviceOutPut.SF_ROW_M_KANGK_DOK_KIB[i].TGL_DOK_KIB).Substring(0, 10);
              string date_ = Convert.ToString(serviceOutPut.SF_ROW_M_KANGK_DOK_KIB[i].TGL_DOK_KIB).Substring(0, 8);
              if (date == "11/11/1000" || date_ == "1/1/0001")
                {
                    serviceOutPut.SF_ROW_M_KANGK_DOK_KIB[i].TGL_DOK_KIB = null;
                }
                binder.Add(serviceOutPut.SF_ROW_M_KANGK_DOK_KIB[i]);
            }
        ...
        {
            this.FormRwyDokKib = new FormRwyDokKib(this, "input");
            StatusCrud = "input";
            this.FormRwyDokKib.ShowDialog();
        }
        protected override void bbEdit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                this.FormRwyDokKib = new FormRwyDokKib(this, "detail");
                StatusCrud = "detail";
            }
            else
            {
                this.FormRwyDokKib = new FormRwyDokKib(this, "edit");
                StatusCrud = "edit";
            }
            this.FormRwyDokKib.ShowDialog();
        }
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            StatusCrud = "hapus";
            this.FormRwyDokKib = new FormRwyDokKib(this, "hapus");
            this.FormRwyDokKib.Size = new System.Drawing.Size(0, 0);
            this.FormRwyDokKib.Opacity = 0;
            this.FormRwyDokKib.Show();
            this.FormRwyDokKib.Hide();
            this.FormRwyDokKib.hapusData();
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcKibAngkSelect.BPSIMANSROW_M_KANGK_DOK_KIB)viewTerpilih.GetRow(e.FocusedRowHandle);
