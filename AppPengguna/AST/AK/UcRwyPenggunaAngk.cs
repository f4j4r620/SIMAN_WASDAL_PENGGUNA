...
{
    class UcRwyPenggunaAngk:UserControlDetail
    {
        private SvcRwyPenggunaAngkSelect.call_pttClient fetchData;
        private SvcRwyPenggunaAngkSelect.InputParameters parInp;
        private SvcRwyPenggunaAngkSelect.OutputParameters outDat;
        private SvcRwyPenggunaAngkSelect.BPSIMANSROW_KANGK_RWYT_PENGGUNA selectedData;
        GridRow grow;
        ...
        public UcRwyPenggunaAngk(decimal? _ID_KANGK, string _status)
            : base()
        {
            this.initRiwayatPengelola();
        ...
        public void initRiwayatPengelola()
        {
            this.gvUcDtl.OptionsView.NewItemRowPosition = NewItemRowPosition.None;
            this.gvUcDtl.OptionsBehavior.Editable = false;
            this.binder = new BindingSource();
            this.binder.DataSource = typeof(SvcRwyPenggunaAngkSelect.BPSIMANSROW_KANGK_RWYT_PENGGUNA);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KANGK_RWYT_PENGGUNA;
                parInp.P_IDSpecified = true;
                parInp.P_ID_TABLE = "ID_KANGK_RWYT_PENGGUNA";
                parInp.P_TABLE = "M_KANGK_RWYT_PENGGUNA";
        ...
        public void getInitPenggunaAngk(string _where = null)
        {
            decimal Max, Min;
            myThread = new Thread(new ThreadStart(this.ShowProgresBar));
            myThread.Start();
            this.nonAktifForm("");
            SvcRwyPenggunaAngkSelect.InputParameters parInp = new SvcRwyPenggunaAngkSelect.InputParameters();
            parInp.P_COL = "";
            ...
            fetchData = new SvcRwyPenggunaAngkSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcRwyPenggunaAngkSelect.OutputParameters dataOut);

        public void showData(SvcRwyPenggunaAngkSelect.OutputParameters serviceOutPut)
        {
            int jmlDataGroup = serviceOutPut.SF_ROW_KANGK_RWYT_PENGGUNA.Count();

            if (this.getById == true && jmlDataGroup > 0)
            {
                if (this.StatusCrud == "edit")
                {
                    serviceOutPut.SF_ROW_KANGK_RWYT_PENGGUNA[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_KANGK_RWYT_PENGGUNA[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_KANGK_RWYT_PENGGUNA[0].TOTAL_DATA.ToString();
                    if (StrTotalDb.Caption == "") 
                    {
            ...
            {
              string date1 = Convert.ToString(serviceOutPut.SF_ROW_KANGK_RWYT_PENGGUNA[i].TGL_KONTRAK).Substring(0, 10);
              string date2 = Convert.ToString(serviceOutPut.SF_ROW_KANGK_RWYT_PENGGUNA[i].TGL_MULAI).Substring(0, 10);
              string date3 = Convert.ToString(serviceOutPut.SF_ROW_KANGK_RWYT_PENGGUNA[i].TGL_SELESAI).Substring(0, 10);
              string date4 = Convert.ToString(serviceOutPut.SF_ROW_KANGK_RWYT_PENGGUNA[i].TGL_SK).Substring(0, 10);
              if (date1 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_KANGK_RWYT_PENGGUNA[i].TGL_KONTRAK = null;
              }
              if (date2 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_KANGK_RWYT_PENGGUNA[i].TGL_MULAI = null;
              }
              if (date3 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_KANGK_RWYT_PENGGUNA[i].TGL_SELESAI = null;
              }
              if (date4 == "11/11/1000")
              {
                serviceOutPut.SF_ROW_KANGK_RWYT_PENGGUNA[i].TGL_SK = null;
              }
                binder.Add(serviceOutPut.SF_ROW_KANGK_RWYT_PENGGUNA[i]);
            }
        ...
        SvcAngkutanRiwayatPengelolaCrud.call_pttClient svcRiwayatPengelolaCrud;
        SvcAngkutanRiwayatPengelolaCrud.OutputParameters outRiwayatPengelolaCrud;
        ...
        private void saveForm(string text)
        {
             if (this.puPengelola.teTglSKPenetapan.Text != "" && this.puPengelola.teSKPenetapan.Text != "")
            {
                ...
                try
                {
                    ...
                    SvcAngkutanRiwayatPengelolaCrud.InputParameters parInp = new SvcAngkutanRiwayatPengelolaCrud.InputParameters();
                    parInp.P_ID_KANGK = this.ID_KANGK;
                    parInp.P_ID_KANGK_RWYT_PENGGUNA = (this.puPengelola.Status == "input") ? 0 : this.selectedData.ID_KANGK_RWYT_PENGGUNA;
                    parInp.P_ID_KANGK_RWYT_PENGGUNASpecified = true;
                    ...
                    this.svcRiwayatPengelolaCrud = new SvcAngkutanRiwayatPengelolaCrud.call_pttClient();
        ...
        public delegate void UbahDsDetail(SvcAngkutanRiwayatPengelolaCrud.OutputParameters outCrud);

        public void ubahDsDetail(SvcAngkutanRiwayatPengelolaCrud.OutputParameters outCrud)
        {
            SvcRwyPenggunaAngkSelect.BPSIMANSROW_KANGK_RWYT_PENGGUNA dataPenyama = new SvcRwyPenggunaAngkSelect.BPSIMANSROW_KANGK_RWYT_PENGGUNA();
            ...
            dataPenyama.ID_KANGK_RWYT_PENGGUNA = (this.modeCrud == 'U') ? selectedData.ID_KANGK_RWYT_PENGGUNA: outCrud.PO_ID_KANGK_RWYT_PENGGUNA;
            dataPenyama.ID_KANGK_RWYT_PENGGUNASpecified = true;
            ...
            switch (this.modeCrud)
            {
                case 'C':
                    ...
                    if (this.puPengelola.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KANGK_RWYT_PENGGUNA", dataPenyama.ID_KANGK_RWYT_PENGGUNA, "M_KANGK_RWYT_PENGGUNA", filePath, "C", puPengelola.ID_JNSDOK);
                        this.search = "";
                ...
                case 'U':
                    ...
                    if (this.puPengelola.FilePath != null)
                    {
                        ...
                        simpanFile("ID_KANGK_RWYT_PENGGUNA", dataPenyama.ID_KANGK_RWYT_PENGGUNA, "M_KANGK_RWYT_PENGGUNA", filePath, SELECT, puPengelola.ID_JNSDOK);
                        this.search = "";
                        this.pencarian = false;
                        this.initGrid();
                        this.getInitPenggunaAngk();
        ...
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
             ...
             MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
            {
                try
                {
                    ...
                    parInp.P_ID_KANGKSpecified = true;
                    parInp.P_ID_KANGK_RWYT_PENGGUNA = selectedData.ID_KANGK_RWYT_PENGGUNA;
                    parInp.P_ID_KANGK_RWYT_PENGGUNASpecified = true;


                    parInp.P_SELECT = "D";
                    this.modeCrud = Convert.ToChar(parInp.P_SELECT);
                    svcRiwayatPengelolaCrud = new SvcAngkutanRiwayatPengelolaCrud.call_pttClient();
                    svcRiwayatPengelolaCrud.Open();
        ...
        protected override void bbSearch_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            try
            {
                ...
                this.getInitPenggunaAngk(get_where_clause(nama_kolom, opr, parameter, parameter_2));
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcRwyPenggunaAngkSelect.BPSIMANSROW_KANGK_RWYT_PENGGUNA)selectedView.GetRow(e.FocusedRowHandle);
