...
{
    class UcRwyPemakaiAngk : UserControlDetail
    {

        private SvcRwyPemakaiAngkSelect.call_pttClient fetchData;
        private SvcRwyPemakaiAngkSelect.InputParameters parInp;
        private SvcRwyPemakaiAngkSelect.OutputParameters outData;
        public SvcRwyPemakaiAngkSelect.BPSIMANSROW_M_KANGK_RWYT_PEMAKAI selectedData;
        ...
        private FormRwyPemakaiAngk FormRwyPemakaiAngk;
        ...
        public UcRwyPemakaiAngk(decimal? _ID_KANGK, String status)
            : base()
        {
            this.InitPemakai();
            this.Status = Status;
        ...
        public void InitPemakai()
        {
            ...
            this.binder.DataSource = typeof(AppPengguna.SvcRwyPemakaiAngkSelect.BPSIMANSROW_M_KANGK_RWYT_PEMAKAI);
        ...
        protected void view_dokumen(object sender, ItemClickEventArgs e)
        {
            try
            {
                ...
                parInp.P_ID = selectedData.ID_KANGK_RWYT_PEMAKAI;
                parInp.P_ID_TABLE = "ID_KANGK_RWYT_PEMAKAI";
                parInp.P_IDSpecified = true;
                parInp.P_TABLE = "M_KANGK_RWYT_PEMAKAI";
        ...
        public void getInitPemakai(string _where = null)
        {
            ...
            myThread.Start();
            this.nonAktifForm("");
            parInp = new SvcRwyPemakaiAngkSelect.InputParameters();
            parInp.P_COL = "";
            decimal Max, Min;
            ...
            fetchData = new SvcRwyPemakaiAngkSelect.call_pttClient();
            fetchData.Open();
        ...
        private delegate void ShowData(SvcRwyPemakaiAngkSelect.OutputParameters dataOut);
        public decimal? NUM;
        private string StatusCrud = "";
        public void showData(SvcRwyPemakaiAngkSelect.OutputParameters serviceOutPut)
        {
            ...
            if (this.getById == true && jmlDataGroup > 0)
            {
                ...
                {
                    serviceOutPut.SF_ROW_M_KANGK_RWYT_PEMAKAI[0].NUM = this.NUM;
                }
                else
                {
                    serviceOutPut.SF_ROW_M_KANGK_RWYT_PEMAKAI[0].NUM = binder.Count + 1;
                }
            }
            if (this.dataInisial == true)
            {
                ...
                if (jmlDataGroup > 0)
                {
                    ...
                    //serviceOutPut.SF_ROW_M_KANGK_RWYT_PEMAKAI[0].TOTAL_DATASpecified = true;
                    StrTotalDb.Caption = serviceOutPut.SF_ROW_M_KANGK_RWYT_PEMAKAI[0].TOTAL_DATA.ToString();
                }
                else
                {
            ...
            {
              string date1 = Convert.ToString(serviceOutPut.SF_ROW_M_KANGK_RWYT_PEMAKAI[i].TGL_BUKU).Substring(0, 10);
              string date2 = Convert.ToString(serviceOutPut.SF_ROW_M_KANGK_RWYT_PEMAKAI[i].TGL_LAHIR).Substring(0, 10);
              string date3 = Convert.ToString(serviceOutPut.SF_ROW_M_KANGK_RWYT_PEMAKAI[i].TGL_MULAI).Substring(0, 10);
              string date4 = Convert.ToString(serviceOutPut.SF_ROW_M_KANGK_RWYT_PEMAKAI[i].TGL_PENSIUN).Substring(0, 10);
              string date5 = Convert.ToString(serviceOutPut.SF_ROW_M_KANGK_RWYT_PEMAKAI[i].TGL_SELESAI).Substring(0, 10);
              string date6 = Convert.ToString(serviceOutPut.SF_ROW_M_KANGK_RWYT_PEMAKAI[i].TGL_SIP).Substring(0, 10);
              string date7 = Convert.ToString(serviceOutPut.SF_ROW_M_KANGK_RWYT_PEMAKAI[i].TGL_SK).Substring(0, 10);
              string date8 = Convert.ToString(serviceOutPut.SF_ROW_M_KANGK_RWYT_PEMAKAI[i].TMT_JAB).Substring(0, 10);

              if (date1 == "11/11/1000")
                {
                    serviceOutPut.SF_ROW_M_KANGK_RWYT_PEMAKAI[i].TGL_BUKU = null;
                }
              if (date2 == "11/11/1000")
                {
                    serviceOutPut.SF_ROW_M_KANGK_RWYT_PEMAKAI[i].TGL_LAHIR = null;
                }
              if (date3 == "11/11/1000")
                {
                    serviceOutPut.SF_ROW_M_KANGK_RWYT_PEMAKAI[i].TGL_MULAI = null;
                }
              if (date4 == "11/11/1000")
                {
                    serviceOutPut.SF_ROW_M_KANGK_RWYT_PEMAKAI[i].TGL_PENSIUN = null;
                }
              if (date5 == "11/11/1000")
                {
                    serviceOutPut.SF_ROW_M_KANGK_RWYT_PEMAKAI[i].TGL_SELESAI = null;
                }
              if (date6 == "11/11/1000")
                {
                    serviceOutPut.SF_ROW_M_KANGK_RWYT_PEMAKAI[i].TGL_SIP = null;
                }
              if (date7 == "11/11/1000")
                {
                    serviceOutPut.SF_ROW_M_KANGK_RWYT_PEMAKAI[i].TGL_SK = null;
                }
              if (date8 == "11/11/1000")
                {
                  serviceOutPut.SF_ROW_M_KANGK_RWYT_PEMAKAI[i].TMT_JAB = null;
                }

                binder.Add(serviceOutPut.SF_ROW_M_KANGK_RWYT_PEMAKAI[i]);
            }
        ...
        {
            this.FormRwyPemakaiAngk = new FormRwyPemakaiAngk(this, "input");
            StatusCrud = "input";
            this.FormRwyPemakaiAngk.ShowDialog();
        }
        protected override void bbEdit_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                this.FormRwyPemakaiAngk = new FormRwyPemakaiAngk(this, "detail");
                StatusCrud = "detail";
            }
            else
            {
                this.FormRwyPemakaiAngk = new FormRwyPemakaiAngk(this, "edit");
                StatusCrud = "edit";
            }
            this.FormRwyPemakaiAngk.ShowDialog();
        }
        protected override void bbHapus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            StatusCrud = "hapus";
            this.FormRwyPemakaiAngk = new FormRwyPemakaiAngk(this, "hapus");
            this.FormRwyPemakaiAngk.Size = new System.Drawing.Size(0, 0);
            this.FormRwyPemakaiAngk.Opacity = 0;
            this.FormRwyPemakaiAngk.Show();
            this.FormRwyPemakaiAngk.Hide();
            this.FormRwyPemakaiAngk.hapusData();
        ...
        protected override void gvUcDtl_FocusedRowChanged(object sender, FocusedRowChangedEventArgs e)
        {
            ...
            {
                selectedData = (SvcRwyPemakaiAngkSelect.BPSIMANSROW_M_KANGK_RWYT_PEMAKAI)viewTerpilih.GetRow(e.FocusedRowHandle);
