...
{
    public partial class ucBMN : ucMain
    {
        ...
        SvcSelectGunaA21.InputParameters input;
        SvcSelectGunaA21.OutputParameters output;
        SvcSelectGunaA21.execute_pttClient client;
        SvcSelectGunaA21.WASDALSROW_MON_GUNA_A21 rowData;
        ...
        public ucBMN(string label, string kode)
        {
            InitializeComponent();
        ...
        private void GetData(string where)
        {
            ...
            {
                FormNonAktif();
                input = new SvcSelectGunaA21.InputParameters();
                if (dataInisial)
                {
                ...
                client = new SvcSelectGunaA21.execute_pttClient();
                client.Open();
        ...
        private delegate void ShowData(SvcSelectGunaA21.OutputParameters output);

        private void ShowDataGrid(SvcSelectGunaA21.OutputParameters output)
        {
            try
            {
                int jmlData = output.SF_MON_GUNA_A21.Count();
                dataCount += jmlData;
                ...
                //    }
                //}
                data.AddRange(output.SF_MON_GUNA_A21.ToList());
        ...
        private void gridView_DoubleClick(object sender, EventArgs e)
        {
            ...
            detail(row.KD_JNS_BMN.ToString(), row.ID_SATKER.ToString());
        }
    }
}
