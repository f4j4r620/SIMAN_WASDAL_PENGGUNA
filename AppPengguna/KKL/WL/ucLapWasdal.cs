...
using AppPengguna.KKL.WL.PEMINDAHTANGANAN;
using AppPengguna.KKL.WL.PENGHAPUSAN;
using AppPengguna.KKL.WL.PEMANFAATAN;
using AppPengguna.KKL.WL.PEMINDAHTANGAN;
...
//    public delegate void CariDataOnline(string strCariData);
    ...
    public partial class ucLapWasdal : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucLapWasdal(FrmKoorKL _frmKoorKL)
        {
            InitializeComponent();
        ...
        public void tabSelect()
        {
            ...
            if (xtbDetail1.SelectedTabPageIndex == 0)
            {
                ...
                if (!tabPenggunaan1Open)
                {
                    ...
                    {
                        penggunaan1 = new ucPenggunaan(FrmKoorKL, this);
                    ...
                    {
                        pemanfaatan1 = new ucPemanfaatan(FrmKoorKL, this);
                    ...
                    {
                        pemindahtanganan1 = new ucPemindahtangan(FrmKoorKL, this);
                    ...
                    {
                        penghapusan1 = new ucPenghapusan(FrmKoorKL, this);
                    ...
                    {
                        penggunaan2 = new ucPenggunaanNew(FrmKoorKL, this);
                    ...
                    {
                        pemanfaatan2 = new ucPemanfaatanNew(FrmKoorKL, this);
                    ...
                    {
                        pemindahtanganan2 = new ucPemindahtanganNew(FrmKoorKL, this);
        ...
        private void setVisibleKolom1(bool set)
        {
            if (set)
            {
                emptySpaceItem1.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Always;
                this.lciNamaKolom1.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Always;
                this.layoutkeyword.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Always;
            ...
            else
            {
                ...
                this.lciNamaKolom1.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never;
                this.layoutkeyword.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never;
        ...
        private void ucMtrWasdal_Load(object sender, EventArgs e)
        {
            ...
            if ((namaModul == "Penggunaan BMN Monitoring") || (namaModul == "Pemanfaatan BMN Monitoring") || (namaModul == "Pemindahtanganan BMN Monitoring"))
                setVisibleKolom1(false);
            else
                setVisibleKolom1(true);
            setVisibleKolom2(false);
            setVisibleKolomNup(false);
