...
namespace AppPengguna.KKL.TL.PSPBMN
{
    public partial class ucRTLPspBmnForm : UserControl
    {
        ...
        KKL.TL.PU.frmPuAset formDaftarAsetSatker;
        KKL.TL.PU.frmPuAset formDaftarAsetKorwil;
        KKL.TL.PU.frmPuAset formDaftarAsetEselon1;
        KKL.TL.PU.frmPuAset formDaftarAsetKl;
        ...
        private void sbTambah_Click(object sender, EventArgs e)
        {
            ...
            //    {
            //        formDaftarAsetSatker = new KKL.TL.PU.frmPuAset()
            //        {
            //            toggleProgressBar = new ToggleProgressBar(toggleProgBarPu),
            ...
            //    {
            //        formDaftarAsetKorwil = new KKL.TL.PU.frmPuAset()
            //        {
            //            toggleProgressBar = new ToggleProgressBar(toggleProgBarPu),
            //            simpanAsetTerpilih = new SimpanDaftarAsetTerpilih(simpanDaftarAset)
            //        };
            ...
            //    {
            //        formDaftarAsetEselon1 = new KKL.TL.PU.frmPuAset()
            //        {
            //            toggleProgressBar = new ToggleProgressBar(toggleProgBarPu),
            //            simpanAsetTerpilih = new SimpanDaftarAsetTerpilih(simpanDaftarAset)
            //        };
            ...
            //    {
            //        formDaftarAsetKl = new KKL.TL.PU.frmPuAset()
            //        {
            //            toggleProgressBar = new ToggleProgressBar(toggleProgBarPu),
            //            simpanAsetTerpilih = new SimpanDaftarAsetTerpilih(simpanDaftarAset)
            //        };
        ...
        KKL.TL.PU.frmPuPenetapan formPuPenetapan;
        KKL.TL.PSPBMN.frmTL formTL;
        ...
        private void formUbahPenetapan()
        {
            ...
            //    {
            //        formPuPenetapan = new KKL.TL.PU.frmPuPenetapan() { simpanDataPenetapan = new SimpanDaftarAsetTerpilih(simpanDaftarAset) };
            //    }
        ...
        private void gvDaftarAset_DoubleClick(object sender, EventArgs e)
        {
            ...
            formTL = new KKL.TL.PSPBMN.frmTL(this, dataAsetTerpilih.ID_ASET.ToString());
            ...
            if (rowTerpilih != null)
            {
                ...
                else
                {
                    ...
                    daftarIdAset = daftarIdAset.TrimEnd(';');
                        ...
                        formTL = new KKL.TL.PSPBMN.frmTL(this, daftarIdAset);
                        formTL.skKeputusan = dataAsetTerpilih.SK_KEPUTUSAN;
                        formTL.ShowDialog();
