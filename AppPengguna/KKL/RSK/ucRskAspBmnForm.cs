...
using AppPengguna.KKL.RSK;
using AppPengguna.KKL.RSK.PU;
using System.IO;
    ...
    public partial class ucRskAspBmnForm : UserControl
    {
        ...
        private void getDaftarAset()
        {
            try
            {
                ...
                parInput.P_SORT = "";
                parInput.STR_WHERE = String.Format(" SK_KEPUTUSAN = '{0}' AND ID_SATKER={1} ", teNomorSk.Text.Trim(),idSatker);
        ...
        private void simpanDaftarAset(string _daftarIdAset, char _modeCudAset)
        {
            try
            {
                ...
                parInp.P_SELECT = (modeCudAset=='V')?"U":Convert.ToString(modeCudAset);
        ...
        {
            AppPengguna.KKL.RSK.PU.frmPuCariAset frmcariaset = null;
            int jmlKolom = gvDaftarAset.Columns.Count;
            if (frmcariaset == null)
            {
                frmcariaset = new AppPengguna.KKL.RSK.PU.frmPuCariAset()
                {
