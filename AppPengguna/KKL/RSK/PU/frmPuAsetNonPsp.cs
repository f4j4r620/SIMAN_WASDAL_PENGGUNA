    ...
    public partial class frmPuAsetNonPsp : Form
    {
        ...
        public void getInitialData()
        {
            try
            {
                ...
                string kdSatkerParent = "";
                
                kdSatkerParent = (kodeSatker.Count() >= 15) ? kodeSatker.Substring(0, 15) : kodeSatker;

                parInp.STR_WHERE = String.Format(" {0} AND (KD_SATKER LIKE '{1}%' {2}) ", whereTb,  kdSatkerParent, strCari);
