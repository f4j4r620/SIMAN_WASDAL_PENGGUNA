...
namespace AppPengguna.KKL.PENERTIBAN
{
    public partial class ucPenertibanForm : UserControl
    {
        ...
        public String _noreg = null;
        KKL.PENERTIBAN.ucPenertibanGrid gridPenertiban;
        ...
        KKL.PENERTIBAN.PU.frmPuAset formDaftarAsetSatker;
        ...
        private void sbPilihAset_LinkClicked(object sender, EventArgs e)    //manggil Pop Up gimana?    //level satker aja
        {
            getPenertiban();
                ...
                {
                    formDaftarAsetSatker = new KKL.PENERTIBAN.PU.frmPuAset()  
                    {
                ...
                idAset = formDaftarAsetSatker.idAset;
                noreg = formDaftarAsetSatker.noReg;

        }

        private void getPenertiban()
        {
            //KKL.PENERTIBAN.PU.frmPuAset gcDaftarAset;
        ...
        public void inisialisasiForm()
        {
            ...
            if (statusForm != "C" && statusForm != "CU")
            {
                ...
                teUraianPenertiban.Text = dataTerpilih.UR_BENTUK_PENERTIBAN;
                ...
                noreg = dataTerpilih.NOREG;
                idAset = dataTerpilih.ID_ASET;
                konfigApp.kodebarang = dataTerpilih.KD_BRG;
                konfigApp.nup = dataTerpilih.NUP.ToString();
            }
            ...
            teKuasaPenggunaBarang.Properties.ReadOnly = false;
            ...
            switch (statusForm)
            {
                ...
                case "A":
                    ...
                    teKuasaPenggunaBarang.Properties.ReadOnly = true;
        ...
        {
            if (cbJenisPenertiban.Text != "" && teUraianPenertiban.Text != "" && teKuasaPenggunaBarang.Text != "" && teKeterangan.Text != "" && teKodeBarang.Text != "" && teUraianBarang.Text != "" && teNup.Text != "")
            {
        ...
        private void loadDataDaftarAset(SvcWasdalAsetSelect.OutputParameters outputDaftarAset)
        {
            ...
            if (jmlData > 1 || outputDaftarAset.SF_ROW_WASDAL_M_ASET[0].KD_BRG != "-")
            {
        ...
        private void simpanDaftarAset(string _daftarIdAset, char _modeCudAset)
        {
            try
            {
                ...
                parInp.P_KUASA_PENGGUNA_BRG = teKuasaPenggunaBarang.Text.Trim();
