...
namespace AppPengguna.KKL.MWD.PSPBMNLAIN.DETAIL1
{
    ...
    public partial class ucTindakLanjut : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucTindakLanjut(FrmKoorKL _frmKl, ucPSPBMNLAIN _ucPSPBMNLAIN)
        {
            InitializeComponent();
            this.frmKl = _frmKl;
        ...
        public void getTindakLanjut()
        {
            ...
            try
            {
                ...
                parInp.STR_WHERE = " (NO_SURAT <> '-') AND KD_KL = '" + konfigApp.kodeKl + "' " + PSPBMNLAIN.strKdPelayanan + this.strCari;
