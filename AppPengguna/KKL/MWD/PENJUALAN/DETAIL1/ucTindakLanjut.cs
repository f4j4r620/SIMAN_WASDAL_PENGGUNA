...
namespace AppPengguna.KKL.MWD.PENJUALAN.DETAIL1
{
    ...
    public partial class ucTindakLanjut : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucTindakLanjut(FrmKoorKL _frmKl, ucPENJUALAN _ucPENJUALAN)
        {
            InitializeComponent();
            this.frmKl = _frmKl;
        ...
        public void getTindakLanjut()
        {
            ...
            try
            {
                ...
                parInp.STR_WHERE = " (NO_SURAT <> '-') AND KD_KL = '" + konfigApp.kodeKl + "' " + PENJUALAN.strKdPelayanan + this.strCari;
