...
namespace AppPengguna.KSK.PENERTIBAN.PU
{
    public partial class frmPuAset : Form
    {
        ...
        SvcWasdalAsetSelect.WASDALSROW_WASDAL_M_ASET dataTerpilih;
        ...
        public string daftarKodeBarang = "";
        public string daftarNup = "";
        public string daftarUraianBarang = "";
        public string _urSatker = "";
        public decimal? _idAset = null;
        public string _noReg = "";
        ...
        public void getInitialData()
        {
            try
            {
                ...
                myThread.Start();
                SvcWasdalAsetSelect.InputParameters parInp = new SvcWasdalAsetSelect.InputParameters();
                parInp.P_COL = "";
                ...
                {
                    case "Y":
                        whereTb = " (KD_JNS_BMN = 1 OR KD_JNS_BMN = 2 OR KD_JNS_BMN = 3 OR KD_JNS_BMN = 8 OR KD_JNS_BMN=9 )  ";
                        break;
                    case "N":
                        whereTb = " (KD_JNS_BMN != 1 AND KD_JNS_BMN != 2 AND KD_JNS_BMN!=3 AND KD_JNS_BMN!=8 AND KD_JNS_BMN!=9)  ";
                        break;
                }
                parInp.STR_WHERE = String.Format(" KD_SATKER LIKE '{0}%' AND STATUS_BMN_YN='Y' {1}",  konfigApp.kodeSatker.Substring(0, 15),  strCari);
        ...
        private delegate void DsSimpanData(SvcWasdalAsetSelect.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalAsetSelect.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_ROW_WASDAL_M_ASET.Count();
            string thnPerlh;
            ...
            for (int i = 0; i < jmlData; i++)
            {
                ...
                dataOut.SF_ROW_WASDAL_M_ASET[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_ROW_WASDAL_M_ASET[i]);
            }
        ...
        public SvcWasdalAsetSelect.WASDALSROW_WASDAL_M_ASET daftarAsetTerpilih;
        
        ucPenertibanForm frmPenertiban = new ucPenertibanForm("");
        ...
        private void bbiSimpan_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (rowTerpilih != null)
            {
                ...
                else if (daftarTerpilih.Count > 1) MessageBox.Show(konfigApp.teksPilihanLebih, konfigApp.judulKonfirmasi);
                        else
                    {
                        
                            daftarAsetTerpilih = (SvcWasdalAsetSelect.WASDALSROW_WASDAL_M_ASET)daftarTerpilih[0];
                            
                        
                            konfigApp.kodebarang = daftarAsetTerpilih.KD_BRG;
                            konfigApp.nup = daftarAsetTerpilih.NO_ASET.ToString();
                            konfigApp.uraianbarang = daftarAsetTerpilih.UR_SSKEL;
                            this._urSatker = daftarAsetTerpilih.UR_SATKER;
                            this._idAset = daftarAsetTerpilih.ID_ASET;
                            this._noReg = daftarAsetTerpilih.NOREG;
                            this.Close();
                    }
            }
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalAsetSelect.WASDALSROW_WASDAL_M_ASET)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
