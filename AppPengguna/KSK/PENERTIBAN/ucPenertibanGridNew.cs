...
{
    public partial class ucPenertibanGridNew : UserControl
    {
        public SvcMonSatkerTertibA1.WASDALSROW_MON_PENERTIBAN_SATKER dataTerpilih;
        ...
        private void gvGridSk_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (viewTerpilih.SelectedRowsCount > 0)
                dataTerpilih = (SvcMonSatkerTertibA1.WASDALSROW_MON_PENERTIBAN_SATKER)viewTerpilih.GetRow(e.FocusedRowHandle);
        }
