...
namespace AppPengguna.KSK.PENERTIBAN
{
    public partial class ucPenertibanForm : UserControl
    {
        ...
        KSK.PENERTIBAN.PU.frmPuAset formDaftarAsetSatker;
        ...
        {
            //KSK.PENERTIBAN.PU.frmPuAset gcDaftarAset;
            ...
            try
            {
                ...
                parInput.P_SORT = "";
                parInput.STR_WHERE = String.Format(" KD_SATKER LIKE '{0}%' AND IN_KD_PELAYANAN =  {1}", konfigApp.kodeSatker.Substring(0, 15), konfigApp.kdPelayanan);
        ...
        private void loadDataAset(SvcWasdalAsetSelect.OutputParameters outputAset)
        {
            ...
            if (jmlData >= 0)
            {
                ...
                cbBentukPenertiban.SelectedIndex = 0;
                ...
                if (dataTerpilih != null)
                {
                    ...
                    cbBentukPenertiban.Text = dataTerpilih.BENTUK_PENERTIBAN;
                    cbBentukPenertiban.EditValue = dataTerpilih.BENTUK_PENERTIBAN;
                }
                if (statusForm != "C")
                    getDaftarAset();
            }
        ...
        {
            cbBentukPenertiban.SelectedIndex = -1;
            ...
            teNup.Text = "";
            teDsrNoLap.Text = "";
            teNoSuratPenertiban.Text = "";
            teTglSrtPenertiban.Text = "";
            teThnAnggaran.Text = "";
            teUraianBarang.Text = "";
            deDsrTglLap.Text = "";
            cbBentukPenertiban.Text = "";
            cbUrBtkPenertiban.Text = "";
        ...
        public void inisialisasiForm()
        {
            ...
            if (statusForm != "C" && statusForm != "CU")
            {
                ...
                int thunAnggaran = 0;
                bool isNumber = int.TryParse(dataTerpilih.THN_ANG, out thunAnggaran);
                if(thunAnggaran != 0)
                {
                    teThnAnggaran.EditValue = new DateTime(thunAnggaran, DateTime.Now.Month, DateTime.Now.Day);
                }
                cbDsrPenertiban.Text = dataTerpilih.DASAR_PENERTIBAN;
                teDsrNoLap.Text = dataTerpilih.NO_LAPORAN;
                deDsrTglLap.EditValue = dataTerpilih.TGL_LAPORAN;
                cbBentukPenertiban.EditValue = dataTerpilih.BENTUK_PENERTIBAN;
                cbUrBtkPenertiban.Text = dataTerpilih.TINDAK_LANJUT_HSL;
                teNoSuratPenertiban.Text = dataTerpilih.NO_SURAT_PENERTIBAN;
                teTglSrtPenertiban.EditValue = dataTerpilih.TGL_SURAT_PENERTIBAN;
                teUraianPenertiban.Text = dataTerpilih.URAIAN_PENERTIBAN_LAIN;
            ...
            cbBentukPenertiban.Properties.ReadOnly = false;
            ...
            switch (statusForm)
            {
                case "C":
                    ...
                    KuasaPenggunaBarang = konfigApp.namaSatker;
                ...
                case "U":
                    ...
                    break;
                case "A":
                    cbBentukPenertiban.Properties.ReadOnly = true;
        ...
        {
            if (cbBentukPenertiban.SelectedIndex == 0)
            {
                cbBentukPenertiban.Text = "PENGGUNAAN";
                
            }
            else if (cbBentukPenertiban.SelectedIndex == 1)
            {
                cbBentukPenertiban.Text = "PEMANFAATAN";
            }
            else if (cbBentukPenertiban.SelectedIndex == 2)
            {
                cbBentukPenertiban.Text = "PEMINDAHTANGAN";
            }
        ...
        private void getDaftarAset()
        {
            ...
            try
            {
                ...
                parInput.P_MINSpecified = true;
                parInput.P_SORT = "";
                parInput.STR_WHERE = String.Format(" ID_SATKER = {0} AND IN_KD_PELAYANAN IS NOT NULL", konfigApp.idSatker, konfigApp.kdPelayanan);
                //parInput.STR_WHERE = String.Format("ID_SATKER = {0}", konfigApp.idSatker, this.strCari);
                ambilDaftarAset = new SvcWasdalAsetSelect.call_pttClient();
                ambilDaftarAset.Open();
                ambilDaftarAset.Beginexecute(parInput, new AsyncCallback(goGetDaftarAset), null);
        ...
        private void simpanDaftarAset(string _daftarIdAset, char _modeCudAset)
        {
            try
            {
                ...
                parInp.P_BENTUK_PENERTIBAN = Convert.ToString(cbBentukPenertiban.EditValue);
        ...
        {
            if (cbBentukPenertiban.Text == "PENGGUNAAN")
            {
                //stsBntkPenertiban = "PENGGUNAAN";
                cbUrBtkPenertiban.Properties.Items.Clear();
                cbUrBtkPenertiban.Properties.Items.Add("Mengajukan Usul Penetapan Status Penggunaan Ke Pengelola Barang");
                cbUrBtkPenertiban.Properties.Items.Add("Menetapkan Status Penggunaan Sesuai Batas Kewenangan Pengguna Barang");
                cbUrBtkPenertiban.Properties.Items.Add("Menyerahkan BMN Yang Tidak Digunakan Kepada Pengelola Barang");
                cbUrBtkPenertiban.Properties.Items.Add("Penertiban Lainnya");
            }
            else if (cbBentukPenertiban.Text == "PEMANFAATAN")
            {
                //stsBntkPenertiban = "PEMANFAATAN";
                cbUrBtkPenertiban.Properties.Items.Clear();
                cbUrBtkPenertiban.Properties.Items.Add("Mengajukan Usulan Pemanfaatan Pada Pengelola Barang");
                cbUrBtkPenertiban.Properties.Items.Add("Penertiban Lainnya");
            }
            else
            {
                ...
                cbUrBtkPenertiban.Properties.Items.Clear();
                cbUrBtkPenertiban.Properties.Items.Add("Pembatalan Pelaksanaan Pemindahtanganan");
                cbUrBtkPenertiban.Properties.Items.Add("Penertiban Lainnya");
            }
