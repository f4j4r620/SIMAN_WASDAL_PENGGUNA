...
{
    public partial class ucRskAspBmnForm : UserControl
    {
        ...
        public ucRskAspBmnForm(string _status)
        {
            InitializeComponent();
            statusForm = _status;
        ...
        public void inisialisasiForm()
        {
            ...
            if (statusForm != "C" && statusForm != "CU")
            {
                ...
                //teNamaKl.Text = dataTerpilih.NM_PHK_LAIN;
            ...
            switch (statusForm)
            {
                ...
                case "U":
                    ...
                    teNamaKl.Properties.ReadOnly = false;
        ...
        //SvcWasdalLAINDetailCrud.OutputParameters dOutSimpanAset;
        //SvcWasdalLAINDetailCrud.call_pttClient simpanDftrAset;
                ...
                switch (modeCudAset)
                {
                    case 'C':
                        ...
                        for (int i = 0; i < daftarAsetSalinan.Count; i++)
                        {
                            ...
                            dataPenyama.KD_STATUS = "06";//daftarAsetTerpilih.KD_STATUS;
                            ...
                            dataPenyama.UR_STATUS = "Alih Status Penggunaan";//daftarAsetTerpilih.UR_STATUS;
                    ...
                    case 'U':
                        ...
                        dataPenyama.KD_STATUS = "06";//dataAsetTerpilih.KD_STATUS;
                        ...
                        dataPenyama.UR_STATUS = "Alih Status Penggunaan";//dataAsetTerpilih.UR_STATUS;
        ...
        #region UPLOAD FILE ==================================
        //SvcUploadFileRsk.execute_pttClient getFileWasdal;
        //SvcUploadFileRsk.OutputParameters outFileWasdal;
        ...
        private void getResultFileUploadRead(IAsyncResult result)
        {
            ...
            {
                nonAktifkanprogressBar();
                // this.Invoke(nkonew AktifkanForm(aktifkanForm));
                MessageBox.Show(konfigApp.teksGagalSimpanFileDok, konfigApp.judulGagalSimpan);
            }
        }
