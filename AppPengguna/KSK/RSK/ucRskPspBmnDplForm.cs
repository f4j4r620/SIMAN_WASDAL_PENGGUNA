...
{
    public partial class ucRskPspBmnDplForm : UserControl
    {
        public ToggleProgressBar toggleProgressBar;
        public SimpanDataRsk simpanDataRskPspBmnDpl;
        ...
        public ucRskPspBmnDplForm(string _status)
        {
            InitializeComponent();
            statusForm = _status;
        ...
        public void inisialisasiForm()
        {
            ...
            if (statusForm != "C" && statusForm != "CU")
            {
                ...
                teNamaPihakLain.Text = dataTerpilih.UR_PHK_LAIN;
        ...
        //    { period = "H"; }
        //    else if (cbPeriode.EditValue == "Mingguan")
        //    { period = "M"; }
        //    else if (cbPeriode.EditValue == "Bulanan")
        //    { period = "B"; }
        //    else if (cbPeriode.EditValue == "Tahunan")
        //    { period = "T"; }
        //    return period;
        //}
            ...
            if (rgJenisAset.SelectedIndex != -1 && teNomorSk.Text.Trim() != "" && teNamaPemohon.Text != "" && teTanggalSk.Text != "" && teNamaInstansi.Text.Trim() != "")
            {
                if (statusForm == "C" || statusForm == "U" || statusForm == "CU")
                {
                    try
                    {
                        ...
                        simpanDataRskPspBmnDpl(statusForm);
                    }
                    catch (Exception ex)
                    {
        ...
        private void sbTambah_Click(object sender, EventArgs e)
        {
            ...
            else if (teJenisPemohon.Text == konfigApp.levelKorwil)
            {
                if (formDaftarAsetKorwil == null)
                {
                    ...
                    formDaftarAsetKorwil.toggleProgressBar = new ToggleProgressBar(toggleProgBarPu);
                    formDaftarAsetKorwil.simpanAsetTerpilih = new SimpanDaftarAsetTerpilih(simpanDaftarAset);
                    formDaftarAsetKorwil.isTb = (dataTerpilih.IS_TB == "Tanah dan Bangunan" ? "Y" : "N");
                }
                ...
                formDaftarAsetKorwil.teSatker.Properties.Items.Insert(0, String.Format("[{0}] {1}", konfigApp.idSatker, konfigApp.namaSatker));
            ...
            else if (teJenisPemohon.Text == konfigApp.levelEselon1)
            {
                if (formDaftarAsetEselon1 == null)
                {
                    ...
                    formDaftarAsetEselon1.toggleProgressBar = new ToggleProgressBar(toggleProgBarPu);
                    formDaftarAsetEselon1.simpanAsetTerpilih = new SimpanDaftarAsetTerpilih(simpanDaftarAset);
                    formDaftarAsetEselon1.isTb = (dataTerpilih.IS_TB == "Tanah dan Bangunan" ? "Y" : "N");
                }
            ...
            else if (teJenisPemohon.Text == konfigApp.levelKl)
            {
                if (formDaftarAsetKl == null)
                {
                    ...
                    formDaftarAsetKl.toggleProgressBar = new ToggleProgressBar(toggleProgBarPu);
                    formDaftarAsetKl.simpanAsetTerpilih = new SimpanDaftarAsetTerpilih(simpanDaftarAset);
                    formDaftarAsetKl.isTb = (dataTerpilih.IS_TB == "Tanah dan Bangunan" ? "Y" : "N");
                }
        ...
        SvcWasdalPSPBMNLAINDetailCrud.OutputParameters dOutSimpanAset;
        SvcWasdalPSPBMNLAINDetailCrud.execute_pttClient simpanDftrAset;
        ...
        private void simpanDaftarAset(string _daftarIdAset, char _modeCudAset)
        {
            try
            {
                myThread = new Thread(new ThreadStart(aktifkanProgresBar));
                myThread.Start();
                SvcWasdalPSPBMNLAINDetailCrud.InputParameters parInp = new SvcWasdalPSPBMNLAINDetailCrud.InputParameters();
                ...
                //        break;
                //}
                parInp.P_KD_STATUS = "05";
                //parInp.P_KD_PELAYANAN = konfigApp.kdPelayanan;
                modeCudAset = (_modeCudAset=='V')?'V':_modeCudAset;
                parInp.P_SELECT = Convert.ToString(modeCudAset);
                simpanDftrAset = new SvcWasdalPSPBMNLAINDetailCrud.execute_pttClient();
                simpanDftrAset.Open();
        ...
        private delegate void DsDaftarAset(SvcWasdalPSPBMNLAINDetailCrud.OutputParameters dataOut);

        private void dsDaftarAset(SvcWasdalPSPBMNLAINDetailCrud.OutputParameters dataOut)
        {
                ...
                switch (modeCudAset)
                {
                    case 'C':
                        ...
                        for (int i = 0; i < daftarAsetSalinan.Count; i++)
                        {
                            ...
                            dataPenyama.KD_STATUS = "05";//daftarAsetTerpilih.KD_STATUS;
                            ...
                            dataPenyama.UR_STATUS = "Digunakan Oleh Pihak Sesuai Ketentuan";//daftarAsetTerpilih.UR_STATUS;
        ...
        private void getFotoAset(decimal? _idAset)
        {
            try
            {
                ...
                {
                    P_MINSpecified = true,
                    P_MIN = konfigApp.currentMin,
                    P_MAXSpecified = true,
                    P_MAX = konfigApp.currentMaks,
                    STR_WHERE = " ID_ASET = " + _idAset
                };
