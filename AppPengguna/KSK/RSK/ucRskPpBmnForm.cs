...
{
    public partial class ucRskPpBmnForm : UserControl
    {
        ...
        public ucRskPpBmnForm(string _status)
        {
            InitializeComponent();
            statusForm = _status;
        ...
        #region Inisialisasi
        private void resetFormRskPpBmn()
        {
        ...
        private void teNamaPenerbit_EditValueChanged(object sender, EventArgs e)
        {
        ...
        private void sbUpload_Click(object sender, EventArgs e)
        {
            if (idSkWasdal == null)
            {
                MessageBox.Show("Silahkan isi data terlebih dahulu", "Informasi", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
