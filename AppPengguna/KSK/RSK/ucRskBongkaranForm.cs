...
using AppPengguna.RSK.PU;

namespace AppPengguna.KSK.RSK
{
    public partial class ucRskBongkaranForm : UserControl
    {
        ...
        public SvcWasdalRSKBongkaranSkSelect.WASDALSROW_SK_BONGKARAN_GRID dataTerpilih;
        ...
        public ucRskBongkaranForm(string _status)
        {
            InitializeComponent();
            statusForm = _status;
        ...
        public void inisialisasiForm()
        {
            ...
            if (statusForm != "C" && statusForm != "CU")
            {
                ...
                idSkWasdal = Convert.ToDecimal(dataTerpilih.ID_SK_BNK);
                teNomorSk.Text = dataTerpilih.SK_KEPUTUSAN_BNK;
                noSkBaru = dataTerpilih.SK_KEPUTUSAN_BNK.Trim();
                DateTime tanggalSurat = Convert.ToDateTime(dataTerpilih.TGL_SK_BNK);
                teTanggalSk.EditValue = tanggalSurat;
                //teTahunAnggaran.Text = dataTerpilih.THN_ANG;
                teJenisPemohon.Text = dataTerpilih.TIPE_PEMOHON;
                idPemohon = Convert.ToDecimal(dataTerpilih.ID_PEMOHON);
                ...
                teNmPenerbitSk.Properties.SearchMode = DevExpress.XtraEditors.Controls.SearchMode.OnlyInPopup;
            ...
            switch (statusForm)
            {
                ...
                case "CU":
                    ...
                    break;
                case "U":
                    this.idSkWasdal = Convert.ToDecimal(dataTerpilih.ID_SK_BNK);
        ...
        private void sbSimpan_Click(object sender, EventArgs e)
        {
            if (rgJenisAset.SelectedIndex != -1 && teNomorSk.Text.Trim() != "" && teNamaPemohon.Text != "" && teTanggalSk.Text != "" && teNamaInstansi.Text.Trim() != "")
            {
                if (statusForm == "C" || statusForm == "U" || statusForm == "CU")
                {
                    try
                    {
                        if (statusForm == "C" && idSkWasdal == null)
                        {
                            idSkWasdal = konfigApp.getGlobalId("ID_SK_BNK");
        ...
        SvcWasdalRSKBongkaranDtlSelect.OutputParameters dOutDaftarAset;
        SvcWasdalRSKBongkaranDtlSelect.execute_pttClient ambilDaftarAset;
        SvcWasdalRSKBongkaranDtlSelect.WASDALSROW_BONGKARAN_GRID_DTL dataAsetTerpilih;
        ...
        private void getDaftarAset()
        {
            try
            {
                ...
                parInput.P_SORT = "";
                //parInput.STR_WHERE = String.Format(" SK_KEPUTUSAN = '{0}' AND ID_SK_WASDAL_PINDAHTANGAN={1}", teNomorSk.Text.Trim(), idSkWasdal);
                parInput.STR_WHERE = String.Format(" SK_KEPUTUSAN_BNK = '{0}'", teNomorSk.Text.Trim());
                ambilDaftarAset = new SvcWasdalRSKBongkaranDtlSelect.execute_pttClient();
        ...
        private delegate void LoadDataDaftarAset(SvcWasdalRSKBongkaranDtlSelect.OutputParameters outputDaftarAset);

        private void loadDataDaftarAset(SvcWasdalRSKBongkaranDtlSelect.OutputParameters outputDaftarAset)
        {
            int jmlData = outputDaftarAset.SF_SK_BONGKARAN_GRID_DTL.Count(); 
            decimal? nilaiPersetujuan = 0;
            decimal? jmlKuantitas = 0;
            dsGridDaftarAset = new ArrayList();
            if (jmlData >= 1 && outputDaftarAset.SF_SK_BONGKARAN_GRID_DTL[0].KD_BRG != "-")
            {
                for (int i = 0; i < jmlData; i++)
                {
                    outputDaftarAset.SF_SK_BONGKARAN_GRID_DTL[i].IS_TB = (outputDaftarAset.SF_SK_BONGKARAN_GRID_DTL[i].IS_TB == "Y" ? konfigApp.namaTb : konfigApp.namaNonTb);
                    //outputDaftarAset.SF_ROW_WASDAL_PT_JUAL[i].DARI_TGL
                    dsGridDaftarAset.Add(outputDaftarAset.SF_SK_BONGKARAN_GRID_DTL[i]);
                    nilaiPersetujuan = nilaiPersetujuan + Convert.ToDecimal(outputDaftarAset.SF_SK_BONGKARAN_GRID_DTL[i].NILAI_PERSETUJUAN);
                    jmlKuantitas = jmlKuantitas + Convert.ToDecimal(outputDaftarAset.SF_SK_BONGKARAN_GRID_DTL[i].KUANTITAS);
                }
                gcDaftarAset.DataSource = null;
                gcDaftarAset.DataSource = dsGridDaftarAset;
            }
        ...
        frmPuAsetBongkaran formDaftarAsetSatker;
        frmPuAsetBongkaran formDaftarAsetKorwil;
        frmPuAsetBongkaran formDaftarAsetEselon1;
        frmPuAsetBongkaran formDaftarAsetKl;
        ...
        private void sbTambah_Click(object sender, EventArgs e)
        {
            if (teJenisPemohon.Text == konfigApp.levelSatker)
            {
                ...
                //{
                    formDaftarAsetSatker = new frmPuAsetBongkaran()
                    {
                        toggleProgressBar = new ToggleProgressBar(toggleProgBarPu),
            ...
            else if (teJenisPemohon.Text == konfigApp.levelKorwil)
            {
                ...
                {
                    formDaftarAsetKorwil = new frmPuAsetBongkaran()
                    {
                        toggleProgressBar = new ToggleProgressBar(toggleProgBarPu),
                        simpanAsetTerpilih = new SimpanDaftarAsetTerpilih(simpanDaftarAset),
                        isTb = (dataTerpilih.IS_TB == "Tanah dan Bangunan" ? "Y" : "N")
            ...
            else if (teJenisPemohon.Text == konfigApp.levelEselon1)
            {
                ...
                {
                    formDaftarAsetEselon1 = new frmPuAsetBongkaran()
                    {
                        toggleProgressBar = new ToggleProgressBar(toggleProgBarPu),
                        simpanAsetTerpilih = new SimpanDaftarAsetTerpilih(simpanDaftarAset),
                        isTb = (dataTerpilih.IS_TB == "Tanah dan Bangunan" ? "Y" : "N")
            ...
            else if (teJenisPemohon.Text == konfigApp.levelKl)
            {
                ...
                {
                    formDaftarAsetKl = new frmPuAsetBongkaran()
                    {
                        toggleProgressBar = new ToggleProgressBar(toggleProgBarPu),
                        simpanAsetTerpilih = new SimpanDaftarAsetTerpilih(simpanDaftarAset),
                        isTb = (dataTerpilih.IS_TB == "Tanah dan Bangunan" ? "Y" : "N")
        ...
        SvcWasdalRSKBongkaranDtlCrud2.OutputParameters dOutSimpanAset;
        SvcWasdalRSKBongkaranDtlCrud2.execute_pttClient simpanDftrAset;
        ...
        private void simpanDaftarAset(string _daftarIdAset, char _modeCudAset)
        {
            try
            {
                myThread = new Thread(new ThreadStart(aktifkanProgresBar));
                myThread.Start();
                SvcWasdalRSKBongkaranDtlCrud2.InputParameters parInp = new SvcWasdalRSKBongkaranDtlCrud2.InputParameters();
                parInp.P_SK_KEPUTUSAN_BNK = teNomorSk.Text.Trim();
                parInp.P_ID_ASET = _daftarIdAset;
                parInp.P_ID_SK_BNK = idSkWasdal;
                parInp.P_ID_SK_BNKSpecified = true;
                parInp.P_IS_VALID = (_modeCudAset == 'V') ? "Y" : "";
                parInp.P_TGL_SK_BNK = teTanggalSk.DateTime;
                parInp.P_TGL_SK_BNKSpecified = true;
                ...
                simpanDftrAset = new SvcWasdalRSKBongkaranDtlCrud2.execute_pttClient();
                simpanDftrAset.Open();
        ...
        private delegate void DsDaftarAset(SvcWasdalRSKBongkaranDtlCrud2.OutputParameters dataOut);

        private void dsDaftarAset(SvcWasdalRSKBongkaranDtlCrud2.OutputParameters dataOut)
        {
            if (dataOut.PO_RESULT == "Y")
            {
                ...
                switch (modeCudAset)
                {
                    case 'C':
                        ...
                        SvcWasdalRSKBongkaranDtlSelect.WASDALSROW_BONGKARAN_GRID_DTL dataPenyama;
                        ...
                        {
                            SvcWasdalAsetSelect2.WASDALSROW_WASDAL_M_ASET2 daftarAsetTerpilih = (SvcWasdalAsetSelect2.WASDALSROW_WASDAL_M_ASET2)daftarAsetSalinan[i];
                            dataPenyama = null;
                            dataPenyama = new SvcWasdalRSKBongkaranDtlSelect.WASDALSROW_BONGKARAN_GRID_DTL();
                            ...
                            dataPenyama.TGL_SK = teTanggalSk.DateTime;
                    ...
                    case 'D':
                        if (daftarTerpilih != null)
                        {
                            ...
                            {
                                SvcWasdalRSKBongkaranDtlSelect.WASDALSROW_BONGKARAN_GRID_DTL daftarAsetTerpilih = (SvcWasdalRSKBongkaranDtlSelect.WASDALSROW_BONGKARAN_GRID_DTL)daftarTerpilih[i];
                    ...
                    case 'U':
                        ...
                        nilaiPenetapanLama = Convert.ToDecimal(dataAsetTerpilih.NILAI_PERSETUJUAN);
                        jmlKuantitasLama = Convert.ToDecimal(dataAsetTerpilih.KUANTITAS);
        ...
        {
            SvcWasdalRSKBongkaranDtlSelect.WASDALSROW_BONGKARAN_GRID_DTL daftarAsetTerpilih;
            if (rowTerpilih != null)
            {
                ...
                else
                {
                    for (int i = 0; i < daftarTerpilih.Count; i++)
                    {
                        daftarAsetTerpilih = (SvcWasdalRSKBongkaranDtlSelect.WASDALSROW_BONGKARAN_GRID_DTL)daftarTerpilih[i];
        ...
        private void gvDaftarAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            {
                dataAsetTerpilih = (SvcWasdalRSKBongkaranDtlSelect.WASDALSROW_BONGKARAN_GRID_DTL)rowTerpilih.GetRow(e.FocusedRowHandle);
        ...
        private void peGambarAset_Click(object sender, EventArgs e)
        {
            if (dataAsetTerpilih != null)
            {
                ...
                {
                    this.getFotoAset(Convert.ToDecimal(dataAsetTerpilih.ID_ASET));
        ...
        private SvcFileRekamSkCruBnk.execute_pttClient fetchingFile;
        private SvcFileRekamSkCruBnk.OutputParameters dataOutFile;
        ...
        private void getInitFileUpload()
        {
            try
            {
                myThread = new Thread(new ThreadStart(aktifkanProgresBar));
                myThread.Start();
                SvcFileRekamSkCruBnk.InputParameters parInp = new SvcFileRekamSkCruBnk.InputParameters();

                if (_statusCrud == "Upload")
                {
                    parInp.P_SELECT = "CE";

                    parInp.P_ID_SK_BNK = this.idSkWasdal.ToString();
                ...
                fetchingFile = new SvcFileRekamSkCruBnk.execute_pttClient();
        ...
        private delegate void dsFileUploadRead(SvcFileRekamSkCruBnk.OutputParameters dataout);

        private void dsfileUploadRead(SvcFileRekamSkCruBnk.OutputParameters dataout)
        {
            if (dataout.PO_RESULT == "Y")
            {
                if (_statusCrud == "Upload")
        ...
        SvcFileRekamSkCruBnk.execute_pttClient getFileWasdal;
        SvcFileRekamSkCruBnk.OutputParameters outFileWasdal;
        ...
        private void sbView_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                getFileWasdal = new SvcFileRekamSkCruBnk.execute_pttClient();
        ...
        private delegate void DsFileWasdal(SvcFileRekamSkCruBnk.OutputParameters outFileWasdal);
        private void dsFileWasdal(SvcFileRekamSkCruBnk.OutputParameters outFileWasdal)
        {
        ...
        {
            AppPengguna.KSK.RSK.PU.frmPuCariAset frmcariaset = null;
            int jmlKolom = gvDaftarAset.Columns.Count;
            if (frmcariaset == null)
            {
                frmcariaset = new AppPengguna.KSK.RSK.PU.frmPuCariAset()
                {
        ...
        private void gvDaftarAset_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                AppPengguna.SvcWasdalRSKBongkaranDtlSelect.WASDALSROW_BONGKARAN_GRID_DTL daftarAsetTerpilih;
                daftarAsetTerpilih = (AppPengguna.SvcWasdalRSKBongkaranDtlSelect.WASDALSROW_BONGKARAN_GRID_DTL)view.GetRow(info.RowHandle);
        ...
        public void simpanNP(decimal? nilai)
        {
            try
            {
                ...
                parInp.P_ID_SK_BNK = idSkWasdal;
                parInp.P_ID_SK_BNKSpecified = true;
                parInp.P_TGL_SK_BNK = Convert.ToDateTime(teTanggalSk.Text);
                parInp.P_ID_ASET = idasetnp;
                parInp.P_NILAI_PERSETUJUAN = (Decimal)nilai;
