...
{
    public partial class ucRskBsgForm : UserControl
    {
        ...
        public ucRskBsgForm(string _status)
        {
            InitializeComponent();
            statusForm = _status;
        ...
        public void inisialisasiForm()
        {
            ...
            if (statusForm != "C" && statusForm != "CU")
            {
                ...
                {
                    case "H":
                        tePeriode.SelectedIndex = 0;
                        break;
                    case "M":
                        tePeriode.SelectedIndex = 1;
                        break;
                    case "B":
                        tePeriode.SelectedIndex = 2;
                        break;
                    case "T":
                        tePeriode.SelectedIndex = 3;
                        break;
                }
            }
        ...
        #region Tombol Validasi Aset

        private void sbValidAset_Click(object sender, EventArgs e)
        {
