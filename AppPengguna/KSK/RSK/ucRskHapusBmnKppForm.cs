...
{
    public partial class ucRskHapusBmnKppForm : UserControl
    {
        public ToggleProgressBar toggleProgressBar;
        public SimpanDataRsk simpanDataRskPspBmn;
        //public DelegateDuaParameter delegateDuaParameter;
        ...
        public SvcWasdalHapusSkSelect.WASDALSROW_READ_WASDAL_HAPUS dataTerpilih;
        ...
        public ucRskHapusBmnKppForm(string _status)
        {
            InitializeComponent();
            statusForm = _status;
        ...
        public void inisialisasiForm()
        {
            ...
            if (statusForm != "C" && statusForm != "CU")
            {
                ...
                teAlasan.Text = dataTerpilih.ALASAN;
                teNamaPengadilan.Text = dataTerpilih.NAMA_PENGADILAN;
            ...
            switch (statusForm)
            {
                ...
                case "U":
                    ...
                    teNmPenerbitSkDetail.Properties.ReadOnly = true;
                    sbCariPemohon.Enabled = false;
                ...
                case "A":
                    ...
                    teNamaPengadilan.Properties.ReadOnly = true;
                    break;
            }
        ...
        private void lePenerbitSk_EditValueChanged(object sender, EventArgs e)
        {
            ...
            if (rgJenisAset.SelectedIndex != -1 && teNomorSk.Text.Trim() != "" && teNamaPemohon.Text != "" && teTanggalSk.Text != "" && lePenerbitSk.Text.Trim() != "")
            {
                if (statusForm == "C" || statusForm == "U" || statusForm == "CU")
                {
                    try
                    {
                        if (statusForm == "C")
                        {
                            idSkWasdal = konfigApp.getGlobalId("ID_SK_WASDAL_HAPUS");
                        }
        ...
        SvcWasdalHapusSelect.OutputParameters dOutDaftarAset;
        SvcWasdalHapusSelect.execute_pttClient ambilDaftarAset;
        SvcWasdalHapusSelect.WASDALSROW_WASDAL_HAPUS dataAsetTerpilih;
        ...
        private void getDaftarAset()
        {
            try
            {
                ...
                myThread.Start();
                svcInstansi = new SvcInstansiSelect.dsSelect_pttClient();
                SvcWasdalHapusSelect.InputParameters parInput = new SvcWasdalHapusSelect.InputParameters();
                parInput.P_COL = "";
                parInput.P_COUNT = "N";
                parInput.P_MAX = 0;
                ...
                parInput.P_SORT = "";
                parInput.STR_WHERE = String.Format(" (SK_KEPUTUSAN = '{0}' AND ID_SK_WASDAL_HAPUS={1}) ", teNomorSk.Text.Trim(), idSkWasdal);
                ambilDaftarAset = new SvcWasdalHapusSelect.execute_pttClient();
        ...
        private delegate void LoadDataDaftarAset(SvcWasdalHapusSelect.OutputParameters outputDaftarAset);

        private void loadDataDaftarAset(SvcWasdalHapusSelect.OutputParameters outputDaftarAset)
        {
            int jmlData = outputDaftarAset.SF_ROW_WASDAL_HAPUS.Count();
            decimal? nilaiPersetujuan = 0;
            decimal? jmlKuantitas = 0;
            dsGridDaftarAset = new ArrayList();
            if (jmlData >= 1 && outputDaftarAset.SF_ROW_WASDAL_HAPUS[0].KD_BRG != "-")
            {
                for (int i = 0; i < jmlData; i++)
                {
                    outputDaftarAset.SF_ROW_WASDAL_HAPUS[i].IS_TB = (outputDaftarAset.SF_ROW_WASDAL_HAPUS[i].IS_TB == "Y" ? konfigApp.namaTb : konfigApp.namaNonTb);
                    outputDaftarAset.SF_ROW_WASDAL_HAPUS[i].NUMSpecified = false;
                    dsGridDaftarAset.Add(outputDaftarAset.SF_ROW_WASDAL_HAPUS[i]);
                    nilaiPersetujuan = nilaiPersetujuan + outputDaftarAset.SF_ROW_WASDAL_HAPUS[i].NILAI_PERSETUJUAN;
                    jmlKuantitas = jmlKuantitas + outputDaftarAset.SF_ROW_WASDAL_HAPUS[i].KUANTITAS;
                }
                gcDaftarAset.DataSource = null;
                gcDaftarAset.DataSource = dsGridDaftarAset;
            }
        ...
        SvcWasdalHapusDetilCud.OutputParameters dOutSimpanAset;
        SvcWasdalHapusDetilCud.execute_pttClient simpanDftrAset;
            ...
            try
            {
                ...
                switch (_modeCudAset)
                {
                    case 'U':
                        ...
                        parInp.P_NILAI_PENETAPAN = Convert.ToDecimal(formPuPenetapan.teNilaiPersetujuan.Text);
                        if (dataAsetTerpilih != null)
                        {
                            //parInp.P_FILE_BUKTI = dataAsetTerpilih.FILE_BUKTI;
                            parInp.P_JNS_BUKTI_LAKSANA = dataAsetTerpilih.JNS_BUKTI_LAKSANA;
                            parInp.P_KET = dataAsetTerpilih.KET;
                            parInp.P_NO_BUKTI_LAKSANA = dataAsetTerpilih.NO_BUKTI_LAKSANA;
                            //parInp.P_TGL_BUKTI_LAKSANA = dataAsetTerpilih.TGL_BUKTI_LAKSANA;
                        }
                        break;
                    case 'C':
                        //parInp.P_FILE_BUKTI = "";
                    ...
                    case 'D':
                        ...
                        parInp.P_NILAI_PENETAPAN = 0;
                        break;
                }
                parInp.P_KD_PELAYANAN = konfigApp.kdPelayanan;
                modeCudAset = _modeCudAset;
                parInp.P_SELECT = Convert.ToString(modeCudAset);
                simpanDftrAset = new SvcWasdalHapusDetilCud.execute_pttClient();
                simpanDftrAset.Open();
        ...
        private delegate void DsDaftarAset(SvcWasdalHapusDetilCud.OutputParameters dataOut);

        private void dsDaftarAset(SvcWasdalHapusDetilCud.OutputParameters dataOut)
        {
            ...
            if (dataOut.PO_RESULT == "Y")
            {
                ...
                switch (modeCudAset)
                {
                    case 'C':
                        ...
                        SvcWasdalHapusSelect.WASDALSROW_WASDAL_HAPUS dataPenyama;
                        ...
                        for (int i = 0; i < daftarAsetSalinan.Count; i++)
                        {
                            ...
                            dataPenyama = null;
                            dataPenyama = new SvcWasdalHapusSelect.WASDALSROW_WASDAL_HAPUS();
                            ...
                            _krgNilTetap = _krgNilTetap + daftarAsetTerpilih.NILAI_SBLM_SUSUT;//NILAI_BUKU;
                    ...
                    case 'D':
                        if (daftarTerpilih != null)
                        {
                            ...
                            {
                                SvcWasdalHapusSelect.WASDALSROW_WASDAL_HAPUS daftarAsetTerpilih = (SvcWasdalHapusSelect.WASDALSROW_WASDAL_HAPUS)daftarTerpilih[i];
                ...
                gcDaftarAset.DataSource = dsGridDaftarAset;
                gcDaftarAset.RefreshDataSource();
                //delegateDuaParameter(teNilaiPenetapan.Text, teKuantitas.Text);
            }
        ...
        {
            SvcWasdalHapusSelect.WASDALSROW_WASDAL_HAPUS daftarAsetTerpilih;
            if (rowTerpilih != null)
            {
                ...
                else
                {
                    for (int i = 0; i < daftarTerpilih.Count; i++)
                    {
                        daftarAsetTerpilih = (SvcWasdalHapusSelect.WASDALSROW_WASDAL_HAPUS)daftarTerpilih[i];
        ...
        private void gvDaftarAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            {
                dataAsetTerpilih = (SvcWasdalHapusSelect.WASDALSROW_WASDAL_HAPUS)rowTerpilih.GetRow(e.FocusedRowHandle);
                if (dataAsetTerpilih.ID_ASET != null)
                {
        ...
        private void gvDaftarAset_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                SvcWasdalHapusSelect.WASDALSROW_WASDAL_HAPUS daftarAsetTerpilih;
                daftarAsetTerpilih = (SvcWasdalHapusSelect.WASDALSROW_WASDAL_HAPUS)view.GetRow(info.RowHandle);
        ...
        public void simpanNP(decimal? nilai)
        {
            try
            {
                ...
                parInp.P_NILAI_PENETAPAN = nilai;
                parInp.P_NILAI_PENETAPANSpecified = true;
                modeCudAset = 'U';
        ...
        private void sbExport_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (ext[1] == "xls")
                    gvDaftarAset.ExportToXls(pathToSave);
                else if (ext[1] == "xlsx")
                    gvDaftarAset.ExportToXlsx(pathToSave);
