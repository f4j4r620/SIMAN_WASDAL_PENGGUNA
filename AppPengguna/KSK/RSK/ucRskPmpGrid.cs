...
{
    public partial class ucRskPmpGrid : UserControl
    {
        public AppPengguna.SvcWasdalPmpSkSelect.WASDALSROW_READ_WASDAL_PT_MODAL dataTerpilih;
        ...
        private void gvGridSk_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (viewTerpilih.SelectedRowsCount > 0)
                dataTerpilih = (AppPengguna.SvcWasdalPmpSkSelect.WASDALSROW_READ_WASDAL_PT_MODAL)viewTerpilih.GetRow(e.FocusedRowHandle);
        }
