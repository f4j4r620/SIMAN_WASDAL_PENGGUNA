...
namespace AppPengguna.KSK.RSK
{
    public partial class ucRskPspBmnForm : UserControl
    {
        ...
        {
            if (rgJenisAset.SelectedIndex != -1 &&
                teNomorSk.Text.Trim() != "" && 
                teNamaPemohon.Text != "" && 
                teTanggalSk.Text != "" && 
                teNmPenerbitSk.Text.Trim() != "")
            {
        ...
        //SvcWasdalPSPBMNDetailCrud2.processResponse dOutSimpanAset;
        //SvcWasdalPSPBMNDetailCrud2.BPELdtlCudClient simpanDftrAset;
        ...
        private void simpanDaftarAset(string _daftarIdAset, char _modeCudAset)
        {
            try
            {
                ...
                //SvcWasdalPSPBMNDetailCrud2.process parInp = new SvcWasdalPSPBMNDetailCrud2.process();
                ...
                parInp.P_IS_VALID = (_modeCudAset == 'V') ? "Y" : "N";
                ...
                //simpanDftrAset = new SvcWasdalPSPBMNDetailCrud2.BPELdtlCudClient();
                simpanDftrAset.Open();
        ...
        private void dsDaftarAset(SvcWasdalPSPBMNDetailCrud.OutputParameters dataOut)
        {
            if (dataOut.PO_RESULT == "Y")
            {
                ...
                switch (modeCudAset)
                {
                    case 'C':
                        ...
                        {
                            SvcAsetSelect2.WASDALSROW_ASET_SELECT daftarAsetTerpilih = (SvcAsetSelect2.WASDALSROW_ASET_SELECT)daftarAsetSalinan[i];
                            dataPenyama = null;
            ...
            else MessageBox.Show(dataOut.PO_RESULT, konfigApp.judulGagal);
        }
        #endregion
        ...
        private void getInitFileUpload()
        {
            ...
            try
            {
                ...
                file = konfigApp.FileToByteArray(teFileSk.Text);
        ...
        private void gvDaftarAset_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                SvcWasdalPSPBMNSelect.WASDALSROW_WASDAL_PSP daftarAsetTerpilih;
                daftarAsetTerpilih = (SvcWasdalPSPBMNSelect.WASDALSROW_WASDAL_PSP)view.GetRow(info.RowHandle);
