...
using AppPengguna.KSK.TL.PU;

namespace AppPengguna.RSK.PU
{
    public partial class frmPuAsetBongkaran : Form
    {
        public ToggleProgressBar toggleProgressBar;
        public SimpanDaftarAsetTerpilih simpanAsetTerpilih = null;
        SvcWasdalAsetSelect2.OutputParameters dOutDaftarAset;
        SvcWasdalAsetSelect2.execute_pttClient ambilDaftarAset;
        SvcWasdalAsetSelect2.WASDALSROW_WASDAL_M_ASET2 dataTerpilih;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                myThread.Start();
                SvcWasdalAsetSelect2.InputParameters parInp = new SvcWasdalAsetSelect2.InputParameters();
                parInp.P_COL = "";
                ...
                string strStatusBmnYn = " AND STATUS_BMN_YN='Y' ";
                  
                string kdSatkerParent = kodeSatker.Substring(0, 15);
                string tambahan = (konfigApp.kodeSatker.Contains("DK") || konfigApp.kodeSatker.Contains("TP")) ? "AND NO_PSP IS NULL " : " ";
                parInp.STR_WHERE = String.Format("{0} "+tambahan+"AND (KD_SATKER LIKE '{1}%' {2}) ", whereTb, kdSatkerParent, strCari);
                ambilDaftarAset = new SvcWasdalAsetSelect2.execute_pttClient();
        ...
        private delegate void DsSimpanData(SvcWasdalAsetSelect2.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalAsetSelect2.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_ROW_WASDAL_M_ASET2.Count();
            ...
            {
                dataOut.SF_ROW_WASDAL_M_ASET2[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_ROW_WASDAL_M_ASET2[i]);
            }
        ...
        public SvcWasdalAsetSelect2.WASDALSROW_WASDAL_M_ASET2 daftarAsetTerpilih;
        ...
        private void bbiSimpan_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (rowTerpilih != null)
            {
                ...
                else
                {
                    ...
                    {
                        daftarAsetTerpilih = (SvcWasdalAsetSelect2.WASDALSROW_WASDAL_M_ASET2)daftarTerpilih[i];
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalAsetSelect2.WASDALSROW_WASDAL_M_ASET2)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
