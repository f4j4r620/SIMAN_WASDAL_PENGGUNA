...
namespace AppPengguna.RSK.PU
{
    public partial class frmPuAsetNonPsp : Form
    {
        ...
        public void getInitialData()
        {
            try
            {
              ...
              //  parInp.P_COL = "";
                ...
                parInp.STR_WHERE = String.Format("{0} "+tambahan+"AND (KD_SATKER_parent LIKE '{1}%' {2}) ", whereTb, kdSatkerParent, strCari);
        ...
        private void dsSimpanData(SvcAsetSelect2.OutputParameters dataOut)
        {
            ...
            //string totalData = (jmlData == 0) ? jmlData.ToString() : dataOut.SF_ROW_ASET_SELECT[jmlData - 1]..ToString();
