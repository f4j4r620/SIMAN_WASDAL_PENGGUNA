...
{
    public partial class ucRskTmBmnForm : UserControl
    {
        ...
        public SvcWasdalTmSkSelect.WASDALSROW_READ_WASDAL_PT_TUKAR dataTerpilih;
        ...
        public ucRskTmBmnForm(string _status)
        {
            InitializeComponent();
            statusForm = _status;
        ...
        private void resetFormRskPspBmn()
        {
            ...
            teJnsAsetPengganti.Text = "";
            teKuantitasAsetPengganti.Text = null;
            teLuasAsetPengganti.Text = null;
            teAlamatAsetPengganti.Text = "";
            teFileSk.Text = "";
        ...
        public void inisialisasiForm()
        {
            ...
            if (statusForm != "C" && statusForm != "CU")
            {
                ...
                //cbPeriode.SelectedText = "";
                teJnsAsetPengganti.Text = dataTerpilih.JNS_ASET_PENGGANTI;
                teKuantitasAsetPengganti.Text = null;
                teLuasAsetPengganti.Text = null;
                teFileSk.Text = dataTerpilih.NM_FILE;
                teAlamatAsetPengganti.Text = dataTerpilih.ALAMAT_ASET_PENGGANTI;
            }
            ...
            teJnsAsetPengganti.Properties.ReadOnly = false;
            teKuantitasAsetPengganti.Properties.ReadOnly = false;
            teLuasAsetPengganti.Properties.ReadOnly = false;
            teAlamatAsetPengganti.Properties.ReadOnly = false;
            if (statusForm == "A")
            {
            ...
            {
                case "C":
                    //idSkWasdal = konfigApp.getGlobalId("ID_SK_WASDAL_PINDAHTANGAN");
                    idSkWasdal = null;
                    break;
                case "CU":
                    teTahunAnggaran.Text = konfigApp.tahunAnggaran.ToString();
                ...
                case "A":
                    ...
                    teJnsAsetPengganti.Properties.ReadOnly = true;
                    teKuantitasAsetPengganti.Properties.ReadOnly = true;
                    teLuasAsetPengganti.Properties.ReadOnly = true;
                    teAlamatAsetPengganti.Properties.ReadOnly = true;
                    break;
            }
            switch (konfigApp.levelUser)
            {
                ...
                case "DITPKNSI":
                    ...
                    xtpIdentitas.Text = "DIT PKNSI: DIREKTORAT PKNSI";
                    kodePenerbitSkDetail = konfigApp.kodeDitPknsi;
                    namaPenerbitSkDetail = konfigApp.namaDitPknsi;
                    break;
                case "KPDJKN":
                    teJenisPemohon.Properties.Items.Clear();
                    teJenisPemohon.Properties.Items.Insert(0, konfigApp.levelSatker);
        ...
        SvcWasdalTmSelect.OutputParameters dOutDaftarAset;
        SvcWasdalTmSelect.execute_pttClient ambilDaftarAset;
        SvcWasdalTmSelect.WASDALSROW_WASDAL_PT_TUKAR dataAsetTerpilih;
        ...
        private void getDaftarAset()
        {
            try
            {
                ...
                ambilDaftarAset = new SvcWasdalTmSelect.execute_pttClient();
        ...
        private delegate void LoadDataDaftarAset(SvcWasdalTmSelect.OutputParameters outputDaftarAset);

        private void loadDataDaftarAset(SvcWasdalTmSelect.OutputParameters outputDaftarAset)
        {
            int jmlData = outputDaftarAset.SF_ROW_WASDAL_PT_TUKAR.Count();
            decimal? nilaiPersetujuan = 0;
            decimal? jmlKuantitas = 0;
            dsGridDaftarAset = new ArrayList();
            if (jmlData >= 1 && outputDaftarAset.SF_ROW_WASDAL_PT_TUKAR[0].KD_BRG != "-")
            {
                for (int i = 0; i < jmlData; i++)
                {
                    outputDaftarAset.SF_ROW_WASDAL_PT_TUKAR[i].IS_TB = (outputDaftarAset.SF_ROW_WASDAL_PT_TUKAR[i].IS_TB == "Y" ? konfigApp.namaTb : konfigApp.namaNonTb);
                    outputDaftarAset.SF_ROW_WASDAL_PT_TUKAR[i].NUMSpecified = false;
                    dsGridDaftarAset.Add(outputDaftarAset.SF_ROW_WASDAL_PT_TUKAR[i]);
                    nilaiPersetujuan = nilaiPersetujuan + outputDaftarAset.SF_ROW_WASDAL_PT_TUKAR[i].NILAI_PERSETUJUAN;
                    jmlKuantitas = jmlKuantitas + outputDaftarAset.SF_ROW_WASDAL_PT_TUKAR[i].KUANTITAS;
                }
                gcDaftarAset.DataSource = null;
                gcDaftarAset.DataSource = dsGridDaftarAset;
            }
        ...
        SvcWasdalTmDetailCrud.OutputParameters dOutSimpanAset;
        SvcWasdalTmDetailCrud.execute_pttClient simpanDftrAset;
        ...
        private void simpanDaftarAset(string _daftarIdAset, char _modeCudAset)
        {
            try
            {
                myThread = new Thread(new ThreadStart(aktifkanProgresBar));
                myThread.Start();
                SvcWasdalTmDetailCrud.InputParameters parInp = new SvcWasdalTmDetailCrud.InputParameters();
                ...
                parInp.P_ID_SK_WASDAL_PINDAHTANGAN = idSkWasdal;
               ...
               // parInp.P_JANGKA_WAKTU = (teJangkaWaktu.Text == "" ? 0 : Convert.ToDecimal(teJangkaWaktu.Text));
                ...
                //parInp.P_PERIODE = konversiPeriode();
                ...
                simpanDftrAset = new SvcWasdalTmDetailCrud.execute_pttClient();
                simpanDftrAset.Open();
        ...
        private delegate void DsDaftarAset(SvcWasdalTmDetailCrud.OutputParameters dataOut);

        private void dsDaftarAset(SvcWasdalTmDetailCrud.OutputParameters dataOut)
        {
            if (dataOut.PO_RESULT == "Y")
            {
                ...
                switch (modeCudAset)
                {
                    case 'C':
                        ...
                        SvcWasdalTmSelect.WASDALSROW_WASDAL_PT_TUKAR dataPenyama;
                        ...
                        for (int i = 0; i < daftarAsetSalinan.Count; i++)
                        {
                            ...
                            dataPenyama = null;
                            dataPenyama = new SvcWasdalTmSelect.WASDALSROW_WASDAL_PT_TUKAR();
                    ...
                    case 'D':
                        if (daftarTerpilih != null)
                        {
                            ...
                            {
                                SvcWasdalTmSelect.WASDALSROW_WASDAL_PT_TUKAR daftarAsetTerpilih = (SvcWasdalTmSelect.WASDALSROW_WASDAL_PT_TUKAR)daftarTerpilih[i];
        ...
        {
            SvcWasdalTmSelect.WASDALSROW_WASDAL_PT_TUKAR daftarAsetTerpilih;
            if (rowTerpilih != null)
            {
                ...
                else
                {
                    for (int i = 0; i < daftarTerpilih.Count; i++)
                    {
                        daftarAsetTerpilih = (SvcWasdalTmSelect.WASDALSROW_WASDAL_PT_TUKAR)daftarTerpilih[i];
        ...
        private void gvDaftarAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            {
                dataAsetTerpilih = (SvcWasdalTmSelect.WASDALSROW_WASDAL_PT_TUKAR)rowTerpilih.GetRow(e.FocusedRowHandle);
        ...
        private void gvDaftarAset_DoubleClick(object sender, EventArgs e)
        {
            ...
            {
                SvcWasdalTmSelect.WASDALSROW_WASDAL_PT_TUKAR daftarAsetTerpilih;
                daftarAsetTerpilih = (SvcWasdalTmSelect.WASDALSROW_WASDAL_PT_TUKAR)view.GetRow(info.RowHandle);
