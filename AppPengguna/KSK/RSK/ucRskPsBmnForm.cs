...
namespace AppPengguna.KSK.RSK
{
    public partial class ucRskPsBmnForm : UserControl
    {
        ...
        #region Ambil Data KPKNL
       

        #endregion

        #region Ambil Data Kanwil
        #endregion
        ...
        private void sbUpload_Click(object sender, EventArgs e)
        {
            if (idSkWasdal == null)
            {
                MessageBox.Show("Silahkan simpan data telebih dahulu", "Informasi", MessageBoxButtons.OK, MessageBoxIcon.Information);
                return;
            }
