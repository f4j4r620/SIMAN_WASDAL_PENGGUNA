...
{
    public partial class ucRTLPpBmnForm : UserControl
    {
        public ToggleProgressBar toggleProgressBar;
        public SimpanDataRtl simpanDataRtlPpBmn;
        ...
        public ucRTLPpBmnForm(string _status)
        {
            InitializeComponent();
            statusForm = _status;
        ...
        #region Inisialisasi
        private void resetFormRtkPPBmn()
        {
        ...
        PPBMN.frmPuAset formDaftarAsetSatker;
        ...
        private void sbTambah_Click(object sender, EventArgs e)
        {
            if (teJenisPemohon.Text == konfigApp.levelSatker)
            {
                ...
                {
                    formDaftarAsetSatker = new PPBMN.frmPuAset()
                    {
                        toggleProgressBar = new ToggleProgressBar(toggleProgBarPu),
