...
namespace AppPengguna.KSK.TL.PSPBMNLAIN
{
    public partial class frmPuSk : Form
    {
        ...
        public PilihSkPengguna pilihSkPspLain = null;

        SvcWasdalPSPBMNLAINSkSelect.OutputParameters dOutDaftarSk;
        SvcWasdalPSPBMNLAINSkSelect.execute_pttClient ambilDaftarSk;
        SvcWasdalPSPBMNLAINSkSelect.WASDALSROW_READ_WASDAL_PSP_LAIN dataTerpilih;
        ...
        private void frmPuSk_Load(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                getInitialData();
                //teSatker.Text = konfigApp.namaSatker;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                ambilDaftarSk = new SvcWasdalPSPBMNLAINSkSelect.execute_pttClient();
                ambilDaftarSk.Open();
        ...
        private delegate void DsSimpanData(SvcWasdalPSPBMNLAINSkSelect.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalPSPBMNLAINSkSelect.OutputParameters dataOut)
        {
            ...
            {
                dataOut.SF_READ_WASDAL_PSP_LAIN[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_READ_WASDAL_PSP_LAIN[i]);
            }
        ...
        private void bbiSimpan_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                this.pilihSkPspLain(dataTerpilih);
                this.Close();
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalPSPBMNLAINSkSelect.WASDALSROW_READ_WASDAL_PSP_LAIN)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
