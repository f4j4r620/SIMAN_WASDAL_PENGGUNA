...
namespace AppPengguna.KSK.TL.PSPBMNLAIN
{
    public partial class frmPuAset : Form
    {
        ...
        SvcWasdalPSPBMNLAINSelect.WASDALSROW_WASDAL_PSP_LAIN dataTerpilih;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                myThread.Start();
                //SvcWasdalPSPBMNLAINSelect.InputParameters parInp = new SvcWasdalPSPBMNLAINSelect.InputParameters();
                SvcWasdalPSPBMNLAINSelect.InputParameters parInp = new SvcWasdalPSPBMNLAINSelect.InputParameters();
                parInp.P_COL = "";
        ...
        private delegate void DsSimpanData(SvcWasdalPSPBMNLAINSelect.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalPSPBMNLAINSelect.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_ROW_WASDAL_PSP_LAIN.Count();
            ...
            {
                dataOut.SF_ROW_WASDAL_PSP_LAIN[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_ROW_WASDAL_PSP_LAIN[i]);
            }
        ...
        public SvcWasdalPSPBMNLAINSelect.WASDALSROW_WASDAL_PSP_LAIN daftarAsetTerpilih;
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalPSPBMNLAINSelect.WASDALSROW_WASDAL_PSP_LAIN)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
