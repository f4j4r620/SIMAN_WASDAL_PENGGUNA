...
{
    public partial class ucRTLBONGKARANGrid : UserControl
    {
        ...
        private void gvGridSk_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (viewTerpilih.SelectedRowsCount > 0)
                dataTerpilih = (SvcTLBongkaranSelect.WASDALSROW_TL_BONGKARAN_GRID)viewTerpilih.GetRow(e.FocusedRowHandle);
