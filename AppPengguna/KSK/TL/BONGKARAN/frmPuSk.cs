...
namespace AppPengguna.KSK.TL.BONGKARAN  
{
    public partial class frmPuSk : Form
    {
        ...
        public PilihSkBOngkaran pilihSkBongkaran = null;

        SvcWasdalRSKBongkaranSkSelect.OutputParameters dOutDaftarSk;
        SvcWasdalRSKBongkaranSkSelect.execute_pttClient ambilDaftarSk;
        SvcWasdalRSKBongkaranSkSelect.WASDALSROW_SK_BONGKARAN_GRID dataTerpilih;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                ambilDaftarSk = new SvcWasdalRSKBongkaranSkSelect.execute_pttClient();
                ambilDaftarSk.Open();
        ...
        private delegate void DsSimpanData(SvcWasdalRSKBongkaranSkSelect.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalRSKBongkaranSkSelect.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_SK_BONGKARAN_GRID.Count();
            ...
            {
                dataOut.SF_SK_BONGKARAN_GRID[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_SK_BONGKARAN_GRID[i]);
            }
        ...
        private void bbiSimpan_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                this.pilihSkBongkaran(dataTerpilih);
                this.Close();
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalRSKBongkaranSkSelect.WASDALSROW_SK_BONGKARAN_GRID)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
