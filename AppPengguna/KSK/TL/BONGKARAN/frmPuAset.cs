...
namespace AppPengguna.KSK.TL.BONGKARAN  
{
    public partial class frmPuAset : Form
    {
        ...
        SvcWasdalRSKBongkaranDtlSelect.WASDALSROW_BONGKARAN_GRID_DTL dataTerpilih;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                SvcWasdalRSKBongkaranDtlSelect.InputParameters parInp = new SvcWasdalRSKBongkaranDtlSelect.InputParameters();
                parInp.P_COL = "";
                ...
                parInp.STR_WHERE = String.Format("IS_VALID = 'Y' AND (NO_BUKTI_LAKSANA IS NULL OR NO_BUKTI_LAKSANA!='{0}') AND ID_SATKER = {1} AND SK_KEPUTUSAN_BNK = '{2}' {3}", noBuktiLaksana, idSatker, skKeputusan, strCari);
        ...
        private delegate void DsSimpanData(SvcWasdalRSKBongkaranDtlSelect.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalRSKBongkaranDtlSelect.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_SK_BONGKARAN_GRID_DTL.Count();
            ...
            {
                dataOut.SF_SK_BONGKARAN_GRID_DTL[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_SK_BONGKARAN_GRID_DTL[i]);
            }
        ...
        public SvcWasdalRSKBongkaranDtlSelect.WASDALSROW_BONGKARAN_GRID_DTL daftarAsetTerpilih;
            ...
            if (rowTerpilih != null)
            {
                ...
                else
                {
                    for (int i = 0; i < daftarTerpilih.Count; i++)
                    {
                        ...
                        daftarIdAset = String.Format("{0}{1};", daftarIdAset, daftarAsetTerpilih.ID_ASET); //id asetnya ga ada 
                    }
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalRSKBongkaranDtlSelect.WASDALSROW_BONGKARAN_GRID_DTL)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
