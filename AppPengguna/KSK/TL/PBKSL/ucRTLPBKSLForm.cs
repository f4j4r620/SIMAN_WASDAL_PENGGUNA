...
{
    public partial class ucRTLPBKSLForm : UserControl
    {
        ...
        public string noBuktiLaksana = null;
        public decimal? idSkTL;
        public decimal? idSkWasdal;

        public ucRTLPBKSLForm(string _status)
        {
            InitializeComponent();
            statusForm = _status;
        ...
        frmPuAset formDaftarAsetSatker;
        frmPuAset formDaftarAsetKorwil;
        frmPuAset formDaftarAsetEselon1;
        frmPuAset formDaftarAsetKl;
        ...
        private void sbTambah_Click(object sender, EventArgs e)
        {
            if (teJenisPemohon.Text == konfigApp.levelSatker)
            {
                ...
                {
                    formDaftarAsetSatker = new frmPuAset()
                    {
                        toggleProgressBar = new ToggleProgressBar(toggleProgBarPu),
