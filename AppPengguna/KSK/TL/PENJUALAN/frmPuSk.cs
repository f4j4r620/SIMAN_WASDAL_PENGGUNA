...
namespace AppPengguna.KSK.TL.PENJUALAN  
{
    public partial class frmPuSk : Form
    {
        ...
        public PilihSkJual pilihSkJual = null;  

        SvcWasdalJualSkSelect.OutputParameters dOutDaftarSk;
        SvcWasdalJualSkSelect.execute_pttClient ambilDaftarSk;
        SvcWasdalJualSkSelect.WASDALSROW_READ_WASDAL_PT_JUAL dataTerpilih;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                ambilDaftarSk = new SvcWasdalJualSkSelect.execute_pttClient();
                ambilDaftarSk.Open();
        ...
        private delegate void DsSimpanData(SvcWasdalJualSkSelect.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalJualSkSelect.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_READ_WASDAL_PT_JUAL.Count();
            ...
            {
                dataOut.SF_READ_WASDAL_PT_JUAL[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_READ_WASDAL_PT_JUAL[i]);
            }
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalJualSkSelect.WASDALSROW_READ_WASDAL_PT_JUAL)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
