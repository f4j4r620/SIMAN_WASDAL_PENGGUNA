...
namespace AppPengguna.KSK.TL.PENJUALAN  
{
    public partial class frmPuAset : Form
    {
        ...
        SvcWasdalJualSelect.WASDALSROW_WASDAL_PT_JUAL dataTerpilih;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                SvcWasdalJualSelect.InputParameters parInp = new SvcWasdalJualSelect.InputParameters();
                parInp.P_COL = "";
                ...
                parInp.STR_WHERE = String.Format("IS_VALID = 'Y' AND (NO_BUKTI_LAKSANA IS NULL OR NO_BUKTI_LAKSANA!='{0}') AND ID_SATKER = {1} AND SK_KEPUTUSAN= '{2}' {3}", noBuktiLaksana, idSatker, skKeputusan, strCari);
        ...
        private delegate void DsSimpanData(SvcWasdalJualSelect.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalJualSelect.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_ROW_WASDAL_PT_JUAL.Count();
            ...
            {
                dataOut.SF_ROW_WASDAL_PT_JUAL[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_ROW_WASDAL_PT_JUAL[i]);
            }
        ...
        public SvcWasdalJualSelect.WASDALSROW_WASDAL_PT_JUAL daftarAsetTerpilih;
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalJualSelect.WASDALSROW_WASDAL_PT_JUAL)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
