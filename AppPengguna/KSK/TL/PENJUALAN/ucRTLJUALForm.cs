...
{
    public partial class ucRTLJUALForm : UserControl
    {
        public ToggleProgressBar toggleProgressBar;
        public SimpanDataRtl simpanDataRtlJUAL;   
        ...
        public ucRTLJUALForm(string _status)
        {
            InitializeComponent();
            statusForm = _status;
        ...
        PENJUALAN.frmPuAset formDaftarAsetSatker;
        ...
        private void sbTambah_Click(object sender, EventArgs e)
        {
            ...
            //{
                ...
                {
                    formDaftarAsetSatker = new PENJUALAN.frmPuAset() 
                    {
                        toggleProgressBar = new ToggleProgressBar(toggleProgBarPu),
            ...
            if (dataOut.PO_RESULT == "Y")
            {
                ...
                switch (modeCudAset)
                {
                    case 'C':
                        ...
                        {
                            SvcWasdalJualSelect.WASDALSROW_WASDAL_PT_JUAL daftarAsetTerpilih = (SvcWasdalJualSelect.WASDALSROW_WASDAL_PT_JUAL)daftarAsetSalinan[i];
                            dataPenyama = null;
