...
{
    public partial class ucRTLAspBmnForm1 : UserControl
    {
        public ToggleProgressBar toggleProgressBar;
        public SimpanDataRtl simpanDataRtlAspBmn;
        ...
        public ucRTLAspBmnForm1(string _status)
        {
            InitializeComponent();
            statusForm = _status;
        ...
        public void inisialisasiForm()
        {
            ...
            if (statusForm != "C" && statusForm != "CU")
            {
              ...
              //  teFileBukti.Text = dataTerpilih.K
            ...
            teNoBuktiLaksana.Properties.ReadOnly = false;
        ...
        {
            if (cbJnsDokLaksana.Text != "" && teNomorSk.Text.Trim() != "" && teNoBuktiLaksana.Text != "" && teKetBukti.Text != "" && filePath!=null && teFileBukti.Text.Trim() != "" )
            {
                if (statusForm == "C" || statusForm == "U" || statusForm == "CU")
                {
                    try
                    {
                        ...
                        simpanDataRtlAspBmn(statusForm);
                    }
                    catch (Exception ex)
                    {
        ...
        private void loadDataDaftarAset(SvcWasdalPspLainTdAsetSelect.OutputParameters outputDaftarAset)
        {
            ...
            if (jmlData >= 1 && outputDaftarAset.SF_ROW_WASDAL_PENGGUNAAN_TL2[0].KD_BRG != "-")
            {
                ...
                {
                    //dOutAsetSewa.SF_ROW_WASDAL_PENGGUNAAN_TL2[i].IS_TB = (dOutAsetSewa.SF_ROW_WASDAL_PENGGUNAAN_TL2[i].IS_TB == "Y" ? konfigApp.namaTb : konfigApp.namaNonTb);
        ...
        ASPBMN.frmPuAset formDaftarAsetSatker;
        ...
        private void sbTambah_Click(object sender, EventArgs e)
        {
            if (teJenisPemohon.Text == konfigApp.levelSatker)
            {
                ...
                {
                    formDaftarAsetSatker = new ASPBMN.frmPuAset()
                    {
                        toggleProgressBar = new ToggleProgressBar(toggleProgBarPu),
                ...
                switch (modeCudAset)
                {
                    case 'C':
                        ...
                        for (int i = 0; i < daftarAsetSalinan.Count; i++)
                        {
                            ...
                            dataPenyama.UR_SATKER = daftarAsetTerpilih.UR_SATKER;
        ...
        private void cbJnsDokLaksana_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (cbJnsDokLaksana.Text != "")
            {
                if (cbJnsDokLaksana.SelectedIndex == 1)
                {
                    lcgBAST.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Always;
                }
                else
                {
                    lcgBAST.Visibility = DevExpress.XtraLayout.Utils.LayoutVisibility.Never;
                }
            }
        }

        private void sbUploadBAST_Click(object sender, EventArgs e)
        {
            ...
            if (ofdDok.ShowDialog() == DialogResult.OK && ofdDok.FileName != "File PDF")
            {
                ...
                teFileBAST.Text = ofdDok.InitialDirectory + ofdDok.FileName;
        ...
        private void cbJnsDokLaksana_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            if (cbJnsDokLaksana.Text == "Keputusan Penghapusan KL") textReadonly = true;
