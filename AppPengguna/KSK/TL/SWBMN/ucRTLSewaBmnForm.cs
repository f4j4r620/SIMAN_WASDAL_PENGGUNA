...
{
    public partial class ucRTLSewaBmnForm : UserControl
    {
        public ToggleProgressBar toggleProgressBar;
        public SimpanDataRtl simpanDataRtlSwBmn;
        ...
        public ucRTLSewaBmnForm(string _status)
        {
            InitializeComponent();
            statusForm = _status;
