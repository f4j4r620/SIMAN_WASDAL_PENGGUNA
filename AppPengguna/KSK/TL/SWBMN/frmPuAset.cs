    ...
    public partial class frmPuAset : Form
    {
        ...
        public void getInitialData()
        {
            try
            {
                ...
                parInp.STR_WHERE = String.Format("IS_VALID = 'Y' AND (NO_BUKTI_LAKSANA IS NULL OR NO_BUKTI_LAKSANA!='{0}') AND KD_SATKER LIKE '{1}%' AND SK_KEPUTUSAN= '{2}' {3}", noBuktiLaksana, kodeSatker.Substring(0, 15), skKeputusan, strCari);
