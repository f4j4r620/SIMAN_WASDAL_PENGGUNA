...
{
    public partial class ucRTLPMPForm : UserControl
    {
        public ToggleProgressBar toggleProgressBar;
        public SimpanDataRtl simpanDataRtlPMP;    
        ...
        public SvcWasdalPmpSkSelect.WASDALSROW_READ_WASDAL_PT_MODAL skTerpilih;
        ...
        public ucRTLPMPForm(string _status)
        {
            InitializeComponent();
            statusForm = _status;
        ...
        PMP.frmPuAset formDaftarAsetSatker;
        ...
        private void sbTambah_Click(object sender, EventArgs e)
        {
            ...
            //{
                ...
                {
                    formDaftarAsetSatker = new PMP.frmPuAset() 
                    {
                        toggleProgressBar = new ToggleProgressBar(toggleProgBarPu),
            ...
            if (dataOut.PO_RESULT == "Y")
            {
                ...
                switch (modeCudAset)
                {
                    case 'C':
                        ...
                        {
                            SvcWasdalPTModalSelect.WASDALSROW_WASDAL_PT_MODAL daftarAsetTerpilih = (SvcWasdalPTModalSelect.WASDALSROW_WASDAL_PT_MODAL)daftarAsetSalinan[i];
                            dataPenyama = null;
