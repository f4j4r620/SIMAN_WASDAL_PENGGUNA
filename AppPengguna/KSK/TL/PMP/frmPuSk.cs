...
namespace AppPengguna.KSK.TL.PMP  
{
    public partial class frmPuSk : Form
    {
        ...
        public PilihSkPmp pilihSkPmp = null;

        SvcWasdalPmpSkSelect.OutputParameters dOutDaftarSk;
        SvcWasdalPmpSkSelect.execute_pttClient ambilDaftarSk;
        SvcWasdalPmpSkSelect.WASDALSROW_READ_WASDAL_PT_MODAL dataTerpilih;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                ambilDaftarSk = new SvcWasdalPmpSkSelect.execute_pttClient();
                ambilDaftarSk.Open();
        ...
        private delegate void DsSimpanData(SvcWasdalPmpSkSelect.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalPmpSkSelect.OutputParameters dataOut)
        {
            ...
            {
                dataOut.SF_READ_WASDAL_PT_MODAL[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_READ_WASDAL_PT_MODAL[i]);
            }
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalPmpSkSelect.WASDALSROW_READ_WASDAL_PT_MODAL)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
