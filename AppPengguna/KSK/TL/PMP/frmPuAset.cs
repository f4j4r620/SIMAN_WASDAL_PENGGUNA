...
namespace AppPengguna.KSK.TL.PMP    
{
    public partial class frmPuAset : Form
    {
        ...
        SvcWasdalPTModalSelect.OutputParameters dOutDaftarAset;
        SvcWasdalPTModalSelect.execute_pttClient ambilDaftarAset;
        SvcWasdalPTModalSelect.WASDALSROW_WASDAL_PT_MODAL dataTerpilih;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                myThread.Start();
                SvcWasdalPTModalSelect.InputParameters parInp = new SvcWasdalPTModalSelect.InputParameters();
                parInp.P_COL = "";
                ...
                ambilDaftarAset = new SvcWasdalPTModalSelect.execute_pttClient();
        ...
        private delegate void DsSimpanData(SvcWasdalPTModalSelect.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalPTModalSelect.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_ROW_WASDAL_PT_MODAL.Count();
            ...
            {
                dataOut.SF_ROW_WASDAL_PT_MODAL[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_ROW_WASDAL_PT_MODAL[i]);
            }
        ...
        public SvcWasdalPTModalSelect.WASDALSROW_WASDAL_PT_MODAL daftarAsetTerpilih;
        ...
        private void bbiSimpan_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (rowTerpilih != null)
            {
                ...
                else
                {
                    ...
                    {
                        daftarAsetTerpilih = (SvcWasdalPTModalSelect.WASDALSROW_WASDAL_PT_MODAL)daftarTerpilih[i];
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalPTModalSelect.WASDALSROW_WASDAL_PT_MODAL)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
