...
{
    public partial class ucRTLPBMNSForm : UserControl
    {
        public ToggleProgressBar toggleProgressBar;
        public SimpanDataRtl simpanDataRtlPbmns;
        ...
        public string noBuktiLaksana = "";
        public decimal? idSkTL = null;
        public decimal? idSkWasdal = null; 

        public ucRTLPBMNSForm(string _status)
        {
            InitializeComponent();
            statusForm = _status;
        ...
        private void setUnitKerja(decimal? _idUnitKerja, string _kodeUnitKerja, string _namaUnitKerja, string _kodeKl, string _namaKl)
        {
            ...
            txtAlamatPhkLain.Text = konfigApp.alamatkl;
        }
        ...
        PBMNS.frmPuAset formDaftarAsetSatker;
        ...
        private void sbTambah_Click(object sender, EventArgs e)
        {
            if (teJenisPemohon.Text == konfigApp.levelSatker)
            {
                ...
                {
                    formDaftarAsetSatker = new PBMNS.frmPuAset()
                    {
                        toggleProgressBar = new ToggleProgressBar(toggleProgBarPu),
        ...
        private void initDok(string select)
        {
            ...
            try
            {
                ...
                parInp.P_ID_SK_WASDALSpecified = true;
                parInp.P_ID_TL_WASDAL = idSkWasdal;
        ...
        private void cbJnsDokLaksana_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                if (cbJnsDokLaksana.SelectedIndex == 4)
                {
        ...
        private void cbJnsDokLaksana_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            if (cmb.SelectedText.ToString() == "BAST Pengembalian BMN") textReadonly = true;
