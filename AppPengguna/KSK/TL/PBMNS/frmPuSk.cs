...
namespace AppPengguna.KSK.TL.PBMNS
{
    public partial class frmPuSk : Form
    {
        ...
        public PilihSkPengguna pilihSkPbmns = null;
        ...
        private void bbiSimpan_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            ...
            {
                this.pilihSkPbmns(dataTerpilih);
                this.Close();
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) 
                dataTerpilih = (SvcWasdalPSPBMNLAINSkSelect.WASDALSROW_READ_WASDAL_PSP_LAIN)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
