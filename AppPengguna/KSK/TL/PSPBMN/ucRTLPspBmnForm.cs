...
namespace AppPengguna.KSK.TL.PSPBMN
{
    public partial class ucRTLPspBmnForm : UserControl
    {
        ...
        public void inisialisasiForm()
        {
            ...
            switch (statusForm)
            {
                ...
                case "A":
                    ...
                    btnUpTindakLanjut.Enabled = false;
        ...
        private void loadDataDaftarAset(SvcWasdalPSPBMNSelect.OutputParameters outputDaftarAset)
        {
            ...
            if (jmlData >= 1) //|| outputDaftarAset.SF_ROW_WASDAL_PSP[0].KD_BRG != "-")
            {
                for (int i = 0; i < jmlData; i++)
                {
                    ...
                    outputDaftarAset.SF_ROW_WASDAL_PSP[i].NILAI_PERSETUJUAN = (outputDaftarAset.SF_ROW_WASDAL_PSP[i].NILAI_PERSETUJUAN == 0 ? outputDaftarAset.SF_ROW_WASDAL_PSP[i].NILAI_PEROLEHAN : outputDaftarAset.SF_ROW_WASDAL_PSP[i].NILAI_PERSETUJUAN);
        ...
        private void gvDaftarAset_DoubleClick(object sender, EventArgs e)
        {
            ...
            formTL = new KSK.TL.PSPBMN.frmTL(this, dataAsetTerpilih.ID_ASET.ToString());
            formTL.skKeputusan = dataAsetTerpilih.SK_KEPUTUSAN;
            formTL.kdStatus = dataAsetTerpilih.KD_STATUS;
            formTL.NM_PHK_LAIN = dataAsetTerpilih.NM_PHK_LAIN;
            formTL.ShowDialog();
        }
            ...
            if (rowTerpilih != null)
            {
                ...
                else
                {
                    ...
                    daftarIdAset = daftarIdAset.TrimEnd(';');
                        ...
                        formTL = new KSK.TL.PSPBMN.frmTL(this, daftarIdAset);
                        formTL.skKeputusan = dataAsetTerpilih.SK_KEPUTUSAN;
                        formTL.ShowDialog();
