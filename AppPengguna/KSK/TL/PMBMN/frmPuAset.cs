...
namespace AppPengguna.KSK.TL.PMBMN  
{
    public partial class frmPuAset : Form
    {
        ...
        SvcWasdalHapusSelect.WASDALSROW_WASDAL_HAPUS dataTerpilih;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                myThread.Start();
                //SvcWasdalHapusSelect.InputParameters parInp = new SvcWasdalHapusSelect.InputParameters();
                SvcWasdalHapusSelect.InputParameters parInp = new SvcWasdalHapusSelect.InputParameters();
                parInp.P_COL = "";
                ...
                parInp.STR_WHERE = String.Format("(NO_BUKTI_LAKSANA IS NULL OR NO_BUKTI_LAKSANA!='{0}') AND ID_SATKER = {1} AND SK_KEPUTUSAN= '{2}' {3}", noBuktiLaksana, idSatker, skKeputusan, strCari);
        ...
        private delegate void DsSimpanData(SvcWasdalHapusSelect.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalHapusSelect.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_ROW_WASDAL_HAPUS.Count();
            ...
            {
                dataOut.SF_ROW_WASDAL_HAPUS[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_ROW_WASDAL_HAPUS[i]);
            }
        ...
        public SvcWasdalHapusSelect.WASDALSROW_WASDAL_HAPUS daftarAsetTerpilih;
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalHapusSelect.WASDALSROW_WASDAL_HAPUS)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
