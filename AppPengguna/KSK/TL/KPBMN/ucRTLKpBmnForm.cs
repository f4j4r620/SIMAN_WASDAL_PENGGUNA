...
{
    public partial class ucRTLKpBmnForm : UserControl
    {
        public ToggleProgressBar toggleProgressBar;
        public SimpanDataRtl simpanDataRtlKpBmn;
        ...
        public ucRTLKpBmnForm(string _status)
        {
            InitializeComponent();
            statusForm = _status;
        ...
        KPBMN.frmPuAset formDaftarAsetSatker;
        ...
        private void sbTambah_Click(object sender, EventArgs e)
        {
            if (teJenisPemohon.Text == konfigApp.levelSatker)
            {
                ...
                {
                    formDaftarAsetSatker = new KPBMN.frmPuAset()
                    {
                        toggleProgressBar = new ToggleProgressBar(toggleProgBarPu),
