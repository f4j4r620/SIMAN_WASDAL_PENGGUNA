...
{
    public partial class ucRTLBSGForm1 : UserControl
    {
        public ToggleProgressBar toggleProgressBar;
        public SimpanDataRtl simpanDataRtlBSG;
        ...
        public ucRTLBSGForm1(string _status)
        {
            InitializeComponent();
            statusForm = _status;
        ...
        private void initDok(string select)
        {
            ...
            try
            {
                ...
                if (uploadSelect.Equals("CE"))
                {
                    ...
                    parInp.P_NM_FILE = teNoBuktiLaksana.Text;
