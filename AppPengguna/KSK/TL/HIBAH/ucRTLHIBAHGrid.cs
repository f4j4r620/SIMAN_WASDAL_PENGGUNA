...
{
    public partial class ucRTLHIBAHGrid : UserControl
    {
        ...
        private void gvGridSk_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (viewTerpilih.SelectedRowsCount > 0)
                dataTerpilih = (SvcWasdalPindahtanganTdLanjutSelect.WASDALSROW_TL_SELECT_WASDAL_PT)viewTerpilih.GetRow(e.FocusedRowHandle);
