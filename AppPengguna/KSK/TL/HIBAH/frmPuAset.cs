...
namespace AppPengguna.KSK.TL.HIBAH   
{
    public partial class frmPuAset : Form
    {
        ...
        SvcWasdalPTHibahSelect.OutputParameters dOutDaftarAset;
        SvcWasdalPTHibahSelect.execute_pttClient ambilDaftarAset;
        SvcWasdalPTHibahSelect.WASDALSROW_WASDAL_PT_HIBAH dataTerpilih;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                myThread.Start();
                //SvcWasdalPTHibahSelect.InputParameters parInp = new SvcWasdalPTHibahSelect.InputParameters();
                SvcWasdalPTHibahSelect.InputParameters parInp = new SvcWasdalPTHibahSelect.InputParameters();
                parInp.P_COL = "";
                ...
                ambilDaftarAset = new SvcWasdalPTHibahSelect.execute_pttClient();
        ...
        private delegate void DsSimpanData(SvcWasdalPTHibahSelect.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalPTHibahSelect.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_ROW_WASDAL_PT_HIBAH.Count();
            ...
            {
                dataOut.SF_ROW_WASDAL_PT_HIBAH[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_ROW_WASDAL_PT_HIBAH[i]);
            }
        ...
        public SvcWasdalPTHibahSelect.WASDALSROW_WASDAL_PT_HIBAH daftarAsetTerpilih;
        ...
        private void bbiSimpan_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (rowTerpilih != null)
            {
                ...
                else
                {
                    ...
                    {
                        daftarAsetTerpilih = (SvcWasdalPTHibahSelect.WASDALSROW_WASDAL_PT_HIBAH)daftarTerpilih[i];
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalPTHibahSelect.WASDALSROW_WASDAL_PT_HIBAH)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
