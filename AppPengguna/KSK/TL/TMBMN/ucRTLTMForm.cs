...
{
    public partial class ucRTLTMForm : UserControl
    {
        public ToggleProgressBar toggleProgressBar;
        public SimpanDataRtl simpanDataRtlTm;
        ...
        public SvcWasdalTmSkSelect.WASDALSROW_READ_WASDAL_PT_TUKAR skTerpilih;
        ...
        public ucRTLTMForm(string _status)
        {
            InitializeComponent();
            statusForm = _status;
        ...
        public void inisialisasiForm()
        {
            ...
            switch (statusForm)
            {
                ...
                case "CU":
                    ...
                    break;
                case "U":
                    this.idSkWasdal = dataTerpilih.ID_SK_WASDAL_PINDAHTANGAN;
                    this.idSkTL = dataTerpilih.ID_TL_WASDAL_PINDAHTANGAN;
            ...
            if (dataOut.PO_RESULT == "Y")
            {
                ...
                switch (modeCudAset)
                {
                    case 'C':
                        ...
                        {
                            SvcWasdalPTTukarSelect.WASDALSROW_WASDAL_PT_TUKAR daftarAsetTerpilih = (SvcWasdalPTTukarSelect.WASDALSROW_WASDAL_PT_TUKAR)daftarAsetSalinan[i];
                            dataPenyama = null;
                            dataPenyama = new SvcWasdalPTTdAsetSelect.WASDALSROW_TL_DTLSELECT_WASDAL_PT();
                            dataPenyama.GUNA_WASDAL = daftarAsetTerpilih.GUNA_WASDAL;
