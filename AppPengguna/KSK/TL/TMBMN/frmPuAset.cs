...
namespace AppPengguna.KSK.TL.TMBMN  
{
    public partial class frmPuAset : Form
    {
        ...
        SvcWasdalPTTukarSelect.OutputParameters dOutDaftarAset;
        SvcWasdalPTTukarSelect.execute_pttClient ambilDaftarAset;
        SvcWasdalPTTukarSelect.WASDALSROW_WASDAL_PT_TUKAR dataTerpilih;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                myThread.Start();
                SvcWasdalPTTukarSelect.InputParameters parInp = new SvcWasdalPTTukarSelect.InputParameters();
                parInp.P_COL = "";
                ...
                ambilDaftarAset = new SvcWasdalPTTukarSelect.execute_pttClient();
        ...
        private delegate void DsSimpanData(SvcWasdalPTTukarSelect.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalPTTukarSelect.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_ROW_WASDAL_PT_TUKAR.Count();
            ...
            {
                dataOut.SF_ROW_WASDAL_PT_TUKAR[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_ROW_WASDAL_PT_TUKAR[i]);
            }
        ...
        public SvcWasdalPTTukarSelect.WASDALSROW_WASDAL_PT_TUKAR daftarAsetTerpilih;
        ...
        private void bbiSimpan_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (rowTerpilih != null)
            {
                ...
                else
                {
                    ...
                    {
                        daftarAsetTerpilih = (SvcWasdalPTTukarSelect.WASDALSROW_WASDAL_PT_TUKAR)daftarTerpilih[i];
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalPTTukarSelect.WASDALSROW_WASDAL_PT_TUKAR)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
