...
namespace AppPengguna.KSK.TL.TMBMN  
{
    public partial class frmPuSk : Form
    {
        ...
        public PilihSkTm pilihSkTm = null;

        SvcWasdalTmSkSelect.OutputParameters dOutDaftarSk;
        SvcWasdalTmSkSelect.execute_pttClient ambilDaftarSk;
        SvcWasdalTmSkSelect.WASDALSROW_READ_WASDAL_PT_TUKAR dataTerpilih;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                ambilDaftarSk = new SvcWasdalTmSkSelect.execute_pttClient();
                ambilDaftarSk.Open();
        ...
        private delegate void DsSimpanData(SvcWasdalTmSkSelect.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalTmSkSelect.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_READ_WASDAL_PT_TUKAR.Count();
            ...
            {
                dataOut.SF_READ_WASDAL_PT_TUKAR[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_READ_WASDAL_PT_TUKAR[i]);
            }
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalTmSkSelect.WASDALSROW_READ_WASDAL_PT_TUKAR)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
