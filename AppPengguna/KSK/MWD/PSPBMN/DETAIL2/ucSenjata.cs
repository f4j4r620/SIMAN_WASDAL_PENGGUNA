...
namespace AppPengguna.KSK.MWD.PSPBMN.DETAIL2
{
    ...
    public partial class ucSenjata : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucSenjata(FrmKoorSatker _frmKpknl, ucPSPBMN _ucPspBmn)
        {
            InitializeComponent();
        ...
        private void loadDataSenjata(SvcMonSnjtSelect.OutputParameters dataOut)
        {
            ...
            for (int i = 0; i < jmlData; i++)
            {
                ...
                dataOut.SF_MON_KSENJ_PSP2[i].TGL_PEROLEHAN = konfigApp.setDefaultDate(dataOut.SF_MON_KSENJ_PSP2[i].TGL_PEROLEHAN);
