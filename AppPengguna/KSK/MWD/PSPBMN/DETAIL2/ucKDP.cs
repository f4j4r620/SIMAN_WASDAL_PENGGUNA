...
namespace AppPengguna.KSK.MWD.PSPBMN.DETAIL2
{
    public partial class ucKDP : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        private void loadDataKDP(SvcMonKDPSelect.OutputParameters dataOut)
        {
            ...
            string totalData = (jmlData == 0) ? jmlData.ToString() : dataOut.SF_MON_KDP_PSP[jmlData - 1].TOTAL_DATA.ToString();
            ...
            for (int i = 0; i < jmlData; i++)
            {
                ...
                dataOut.SF_MON_KDP_PSP[i].TGL_PEROLEHAN = konfigApp.setDefaultDate(dataOut.SF_MON_KDP_PSP[i].TGL_PEROLEHAN);
