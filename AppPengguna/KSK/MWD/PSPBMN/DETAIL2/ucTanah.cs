...
namespace AppPengguna.KSK.MWD.PSPBMN.DETAIL2
{
    ...
    public partial class ucTanah : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucTanah(FrmKoorSatker _frmKpknl, ucPSPBMN _ucPspBmn)
        {
            InitializeComponent();
        ...
        private void loadDataTanah(SvcMonTanahSelect.OutputParameters dataOut)
        {
            ...
            for (int i = 0; i < jmlData; i++)
            {
                ...
                dataOut.SF_MON_KTNH_PSP2[i].TGL_PEROLEHAN = konfigApp.setDefaultDate(dataOut.SF_MON_KTNH_PSP2[i].TGL_PEROLEHAN);
