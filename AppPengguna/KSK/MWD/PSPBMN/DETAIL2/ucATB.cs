...
namespace AppPengguna.KSK.MWD.PSPBMN.DETAIL2
{
    ...
    public partial class ucATB : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucATB(FrmKoorSatker _frmKpknl, ucPSPBMN _ucPspBmn)
        {
            InitializeComponent();
        ...
        private void loadDataATB(SvcMonATBSelect.OutputParameters dataOut)
        {
            ...
            for (int i = 0; i < jmlData; i++)
            {
                ...
                dataOut.SF_MON_KTWJD_PSP2[i].TGL_PEROLEHAN = konfigApp.setDefaultDate(dataOut.SF_MON_KTWJD_PSP2[i].TGL_PEROLEHAN);
