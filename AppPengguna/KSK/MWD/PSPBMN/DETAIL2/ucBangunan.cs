...
namespace AppPengguna.KSK.MWD.PSPBMN.DETAIL2
{
    public partial class ucBangunan : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucBangunan(FrmKoorSatker _frmKpknl, ucPSPBMN _ucPspBmn)
        {
            InitializeComponent();
        ...
        private void loadDataBangunan(SvcMonBgnSelect.OutputParameters dataOut)
        {
            ...
            string totalData = (jmlData == 0) ? jmlData.ToString() : dataOut.SF_MON_KBDG_PSP2[jmlData - 1].TOTAL_DATA.ToString();
            ...
            for (int i = 0; i < jmlData; i++)
            {
                ...
                dataOut.SF_MON_KBDG_PSP2[i].TGL_PEROLEHAN = konfigApp.setDefaultDate(dataOut.SF_MON_KBDG_PSP2[i].TGL_PEROLEHAN);
