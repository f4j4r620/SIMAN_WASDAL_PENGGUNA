...
namespace AppPengguna.KSK.MWD.PSPBMN.DETAIL2
{
    public partial class ucJlnJmbtn : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucJlnJmbtn(FrmKoorSatker _frmKpknl, ucPSPBMN _ucPspBmn)
        {
            InitializeComponent();
        ...
        private void loadDataJlnJmbtn(SvcMonJlnJmbtnSelect.OutputParameters dataOut)
        {
            ...
            for (int i = 0; i < jmlData; i++)
            {
                ...
                dataOut.SF_MON_KJALJ_PSP2[i].TGL_PEROLEHAN = konfigApp.setDefaultDate(dataOut.SF_MON_KJALJ_PSP2[i].TGL_PEROLEHAN);
