...
namespace AppPengguna.KSK.MWD.PSPBMN.DETAIL2
{
    ...
    public partial class ucMesinTik : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucMesinTik(FrmKoorSatker _frmKpknl, ucPSPBMN _ucPspBmn)
        {
            InitializeComponent();
        ...
        public void getMesinTik()
        {
            ...
            try
            {
                ...
                parInp.STR_WHERE = String.Format("ID_SATKER={0}", konfigApp.kodeSatker.Substring(0, 15), konfigApp.idSatker) + " AND (NO_SURAT is null) " + this.strCari;
        ...
        private void loadDataMesinTik(SvcMonMesinTikSelect.OutputParameters dataOut)
        {
            ...
            string totalData = (jmlData == 0) ? jmlData.ToString() : dataOut.SF_MON_KKTIK_PSP2[jmlData - 1].TOTAL_DATA.ToString();
            ...
            for (int i = 0; i < jmlData; i++)
            {
                ...
                dataOut.SF_MON_KKTIK_PSP2[i].TGL_PEROLEHAN = konfigApp.setDefaultDate(dataOut.SF_MON_KKTIK_PSP2[i].TGL_PEROLEHAN);
