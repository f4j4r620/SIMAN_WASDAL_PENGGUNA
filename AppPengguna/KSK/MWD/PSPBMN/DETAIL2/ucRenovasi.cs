    ...
    public partial class ucRenovasi : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public void getRenovasi()
        {
            ...
            try
            {
                ...
                parInp.STR_WHERE = String.Format("STATUS_BMN_YN ='Y' AND (KD_SATKER LIKE '{0}%' OR (TIPE_PEMOHON='SATKER' AND ID_PEMOHON={1}))", konfigApp.kodeSatker.Substring(0, 15), konfigApp.idSatker) + " AND (NO_SURAT is null) " + this.strCari;
        ...
        private void loadDataRenovasi(SvcMonRenovSelect.OutputParameters dataOut)
        {
            ...
            string totalData = (jmlData == 0) ? jmlData.ToString() : dataOut.SF_MON_KRNV_PSP[jmlData - 1].TOTAL_DATA.ToString();
            ...
            for (int i = 0; i < jmlData; i++)
            {
                ...
                dataOut.SF_MON_KRNV_PSP[i].TGL_PEROLEHAN = konfigApp.setDefaultDate(dataOut.SF_MON_KRNV_PSP[i].TGL_PEROLEHAN);
