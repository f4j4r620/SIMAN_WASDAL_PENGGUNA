...
//    public delegate void CariDataOnline(string strCariData);
    ...
    public partial class ucMonLAIN : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        // public DETAIL.ucPersediaan persediaan1 = null;
       ...
       // public DETAIL2.ucPersediaan persediaan2 = null;
        ...
        public ucMonLAIN(FrmKoorSatker _frmKpknl)
        {
            InitializeComponent();
        ...
        public void tabSelect()
        {
            ...
            if (xtbDetail1.SelectedTabPageIndex == 0)
            {
                ...
                if (!tabPenggunaan1Open)
                {
                    ...
                    //{
                    //    penggunaan1 = new DETAIL.ucPenggunaan(FrmKoorSatker, this);
                    ...
                    //{
                    //    pemanfaatan1 = new DETAIL.ucPemanfaatan(FrmKoorSatker, this);
            ...
            if (xtbDetail1.SelectedTabPageIndex == 1)
            {
                if (!tabTanah1Open)
                {
                    tanah1 = new DETAIL.ucTanah(FrmKoorSatker, this);
            ...
            else if (xtbDetail1.SelectedTabPageIndex == 2)
            {
                if (!tabBangunan1Open)
                {
                    bangunan1 = new DETAIL.ucBangunan(FrmKoorSatker, this);
            ...
            else if (xtbDetail1.SelectedTabPageIndex == 3)
            {
                if (!tabRmhNgr1Open)
                {
                    rmhNgr1 = new DETAIL.ucRmhNgr(FrmKoorSatker, this);
            ...
            else if (xtbDetail1.SelectedTabPageIndex == 4)
            {
                if (!tabAngkutan1Open)
                {
                    angkutan1 = new DETAIL.ucAngkutan(FrmKoorSatker, this);
            ...
            else if (xtbDetail1.SelectedTabPageIndex == 5)
            {
                if (!tabBgnAir1Open)
                {
                    bangunanAir1 = new DETAIL.ucBangunanAir(FrmKoorSatker, this);
            ...
            else if (xtbDetail1.SelectedTabPageIndex == 6)
            {
                if (!tabSenjata1Open)
                {
                    senjata1 = new DETAIL.ucSenjata(FrmKoorSatker, this);
            ...
            else if (xtbDetail1.SelectedTabPageIndex == 7)
            {
                if (!tabMsnNTik1Open)
                {
                    mesinNonTik1 = new DETAIL.ucMesinNonTik(FrmKoorSatker, this);
            ...
            else if (xtbDetail1.SelectedTabPageIndex == 8)
            {
                if (!tabJlnJmbtn1Open)
                {
                    jlnJmbtn1 = new DETAIL.ucJlnJmbtn(FrmKoorSatker, this);
            ...
            else if (xtbDetail1.SelectedTabPageIndex == 9)
            {
                if (!tabPropSus1Open)
                {
                    propSus1 = new DETAIL.ucPropSus(FrmKoorSatker, this);
            ...
            else if (xtbDetail1.SelectedTabPageIndex == 10)
            {
                if (!tabAtl1Open)
                {
                    ATL1 = new DETAIL.ucATL(FrmKoorSatker, this);
            ...
            else if (xtbDetail1.SelectedTabPageIndex == 11)
            {
                if (!tabMsnTik1Open)
                {
                    mesinTik1 = new DETAIL.ucMesinTik(FrmKoorSatker, this);
            ...
            else if (xtbDetail1.SelectedTabPageIndex == 12)
            {
                if (!tabAtb1Open)
                {
                    ATB1 = new DETAIL.ucATB(FrmKoorSatker, this);
            ...
            else if (xtbDetail1.SelectedTabPageIndex == 13)
            {
                if (!tabKdp1Open)
                {
                    KDP1 = new DETAIL.ucKDP(FrmKoorSatker, this);
            ...
            else if (xtbDetail1.SelectedTabPageIndex == 14)
            {
                if (!tabRenov1Open)
                {
                    renovasi1 = new DETAIL.ucRenovasi(FrmKoorSatker, this);
