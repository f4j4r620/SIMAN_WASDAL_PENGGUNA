...
namespace AppPengguna.KSK.MWD.PSPBMN
{
    ...
    public partial class ucPSPBMN : DevExpress.XtraEditors.XtraUserControl
    {
       ...
       // public DETAIL1.ucPersediaan persediaan1 = null;
       ...
       // public DETAIL2.ucPersediaan persediaan2 = null;
        ...
        public ucPSPBMN(FrmKoorSatker _frmKpknl)
        {
            InitializeComponent();
        ...
        public void tabSelect()
        {
                ...
                if (xtbDetail1.SelectedTabPageIndex == 0)
                {
                    if (!tabTindakLanjut1Open)
                    {
                        if (tindakLanjut1 == null)
                        {
                            ...
                            tindakLanjut1.cariDataOnline = new DETAIL1.CariDataOnline(this.pencarianData);
            ...
            else 
            {
                ...
                if (xtbDetail2.SelectedTabPageIndex == 0)
                {
                    if (!tabTanah2Open)
                    {
                        tanah2 = new DETAIL2.ucTanah(FrmKoorSatker, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 1)
                {
                    if (!tabBangunan2Open)
                    {
                        bangunan2 = new DETAIL2.ucBangunan(FrmKoorSatker, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 2)
                {
                    if (!tabRmhNgr2Open)
                    {
                        rmhNgr2 = new DETAIL2.ucRmhNgr(FrmKoorSatker, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 3)
                {
                    if (!tabAngkutan2Open)
                    {
                        angkutan2 = new DETAIL2.ucAngkutan(FrmKoorSatker, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 4)
                {
                    if (!tabBgnAir2Open)
                    {
                        bangunanAir2 = new DETAIL2.ucBangunanAir(FrmKoorSatker, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 5)
                {
                    if (!tabSenjata2Open)
                    {
                        senjata2 = new DETAIL2.ucSenjata(FrmKoorSatker, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 6)
                {
                    if (!tabMsnNTik2Open)
                    {
                        mesinNonTik2 = new DETAIL2.ucMesinNonTik(FrmKoorSatker, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 7)
                {
                    if (!tabJlnJmbtn2Open)
                    {
                        jlnJmbtn2 = new DETAIL2.ucJlnJmbtn(FrmKoorSatker, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 8)
                {
                    if (!tabPropSus2Open)
                    {
                        propSus2 = new DETAIL2.ucPropSus(FrmKoorSatker, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 9)
                {
                    if (!tabAtl2Open)
                    {
                        ATL2 = new DETAIL2.ucATL(FrmKoorSatker, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 10)
                {
                    if (!tabMsnTik2Open)
                    {
                        mesinTik2 = new DETAIL2.ucMesinTik(FrmKoorSatker, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 11)
                {
                    if (!tabAtb2Open)
                    {
                        ATB2 = new DETAIL2.ucATB(FrmKoorSatker, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 12)
                {
                    if (!tabKdp2Open)
                    {
                        KDP2 = new DETAIL2.ucKDP(FrmKoorSatker, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 13)
                {
                    if (!tabRenov2Open)
                    {
                        renovasi2 = new DETAIL2.ucRenovasi(FrmKoorSatker, this);
        ...
        /// </param>
        /// <param name="subTab">
        /// sub tab dari tab utama
        /// untuk Tab Utama BMN sudah PSP : 
        /// ---Tidak ada----
        /// untuk Tab Utama BMN belum PSP :
        /// Input : 
        /// 0  -> Tab Tanah
        /// 1  -> Tab Bangunan
        /// 2  -> Tab Rumah Negara
        /// 3  -> Tab Angkutan
        /// 4  -> Tab Bangunan Air
        /// 5  -> Tab Persenjataan Alustita
        /// 6  -> Tab Mesin Peralatan Non TIK
        /// 7  -> Tab Jalan Dan Jembatan
        /// 8  -> Tab Jaringan dan Irigasi
        /// 9  -> Tab Aset Tetap Lainnya
        /// 10  -> Tab Mesin Peralatan Khusus TIK
        /// 11 -> Tab Aset Tak Berwujud
        /// 12 -> Tab KDP
        /// 13 -> Tab Renovasi
        /// </param>
        public void ExportToExcel(int MainTab,int subTab)
        {
            try
            {
                string pathToSave = "";
                ...
                if (MainTab == 0)
                {
                    tindakLanjut1.gvTLPSPBMN.ExportToXls(pathToSave);
                }
                else // MainTab == 1
                {
                    switch (subTab)
                    {
                        case 0:
                            tanah2.gvTanah.ExportToXls(pathToSave);
                            break;
                        case 1:
                            bangunan2.gvBangunan.ExportToXls(pathToSave);
                            break;
                        case 2:
                            rmhNgr2.gvRmhNgr.ExportToXls(pathToSave);
                            break;
                        case 3:
                            angkutan2.gvAngkutan.ExportToXls(pathToSave);
                            break;
                        case 4:
                            bangunanAir2.gvBangunanAir.ExportToXls(pathToSave);
                            break;
                        case 5:
                            senjata2.gvSenjata.ExportToXls(pathToSave);
                            break;
                        case 6:
                            mesinNonTik2.gvMesinNonTik.ExportToXls(pathToSave);
                            break;
                        case 7:
                            jlnJmbtn2.gvJlnJmbtn.ExportToXls(pathToSave);
                            break;
                        case 8:
                            propSus2.gvPropSus.ExportToXls(pathToSave);
                            break;
                        case 9:
                            ATL2.gvATL.ExportToXls(pathToSave);
                            break;
                        case 10 :
                            mesinTik2.gvMesinTik.ExportToXls(pathToSave);
                            break;
                        case 11 :
                            ATB2.gvATB.ExportToXls(pathToSave);
                            break;
                        case 12 :
                            KDP2.gvKDP.ExportToXls(pathToSave);
                            break;
                        case 13 :
                            renovasi2.gvRenovasi.ExportToXls(pathToSave);
                            break;
                    }
                }
