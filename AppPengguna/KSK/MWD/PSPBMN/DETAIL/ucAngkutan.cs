...
namespace AppPengguna.KSK.MWD.PSPBMN.DETAIL
{
    ...
    public partial class ucAngkutan : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucAngkutan(FrmKoorSatker _frmKpknl, ucMonLAIN _ucPspBmn)
        {
            InitializeComponent();
        ...
        public void getAngkutan()
        {
            ...
            try
            {
                ...
                parInp.STR_WHERE = String.Format("ID_SATKER={0} OR (TIPE_PEMOHON='SATKER' AND ID_PEMOHON={1})", konfigApp.idSatker, konfigApp.idSatker) + " AND (NO_SURAT != '-') " + PSPBMN.strKdPelayanan + this.strCari;
