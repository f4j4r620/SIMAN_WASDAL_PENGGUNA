...
{
    public partial class ucKSPBmn : ucMain
    {
        ...
        ///  Service
        /// </summary>
        SvcMonSatkerManfaatA231.InputParameters input;
        SvcMonSatkerManfaatA231.OutputParameters output;
        SvcMonSatkerManfaatA231.execute_pttClient client;
        SvcMonSatkerManfaatA231.WASDALSROW_MON_MANFAAT_SATKER_A231 rowData;
        ...
        public ucKSPBmn(string label, string kode)
        {
            InitializeComponent();
        ...
        private void GetData(string where)
        {
            ...
            {
                FormNonAktif();
                input = new SvcMonSatkerManfaatA231.InputParameters();
                if (dataInisial)
                {
                ...
                client = new SvcMonSatkerManfaatA231.execute_pttClient();
                client.Open();
        ...
        private delegate void ShowData(SvcMonSatkerManfaatA231.OutputParameters output);

        private void ShowDataGrid(SvcMonSatkerManfaatA231.OutputParameters output)
        {
            try
            {
                int jmlData = output.SF_MON_MANFAAT_SATKER_A231.Count();
                dataCount += jmlData;
                ...
                data.AddRange(output.SF_MON_MANFAAT_SATKER_A231);
