...
{
    public partial class ucKSPI : ucMain
    {
        ...
        ///  Service
        /// </summary>
        SvcMonSatkerManfaatA25.InputParameters input;
        SvcMonSatkerManfaatA25.OutputParameters output;
        SvcMonSatkerManfaatA25.execute_pttClient client;
        SvcMonSatkerManfaatA25.WASDALSROW_MON_MANFAAT_SATKER_A21 rowData;
        ...
        public ucKSPI(string label, string kode)
        {
            InitializeComponent();
        ...
        private void GetData(string where)
        {
            ...
            {
                FormNonAktif();
                input = new SvcMonSatkerManfaatA25.InputParameters();
                if (dataInisial)
                {
                ...
                client = new SvcMonSatkerManfaatA25.execute_pttClient();
                client.Open();
        ...
        private delegate void ShowData(SvcMonSatkerManfaatA25.OutputParameters output);

        private void ShowDataGrid(SvcMonSatkerManfaatA25.OutputParameters output)
        {
            try
            {
                int jmlData = output.SF_MON_MANFAAT_SATKER_A25.Count();
                dataCount += jmlData;
                ...
                data.AddRange(output.SF_MON_MANFAAT_SATKER_A25);
