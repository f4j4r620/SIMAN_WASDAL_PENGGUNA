...
{
    public partial class ucPinjamPakai : ucMain
    {
        ...
        ///  Service
        /// </summary>
        SvcMonSatkerManfaatA22.InputParameters input;
        SvcMonSatkerManfaatA22.OutputParameters output;
        SvcMonSatkerManfaatA22.execute_pttClient client;
        SvcMonSatkerManfaatA22.WASDALSROW_MON_MANFAAT_SATKER_A21 rowData;

        public ucPinjamPakai()
        {
            InitializeComponent();
        }

        public ucPinjamPakai(string label, string kode)
        {
            InitializeComponent();
        ...
        private void GetData(string where)
        {
            ...
            {
                FormNonAktif();
                input = new SvcMonSatkerManfaatA22.InputParameters();
                if (dataInisial)
                {
                ...
                client = new SvcMonSatkerManfaatA22.execute_pttClient();
                client.Open();
        ...
        private delegate void ShowData(SvcMonSatkerManfaatA22.OutputParameters output);

        private void ShowDataGrid(SvcMonSatkerManfaatA22.OutputParameters output)
        {
            try
            {
                int jmlData = output.SF_MON_MANFAAT_SATKER_A22.Count();
                dataCount += jmlData;
                ...
                data.AddRange(output.SF_MON_MANFAAT_SATKER_A22);
        ...
        private void bandedGridView1_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                rowData = new SvcMonSatkerManfaatA22.WASDALSROW_MON_MANFAAT_SATKER_A21();
                rowData = (SvcMonSatkerManfaatA22.WASDALSROW_MON_MANFAAT_SATKER_A21)bandedGridView1.GetFocusedRow();
                GoTo(rowData.SK_KEPUTUSAN, "SURAT PERSETUJUAN : " + rowData.SK_KEPUTUSAN);
            }
            catch (Exception)
            {
                rowData = null;
