...
{
    public partial class ucKSP : ucMain
    {
        ...
        ///  Service
        /// </summary>
        SvcMonSatkerManfaatA23.InputParameters input;
        SvcMonSatkerManfaatA23.OutputParameters output;
        SvcMonSatkerManfaatA23.execute_pttClient client;
        SvcMonSatkerManfaatA23.WASDALSROW_MON_MANFAAT_SATKER_A21 rowData;
        ...
        public ucKSP(string label, string kode)
        {
            InitializeComponent();
        ...
        private void GetData(string where)
        {
            ...
            {
                FormNonAktif();
                input = new SvcMonSatkerManfaatA23.InputParameters();
                if (dataInisial)
                {
                ...
                client = new SvcMonSatkerManfaatA23.execute_pttClient();
                client.Open();
        ...
        private delegate void ShowData(SvcMonSatkerManfaatA23.OutputParameters output);

        private void ShowDataGrid(SvcMonSatkerManfaatA23.OutputParameters output)
        {
            try
            {
                int jmlData = output.SF_MON_MANFAAT_SATKER_A23.Count();
                dataCount += jmlData;
                ...
                data.AddRange(output.SF_MON_MANFAAT_SATKER_A23);
