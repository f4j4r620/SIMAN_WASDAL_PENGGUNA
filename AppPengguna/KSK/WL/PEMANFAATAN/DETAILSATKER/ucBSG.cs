...
{
    public partial class ucBSG : ucMain
    {
        ...
        ///  Service
        /// </summary>
        SvcMonSatkerManfaatA24.InputParameters input;
        SvcMonSatkerManfaatA24.OutputParameters output;
        SvcMonSatkerManfaatA24.execute_pttClient client;
        SvcMonSatkerManfaatA24.WASDALSROW_MON_MANFAAT_SATKER_A21 rowData;
        ...
        public ucBSG(string label, string kode)
        {
            InitializeComponent();
        ...
        private void GetData(string where)
        {
            ...
            {
                FormNonAktif();
                input = new SvcMonSatkerManfaatA24.InputParameters();
                if (dataInisial)
                {
                ...
                client = new SvcMonSatkerManfaatA24.execute_pttClient();
                client.Open();
        ...
        private delegate void ShowData(SvcMonSatkerManfaatA24.OutputParameters output);

        private void ShowDataGrid(SvcMonSatkerManfaatA24.OutputParameters output)
        {
            try
            {
                int jmlData = output.SF_MON_MANFAAT_SATKER_A24.Count();
                dataCount += jmlData;
                ...
                data.AddRange(output.SF_MON_MANFAAT_SATKER_A24);
