...
{
    public partial class ucTukarMenukar : ucMain
    {
        ...
        ///  Service
        /// </summary>
        SvcMonSatkerPindahA22.InputParameters input;
        SvcMonSatkerPindahA22.OutputParameters output;
        SvcMonSatkerPindahA22.execute_pttClient client;
        SvcMonSatkerPindahA22.WASDALSROW_MON_PINDAH_SATKER_A21 rowData;
        public ucTukarMenukar()
        {
            InitializeComponent();
        }

        public ucTukarMenukar(string label, string kode)
        {
            InitializeComponent();
        ...
        private void GetData(string where)
        {
            ...
            {
                FormNonAktif();
                input = new SvcMonSatkerPindahA22.InputParameters();
                if (dataInisial)
                {
                ...
                client = new SvcMonSatkerPindahA22.execute_pttClient();
                client.Open();
        ...
        private delegate void ShowData(SvcMonSatkerPindahA22.OutputParameters output);

        private void ShowDataGrid(SvcMonSatkerPindahA22.OutputParameters output)
        {
            try
            {
                int jmlData = output.SF_MON_PINDAH_SATKER_A22.Count();
                dataCount += jmlData;
                ...
                data.AddRange(output.SF_MON_PINDAH_SATKER_A22);
        ...
        private void gridView_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                rowData = new SvcMonSatkerPindahA22.WASDALSROW_MON_PINDAH_SATKER_A21();
                rowData = (SvcMonSatkerPindahA22.WASDALSROW_MON_PINDAH_SATKER_A21)gridView.GetFocusedRow();
