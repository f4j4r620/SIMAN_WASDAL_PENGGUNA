...
{
    public partial class ucPMPP : ucMain
    {
        ...
        ///  Service
        /// </summary>
        SvcMonSatkerPindahA24.InputParameters input;
        SvcMonSatkerPindahA24.OutputParameters output;
        SvcMonSatkerPindahA24.execute_pttClient client;
        SvcMonSatkerPindahA24.WASDALSROW_MON_PINDAH_KPKNL_A21 rowData;
        public ucPMPP()
        {
            InitializeComponent();
        }

        public ucPMPP(string label, string kode)
        {
            InitializeComponent();
        ...
        private void GetData(string where)
        {
            ...
            {
                FormNonAktif();
                input = new SvcMonSatkerPindahA24.InputParameters();
                if (dataInisial)
                {
                ...
                client = new SvcMonSatkerPindahA24.execute_pttClient();
                client.Open();
        ...
        private delegate void ShowData(SvcMonSatkerPindahA24.OutputParameters output);

        private void ShowDataGrid(SvcMonSatkerPindahA24.OutputParameters output)
        {
            try
            {
                int jmlData = output.SF_MON_PINDAH_SATKER_A24.Count();
                dataCount += jmlData;
                ...
                data.AddRange(output.SF_MON_PINDAH_SATKER_A24);
        ...
        private void gridView_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                rowData = new SvcMonSatkerPindahA24.WASDALSROW_MON_PINDAH_KPKNL_A21();
                rowData = (SvcMonSatkerPindahA24.WASDALSROW_MON_PINDAH_KPKNL_A21)gridView.GetFocusedRow();
