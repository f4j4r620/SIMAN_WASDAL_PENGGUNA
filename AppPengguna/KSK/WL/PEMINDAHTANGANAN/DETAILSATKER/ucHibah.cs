...
{
    public partial class ucHibah : ucMain
    {
        ...
        ///  Service
        /// </summary>
        SvcMonSatkerPindahA23.InputParameters input;
        SvcMonSatkerPindahA23.OutputParameters output;
        SvcMonSatkerPindahA23.execute_pttClient client;
        SvcMonSatkerPindahA23.WASDALSROW_MON_PINDAH_SATKER_A21 rowData;
        public ucHibah()
        {
            InitializeComponent();
        }

        public ucHibah(string label, string kode)
        {
            InitializeComponent();
        ...
        private void GetData(string where)
        {
            ...
            {
                FormNonAktif();
                input = new SvcMonSatkerPindahA23.InputParameters();
                if (dataInisial)
                {
                ...
                client = new SvcMonSatkerPindahA23.execute_pttClient();
                client.Open();
        ...
        private delegate void ShowData(SvcMonSatkerPindahA23.OutputParameters output);

        private void ShowDataGrid(SvcMonSatkerPindahA23.OutputParameters output)
        {
            try
            {
                int jmlData = output.SF_MON_PINDAH_SATKER_A23.Count();
                dataCount += jmlData;
                ...
                data.AddRange(output.SF_MON_PINDAH_SATKER_A23);
        ...
        private void gridView_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                rowData = new SvcMonSatkerPindahA23.WASDALSROW_MON_PINDAH_SATKER_A21();
                rowData = (SvcMonSatkerPindahA23.WASDALSROW_MON_PINDAH_SATKER_A21)gridView.GetFocusedRow();
