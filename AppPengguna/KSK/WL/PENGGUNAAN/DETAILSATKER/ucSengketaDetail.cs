...
namespace AppPengguna.KSK.WL.PENGGUNAAN.DETAILSATKER
{
    public partial class ucSengketaDetail : ucMain
    {
        ...
        SvcSelectGunaB51.InputParameters input;
        SvcSelectGunaB51.OutputParameters output;
        SvcSelectGunaB51.execute_pttClient client;
        SvcSelectGunaB51.WASDALSROW_MON_GUNA_KPKNL_B51 rowData;
        ...
        private void GetData(string where)
        {
            ...
            {
                FormNonAktif();
                input = new SvcSelectGunaB51.InputParameters();
                if (dataInisial)
                {
                ...
                client = new SvcSelectGunaB51.execute_pttClient();
                client.Open();
        ...
        private delegate void ShowData(SvcSelectGunaB51.OutputParameters output);

        private void ShowDataGrid(SvcSelectGunaB51.OutputParameters output)
        {
            try
            {
                int jmlData = output.SF_MON_GUNA_KPKNL_B51.Count();
                ...
                data.AddRange(output.SF_MON_GUNA_KPKNL_B51);
        ...
        private void bandedGridView1_CustomUnboundColumnData(object sender, DevExpress.XtraGrid.Views.Base.CustomColumnDataEventArgs e)
        {
            try
            {
                var row = (SvcSelectGunaB51.WASDALSROW_MON_GUNA_KPKNL_B51)e.Row;
