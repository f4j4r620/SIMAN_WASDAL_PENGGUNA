...
namespace AppPengguna.KSK.MONPNBP.SWBMN
{
    ...
    {
        public SvcWasdalMonPnbpSsbp.WASDALSROW_SELECT_MANFAAT_PNBP dataTerpilih;
        ...
        private void gvGridSk_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (viewTerpilih.SelectedRowsCount > 0)
                dataTerpilih = (SvcWasdalMonPnbpSsbp.WASDALSROW_SELECT_MANFAAT_PNBP)viewTerpilih.GetRow(e.FocusedRowHandle);
