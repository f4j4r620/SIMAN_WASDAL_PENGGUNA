...
{
    public partial class ucPNBPBSGForm : UserControl
    {
        public ToggleProgressBar toggleProgressBar;
        public SimpanDataRPNBP simpanDataRkmPnbpBSG;
        ...
        public ucPNBPBSGForm(string _status)
        {
            InitializeComponent();
            statusForm = _status;
        ...
        public void inisialisasiForm()
        {
            ...
            teNamaInstansi.Properties.ShowDropDown = DevExpress.XtraEditors.Controls.ShowDropDown.Never;
            leAkun.Properties.ShowDropDown = DevExpress.XtraEditors.Controls.ShowDropDown.Never;
            ...
            if (teNomorSk.Text.Trim() != "" && teNTPN.Text != "" && teKet.Text != "" )
            {
                if (konfigApp.cekMinus(Convert.ToDecimal(teNilaiPnbp.Text)) == false)
                {
                    if (statusForm == "C" || statusForm == "U" || statusForm == "CU")
                        simpanDataRkmPnbpBSG(statusForm);
                    if (statusForm == "C")
                    {
                        sbTambah.Enabled = true;
                        sbHapus.Enabled = true;
        ...
        private void dsFileWasdal(SvcPnbpGetFile.OutputParameters outFileWasdal)
        {
            if (outFileWasdal.PO_RESULT == "Y")
            {
                if (uploadSelect.Equals("CE"))
                {
                    ...
                    if (dataTerpilih != null)
                    {
                        dataTerpilih.NM_FILE = outFileWasdal.PO_NM_FILE;
                    }
