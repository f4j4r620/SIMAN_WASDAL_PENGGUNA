...
namespace AppPengguna.KSK.PNBP.TMBMN
{
    public partial class frmPuAset : Form
    {
        ...
        SvcWasdalTukarPnbpAset.OutputParameters dOutDaftarAset;
        SvcWasdalTukarPnbpAset.execute_pttClient ambilDaftarAset;
        SvcWasdalTukarPnbpAset.WASDALSROW_ASET_WASDAL_TUKAR_PNBP dataTerpilih;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                myThread.Start();
                SvcWasdalTukarPnbpAset.InputParameters parInp = new SvcWasdalTukarPnbpAset.InputParameters();
                parInp.P_COL = "";
                ...
                parInp.STR_WHERE = String.Format(" NTPN = '" + ntpn + "' AND ID_SATKER = {0} AND SK_KEPUTUSAN= '{1}' AND ID_SK_WASDAL_PINDAHTANGAN IS NULL AND ID_TL_WASDAL_PINDAHTANGAN = {2} {3}", idSatker, skKeputusan, idTLWasdal, strCari);
                ambilDaftarAset = new SvcWasdalTukarPnbpAset.execute_pttClient();
        ...
        private delegate void DsSimpanData(SvcWasdalTukarPnbpAset.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalTukarPnbpAset.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_ASET_WASDAL_TUKAR_PNBP.Count();
            ...
            {
                dataOut.SF_ASET_WASDAL_TUKAR_PNBP[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_ASET_WASDAL_TUKAR_PNBP[i]);
            }
        ...
        public SvcWasdalTukarPnbpAset.WASDALSROW_ASET_WASDAL_TUKAR_PNBP daftarAsetTerpilih;
        ...
        private void bbiSimpan_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (rowTerpilih != null)
            {
                ...
                else
                {
                    ...
                    {
                        daftarAsetTerpilih = (SvcWasdalTukarPnbpAset.WASDALSROW_ASET_WASDAL_TUKAR_PNBP)daftarTerpilih[i];
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalTukarPnbpAset.WASDALSROW_ASET_WASDAL_TUKAR_PNBP)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
