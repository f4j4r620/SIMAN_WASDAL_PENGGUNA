...
{
    public partial class ucPNBPDPLForm : UserControl
    {
        public ToggleProgressBar toggleProgressBar;
        public SimpanDataRPNBP simpanDataRkmPnbpDPL;
        ...
        public SvcWasdalLainPnbpSelect.WASDALSROW_SELECT_LAIN_PNBP dataTerpilih;
        public SvcWasdalLainPnbpSelectSK.WASDALSROW_READ_WASDAL_PSP_LAIN_PNBP skTerpilih;
        ...
        public ucPNBPDPLForm(string _status)
        {
            InitializeComponent();
            statusForm = _status;
        ...
        public void inisialisasiForm()
        {
            ...
            if (statusForm != "C" && statusForm != "CU")
            {
                ...
                idTlSkWasdal = dataTerpilih.ID_TL_WASDAL_GUNA;
            ...
            else
            {
                ...
                idTlSkWasdal = skTerpilih.ID_TL_WASDAL_GUNA;
            ...
            if (teNomorSk.Text.Trim() != "" && teNTPN.Text != "" && teKet.Text != "")
            {
                if (konfigApp.cekMinus(Convert.ToDecimal(teNilaiPnbp.Text)) == false)
                {
                    if (statusForm == "C" || statusForm == "U" || statusForm == "CU")
                        simpanDataRkmPnbpDPL(statusForm);
                    if (statusForm == "C")
                    {
                        sbTambah.Enabled = true;
                        sbHapus.Enabled = true;
        ...
        SvcWasdalLainPnbpSelectAset.OutputParameters dOutAsetSewaPnbp;
        SvcWasdalLainPnbpSelectAset.execute_pttClient ambilDaftarAsetPnbp;
        SvcWasdalLainPnbpSelectAset.WASDALSROW_DTLSEL_LAIN_PNBP dataAsetTerpilih;
        ...
        private void getDaftarAset()
        {
            try
            {
                myThread = new Thread(new ThreadStart(aktifkanProgresBar));
                myThread.Start();
                SvcWasdalLainPnbpSelectAset.InputParameters parInput = new SvcWasdalLainPnbpSelectAset.InputParameters();
                parInput.P_COL = "";
                parInput.P_COUNT = "N";
                parInput.P_MAX = 0;
                ...
                ambilDaftarAsetPnbp = new SvcWasdalLainPnbpSelectAset.execute_pttClient();
        ...
        private delegate void LoadDataDaftarAset(SvcWasdalLainPnbpSelectAset.OutputParameters outputDaftarAset);

        private void loadDataDaftarAset(SvcWasdalLainPnbpSelectAset.OutputParameters outputDaftarAset)
        {
            int jmlData = outputDaftarAset.SF_DTLSEL_WASDAL_LAIN_PNBP.Count();
            decimal? nilaiPersetujuan = 0;
            decimal? jmlKuantitas = 0;
            dsGridDaftarAset = new ArrayList();
            if (jmlData >= 1 && outputDaftarAset.SF_DTLSEL_WASDAL_LAIN_PNBP[0].KD_BRG != "-")
            {
                for (int i = 0; i < jmlData; i++)
                {
                    dOutAsetSewaPnbp.SF_DTLSEL_WASDAL_LAIN_PNBP[i].IS_TB = (dOutAsetSewaPnbp.SF_DTLSEL_WASDAL_LAIN_PNBP[i].IS_TB == "Y" ? konfigApp.namaTb : konfigApp.namaNonTb);
                    dOutAsetSewaPnbp.SF_DTLSEL_WASDAL_LAIN_PNBP[i].NUMSpecified = false;
                    dsGridDaftarAset.Add(dOutAsetSewaPnbp.SF_DTLSEL_WASDAL_LAIN_PNBP[i]);
                    nilaiPersetujuan = nilaiPersetujuan + dOutAsetSewaPnbp.SF_DTLSEL_WASDAL_LAIN_PNBP[i].NILAI_PERSETUJUAN;
                    jmlKuantitas = jmlKuantitas + dOutAsetSewaPnbp.SF_DTLSEL_WASDAL_LAIN_PNBP[i].KUANTITAS;
                }
                gcDaftarAset.DataSource = null;
                gcDaftarAset.DataSource = dsGridDaftarAset;
                gcDaftarAset.RefreshDataSource();
        ...
        DPL.frmPuAset formDaftarAsetSatker;
        DPL.frmPuAset formDaftarAsetKorwil;
        DPL.frmPuAset formDaftarAsetEselon1;
        DPL.frmPuAset formDaftarAsetKl;
        ...
        private void sbTambah_Click(object sender, EventArgs e)
        {
            if (teJenisPemohon.Text == konfigApp.levelSatker)
            {
                ...
                //{
                    formDaftarAsetSatker = new DPL.frmPuAset()
                    {
                        toggleProgressBar = new ToggleProgressBar(toggleProgBarPu),
                ...
                formDaftarAsetSatker.idTLWasdal = (dataTerpilih == null) ? skTerpilih.ID_TL_WASDAL_GUNA.ToString() : dataTerpilih.ID_TL_WASDAL_GUNA.ToString();
        ...
        SvcWasdalLainPnbpDetilCud.OutputParameters dOutSimpanAset;
        SvcWasdalLainPnbpDetilCud.execute_pttClient simpanDftrAset;
        ...
        private void simpanDaftarAset(string _daftarIdAset,decimal? _nilaiTotalAset, char _modeCudAset)
        {
            try
            {
                myThread = new Thread(new ThreadStart(aktifkanProgresBar));
                myThread.Start();
                SvcWasdalLainPnbpDetilCud.InputParameters parInp = new SvcWasdalLainPnbpDetilCud.InputParameters();
                ...
                {
                    parInp.P_ID_TL_WASDAL_GUNA = (dataTerpilih == null) ? skTerpilih.ID_TL_WASDAL_GUNA : dataTerpilih.ID_TL_WASDAL_GUNA;
                ...
                {
                    parInp.P_ID_TL_WASDAL_GUNA = idTlSkWasdal;// (dataTerpilih == null) ? skTerpilih.ID_TL_WASDAL_GUNA : dataTerpilih.ID_TL_WASDAL_GUNA;
                    parInp.P_ID_TL_WASDAL_GUNASpecified = true;
                ...
                simpanDftrAset = new SvcWasdalLainPnbpDetilCud.execute_pttClient();
                //simpanDftrAset.Open();
        ...
        private delegate void DsDaftarAset(SvcWasdalLainPnbpDetilCud.OutputParameters dataOut);

        private void dsDaftarAset(SvcWasdalLainPnbpDetilCud.OutputParameters dataOut)
        {
            if (dataOut.PO_RESULT == "Y")
            {
                ...
                switch (modeCudAset)
                {
                    case 'C':
                        ...
                        SvcWasdalLainPnbpSelectAset.WASDALSROW_DTLSEL_LAIN_PNBP dataPenyama;
                        ...
                        {
                            SvcWasdalLainPnbpAset.WASDALSROW_ASET_WASDAL_LAIN_PNBP daftarAsetTerpilih = (SvcWasdalLainPnbpAset.WASDALSROW_ASET_WASDAL_LAIN_PNBP)daftarAsetSalinan[i];

                            dataPenyama = null;
                            dataPenyama = new SvcWasdalLainPnbpSelectAset.WASDALSROW_DTLSEL_LAIN_PNBP();
                    ...
                    case 'D':
                        if (daftarTerpilih != null)
                        {
                            ...
                            {
                                SvcWasdalLainPnbpSelectAset.WASDALSROW_DTLSEL_LAIN_PNBP daftarAsetTerpilih = (SvcWasdalLainPnbpSelectAset.WASDALSROW_DTLSEL_LAIN_PNBP)daftarTerpilih[i];
                                _krgNilTetap = _krgNilTetap - daftarAsetTerpilih.NILAI_PENETAPAN;
                                _krgKuantitas = _krgKuantitas - daftarAsetTerpilih.KUANTITAS_SK;
        ...
        {
            SvcWasdalLainPnbpSelectAset.WASDALSROW_DTLSEL_LAIN_PNBP daftarAsetTerpilih;
            if (rowTerpilih != null)
            {
                ...
                else
                {
                    for (int i = 0; i < daftarTerpilih.Count; i++)
                    {
                        daftarAsetTerpilih = (SvcWasdalLainPnbpSelectAset.WASDALSROW_DTLSEL_LAIN_PNBP)daftarTerpilih[i];
        ...
        private void gvDaftarAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            {
                dataAsetTerpilih = (SvcWasdalLainPnbpSelectAset.WASDALSROW_DTLSEL_LAIN_PNBP)rowTerpilih.GetRow(e.FocusedRowHandle);
