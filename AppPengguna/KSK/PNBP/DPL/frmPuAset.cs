...
namespace AppPengguna.KSK.PNBP.DPL
{
    public partial class frmPuAset : Form
    {
        ...
        SvcWasdalLainPnbpAset.OutputParameters dOutDaftarAset;
        SvcWasdalLainPnbpAset.execute_pttClient ambilDaftarAset;
        SvcWasdalLainPnbpAset.WASDALSROW_ASET_WASDAL_LAIN_PNBP dataTerpilih;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                myThread.Start();
                SvcWasdalLainPnbpAset.InputParameters parInp = new SvcWasdalLainPnbpAset.InputParameters();
                parInp.P_COL = "";
                ...
                parInp.STR_WHERE = String.Format(" NTPN = '{0}' AND ID_SATKER = {1} AND SK_KEPUTUSAN = '{2}' AND ID_SK_WASDAL IS NULL AND ID_TL_WASDAL_GUNA = {3} {4}", ntpn, idSatker, skKeputusan, idTLWasdal, strCari);

                ambilDaftarAset = new SvcWasdalLainPnbpAset.execute_pttClient();
        ...
        private delegate void DsSimpanData(SvcWasdalLainPnbpAset.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalLainPnbpAset.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_ASET_WASDAL_LAIN_PNBP.Count();
            ...
            {
                dataOut.SF_ASET_WASDAL_LAIN_PNBP[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_ASET_WASDAL_LAIN_PNBP[i]);
            }
        ...
        public SvcWasdalLainPnbpAset.WASDALSROW_ASET_WASDAL_LAIN_PNBP daftarAsetTerpilih;
        ...
        private void bbiSimpan_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (rowTerpilih != null)
            {
                ...
                else
                {
                    ...
                    {
                        daftarAsetTerpilih = (SvcWasdalLainPnbpAset.WASDALSROW_ASET_WASDAL_LAIN_PNBP)daftarTerpilih[i];
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalLainPnbpAset.WASDALSROW_ASET_WASDAL_LAIN_PNBP)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
