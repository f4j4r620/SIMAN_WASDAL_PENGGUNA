...
{
    public partial class ucPNBPBGSForm : UserControl
    {
        public ToggleProgressBar toggleProgressBar;
        public SimpanDataRPNBP simpanDataRkmPnbpBGS;
        ...
        public ucPNBPBGSForm(string _status)
        {
            InitializeComponent();
            statusForm = _status;
        ...
        private void simpanDaftarAset(string _daftarIdAset,decimal? _nilaiTotalAset, char _modeCudAset,decimal? id_tl_wasdal_manfaat)
        {
            try
            {
                myThread = new Thread(new ThreadStart(aktifkanProgresBar));
