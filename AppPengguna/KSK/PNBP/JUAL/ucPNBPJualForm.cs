...
namespace AppPengguna.KSK.PNBP.JUAL
{
    public partial class ucPNBPJualForm : UserControl
    {
        ...
        public SvcWasdalPTJualPnbpSelectSk.WASDALSROW_READ_WASDAL_PT_JUAL_PNBP skTerpilih;
        ...
        private void simpanDaftarAset(string _daftarIdAset,decimal? _nilaiTotalAset, char _modeCudAset)
        {
            try
            {
                ...
                if (Convert.ToString(_modeCudAset) == "C")
                {
                    ...
                    parInp.P_ID_TL_WASDAL_PINDAHTANGAN = idTlSkWasdal;
            ...
            if (dataOut.PO_RESULT == "Y")
            {
                ...
                switch (modeCudAset)
                {
                    case 'C':
                        ...
                        {
                            SvcWasdalPTJualPnbpAset.WASDALSROW_ASET_WASDAL_JUAL_PNBP daftarAsetTerpilih = (SvcWasdalPTJualPnbpAset.WASDALSROW_ASET_WASDAL_JUAL_PNBP)daftarAsetSalinan[i];
                            dataPenyama = null;
