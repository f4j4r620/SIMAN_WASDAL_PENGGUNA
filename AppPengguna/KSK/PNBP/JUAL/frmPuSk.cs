...
namespace AppPengguna.KSK.PNBP.JUAL
{
    public partial class frmPuSk : Form
    {
        ...
        public PilihSkJualPnbp pilihSk = null;

        SvcWasdalPTJualPnbpSelectSk.OutputParameters dOutDaftarSk;
        SvcWasdalPTJualPnbpSelectSk.execute_pttClient ambilDaftarSk;
        SvcWasdalPTJualPnbpSelectSk.WASDALSROW_READ_WASDAL_PT_JUAL_PNBP dataTerpilih;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                myThread.Start();
                SvcWasdalPTJualPnbpSelectSk.InputParameters parInp = new SvcWasdalPTJualPnbpSelectSk.InputParameters();
                parInp.P_COL = "";
                ...
                parInp.STR_WHERE = String.Format("ID_TL_WASDAL_PINDAHTANGAN IS NOT NULL AND KD_PELAYANAN = '{0}' AND (ID_USER = {1} OR (TIPE_PEMOHON='SATKER' AND ID_PEMOHON={2})) {3}", konfigApp.kdPelayanan, konfigApp.idUser, konfigApp.idSatker, this.strCari);
                ambilDaftarSk = new SvcWasdalPTJualPnbpSelectSk.execute_pttClient();
                ambilDaftarSk.Open();
        ...
        private delegate void DsSimpanData(SvcWasdalPTJualPnbpSelectSk.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalPTJualPnbpSelectSk.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_READ_WASDAL_PT_JUAL_PNBP.Count();
            ...
            {
                dataOut.SF_READ_WASDAL_PT_JUAL_PNBP[i].NUMSpecified = false;
                dataOut.SF_READ_WASDAL_PT_JUAL_PNBP[i].TGL_SK = konfigApp.setDefaultDate(dataOut.SF_READ_WASDAL_PT_JUAL_PNBP[i].TGL_SK);
                dataOut.SF_READ_WASDAL_PT_JUAL_PNBP[i].PERIODE = konfigApp.setPeriode(dataOut.SF_READ_WASDAL_PT_JUAL_PNBP[i].PERIODE);
                dsGridData.Add(dataOut.SF_READ_WASDAL_PT_JUAL_PNBP[i]);
            }
        ...
        public SvcWasdalJualSkSelect.WASDALSROW_READ_WASDAL_PT_JUAL daftarSkTerpilih;
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalPTJualPnbpSelectSk.WASDALSROW_READ_WASDAL_PT_JUAL_PNBP)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
