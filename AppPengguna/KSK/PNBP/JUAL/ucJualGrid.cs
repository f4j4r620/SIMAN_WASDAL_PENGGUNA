...
{
    public partial class ucJualGrid : UserControl
    {
        ...
        private void gvGridSk_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (viewTerpilih.SelectedRowsCount > 0)
                dataTerpilih = (SvcWasdalPTJualPnbpSelect.WASDALSROW_SELECT_JUAL_PNBP)viewTerpilih.GetRow(e.FocusedRowHandle);
        ...
        private void detailDataTerpilih()
        {
            try
            {
               dataTerpilih = (SvcWasdalPTJualPnbpSelect.WASDALSROW_SELECT_JUAL_PNBP)gvGridSk.GetFocusedRow();
               if (dataTerpilih != null)
               {
                   if (dataTerpilih.ID_TL_WASDAL_PINDAHTANGAN != null)
                   {
