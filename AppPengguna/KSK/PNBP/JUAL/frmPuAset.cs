...
namespace AppPengguna.KSK.PNBP.JUAL
{
    public partial class frmPuAset : Form
    {
        ...
        SvcWasdalPTJualPnbpAset.OutputParameters dOutDaftarAset;
        SvcWasdalPTJualPnbpAset.execute_pttClient ambilDaftarAset;
        SvcWasdalPTJualPnbpAset.WASDALSROW_ASET_WASDAL_JUAL_PNBP dataTerpilih;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                myThread.Start();
                SvcWasdalPTJualPnbpAset.InputParameters parInp = new SvcWasdalPTJualPnbpAset.InputParameters();
                parInp.P_COL = "";
                ...
                parInp.STR_WHERE = String.Format("NTPN = '{0}' AND ID_SATKER = {1} AND SK_KEPUTUSAN= '{2}' AND ID_SK_WASDAL_PINDAHTANGAN IS NULL AND ID_TL_WASDAL_PINDAHTANGAN = {3} {4}", ntpn, idSatker, skKeputusan,idTlWasdal, strCari);

                ambilDaftarAset = new SvcWasdalPTJualPnbpAset.execute_pttClient();
        ...
        private delegate void DsSimpanData(SvcWasdalPTJualPnbpAset.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalPTJualPnbpAset.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_ASET_WASDAL_JUAL_PNBP.Count();
            ...
            {
                dataOut.SF_ASET_WASDAL_JUAL_PNBP[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_ASET_WASDAL_JUAL_PNBP[i]);
            }
        ...
        public SvcWasdalPTJualPnbpAset.WASDALSROW_ASET_WASDAL_JUAL_PNBP daftarAsetTerpilih;
        ...
        private void bbiSimpan_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (rowTerpilih != null)
            {
                ...
                else
                {
                    ...
                    {
                        daftarAsetTerpilih = (SvcWasdalPTJualPnbpAset.WASDALSROW_ASET_WASDAL_JUAL_PNBP)daftarTerpilih[i];
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalPTJualPnbpAset.WASDALSROW_ASET_WASDAL_JUAL_PNBP)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
