...
namespace AppPengguna.KSK.PNBP.SWBMN
{
    public partial class frmPuAset : Form
    {
        ...
        public SimpanDaftarAsetPnbpTerpilihManfaat simpanAsetTerpilih = null;
        //SvcWasdalManfaatPnbpAset.OutputParameters dOutDaftarAset;
        //SvcWasdalManfaatPnbpAset.execute_pttClient ambilDaftarAset;
        //SvcWasdalManfaatPnbpAset.WASDALSROW_DTLSEL_MANFAAT_PNBP dataTerpilih;
        ...
        public SvcWasdalManfaatPnbpAset.WASDALSROW_ASET_WASDAL_MANFAAT_PNBP daftarAsetTerpilih;
        ...
        private void bbiSimpan_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (rowTerpilih != null)
            {
                ...
                else
                {
                    ...
                    {
                        daftarAsetTerpilih = (SvcWasdalManfaatPnbpAset.WASDALSROW_ASET_WASDAL_MANFAAT_PNBP)daftarTerpilih[i];
                    ...
                    id_tl_wasdal_manfaat = ((SvcWasdalManfaatPnbpAset.WASDALSROW_ASET_WASDAL_MANFAAT_PNBP)daftarTerpilih[0]).ID_TL_WASDAL_MANFAAT;
                    this.simpanAsetTerpilih(daftarIdAset, nilaiTotalAset, 'C', id_tl_wasdal_manfaat);
                    this.Close();
                }
            }
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) 
                dataTerpilih = (SvcWasdalManfaatPnbpAset.WASDALSROW_ASET_WASDAL_MANFAAT_PNBP)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
