...
{
    public partial class ucSewaBmnGrid : UserControl
    {
        ...
        private void gvGridSk_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            try
            {
                ...
                if (viewTerpilih.SelectedRowsCount > 0)
                    dataTerpilih = (SvcWasdalManfaatPnbpSelect.WASDALSROW_SELECT_MANFAAT_PNBP)viewTerpilih.GetRow(e.FocusedRowHandle);
            }
            catch (Exception)
            { 
        ...
        private void detailDataTerpilih()
        {
            try
            {
                dataTerpilih = (SvcWasdalManfaatPnbpSelect.WASDALSROW_SELECT_MANFAAT_PNBP)gvGridSk.GetFocusedRow();
                if (dataTerpilih != null)
                {
                    if (dataTerpilih.ID_TL_WASDAL_MANFAAT != null)
                    {
