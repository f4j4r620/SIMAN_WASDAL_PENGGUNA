    ...
    public partial class ucPNBPSewaBmnForm : UserControl
    {
        ...
        private void getDaftarAset()
        {
            try
            {
                ...
                parInput.P_SORT = "";
                parInput.STR_WHERE = String.Format(" (SK_KEPUTUSAN = '{0}' AND NTPN = '{1}' AND ID_WASDAL_PNBP = {2}) ", teNomorSk.Text.Trim(), teNTPN.Text, dataTerpilih.ID_WASDAL_PNBP);
        ...
        private void loadDataDaftarAset(SvcWasdalManfaatAsetPnbpSelect.OutputParameters outputDaftarAset)
        {
            ...
            // Perubahan , KD_BRG == "-" dibolehkan untuk ditampilkan pada detil aset
            // TGL : 13/03/2017
            // Request Mas Ben
