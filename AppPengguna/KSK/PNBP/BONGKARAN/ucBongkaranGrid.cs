...
{
    public partial class ucBongkaranGrid : UserControl
    {
        ...
        private void gvGridSk_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (viewTerpilih.SelectedRowsCount > 0)
                dataTerpilih = (SvcPnbpBongkaranSelect.WASDALSROW_SELECT_PNBP_BONG)viewTerpilih.GetRow(e.FocusedRowHandle);
        ...
        private void detailDataTerpilih()
        {
            try
            {
               dataTerpilih = (SvcPnbpBongkaranSelect.WASDALSROW_SELECT_PNBP_BONG)gvGridSk.GetFocusedRow();
               if (dataTerpilih != null)
               {
                   if (dataTerpilih.ID_TL_WASDAL_BNK != null)
                   {
