...
{
    public partial class ucPNBPBongkaranForm : UserControl
    {
        public ToggleProgressBar toggleProgressBar;
        public SimpanDataRPNBP simpanDataRkmPnbpBongkaran;
        ...
        public SvcPnbpBongkaranSelect.WASDALSROW_SELECT_PNBP_BONG dataTerpilih;
        public SvcTLBongkaranSelect.WASDALSROW_TL_BONGKARAN_GRID skTerpilih;
        ...
        public decimal? idSkPnbpBaru = null;
        public decimal? idSkPnbpLama = null;

        public ucPNBPBongkaranForm(string _status)
        {
            InitializeComponent();
            statusForm = _status;
        ...
        public void inisialisasiForm()
        {
            ...
            if (statusForm != "C" && statusForm != "CU")
            {
                ...
                idSkPNBP = dataTerpilih.ID_PNBP_BNK;
                idSkWasdal = dataTerpilih.ID_SK_BNK;
                idSkPnbpBaru = idSkPNBP;
                teNomorSk.Text = dataTerpilih.SK_KEPUTUSAN_BNK;
                noSkBaru = dataTerpilih.SK_KEPUTUSAN_BNK.Trim();
                tanggalSurat = Convert.ToDateTime(dataTerpilih.TGL_SK_BNK);
                ...
                idTlSkWasdal = dataTerpilih.ID_TL_WASDAL_BNK;
            ...
            else
            {
                ...
                idTlSkWasdal = skTerpilih.ID_TL_WASDAL_BNK;
            ...
            {
                case "C":
                    idSkPNBP = konfigApp.getGlobalId("ID_PNBP_BNK");
                ...
                case "CU":
                    ...
                    break;
                case "U":
                    this.idSkWasdal = dataTerpilih.ID_SK_BNK;
                    this.idSkPNBP = dataTerpilih.ID_PNBP_BNK;
            ...
            if (teNomorSk.Text.Trim() != "" && teNTPN.Text != "" && teKet.Text != "")
            {
                if (konfigApp.cekMinus(Convert.ToDecimal(teNilaiPnbp.Text)) == false)
                {
                    if (statusForm == "C" || statusForm == "U" || statusForm == "CU")
                        simpanDataRkmPnbpBongkaran(statusForm);
                    if (statusForm == "C")
                    {
                        sbTambah.Enabled = true;
                        sbHapus.Enabled = true;
        ...
        SvcPnbpBongkaranDtlSelect.OutputParameters dOutAsetSewaPnbp;
        SvcPnbpBongkaranDtlSelect.execute_pttClient ambilDaftarAsetPnbp;
        SvcPnbpBongkaranDtlSelect.WASDALSROW_DTLSEL_PNBP_BNK dataAsetTerpilih;
        ...
        private void getDaftarAset()
        {
            try
            {
                ...
                SvcPnbpBongkaranDtlSelect.InputParameters parInput = new SvcPnbpBongkaranDtlSelect.InputParameters();
                parInput.P_COL = "";
                parInput.P_COUNT = "N";
                parInput.P_MAX = 0;
                ...
                parInput.P_SORT = "";
                parInput.STR_WHERE = String.Format(" (SK_KEPUTUSAN_BNK = '{0}' AND NTPN = '{1}' )", teNomorSk.Text.Trim(), teNTPN.Text);
                ambilDaftarAsetPnbp = new SvcPnbpBongkaranDtlSelect.execute_pttClient();
        ...
        private delegate void LoadDataDaftarAset(SvcPnbpBongkaranDtlSelect.OutputParameters outputDaftarAset);

        private void loadDataDaftarAset(SvcPnbpBongkaranDtlSelect.OutputParameters outputDaftarAset)
        {
            int jmlData = outputDaftarAset.SF_DTLSEL_PNBP_BONG.Count();
            decimal? nilaiPersetujuan = 0;
            decimal? jmlKuantitas = 0;
            dsGridDaftarAset = new ArrayList();
            if (jmlData >= 1 && outputDaftarAset.SF_DTLSEL_PNBP_BONG[0].KD_BRG != "-")
            {
                for (int i = 0; i < jmlData; i++)
                {
                    dOutAsetSewaPnbp.SF_DTLSEL_PNBP_BONG[i].IS_TB = (dOutAsetSewaPnbp.SF_DTLSEL_PNBP_BONG[i].IS_TB == "Y" ? konfigApp.namaTb : konfigApp.namaNonTb);
                    dOutAsetSewaPnbp.SF_DTLSEL_PNBP_BONG[i].NUMSpecified = false;
                    dsGridDaftarAset.Add(dOutAsetSewaPnbp.SF_DTLSEL_PNBP_BONG[i]);
                    nilaiPersetujuan = nilaiPersetujuan + dOutAsetSewaPnbp.SF_DTLSEL_PNBP_BONG[i].NILAI_PERSETUJUAN;
                    jmlKuantitas = jmlKuantitas + dOutAsetSewaPnbp.SF_DTLSEL_PNBP_BONG[i].KUANTITAS;
                }
        ...
        BONGKARAN.frmPuAset formDaftarAsetKorwil;
        BONGKARAN.frmPuAset formDaftarAsetEselon1;
        BONGKARAN.frmPuAset formDaftarAsetKl;
        ...
        SvcPnbpBongkaranDtlCud.OutputParameters dOutSimpanAset;
        SvcPnbpBongkaranDtlCud.execute_pttClient simpanDftrAset;
        ...
        private void simpanDaftarAset(string _daftarIdAset,decimal? _nilaiTotalAset, char _modeCudAset)
        {
            try
            {
                myThread = new Thread(new ThreadStart(aktifkanProgresBar));
                myThread.Start();
                SvcPnbpBongkaranDtlCud.InputParameters parInp = new SvcPnbpBongkaranDtlCud.InputParameters();
                ...
                simpanDftrAset = new SvcPnbpBongkaranDtlCud.execute_pttClient();
                simpanDftrAset.Open();
        ...
        private delegate void DsDaftarAset(SvcPnbpBongkaranDtlCud.OutputParameters dataOut);

        private void dsDaftarAset(SvcPnbpBongkaranDtlCud.OutputParameters dataOut)
        {
            if (dataOut.PO_RESULT == "Y")
            {
                ...
                switch (modeCudAset)
                {
                    case 'C':
                        ...
                        SvcPnbpBongkaranDtlSelect.WASDALSROW_DTLSEL_PNBP_BNK dataPenyama;
                        ...
                        {
                            SvcPnbpBongkaranListAset.WASDALSROW_ASET_PNBP_BNK daftarAsetTerpilih = (SvcPnbpBongkaranListAset.WASDALSROW_ASET_PNBP_BNK)daftarAsetSalinan[i];
                            dataPenyama = null;
                            dataPenyama = new SvcPnbpBongkaranDtlSelect.WASDALSROW_DTLSEL_PNBP_BNK();
        ...
        {
            SvcPnbpBongkaranDtlSelect.WASDALSROW_DTLSEL_PNBP_BNK daftarAsetTerpilih;
            if (rowTerpilih != null)
            {
                ...
                else
                {
                    for (int i = 0; i < daftarTerpilih.Count; i++)
                    {
                        daftarAsetTerpilih = (SvcPnbpBongkaranDtlSelect.WASDALSROW_DTLSEL_PNBP_BNK)daftarTerpilih[i];
        ...
        private void gvDaftarAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            {
                dataAsetTerpilih = (SvcPnbpBongkaranDtlSelect.WASDALSROW_DTLSEL_PNBP_BNK)rowTerpilih.GetRow(e.FocusedRowHandle);
