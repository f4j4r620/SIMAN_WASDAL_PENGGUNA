...
namespace AppPengguna.KSK.PNBP.BONGKARAN
{
    public partial class frmPuAset : Form
    {
        ...
        SvcPnbpBongkaranListAset.OutputParameters dOutDaftarAset;
        SvcPnbpBongkaranListAset.execute_pttClient ambilDaftarAset;
        SvcPnbpBongkaranListAset.WASDALSROW_ASET_PNBP_BNK dataTerpilih;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                myThread.Start();
                SvcPnbpBongkaranListAset.InputParameters parInp = new SvcPnbpBongkaranListAset.InputParameters();
                parInp.P_COL = "";
                ...
                parInp.STR_WHERE = String.Format("NTPN = '{0}' AND ID_SATKER = {1} AND SK_KEPUTUSAN_BNK = '{2}' AND ID_SK_BNK IS NULL AND ID_TL_WASDAL_BNK = {3} {4}", ntpn, idSatker, skKeputusan, idTlWasdal, strCari);

                ambilDaftarAset = new SvcPnbpBongkaranListAset.execute_pttClient();
        ...
        private delegate void DsSimpanData(SvcPnbpBongkaranListAset.OutputParameters dataOut);

        private void dsSimpanData(SvcPnbpBongkaranListAset.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_ASET_PNBP_BNK.Count();
            ...
            {
                dataOut.SF_ASET_PNBP_BNK[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_ASET_PNBP_BNK[i]);
            }
        ...
        public SvcPnbpBongkaranListAset.WASDALSROW_ASET_PNBP_BNK daftarAsetTerpilih;
        ...
        private void bbiSimpan_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (rowTerpilih != null)
            {
                ...
                else
                {
                    ...
                    {
                        daftarAsetTerpilih = (SvcPnbpBongkaranListAset.WASDALSROW_ASET_PNBP_BNK)daftarTerpilih[i];
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcPnbpBongkaranListAset.WASDALSROW_ASET_PNBP_BNK)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
