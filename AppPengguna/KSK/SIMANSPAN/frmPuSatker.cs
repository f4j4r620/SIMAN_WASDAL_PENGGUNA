...
namespace AppPengguna.KSK.SIMANSPAN
{
    public partial class frmPuSatker : Form
    {
        ...
        public SelectSatkerPerbandingan selectUnitKerja;
        public string idManualLama = null;
        public string idManualBaru = null;
        public string kode_satker_span = "";
        ...
        public void getInitialData()
        {
            try
            {
                ...
                parInp.P_SORT = "";
                string _strWhere = String.Format(" KD_SATKER like '%{0}%' {1} ", kode_satker_span, strCari);
                //if (whereAwal != "" && strCari != "") _strWhere = String.Format(" kd_satker like '%{0}%' {1} ", kode_satker_span, strCari);
