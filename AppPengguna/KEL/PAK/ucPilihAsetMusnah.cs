...
{
    public partial class ucPilihAsetMusnah : UserControl
    {
        public ucPilihAsetMusnah()
        {
            InitializeComponent();
        }
        ...
        SvcKelPilihAsetMusnah.execute_pttClient fetchdata;
        SvcKelPilihAsetMusnah.OutputParameters output;
        ...
        public void load()
        {
            try
            {
                ...
                myThread.Start();
                SvcKelPilihAsetMusnah.InputParameters parInp = new SvcKelPilihAsetMusnah.InputParameters();
                ...
                fetchdata = new SvcKelPilihAsetMusnah.execute_pttClient();
        ...
        private delegate void DsRskPspBmn(SvcKelPilihAsetMusnah.OutputParameters dataOut);

        private void dsRskPspBmn(SvcKelPilihAsetMusnah.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_ROW_ASET_PEMUSNAHAN.Count();
            if (dataInisial) arrayList = new ArrayList();

            foreach (SvcKelPilihAsetMusnah.DBKELOLASROW_ASET_PEMUSNAHAN item in dataOut.SF_ROW_ASET_PEMUSNAHAN)
                arrayList.Add(item);
