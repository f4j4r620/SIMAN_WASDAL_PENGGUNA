...
namespace AppPengguna.KEL
{
    public partial class ucPilihAsetPsp : UserControl
    {
        ...
        SvcKelPilihAsetPsp.execute_pttClient fetchdata;
        SvcKelPilihAsetPsp.OutputParameters output;
        ...
        public void load()
        {
            try
            {
                ...
                myThread.Start();
                SvcKelPilihAsetPsp.InputParameters parInp = new SvcKelPilihAsetPsp.InputParameters();
                ...
                fetchdata = new SvcKelPilihAsetPsp.execute_pttClient();
        ...
        private delegate void DsRskPspBmn(SvcKelPilihAsetPsp.OutputParameters dataOut);

        private void dsRskPspBmn(SvcKelPilihAsetPsp.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_ROW_ASET_STAT_GUNA.Count();
            if (dataInisial) arrayList = new ArrayList();

            foreach (SvcKelPilihAsetPsp.DBKELOLASROW_ASET_STAT_GUNA item in dataOut.SF_ROW_ASET_STAT_GUNA)
                arrayList.Add(item);
