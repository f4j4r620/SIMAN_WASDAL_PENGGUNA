...
{
    public partial class ucPilihAsetPbksl : UserControl
    {
        public ucPilihAsetPbksl()
        {
            InitializeComponent();
        }
        ...
        SvcKelPilihAsetPbksl.execute_pttClient fetchdata;
        SvcKelPilihAsetPbksl.OutputParameters output;
        ...
        public void load()
        {
            try
            {
                ...
                myThread.Start();
                SvcKelPilihAsetPbksl.InputParameters parInp = new SvcKelPilihAsetPbksl.InputParameters();
                ...
                fetchdata = new SvcKelPilihAsetPbksl.execute_pttClient();
        ...
        private delegate void DsRskPspBmn(SvcKelPilihAsetPbksl.OutputParameters dataOut);

        private void dsRskPspBmn(SvcKelPilihAsetPbksl.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_ROW_ASET_HAPUS_SEBAB_LAIN.Count();
            if (dataInisial) arrayList = new ArrayList();

            foreach (SvcKelPilihAsetPbksl.DBKELOLASROW_ASET_HAPUS_SEBAB_LAIN item in dataOut.SF_ROW_ASET_HAPUS_SEBAB_LAIN)
                arrayList.Add(item);
