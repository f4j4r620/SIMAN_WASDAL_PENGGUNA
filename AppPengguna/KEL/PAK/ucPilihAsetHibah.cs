...
{
    public partial class ucPilihAsetHibah : UserControl
    {
        public ucPilihAsetHibah()
        {
            InitializeComponent();
        }
        ...
        SvcKelPilihAsetHibah.execute_pttClient fetchdata;
        SvcKelPilihAsetHibah.OutputParameters output;
        ...
        public void load()
        {
            try
            {
                ...
                myThread.Start();
                SvcKelPilihAsetHibah.InputParameters parInp = new SvcKelPilihAsetHibah.InputParameters();
                ...
                fetchdata = new SvcKelPilihAsetHibah.execute_pttClient();
        ...
        private delegate void DsRskPspBmn(SvcKelPilihAsetHibah.OutputParameters dataOut);

        private void dsRskPspBmn(SvcKelPilihAsetHibah.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_ROW_ASET_HIBAH.Count();
            if (dataInisial) arrayList = new ArrayList();

            foreach (SvcKelPilihAsetHibah.DBKELOLASROW_ASET_HIBAH item in dataOut.SF_ROW_ASET_HIBAH)
                arrayList.Add(item);
