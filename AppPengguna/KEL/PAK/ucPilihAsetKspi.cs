...
{
    public partial class ucPilihAsetKspi : UserControl
    {
        public ucPilihAsetKspi()
        {
            InitializeComponent();
        }
        ...
        SvcKelPilihAsetKspi.execute_pttClient fetchdata;
        SvcKelPilihAsetKspi.OutputParameters output;
        ...
        public void load()
        {
            try
            {
                ...
                myThread.Start();
                SvcKelPilihAsetKspi.InputParameters parInp = new SvcKelPilihAsetKspi.InputParameters();
                ...
                fetchdata = new SvcKelPilihAsetKspi.execute_pttClient();
        ...
        private delegate void DsRskPspBmn(SvcKelPilihAsetKspi.OutputParameters dataOut);

        private void dsRskPspBmn(SvcKelPilihAsetKspi.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_ROW_ASET_BSG.Count();
            if (dataInisial) arrayList = new ArrayList();

            foreach (SvcKelPilihAsetKspi.DBKELOLASROW_ASET_BSG item in dataOut.SF_ROW_ASET_BSG)
                arrayList.Add(item);
