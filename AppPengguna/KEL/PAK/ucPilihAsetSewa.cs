...
{
    public partial class ucPilihAsetSewa : UserControl
    {
        public ucPilihAsetSewa()
        {
            InitializeComponent();
        }
        ...
        SvcKelPilihAsetSewa.execute_pttClient fetchdata;
        SvcKelPilihAsetSewa.OutputParameters output;
        ...
        public void load()
        {
            try
            {
                ...
                myThread.Start();
                SvcKelPilihAsetSewa.InputParameters parInp = new SvcKelPilihAsetSewa.InputParameters();
                ...
                fetchdata = new SvcKelPilihAsetSewa.execute_pttClient();
        ...
        private delegate void DsRskPspBmn(SvcKelPilihAsetSewa.OutputParameters dataOut);

        private void dsRskPspBmn(SvcKelPilihAsetSewa.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_ROW_ASET_SEWA_BMN.Count();
            if (dataInisial) arrayList = new ArrayList();

            foreach (SvcKelPilihAsetSewa.DBKELOLASROW_ASET_SEWA_BMN item in dataOut.SF_ROW_ASET_SEWA_BMN)
                arrayList.Add(item);
