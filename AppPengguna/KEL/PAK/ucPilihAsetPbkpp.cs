...
{
    public partial class ucPilihAsetPbkpp : UserControl
    {
        public ucPilihAsetPbkpp()
        {
            InitializeComponent();
        }
        ...
        SvcKelPilihAsetPbkpp.execute_pttClient fetchdata;
        SvcKelPilihAsetPbkpp.OutputParameters output;
        ...
        public void load()
        {
            try
            {
                ...
                myThread.Start();
                SvcKelPilihAsetPbkpp.InputParameters parInp = new SvcKelPilihAsetPbkpp.InputParameters();
                ...
                fetchdata = new SvcKelPilihAsetPbkpp.execute_pttClient();
        ...
        private delegate void DsRskPspBmn(SvcKelPilihAsetPbkpp.OutputParameters dataOut);

        private void dsRskPspBmn(SvcKelPilihAsetPbkpp.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_ROW_ASET_HAPUS_PUTUSAN.Count();
            if (dataInisial) arrayList = new ArrayList();

            foreach (SvcKelPilihAsetPbkpp.DBKELOLASROW_ASET_HAPUS_PUTUSAN item in dataOut.SF_ROW_ASET_HAPUS_PUTUSAN)
                arrayList.Add(item);
