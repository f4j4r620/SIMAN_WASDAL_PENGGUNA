...
{
    public partial class ucPilihAsetPmp : UserControl
    {
        public ucPilihAsetPmp()
        {
            InitializeComponent();
        }
        ...
        SvcKelPilihAsetPmp.execute_pttClient fetchdata;
        SvcKelPilihAsetPmp.OutputParameters output;
        ...
        public void load()
        {
            try
            {
                ...
                myThread.Start();
                SvcKelPilihAsetPmp.InputParameters parInp = new SvcKelPilihAsetPmp.InputParameters();
                ...
                fetchdata = new SvcKelPilihAsetPmp.execute_pttClient();
        ...
        private delegate void DsRskPspBmn(SvcKelPilihAsetPmp.OutputParameters dataOut);

        private void dsRskPspBmn(SvcKelPilihAsetPmp.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_ROW_ASET_SERTA_MODAL.Count();
            if (dataInisial) arrayList = new ArrayList();

            foreach (SvcKelPilihAsetPmp.DBKELOLASROW_ASET_SERTA_MODAL item in dataOut.SF_ROW_ASET_SERTA_MODAL)
                arrayList.Add(item);
