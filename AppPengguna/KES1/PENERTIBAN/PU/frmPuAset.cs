    ...
    public partial class frmPuAset : Form
    {
        ...
        public void getInitialData()
        {
            try
            {
                ...
                parInp.STR_WHERE = String.Format(" {0} ID_ESELON1 = {1} AND IN_KD_PELAYANAN =  {2} {3}",whereTb, konfigApp.idEselon1, konfigApp.kdPelayanan,strCari);
        ...
        private void bbiSimpan_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (rowTerpilih != null)
            {
                ...
                idAset = daftarAsetTerpilih.ID_ASET;
                noReg = daftarAsetTerpilih.NOREG;
            }
