...
namespace AppPengguna.KES1.WL.PENGGUNAAN
{
    ...
    public partial class ucPenggunaanNew : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        SvcMonGunaKorEsKlA1.selectMonGunaKorEsKlA1_pttClient SvcMonSatkerGunaA1Select = null;
        ...
        public ucPenggunaanNew(FrmKoorEselon1 _frmSatker, ucLapWasdal _ucASPBMN)
        {
            InitializeComponent();
        ...
        public void getTindakLanjut()
        {
            ...
            try
            {
                ...
                parInp.P_COL = "";
                parInp.P_SORT = "";
                SvcMonSatkerGunaA1Select = new SvcMonGunaKorEsKlA1.selectMonGunaKorEsKlA1_pttClient();
