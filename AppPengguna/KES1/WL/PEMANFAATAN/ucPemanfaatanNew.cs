...
namespace AppPengguna.KES1.WL.PEMANFAATAN
{
    ...
    public partial class ucPemanfaatanNew : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        SvcMonManfaatKorEsKlA1.selectMonManfaatKorEsKlA1_pttClient SvcMonManfaatKorEsKlSelect = null;
        ...
        public ucPemanfaatanNew(FrmKoorEselon1 _frmSatker, ucLapWasdal _ucASPBMN)
        {
            InitializeComponent();
        ...
        public void getTindakLanjut()
        {
            ...
            try
            {
                ...
                parInp.P_COL = "";
                parInp.P_SORT = "";
                SvcMonManfaatKorEsKlSelect = new SvcMonManfaatKorEsKlA1.selectMonManfaatKorEsKlA1_pttClient();
                SvcMonManfaatKorEsKlSelect.Beginexecute(parInp, new AsyncCallback(getDataAngkutan), null);
            }
            catch
            {
        ...
        private void getDataAngkutan(IAsyncResult result)
        {
            try
            {
                outLapGunaSkSelect = SvcMonManfaatKorEsKlSelect.Endexecute(result);
                SvcMonManfaatKorEsKlSelect.Close();
                frmSatker.fToggleProgressBar("finish");
                this.Invoke(new AktifkanForm(frmSatker.aktifkanForm), "");
