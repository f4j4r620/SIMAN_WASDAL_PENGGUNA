...
namespace AppPengguna.KES1.MWD.PMBMN.DETAIL1
{
    ...
    public partial class ucTindakLanjut : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucTindakLanjut(FrmKoorEselon1 _frmKl, ucPMBMN _ucPMBMN)
        {
            InitializeComponent();
            this.frmKl = _frmKl;
            PMBMN = _ucPMBMN;
        ...
        public void getTindakLanjut()
        {
            ...
            try
            {
                ...
                parInp.STR_WHERE = "ID_ESELON1 = " + konfigApp.idEselon1 + " AND (NO_SURAT <> '-') " + PMBMN.strKdPelayanan + this.strCari;
