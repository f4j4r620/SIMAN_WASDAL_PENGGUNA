...
namespace AppPengguna.KES1.MWD.ASPBMN.DETAIL1
{
    ...
    public partial class ucTindakLanjut : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucTindakLanjut(FrmKoorEselon1 _frmKl, ucASPBMN _ucASPBMN)
        {
            InitializeComponent();
            this.frmKl = _frmKl;
            ASPBMN = _ucASPBMN;
        ...
        public void getTindakLanjut()
        {
            ...
            try
            {
                ...
                parInp.STR_WHERE = "ID_ESELON1 = "+konfigApp.idEselon1+" AND (NO_SURAT <> '-') " + ASPBMN.strKdPelayanan + this.strCari;
