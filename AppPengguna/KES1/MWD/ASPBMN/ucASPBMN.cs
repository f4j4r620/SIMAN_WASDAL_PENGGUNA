...
namespace AppPengguna.KES1.MWD.ASPBMN
{
    ...
    public partial class ucASPBMN : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucASPBMN(FrmKoorEselon1 _frmKoorKL)
        {
            InitializeComponent();
        ...
        public void initSearch()
        {
            ...
            this.dtParams1.Add("%{1}%");
            this.addColumn("NM_PHK_LAIN", "NAMA PIHAK LAIN");
            this.dtParams1.Add("{1}%");
        ...
        private string getFieldKolom(int indeKKLolom)
        {
            if (indeKKLolom > -1) return daftarFieldKolom[indeKKLolom].ToString();
            else return "";
        }
