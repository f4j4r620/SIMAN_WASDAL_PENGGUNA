...
namespace AppPengguna.KES1.MWD.PENJUALAN
{
...

    {
        ...
        SvcWasdalPTJualDetilCud.call_pttClient svcWasdalPTJualDetilCud = null;
        SvcWasdalPTJualDetilCud.OutputParameters dataoutWlPENJUALANDetailCrud = null;
        ucPENJUALAN ucPBMNS;
        ...
        public frmTL(ucPENJUALAN _ucPENJUALAN)
        {
            InitializeComponent();
            this.ucPBMNS = _ucPENJUALAN;
        }
        ...
        #region CRUD ASET
        public void crudWlDetailPenjualan()
        {
            try
            {
                this.setThread(true);

                SvcWasdalPTJualDetilCud.InputParameters parInp = new SvcWasdalPTJualDetilCud.InputParameters();
                ...
                svcWasdalPTJualDetilCud = new SvcWasdalPTJualDetilCud.call_pttClient();
                svcWasdalPTJualDetilCud.Beginexecute(parInp, new AsyncCallback(resultPENJUALANDetailCrud), "");
            }
            catch
            {
        ...
        private void resultPENJUALANDetailCrud(IAsyncResult result)
        {
            try
            {
                dataoutWlPENJUALANDetailCrud = svcWasdalPTJualDetilCud.Endexecute(result);
                svcWasdalPTJualDetilCud.Close();
                this.setThread(false);
                this.Invoke(new ResponWlPENJUALANDetailCrud(this.responWlPENJUALANDetailCrud), dataoutWlPENJUALANDetailCrud);
            }
            catch (Exception e)
            {
                this.setThread(false);
        ...
        private delegate void ResponWlPENJUALANDetailCrud(SvcWasdalPTJualDetilCud.OutputParameters dataoutWlPENJUALANDetailCrud);
        private void responWlPENJUALANDetailCrud(SvcWasdalPTJualDetilCud.OutputParameters dataoutWlPENJUALANDetailCrud)
        {
            if (dataoutWlPENJUALANDetailCrud.PO_RESULT == "Y")
            {
            ...
            {
                this.setThread(false);
                MessageBox.Show(dataoutWlPENJUALANDetailCrud.PO_RESULT_MESSAGE, konfigApp.judulGagal);
            }
        }
