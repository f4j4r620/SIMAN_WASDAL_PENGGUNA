...
namespace AppPengguna.KES1.MWD.HapusBmnPengadilan.DETAIL1
{
    ...
    public partial class ucTindakLanjut : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucTindakLanjut(FrmKoorEselon1 _frmKl, ucHapusBmnPengadilan _ucHapusBmnPengadilan)
        {
            InitializeComponent();
            this.frmKl = _frmKl;
        ...
        public void getTindakLanjut()
        {
            ...
            try
            {
                ...
                parInp.STR_WHERE = "ID_ESELON1 = " + konfigApp.idEselon1 + " AND (NO_SURAT <> '-') " + HapusBmnPengadilan.strKdPelayanan + this.strCari;
                parInp.P_COL = "KD_BRG";
                parInp.P_SORT = "ASC";
                parInp.P_COUNT = "y";
