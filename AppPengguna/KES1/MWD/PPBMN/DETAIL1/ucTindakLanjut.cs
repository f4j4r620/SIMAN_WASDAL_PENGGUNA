...
namespace AppPengguna.KES1.MWD.PPBMN.DETAIL1
{
    ...
    public partial class ucTindakLanjut : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucTindakLanjut(FrmKoorEselon1 _frmKl, ucPPBMN _ucPPBMN)
        {
            InitializeComponent();
            this.frmKl = _frmKl;
            PPBMN = _ucPPBMN;
        ...
        public void getTindakLanjut()
        {
            ...
            try
            {
                ...
                parInp.STR_WHERE = "ID_ESELON1 = " + konfigApp.idEselon1 + " AND (NO_SURAT <> '-') " + PPBMN.strKdPelayanan + this.strCari;
