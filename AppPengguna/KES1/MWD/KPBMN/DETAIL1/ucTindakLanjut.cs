...
namespace AppPengguna.KES1.MWD.KPBMN.DETAIL1
{
    ...
    public partial class ucTindakLanjut : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucTindakLanjut(FrmKoorEselon1 _frmKl, ucKPBMN _ucASPBMN)
        {
            InitializeComponent();
            this.frmKl = _frmKl;
            KPBMN = _ucASPBMN;
        ...
        public void getTindakLanjut()
        {
            ...
            try
            {
                ...
                parInp.STR_WHERE = "ID_ESELON1 = " + konfigApp.idEselon1 + " AND (NO_SURAT <> '-') " + KPBMN.strKdPelayanan + this.strCari;
