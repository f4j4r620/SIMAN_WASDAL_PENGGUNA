...
using AppPengguna.KES1.MWD.ASPBMN;
...
namespace AppPengguna.KES1.MWD.TUKAR
{
...

    {
        ...
        SvcWasdalPTTukarDetilCud.execute_pttClient svcWasdalPTTukarDetilCud = null;
        SvcWasdalPTTukarDetilCud.OutputParameters dataoutWlPSPBMNLAINDetailCrud = null;
        ucTukar ucTukar;
        ...
        public string AsetPenggantiAlamat { get; set; }
        public decimal? AsetPenggantiLuas { get; set; }
        public string AsetPenggantiJenis { get; set; }
        public decimal? AsetPenggantiKuantitas { get; set; }
        ...
        public frmTL(ucTukar _ucPSPBMNLAIN)
        {
            InitializeComponent();
            this.ucTukar = _ucPSPBMNLAIN;
        }
        ...
        public void crudWlDetailPSPBMNLAIN()
        {
            try
            {
                ...
                SvcWasdalPTTukarDetilCud.InputParameters parInp = new SvcWasdalPTTukarDetilCud.InputParameters();

                parInp.P_ASET_PENGGANTI_ALAMAT = AsetPenggantiAlamat;
                //parInp.P_FILE_BUKTI = FILE_BUKTI;
                parInp.P_ID_ASET = idAset.ToString();
                parInp.P_ASET_PENGGANTI_JENIS = AsetPenggantiJenis;
                parInp.P_ASET_PENGGANTI_KUANTITAS = AsetPenggantiKuantitas;
                parInp.P_ASET_PENGGANTI_KUANTITASSpecified = true;
                parInp.P_JNS_BUKTI_LAKSANA = JNS_BUKTI_LAKSANA;
                parInp.P_ASET_PENGGANTI_LUAS = AsetPenggantiLuas;
                ...
                svcWasdalPTTukarDetilCud = new SvcWasdalPTTukarDetilCud.execute_pttClient();
                svcWasdalPTTukarDetilCud.Beginexecute(parInp, new AsyncCallback(resultPSPBMNLAINDetailCrud), "");
            }
            catch
            {
        ...
        private void resultPSPBMNLAINDetailCrud(IAsyncResult result)
        {
            try
            {
                dataoutWlPSPBMNLAINDetailCrud = svcWasdalPTTukarDetilCud.Endexecute(result);
                svcWasdalPTTukarDetilCud.Close();
                this.setThread(false);
        ...
        private delegate void ResponWlPSPBMNLAINDetailCrud(SvcWasdalPTTukarDetilCud.OutputParameters dataoutWlPSPBMNLAINDetailCrud);
        private void responWlPSPBMNLAINDetailCrud(SvcWasdalPTTukarDetilCud.OutputParameters dataoutWlPSPBMNLAINDetailCrud)
        {
