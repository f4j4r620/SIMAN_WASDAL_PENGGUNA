...
namespace AppPengguna.KES1.MWD.TUKAR.DETAIL1
{
    ...
    public partial class ucTindakLanjut : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucTindakLanjut(FrmKoorEselon1 _frmKl, ucTukar _ucTUKAR)
        {
            InitializeComponent();
            this.frmKl = _frmKl;
            TUKAR = _ucTUKAR;
        ...
        public void getTindakLanjut()
        {
            ...
            try
            {
                ...
                parInp.STR_WHERE = "ID_ESELON1 = " + konfigApp.idEselon1 + " AND (NO_SURAT <> '-') " + TUKAR.strKdPelayanan + this.strCari;
