...
namespace AppPengguna.KES1.MWD.BGS.DETAIL1
{
    ...
    public partial class ucTindakLanjut : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucTindakLanjut(FrmKoorEselon1 _frmSatker, ucBGS _ucBGS)
        {
            InitializeComponent();
            this.frmKl = _frmSatker;
            BGS = _ucBGS;
        }
        ...
        public void getTindakLanjut()
        {
            ...
            try
            {
                ...
                parInp.STR_WHERE = "ID_ESELON1 = " + konfigApp.idEselon1 + " AND (NO_SURAT <> '-') " + BGS.strKdPelayanan + this.strCari;
