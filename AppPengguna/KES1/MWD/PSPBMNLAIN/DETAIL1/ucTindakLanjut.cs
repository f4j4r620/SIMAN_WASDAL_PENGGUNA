...
namespace AppPengguna.KES1.MWD.PSPBMNLAIN.DETAIL1
{
    ...
    public partial class ucTindakLanjut : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucTindakLanjut(FrmKoorEselon1 _frmKl, ucPSPBMNLAIN _ucPSPBMNLAIN)
        {
            InitializeComponent();
            this.frmKl = _frmKl;
        ...
        public void getTindakLanjut()
        {
            ...
            try
            {
                ...
                parInp.STR_WHERE = "ID_ESELON1 = " + konfigApp.idEselon1 + " AND (NO_SURAT <> '-') " + PSPBMNLAIN.strKdPelayanan + this.strCari;
