...
namespace AppPengguna.KES1.MWD.PSPBMNLAIN
{
    ...
    public partial class frmTL : DevExpress.XtraEditors.XtraForm
    {
        ...
        SvcWasdalPSPBMNLAINDetailCrud.execute_pttClient svcWlPSPBMNLAINDetailCrud = null;
        SvcWasdalPSPBMNLAINDetailCrud.OutputParameters dataoutWlPSPBMNLAINDetailCrud = null;

        ucPSPBMNLAIN ucPSPBMNLAIN;
        ...
        public void SETPERIODE(string kd)
        {
            ...
            else if (kd.Equals("Mingguan"))
                cbPeriode.SelectedIndex = 1;
            else if (kd.Equals("Bulanan"))
                cbPeriode.SelectedIndex = 2;
            else if (kd.Equals("Tahunan"))
        ...
        public frmTL(ucPSPBMNLAIN _ucPSPBMNLAIN)
        {
            Icon = Properties.Resources.logo_2016;
            InitializeComponent();
            this.ucPSPBMNLAIN = _ucPSPBMNLAIN;
        }
        ...
        //    input.P_COL = "";
        //    input.P_SORT = "";
        //    input.STR_WHERE = "AND (KD_STATUS = '05')";
        //    outputStatus = new SvcStatusSelect.OutputParameters();
     ...
     //       teDokPelaksana.Properties.DataSource = outputJnsDok.SF_ROW_R_JNS_DOK;
        ...
        public void crudWlDetailPSPBMNLAIN()
        {
            try
            {
                ...
                parInp.P_PERIODE = GETPERIODE();

                parInp.P_SELECT = "U";

                svcWlPSPBMNLAINDetailCrud = new SvcWasdalPSPBMNLAINDetailCrud.execute_pttClient();
        ...
        private delegate void ResponWlPSPBMNLAINDetailCrud(SvcWasdalPSPBMNLAINDetailCrud.OutputParameters dataoutWlPSPBMNLAINDetailCrud);
        private void responWlPSPBMNLAINDetailCrud(SvcWasdalPSPBMNLAINDetailCrud.OutputParameters dataoutWlPSPBMNLAINDetailCrud)
        {
            if (dataoutWlPSPBMNLAINDetailCrud.PO_RESULT == "Y")
            {
                ucPSPBMNLAIN.tabSelect();
                this.Close();
            }
            else
            {
