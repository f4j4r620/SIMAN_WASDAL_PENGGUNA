...
namespace AppPengguna.KES1.MWD.PSPBMN.DETAIL1 
{
    ...
    public partial class ucTindakLanjut : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucTindakLanjut(FrmKoorEselon1 _frmKl, ucPSPBMN _ucPSPBMN)
        {
            InitializeComponent();
            this.frmKl = _frmKl;
            PSPBMN = _ucPSPBMN;
        ...
        public void getTindakLanjut()
        {
            ...
            try
            {
                ...
                parInp.STR_WHERE = "ID_ESELON1 = " + konfigApp.idEselon1 + " AND (NO_SURAT <> '-')" + PSPBMN.strKdPelayanan + this.strCari;
