...
namespace AppPengguna.KES1.MWD.PSPBMN.DETAIL2
{
    ...
    public partial class ucTanah : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucTanah(FrmKoorEselon1 _frmKpknl, ucPSPBMN _ucPspBmn)
        {
            InitializeComponent();
        ...
        {
            int jmlData = dataOut.SF_MON_KTNH_PSP2.Count(); decimal jmlCurrent = 0;
            string totalData = (jmlData == 0) ? jmlData.ToString() : dataOut.SF_MON_KTNH_PSP2[jmlData - 1].TOTAL_DATA.ToString();
