...
namespace AppPengguna.KES1.MWD.PSPBMN.DETAIL2
{
    ...
    public partial class ucPropSus : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucPropSus(FrmKoorEselon1 _frmKpknl, ucPSPBMN _ucPspBmn)
        {
            InitializeComponent();
        ...
        private void loadDataPropSus(SvcMonPropSusSelect.OutputParameters dataOut)
        {
            ...
            string totalData = (jmlData == 0) ? jmlData.ToString() : dataOut.SF_MON_KPROK_PSP2[jmlData - 1].TOTAL_DATA.ToString();
