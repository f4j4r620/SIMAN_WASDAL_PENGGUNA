...
namespace AppPengguna.KES1.MWD.PSPBMN.DETAIL2
{
    ...
    public partial class ucSejarah : DevExpress.XtraEditors.XtraUserControl
    {
        ...
        public ucSejarah(FrmKoorSatker _frmKpknl, ucPSPBMN _ucPspBmn)
        {
            InitializeComponent();
        ...
        private void loadDataSejarah(SvcMonSjrhSelect.OutputParameters dataOut)
        {
            ...
            string totalData = (jmlData == 0) ? jmlData.ToString() : dataOut.SF_MON_SEJARAH_PSP[jmlData - 1].TOTAL_DATA.ToString();
