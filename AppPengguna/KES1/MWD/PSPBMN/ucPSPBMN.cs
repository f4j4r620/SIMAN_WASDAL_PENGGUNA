...
namespace AppPengguna.KES1.MWD.PSPBMN
{
    ...
    public partial class ucPSPBMN : DevExpress.XtraEditors.XtraUserControl
    {
       ...
       // public DETAIL2.ucPersediaan persediaan2 = null;
        ...
        public ucPSPBMN(FrmKoorEselon1 _frmKoorKL)
        {
            InitializeComponent();
            this.FrmKoorEselon1 = _frmKoorKL;
            this.initSearch();
        ...
        public void tabSelect()
        {
            ...
            if (xtcPSP.SelectedTabPageIndex == 0)
            {
                ...
                if (xtbDetail1.SelectedTabPageIndex == 0)
                {
                    if (!tabTindakLanjut1Open)
                    {
                        ...
                        {
                            tindakLanjut1 = new DETAIL1.ucTindakLanjut(FrmKoorEselon1, this);
                ...
                //    if (!tabTanah1Open)
                //    {
                //        tanah1 = new DETAIL1.ucTanah(FrmKoorEselon1, this);
                ...
                //    if (!tabBangunan1Open)
                //    {
                //        bangunan1 = new DETAIL1.ucBangunan(FrmKoorEselon1, this);
                ...
                //    if (!tabRmhNgr1Open)
                //    {
                //        rmhNgr1 = new DETAIL1.ucRmhNgr(FrmKoorEselon1, this);
                ...
                //    if (!tabAngkutan1Open)
                //    {
                //        angkutan1 = new DETAIL1.ucAngkutan(FrmKoorEselon1, this);
                ...
                //    if (!tabBgnAir1Open)
                //    {
                //        bangunanAir1 = new DETAIL1.ucBangunanAir(FrmKoorEselon1, this);
                ...
                //    if (!tabSenjata1Open)
                //    {
                //        senjata1 = new DETAIL1.ucSenjata(FrmKoorEselon1, this);
                ...
                //    if (!tabMsnNTik1Open)
                //    {
                //        mesinNonTik1 = new DETAIL1.ucMesinNonTik(FrmKoorEselon1, this);
                ...
                //    if (!tabJlnJmbtn1Open)
                //    {
                //        jlnJmbtn1 = new DETAIL1.ucJlnJmbtn(FrmKoorEselon1, this);
                ...
                //    if (!tabPropSus1Open)
                //    {
                //        propSus1 = new DETAIL1.ucPropSus(FrmKoorEselon1, this);
                ...
                //    if (!tabAtl1Open)
                //    {
                //        ATL1 = new DETAIL1.ucATL(FrmKoorEselon1, this);
                ...
                //    if (!tabMsnTik1Open)
                //    {
                //        mesinTik1 = new DETAIL1.ucMesinTik(FrmKoorEselon1, this);
                ...
                //    if (!tabAtb1Open)
                //    {
                //        ATB1 = new DETAIL1.ucATB(FrmKoorEselon1, this);
                ...
                //    if (!tabKdp1Open)
                //    {
                //        KDP1 = new DETAIL1.ucKDP(FrmKoorEselon1, this);
                ...
                //    if (!tabRenov1Open)
                //    {
                //        renovasi1 = new DETAIL1.ucRenovasi(FrmKoorEselon1, this);
            ...
            else 
            {
                ...
                if (xtbDetail2.SelectedTabPageIndex == 0)
                {
                    if (!tabTanah2Open)
                    {
                        tanah2 = new DETAIL2.ucTanah(FrmKoorEselon1, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 1)
                {
                    if (!tabBangunan2Open)
                    {
                        bangunan2 = new DETAIL2.ucBangunan(FrmKoorEselon1, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 2)
                {
                    if (!tabRmhNgr2Open)
                    {
                        rmhNgr2 = new DETAIL2.ucRmhNgr(FrmKoorEselon1, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 3)
                {
                    if (!tabAngkutan2Open)
                    {
                        angkutan2 = new DETAIL2.ucAngkutan(FrmKoorEselon1, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 4)
                {
                    if (!tabBgnAir2Open)
                    {
                        bangunanAir2 = new DETAIL2.ucBangunanAir(FrmKoorEselon1, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 5)
                {
                    if (!tabSenjata2Open)
                    {
                        senjata2 = new DETAIL2.ucSenjata(FrmKoorEselon1, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 6)
                {
                    if (!tabMsnNTik2Open)
                    {
                        mesinNonTik2 = new DETAIL2.ucMesinNonTik(FrmKoorEselon1, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 7)
                {
                    if (!tabJlnJmbtn2Open)
                    {
                        jlnJmbtn2 = new DETAIL2.ucJlnJmbtn(FrmKoorEselon1, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 8)
                {
                    if (!tabPropSus2Open)
                    {
                        propSus2 = new DETAIL2.ucPropSus(FrmKoorEselon1, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 9)
                {
                    if (!tabAtl2Open)
                    {
                        ATL2 = new DETAIL2.ucATL(FrmKoorEselon1, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 10)
                {
                    if (!tabMsnTik2Open)
                    {
                        mesinTik2 = new DETAIL2.ucMesinTik(FrmKoorEselon1, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 11)
                {
                    if (!tabAtb2Open)
                    {
                        ATB2 = new DETAIL2.ucATB(FrmKoorEselon1, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 12)
                {
                    if (!tabKdp2Open)
                    {
                        KDP2 = new DETAIL2.ucKDP(FrmKoorEselon1, this);
                ...
                else if (xtbDetail2.SelectedTabPageIndex == 13)
                {
                    if (!tabRenov2Open)
                    {
                        renovasi2 = new DETAIL2.ucRenovasi(FrmKoorEselon1, this);
