...
namespace AppPengguna.KES1.MWD.PSPBMN
{
    ...
    public partial class frmTL : DevExpress.XtraEditors.XtraForm
    {
        ...
        public frmTL(ucPSPBMN _ucPSPBMN)
        {
            InitializeComponent();
        ...
        private void sbSave_Click(object sender, EventArgs e)
        {
            ...
            //crudWlDetailPSPBMN();
            if (MessageBox.Show(String.Format("Apakah anda ingin tindak lanjut yang sama untuk BMN lain dengan No SK {0}?", this.skKeputusan), konfigApp.judulKonfirmasi,
