...
namespace AppPengguna.KES1.PNBP.JUAL
{
    public partial class frmPuAset : Form
    {
        ...
        SvcWasdalPTJualAsetPnbpSelect.OutputParameters dOutDaftarAset;
        SvcWasdalPTJualAsetPnbpSelect.execute_pttClient ambilDaftarAset;
        SvcWasdalPTJualAsetPnbpSelect.WASDALSROW_DTLSEL_JUAL_PNBP dataTerpilih;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                myThread.Start();
                SvcWasdalPTJualAsetPnbpSelect.InputParameters parInp = new SvcWasdalPTJualAsetPnbpSelect.InputParameters();
                parInp.P_COL = "";
                ...
                ambilDaftarAset = new SvcWasdalPTJualAsetPnbpSelect.execute_pttClient();
        ...
        private delegate void DsSimpanData(SvcWasdalPTJualAsetPnbpSelect.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalPTJualAsetPnbpSelect.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_DTLSEL_WASDAL_JUAL_PNBP.Count();
            ...
            {
                dataOut.SF_DTLSEL_WASDAL_JUAL_PNBP[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_DTLSEL_WASDAL_JUAL_PNBP[i]);
            }
        ...
        public SvcWasdalPTJualAsetPnbpSelect.WASDALSROW_DTLSEL_JUAL_PNBP daftarAsetTerpilih;
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalPTJualAsetPnbpSelect.WASDALSROW_DTLSEL_JUAL_PNBP)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
