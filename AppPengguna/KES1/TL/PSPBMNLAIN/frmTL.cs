...
namespace AppPengguna.KES1.TL.PSPBMNLAIN 
{
    ...
    public partial class frmTL : DevExpress.XtraEditors.XtraForm
    {
        ...
        SvcWasdalLainTindakLanjutDetilCud.call_pttClient svcWasdalLainTindakLanjutDetilCud = null;
        SvcWasdalLainTindakLanjutDetilCud.OutputParameters dataoutWlPSPBMNLAINDetailCrud = null;

        ucRTLPspBmnLainForm ucPSPBMNLAIN;
        ...
        public frmTL(ucRTLPspBmnLainForm _ucPSPBMNLAIN)
        {
            InitializeComponent();
     ...
     //       teDokPelaksana.Properties.DataSource = outputJnsDok.SF_ROW_R_JNS_DOK;
           ...
           try
            {
                ...
                svcWasdalLainTindakLanjutDetilCud = new SvcWasdalLainTindakLanjutDetilCud.call_pttClient();
                svcWasdalLainTindakLanjutDetilCud.Beginexecute(parInp, new AsyncCallback(resultPSPBMNLAINDetailCrud), "");
            }
            catch
            {
        ...
        private void resultPSPBMNLAINDetailCrud(IAsyncResult result)
        {
            try
            {
                dataoutWlPSPBMNLAINDetailCrud = svcWasdalLainTindakLanjutDetilCud.Endexecute(result);
                svcWasdalLainTindakLanjutDetilCud.Close();
                this.setThread(false);
        ...
        private delegate void ResponWlPSPBMNLAINDetailCrud(SvcWasdalLainTindakLanjutDetilCud.OutputParameters dataoutWlDetailCrud);
        private void responWlPSPBMNLAINDetailCrud(SvcWasdalLainTindakLanjutDetilCud.OutputParameters dataoutWlDetailCrud)
        {
