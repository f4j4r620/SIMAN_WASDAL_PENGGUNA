...
namespace AppPengguna.KSK.TL.ASPBMN
{
    ...
    public partial class frmTL : DevExpress.XtraEditors.XtraForm
    {
        ...
        SvcWasdalOtherDetailCud.call_pttClient svcWasdalOtherDetailCud = null;
        SvcWasdalOtherDetailCud.OutputParameters dataoutWlASPBMNDetailCrud = null;


        ucRTLAspBmnForm ucASPBMN;
        ...
        public frmTL(ucRTLAspBmnForm _ucASPBMN, string _daftarAset)
        {
            InitializeComponent();
            this.ucASPBMN = _ucASPBMN;
        ...
        #region CRUD ASET
        public void crudWlDetailASPBMN()
        {
            try
            {
                this.setThread(true);
                ...
                svcWasdalOtherDetailCud = new SvcWasdalOtherDetailCud.call_pttClient();
                if (this.skKeputusan != "-")
                {
                    svcWasdalOtherDetailCud.Beginexecute(parInp, new AsyncCallback(resultASPBMNDetailCrud), "");
                }
                else
                {
                    this.setThread(false);
        ...
        private void resultASPBMNDetailCrud(IAsyncResult result)
        {
            try
            {
                dataoutWlASPBMNDetailCrud = svcWasdalOtherDetailCud.Endexecute(result);
                svcWasdalOtherDetailCud.Close();
                this.setThread(false);
                this.Invoke(new ResponWlASPBMNDetailCrud(this.responWlASPBMNDetailCrud), dataoutWlASPBMNDetailCrud);
        ...
        private delegate void ResponWlASPBMNDetailCrud(SvcWasdalOtherDetailCud.OutputParameters dataoutWlASPBMNDetailCrud);
        private void responWlASPBMNDetailCrud(SvcWasdalOtherDetailCud.OutputParameters dataoutWlASPBMNDetailCrud)
        {
            if (dataoutWlASPBMNDetailCrud.PO_RESULT == "Y")
            {
                ...
                ucASPBMN.getDaftarAset();
                
            }
            else
            {
                MessageBox.Show(dataoutWlASPBMNDetailCrud.PO_RESULT_MESSAGE, konfigApp.judulGagal);
            }
        }
