...
namespace AppPengguna.KES1.TL.PENJUALAN  
{
    public partial class frmPuAset : Form
    {
        ...
        SvcWasdalPTJualSelect.OutputParameters dOutDaftarAset;
        SvcWasdalPTJualSelect.execute_pttClient ambilDaftarAset;
        SvcWasdalPTJualSelect.WASDALSROW_WASDAL_PT_JUAL dataTerpilih;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                myThread.Start();
                //SvcWasdalPTJualSelect.InputParameters parInp = new SvcWasdalPTJualSelect.InputParameters();
                SvcWasdalPTJualSelect.InputParameters parInp = new SvcWasdalPTJualSelect.InputParameters();
                parInp.P_COL = "";
        ...
        private delegate void DsSimpanData(SvcWasdalPTJualSelect.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalPTJualSelect.OutputParameters dataOut)
        {
        ...
        public SvcWasdalPTJualSelect.WASDALSROW_WASDAL_PT_JUAL daftarAsetTerpilih;
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalPTJualSelect.WASDALSROW_WASDAL_PT_JUAL)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
