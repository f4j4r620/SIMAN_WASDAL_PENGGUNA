...
{
    public partial class ucRTLBGSForm : UserControl
    {
        ...
        public ucRTLBGSForm(string _status)
        {
            InitializeComponent();
            statusForm = _status;
        ...
        KSK.TL.PU.frmPuAset formDaftarAsetSatker;
        KSK.TL.PU.frmPuAset formDaftarAsetKorwil;
        KSK.TL.PU.frmPuAset formDaftarAsetEselon1;
        KSK.TL.PU.frmPuAset formDaftarAsetKl;
        ...
        private void sbTambah_Click(object sender, EventArgs e)
        {
            ...
            //    {
            //        formDaftarAsetSatker = new KSK.TL.PU.frmPuAset()
            //        {
            //            toggleProgressBar = new ToggleProgressBar(toggleProgBarPu),
            ...
            //    {
            //        formDaftarAsetKorwil = new KSK.TL.PU.frmPuAset()
            //        {
            //            toggleProgressBar = new ToggleProgressBar(toggleProgBarPu),
            //            simpanAsetTerpilih = new SimpanDaftarAsetTerpilih(simpanDaftarAset)
            //        };
            ...
            //    {
            //        formDaftarAsetEselon1 = new KSK.TL.PU.frmPuAset()
            //        {
            //            toggleProgressBar = new ToggleProgressBar(toggleProgBarPu),
            //            simpanAsetTerpilih = new SimpanDaftarAsetTerpilih(simpanDaftarAset)
            //        };
            ...
            //    {
            //        formDaftarAsetKl = new KSK.TL.PU.frmPuAset()
            //        {
            //            toggleProgressBar = new ToggleProgressBar(toggleProgBarPu),
            //            simpanAsetTerpilih = new SimpanDaftarAsetTerpilih(simpanDaftarAset)
            //        };
        ...
        private void dsDaftarAset(SvcWasdalManfaatDetailCrud.OutputParameters dataOut)
        {
            if (dataOut.PO_RESULT == "Y")
            {
                ...
                SvcWasdalManfaatSelect.WASDALSROW_WASDAL_MANFAAT dataPenyama = null;
                ...
                switch (modeCudAset)
                {
                    ...
                    case 'U':
                        ...
                        //dataPenyama.KUANTITAS = Convert.ToDecimal(formPuPenetapan.teKuantitas.Text); kalo dipake error
                        dataPenyama.KUANTITAS = dataTerpilih.KUANTITAS_SK;
                        ...
                        dataPenyama.NILAI_PERSETUJUAN = dataTerpilih.NILAI_PENETAPAN;
        ...
        KSK.TL.PU.frmPuPenetapan formPuPenetapan;
        //KSK.TL.PPBMN.frmTL formTL;
        ...
        private void formUbahPenetapan()
        {
            ...
            //    {
            //        formPuPenetapan = new KSK.TL.PU.frmPuPenetapan() { simpanDataPenetapan = new SimpanDaftarAsetTerpilih(simpanDaftarAset) };
            //    }
        ...
        {
            //formUbahPenetapan();
            //formTL = new KSK.TL.PPBMN.frmTL(this, dataAsetTerpilih.ID_ASET.ToString());
        ...
        private void btnUpTindakLanjut_Click(object sender, EventArgs e)
        {
            ...
            if (rowTerpilih != null)
            {
                ...
                else
                {
                    ...
                    {
                        daftarAsetTerpilih = (SvcWasdalManfaatSelect.WASDALSROW_WASDAL_MANFAAT)daftarTerpilih[i];
                        kdStatus = dataAsetTerpilih.KD_STATUS;
                        daftarIdAset = String.Format("{0}{1};", daftarIdAset, daftarAsetTerpilih.ID_ASET);
                    }
                    daftarIdAset = daftarIdAset.TrimEnd(';');
                    if (MessageBox.Show("Apakah Anda ingin menindaklanjuti Daftar Aset yang terpilih?", konfigApp.judulKonfirmasi,
                        MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes)
                    {
                        //formTL = new KSK.TL.PPBMN.frmTL(this, daftarIdAset);
                        //formTL.skKeputusan = dataAsetTerpilih.SK_KEPUTUSAN;
                        //formTL.ShowDialog();
