...
namespace AppPengguna.KES1.TL.PBKPP
{
    public partial class frmPuSk : Form
    {
        ...
        public PilihSkHapus pilihSkPM = null;  

        SvcWasdalHapusSkTLSelect.OutputParameters dOutDaftarSk;
        SvcWasdalHapusSkTLSelect.execute_pttClient ambilDaftarSk;
        SvcWasdalHapusSkTLSelect.WASDALSROW_SK_WASDAL_HAPUS_TL dataTerpilih;
        ...
        public void getInitialData()
        {
            try
            {
                ...
                myThread.Start();
                SvcWasdalHapusSkTLSelect.InputParameters parInp = new SvcWasdalHapusSkTLSelect.InputParameters();
                parInp.P_COL = "";
                ...
                parInp.STR_WHERE = String.Format(" NO_BUKTI_LAKSANA = NULL AND KD_PELAYANAN = '{0}' AND ID_PEMOHON = {1} {2}", konfigApp.kdPelayanan, konfigApp.idSatker, this.strCari);
                ambilDaftarSk = new SvcWasdalHapusSkTLSelect.execute_pttClient();
                ambilDaftarSk.Open();
        ...
        private delegate void DsSimpanData(SvcWasdalHapusSkTLSelect.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalHapusSkTLSelect.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_SK_WASDAL_HAPUS_TL.Count();
            ...
            {
                dataOut.SF_SK_WASDAL_HAPUS_TL[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_SK_WASDAL_HAPUS_TL[i]);
            }
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalHapusSkTLSelect.WASDALSROW_SK_WASDAL_HAPUS_TL)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
