    ...
    public partial class frmPuAset : Form
    {
        ...
        public void getInitialData()
        {
            try
            {
                ...
                SvcWasdalManfaatAsetPnbpSelect.InputParameters parInp = new SvcWasdalManfaatAsetPnbpSelect.InputParameters();
                parInp.P_COL = "";
        ...
        private delegate void DsSimpanData(SvcWasdalManfaatAsetPnbpSelect.OutputParameters dataOut);

        private void dsSimpanData(SvcWasdalManfaatAsetPnbpSelect.OutputParameters dataOut)
        {
            int jmlData = dataOut.SF_DTLSEL_WASDAL_MANFAAT_PNBP.Count();
            ...
            {
                dataOut.SF_DTLSEL_WASDAL_MANFAAT_PNBP[i].NUMSpecified = false;
                dsGridData.Add(dataOut.SF_DTLSEL_WASDAL_MANFAAT_PNBP[i]);
            }
        ...
        private void gvAset_FocusedRowChanged(object sender, DevExpress.XtraGrid.Views.Base.FocusedRowChangedEventArgs e)
        {
            ...
            if (rowTerpilih.SelectedRowsCount > 0) dataTerpilih = (SvcWasdalManfaatAsetPnbpSelect.WASDALSROW_DTLSEL_MANFAAT_PNBP)rowTerpilih.GetRow(e.FocusedRowHandle);
        }
